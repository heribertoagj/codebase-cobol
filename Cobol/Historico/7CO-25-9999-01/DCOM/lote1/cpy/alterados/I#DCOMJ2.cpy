...
FS2511           15  WRK-CCNPJ-AVAL         PIC  X(09).
FS2511           15  WRK-FILIAL-AVAL        PIC  X(04).
                 15  WRK-CCTRL-AVAL         PIC  9(02).
                 15  WRK-NOME-AVAL          PIC  X(40).
                 15  WRK-DATA-ADITAMENTO    PIC  X(10).
FS2511           15  WRK-CCNPJ-CEDENTE      PIC  X(09).
FS2511           15  WRK-FILIAL-CEDENTE     PIC  X(04).
                 15  WRK-CCTRL-CEDENTE      PIC  9(02).
FS2511           15  WRK-CCNPJ-SACADO       PIC  X(09).
FS2511           15  WRK-FILIAL-SACADO      PIC  X(04).
...
FS2511           15  WRK-COMU-CCNPJ-EMIT    PIC  X(09).
FS2511           15  WRK-COMU-CFLIAL-EMIT   PIC  X(04).
