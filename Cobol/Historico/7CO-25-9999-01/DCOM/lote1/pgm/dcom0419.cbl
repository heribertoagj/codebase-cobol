      ...
      *     DATA........: 05/02/2007                                   *
      *----------------------------------------------------------------*
      *     OBJETIVO....: CANCELAR CONTRATO - DETALHE                  *
      *----------------------------------------------------------------*
      *     TELAS.......:                                              *
      *     DCOMDSTM  -   CANCELAR OPERACAO - DEMONSTRATIVO            *
      *----------------------------------------------------------------*
      *     INC'S.......:                                              *
...
WIP001*================================================================*
      ...
      *----------------------------------------------------------------*
      *           *** DCOM0419 - INICIO DA AREA DE WORKING ***         *
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-AUXILIARES.
           05  WRK-SQLCA-419           PIC  X(136)       VALUE SPACES.
       ...
       01  WRK-MENS-5143.
           05  WRK-RET-5143            PIC  X(004)       VALUE SPACES.
           05  WRK-TRACO-5143          PIC  X(001)       VALUE '-'.
           05  WRK-MENS-5143           PIC  X(074)       VALUE SPACES.
...
FS2511         05  4170-SAI-CFLIAL-CNPJ      PIC  X(04).
      ...
      *----------------------------------------------------------------*
      ...
      /---------------------------------------------------------------*
      *  AREA DA BRAD0660 COM MASCARA DA TELA DCOMDSTM - SEGMENTO 00  *
      *---------------------------------------------------------------*
...
FS2511         10  COMU-FILIAL         PIC  X(04)        VALUE SPACES.
      ...
      *---------------------------------------------------------------
      *        *** AREA DE COMUNICACAO CHAMADO DCOM0417
      *---------------------------------------------------------------

       01  COMU-AREA-417.
           05  COMU-LL-417            PIC S9(004) COMP    VALUE +244.
           05  COMU-ZZ-417            PIC S9(004) COMP    VALUE ZEROS.
           05  COMU-TRANCODE-417.
               10  COMU-TRANSACAO-417 PIC  X(008)         VALUE SPACES.
               10  FILLER             PIC  X(007)         VALUE SPACES.
           05  COMU-SENHAS-417        PIC  X(037)         VALUE SPACES.
           05  COMU-COMANDO-417       PIC  X(068)         VALUE SPACES.
           05  COMU-OPCAO-417         PIC  9(001)         VALUE ZEROS.
           05  COMU-TMSTAMP-417       PIC  X(026)         VALUE SPACES.
           05  COMU-CONTRATO-417      PIC  9(009)         VALUE ZEROS.
           05  COMU-CODAGE-417        PIC  9(005)         VALUE ZEROS.
           05  COMU-MENSA-417         PIC  X(079)         VALUE SPACES.

      *---------------------------------------------------------------
      *        *** AREA DE COMUNICACAO CHAMADO DCOM0418
      *---------------------------------------------------------------

       01  COMU-AREA-418.
           05  COMU-LL-418            PIC S9(004) COMP    VALUE +276.
           05  COMU-ZZ-418            PIC S9(004) COMP    VALUE ZEROS.
           05  COMU-TRANCODE-418.
               10  COMU-TRANSACAO-418 PIC  X(008)         VALUE SPACES.
               10  FILLER             PIC  X(007)         VALUE SPACES.
           05  COMU-SENHAS-418        PIC  X(037)         VALUE SPACES.
           05  COMU-COMANDO-418       PIC  X(068)         VALUE SPACES.
           05  COMU-OPCAO-418         PIC  9(001)         VALUE ZEROS.
           05  COMU-TMSTAMP-418       PIC  X(026)         VALUE SPACES.
           05  COMU-CONTRATO-418      PIC  9(009)         VALUE ZEROS.
           05  COMU-CODAGE-418-X.
               10  COMU-CODAGE-418-N  PIC  9(005)         VALUE ZEROS.
           05  COMU-CONTA-418-X.
               10  COMU-CONTA-418-N   PIC  9(013)         VALUE ZEROS.
           05  COMU-NUMERO-418-X.
FS2511*        10  COMU-NUMERO-418-N  PIC  9(009)         VALUE ZEROS.
FS2511         10  COMU-NUMERO-418-N  PIC  X(009)         VALUE ZEROS.
           05  COMU-FILIAL-418-X.
FS2511*        10  COMU-FILIAL-418-N  PIC  9(004)         VALUE ZEROS.
FS2511         10  COMU-FILIAL-418-N  PIC  X(04)          VALUE SPACES.
           05  COMU-CONTROLE-418-X.
               10  COMU-CONTROLE-418-N PIC 9(002)         VALUE ZEROS.
           05  COMU-PAGINA-418         PIC 9(004)         VALUE ZEROS.
           05  COMU-MENSA-418          PIC X(079)         VALUE SPACES.
...
WIP001
      ...
      *----------------------------------------------------------------*
      *        *** DCOM0419 - FIM DA AREA DE WORKING ***               *
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  'DCOMDSTM'             TO WRK-TELA.

           IF WRK-TRANSACAO            NOT EQUAL  'DCOM0419'
              PERFORM  2100-RECEBER-CONTROLE
           ELSE
              PERFORM  2200-PROCESSAR-MENSAGEM
           END-IF.

           IF WRK-TELA                 EQUAL  'DCOMDSTM'
      ...
      *----------------------------------------------------------------*
           ...
           IF WRK-TRANSACAO            EQUAL 'DCOM0413'
              ...
              MOVE COMU-OPERACAO-413      TO INP-CONTRAT
                                             ...
                                             WRK-CONTRATO-4170
           ELSE
            IF WRK-TRANSACAO           EQUAL 'DCOM0417'
               MOVE WRK-MENSAGEM          TO COMU-AREA-417
               MOVE COMU-TRANSACAO-417    TO INP-TRANSAC
                                             OUT-TRANSAC
               MOVE COMU-OPCAO-417        TO INP-OPCAO
                                             OUT-OPCAO
               MOVE COMU-TMSTAMP-417      TO INP-TMSTAMP
                                             OUT-TMSTAMP
               MOVE COMU-CONTRATO-417     TO INP-CONTRAT
                                             OUT-CONTRAT
                                             WRK-4128E-CCONTR-LIM-DESC
                                             ROTENT-CCONTR-LIM-DESC-4113
                                             WRK-CONTRATO-4170
            ELSE
            IF WRK-TRANSACAO           EQUAL 'DCOM0418'
               MOVE WRK-MENSAGEM          TO COMU-AREA-418
               MOVE COMU-TRANSACAO-418    TO INP-TRANSAC
                                             OUT-TRANSAC
               MOVE COMU-OPCAO-418        TO INP-OPCAO
                                             OUT-OPCAO
               MOVE COMU-TMSTAMP-418      TO INP-TMSTAMP
                                             OUT-TMSTAMP
               MOVE COMU-CONTRATO-418     TO INP-CONTRAT
                                             OUT-CONTRAT
                                             WRK-4128E-CCONTR-LIM-DESC
                                             ROTENT-CCONTR-LIM-DESC-4113
                                             WRK-CONTRATO-4170
               MOVE COMU-PAGINA-418       TO INP-PAGINA
                                             OUT-PAGINA
               IF   COMU-CODAGE-418-N     GREATER  ZEROS
...
WIP001     IF  WRK-ERRO-ACESSO        EQUAL  'N'
WIP001         PERFORM 2114-VALIDAR-OPTIN
WIP001     END-IF.
WIP001
WIP001     IF  WRK-INCONSIS           EQUAL '*'
WIP001         MOVE WRK-5124S-MSG-RETORNO
WIP001                                TO OUT-MENSAG
WIP001         MOVE 'N'               TO WRK-EFETUADO
WIP001         MOVE 'S'               TO WRK-PERFIL
WIP001         PERFORM 2220-RETORNAR-CHAMADOR
WIP001         GO TO 2100-99-FIM
WIP001     END-IF.
WIP001
           ...
           IF  WRK-ERRO-ACESSO        EQUAL  'N'
               MOVE  'TECLE <PF6> PARA EFETIVAR O CANCELAMENTO OU <PF3>
      -        'PARA RETORNAR'           TO  OUT-MENSAG
           END-IF.
...
WIP001*----------------------------------------------------------------*
WIP001 2114-VALIDAR-OPTIN              SECTION.
WIP001*----------------------------------------------------------------*
WIP001*
...
WIP001                WRK-SQLCA.
WIP001*
WIP001     MOVE INP-CONTRAT-N          TO WRK-5124E-CCONTR-LIM.
...
WIP001
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE WRK-4128S-COD-RETORNO
               WHEN  '0000'
                   ...
                   MOVE WRK-4128S-IPSSOA-DESC-COML
                                              TO OUT-NOME
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'DCOM0419'           TO COMU-TRANSACAO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  WRK-MENSAGEM          TO  INPUT-DSTM.
      ...
      *----------------------------------------------------------------*
           ...
           IF  INP-TRANSAC                 EQUAL 'DCOM0413'
               ...
               ELSE
                   MOVE 'CANCELAMENTO EFETUADO COM SUCESSO'
                                           TO COMU-MENSAG
               END-IF
               ...
               MOVE  COMU-AREA             TO  WRK-MENSAGEM
           ELSE
            IF INP-TRANSAC                 EQUAL 'DCOM0417'
               INITIALIZE                      COMU-AREA-417
               MOVE  LENGTH COMU-AREA-417  TO  COMU-LL-417
               MOVE  ZEROS                 TO  COMU-ZZ-417
               MOVE  WRK-CHNG              TO  WRK-FUNCAO
               MOVE  'DCOM0417'            TO  WRK-TELA
               MOVE  'DCOM0419'            TO  COMU-TRANSACAO-417
               MOVE  INP-SENHAS            TO  COMU-SENHAS-417
               MOVE  INP-COMANDO           TO  COMU-COMANDO-417
               MOVE  INP-OPCAO             TO  COMU-OPCAO-417
               MOVE  INP-TMSTAMP           TO  COMU-TMSTAMP-417
               MOVE  INP-CONTRAT           TO  COMU-CONTRATO-417
               MOVE  INP-AGENC(01:05)      TO  WRK-AGENCIA
               MOVE  WRK-AGENCIA           TO  COMU-CODAGE-417
               IF    WRK-EFETUADO          NOT EQUAL 'S'
                     MOVE  SPACES          TO  COMU-MENSA-417
               ELSE
                     MOVE 'CANCELAMENTO EFETUADO COM SUCESSO'
                                           TO COMU-MENSA-417
               END-IF
               MOVE  COMU-AREA-417         TO  WRK-MENSAGEM
           ELSE
            IF INP-TRANSAC                 EQUAL 'DCOM0418'
               INITIALIZE                      COMU-AREA-418
               MOVE  LENGTH COMU-AREA-418  TO  COMU-LL-418
               MOVE  ZEROS                 TO  COMU-ZZ-418
               MOVE  WRK-CHNG              TO  WRK-FUNCAO
               MOVE  'DCOM0418'            TO  WRK-TELA
               MOVE  'DCOM0419'            TO  COMU-TRANSACAO-418
               MOVE  INP-SENHAS            TO  COMU-SENHAS-418
               MOVE  INP-COMANDO           TO  COMU-COMANDO-418
               MOVE  INP-OPCAO             TO  COMU-OPCAO-418
               MOVE  INP-TMSTAMP           TO  COMU-TMSTAMP-418
               MOVE  INP-CONTRAT           TO  COMU-CONTRATO-418
               MOVE  INP-PAGINA            TO  COMU-PAGINA-418
               IF  INP-TIPO              EQUAL  1
                   MOVE  INP-AGENC(01:05)    TO COMU-CODAGE-418-X
                   MOVE  INP-CONTA           TO COMU-CONTA-418-X
                   MOVE  SPACES              TO COMU-NUMERO-418-X
                                                COMU-FILIAL-418-X
                                                COMU-CONTROLE-418-X
               ELSE
                   MOVE  SPACES              TO COMU-CODAGE-418-X
                   MOVE  SPACES              TO COMU-CONTA-418-X
                   MOVE  INP-CNPJCPF(01:03)  TO COMU-NUMERO-418-X(01:03)
                   MOVE  INP-CNPJCPF(05:03)  TO COMU-NUMERO-418-X(04:03)
                   MOVE  INP-CNPJCPF(09:03)  TO COMU-NUMERO-418-X(07:03)
                   MOVE  INP-CNPJCPF(13:04)  TO COMU-FILIAL-418-X
                   MOVE  INP-CNPJCPF(18:02)  TO COMU-CONTROLE-418-X
               END-IF
               IF    WRK-EFETUADO          NOT EQUAL 'S'
                     MOVE  SPACES          TO  COMU-MENSA-418
               ELSE
                     MOVE 'CANCELAMENTO EFETUADO COM SUCESSO'
                                           TO  COMU-MENSA-418
               END-IF
            MOVE     COMU-AREA-418               TO  WRK-MENSAGEM
            END-IF
            END-IF
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE ROTSAI-COD-RETORNO
               ...
               WHEN '0000'
                   MOVE 'CANCELAMENTO EFETUADO COM SUCESSO TECLE <PFK3>
      -                 'PARA NOVO CANCELAMENTO'  TO OUT-MENSAG
                   MOVE 'S'                       TO WRK-EFETUADO
                   PERFORM 2220-RETORNAR-CHAMADOR
      ...
      *----------------------------------------------------------------*
           ...
           CALL  'BRAD0660'            USING  OUTPUT-DSTM
                                              660-DCOMDSTM.
           ...
           MOVE  OUTPUT-DSTM           TO  WRK-MENSAGEM.
      ...
      *----------------------------------------------------------------*
           ...
           IF ERR-MODULO    NOT EQUAL  SPACES  AND  LOW-VALUES
              MOVE  'DCOM0419'         TO  ERR-PGM
           ELSE
              MOVE  'SENHAS02'         TO  ERR-PGM
              MOVE  'DCOM0419'         TO  ERR-MODULO
           END-IF.
