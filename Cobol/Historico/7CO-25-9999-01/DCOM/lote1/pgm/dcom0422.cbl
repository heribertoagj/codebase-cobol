      ...
      *     DATA........: 14/03/2007                                   *
      *----------------------------------------------------------------*
      *     OBJETIVO....: CONSULTA CONTRATO LIMITE - DETALHE           *
      *----------------------------------------------------------------*
      *     TELAS.......:                                              *
      *     DCOMDVTM  -   LIBERAR OPERACAO - DEMONSTRATIVO             *
      *----------------------------------------------------------------*
      *     INC'S.......:                                              *
      ...
      *----------------------------------------------------------------*
      *           *** DCOM0422 - INICIO DA AREA DE WORKING ***         *
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-AUXILIARES.
           05  WRK-SQLCA-422           PIC  X(136)       VALUE SPACES.
...
FS2511      05  4170-SAI-CFLIAL-CNPJ      PIC  X(04).
      ...
      *----------------------------------------------------------------*
      *        *** AREA DA TELA DCOMDVTM  -  OUTPUT ***                *
      *----------------------------------------------------------------*

       01  OUTPUT-DVTM.
           05  OUT-LL                    PIC S9(004) COMP VALUE +598.
      ...
      /---------------------------------------------------------------*
      *  AREA DA BRAD0660 COM MASCARA DA TELA DCOMDVTM - SEGMENTO 00  *
      *---------------------------------------------------------------*

       01  660-DCOMDVTM.
           05  660-LL-AREA             PIC  9(04)  COMP  VALUE 0066.
           05  660-LL-MENSAGEM         PIC  9(04)  COMP  VALUE 0598.
      ...
      *---------------------------------------------------------------*
      *    AREA DE RETORNO PARA O MODULO DCOM0413                     *
      *---------------------------------------------------------------*
...
FS2511         10  COMU-FILIAL         PIC  X(04)     VALUE SPACES.
      ...
      *---------------------------------------------------------------
      *        *** AREA DE COMUNICACAO CHAMADO DCOM0420
      *---------------------------------------------------------------

       01  COMU-AREA-420.
           05  COMU-LL-420            PIC S9(004) COMP    VALUE +165.
           05  COMU-ZZ-420            PIC S9(004) COMP    VALUE ZEROS.
           05  COMU-TRANCODE-420.
               10  COMU-TRANSACAO-420 PIC  X(008)         VALUE SPACES.
               10  FILLER             PIC  X(007)         VALUE SPACES.
           05  COMU-SENHAS-420        PIC  X(037)         VALUE SPACES.
           05  COMU-COMANDO-420       PIC  X(068)         VALUE SPACES.
           05  COMU-OPCAO-420         PIC  X(001)         VALUE SPACES.
           05  COMU-TMSTAMP-420       PIC  X(026)         VALUE SPACES.
           05  COMU-CONTRATO-420      PIC  9(009)         VALUE ZEROS.
           05  COMU-CODAGE-420        PIC  9(005)         VALUE ZEROS.

      *---------------------------------------------------------------
      *        *** AREA DE COMUNICACAO CHAMADO DCOM0421
      *---------------------------------------------------------------

       01  COMU-AREA-421.
           05  COMU-LL-421            PIC S9(004) COMP    VALUE +193.
           05  COMU-ZZ-421            PIC S9(004) COMP    VALUE ZEROS.
           05  COMU-TRANCODE-421.
               10  COMU-TRANSACAO-421 PIC  X(008)         VALUE SPACES.
               10  FILLER             PIC  X(007)         VALUE SPACES.
           05  COMU-SENHAS-421        PIC  X(037)         VALUE SPACES.
           05  COMU-COMANDO-421       PIC  X(068)         VALUE SPACES.
           05  COMU-TIPO-421          PIC  9(001)         VALUE ZEROS.
           05  COMU-TMSTAMP-421       PIC  X(026)         VALUE SPACES.
           05  COMU-CONTRATO-421      PIC  9(009)         VALUE ZEROS.
           05  COMU-CODAGE-421        PIC  9(005)         VALUE ZEROS.
           05  COMU-CONTA-421         PIC  9(013)         VALUE ZEROS.
           05  COMU-NUMERO-421.
FS2511*        10  COMU-NUMERO-421-N  PIC  9(009)         VALUE ZEROS.
FS2511         10  COMU-NUMERO-421-N  PIC  X(009)         VALUE SPACES.
FS2511*    05  COMU-FILIAL-421        PIC  9(004)         VALUE ZEROS.
FS2511     05  COMU-FILIAL-421        PIC  X(04)          VALUE SPACES.
           05  COMU-CONTROLE-421      PIC  9(002)         VALUE ZEROS.
...
FS2511         05  WRK-4128S-CFLIAL-CNPJ        PIC  X(04).
      ...
      *----------------------------------------------------------------*
      *        *** DCOM0422 - FIM DA AREA DE WORKING ***               *
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  'DCOMDVTM'             TO WRK-TELA.

           IF WRK-TRANSACAO            NOT EQUAL  'DCOM0422'
              PERFORM  2100-RECEBER-CONTROLE
           ELSE
              PERFORM  2200-PROCESSAR-MENSAGEM
           END-IF.

           IF WRK-TELA                 EQUAL  'DCOMDVTM'
      ...
      *----------------------------------------------------------------*
           ...
           IF WRK-TRANSACAO            EQUAL 'DCOM0413'
              ...
              MOVE COMU-OPERACAO-413      TO INP-CONTRAT
                                             ...
                                             WRK-CONTRATO-4170
           ELSE
           IF  WRK-TRANSACAO           EQUAL 'DCOM0420'
               MOVE WRK-MENSAGEM          TO COMU-AREA-420
               MOVE COMU-TRANSACAO-420    TO INP-TRANSAC
                                             OUT-TRANSAC
               MOVE COMU-OPCAO-420        TO INP-OPCAO
                                             OUT-OPCAO
               MOVE COMU-TMSTAMP-420      TO INP-TMSTAMP
                                             OUT-TMSTAMP
               MOVE COMU-CONTRATO-420     TO INP-CONTRAT
                                             OUT-CONTRAT
                                             WRK-4128E-CCONTR-LIM-DESC
                                             ROTENT-CCONTR-LIM-DESC-4113
                                             WRK-CONTRATO-4170
           ELSE
           IF  WRK-TRANSACAO           EQUAL 'DCOM0421'
               MOVE WRK-MENSAGEM          TO COMU-AREA-421
               MOVE COMU-TRANSACAO-421    TO INP-TRANSAC
                                             OUT-TRANSAC
               MOVE COMU-TMSTAMP-421      TO INP-TMSTAMP
                                             OUT-TMSTAMP
               MOVE COMU-TIPO-421         TO INP-FASE
                                             OUT-FASE
               MOVE COMU-CONTRATO-421     TO INP-CONTRAT
                                             OUT-CONTRAT
                                             WRK-4128E-CCONTR-LIM-DESC
                                             ROTENT-CCONTR-LIM-DESC-4113
                                             WRK-CONTRATO-4170
           ...
           IF  WRK-ERRO-ACESSO        EQUAL  'N'
               MOVE  SG-MENSAGEM(0046)    TO  OUT-MENSAG
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF R6416S-COD-RETORNO       EQUAL ZEROS
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  WRK-MENSAGEM          TO  INPUT-DVTM.
      ...
      *----------------------------------------------------------------*
           ...
           IF  INP-TRANSAC                 EQUAL 'DCOM0413'
               ...
               MOVE  'DCOM0422'            TO  COMU-TRANSACAO
               MOVE  INP-OPCAO             TO  COMU-OPCAO
               MOVE  INP-TMSTAMP           TO  COMU-TMSTAMP

               IF    WRK-PERFIL            EQUAL 'S' OR
                     WRK-INCONSIS          EQUAL '*'
           ...
           ELSE
           IF  INP-TRANSAC                 EQUAL 'DCOM0420'
               INITIALIZE                      COMU-AREA-420
               MOVE  LENGTH COMU-AREA-420  TO  COMU-LL-420
               MOVE  ZEROS                 TO  COMU-ZZ-420
               MOVE  WRK-CHNG              TO  WRK-FUNCAO
               MOVE  'DCOM0420'            TO  WRK-TELA
               MOVE  'DCOM0422'            TO  COMU-TRANSACAO-420
               MOVE  INP-SENHAS            TO  COMU-SENHAS-420
               MOVE  INP-COMANDO           TO  COMU-COMANDO-420
               MOVE  INP-OPCAO             TO  COMU-OPCAO-420
               MOVE  INP-TMSTAMP           TO  COMU-TMSTAMP-420
               MOVE  INP-CONTRAT           TO  COMU-CONTRATO-420
               MOVE  INP-AGENC(01:05)      TO  WRK-AGENCIA
               MOVE  WRK-AGENCIA           TO  COMU-CODAGE-420
               MOVE  COMU-AREA-420         TO  WRK-MENSAGEM
           ELSE
           IF  INP-TRANSAC                 EQUAL 'DCOM0421'
               INITIALIZE                      COMU-AREA-421
               MOVE  LENGTH COMU-AREA-421  TO  COMU-LL-421
               MOVE  ZEROS                 TO  COMU-ZZ-421
               MOVE  WRK-CHNG              TO  WRK-FUNCAO
               MOVE  'DCOM0421'            TO  WRK-TELA
               MOVE  'DCOM0422'            TO  COMU-TRANSACAO-421
               MOVE  INP-SENHAS            TO  COMU-SENHAS-421
               MOVE  INP-COMANDO           TO  COMU-COMANDO-421
               MOVE  INP-TMSTAMP           TO  COMU-TMSTAMP-421
               MOVE  INP-FASE              TO  COMU-TIPO-421
               MOVE  INP-CONTRAT           TO  COMU-CONTRATO-421
               MOVE  INP-AGENC(01:05)      TO  WRK-AGENCIA
               MOVE  WRK-AGENCIA           TO  COMU-CODAGE-421
               MOVE  INP-CONTA-N           TO  COMU-CONTA-421
               MOVE  INP-CNPJCPF(01:03)    TO  COMU-NUMERO-421(1:3)
               MOVE  INP-CNPJCPF(05:03)    TO  COMU-NUMERO-421(4:3)
               MOVE  INP-CNPJCPF(09:03)    TO  COMU-NUMERO-421(7:3)
               MOVE  INP-CNPJCPF(13:04)    TO  COMU-FILIAL-421
               MOVE  INP-CNPJCPF(18:02)    TO  COMU-CONTROLE-421
               MOVE  COMU-AREA-421         TO  WRK-MENSAGEM
           END-IF
           END-IF
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           CALL  'BRAD0660'            USING  OUTPUT-DVTM
                                              660-DCOMDVTM.
           ...
           MOVE  OUTPUT-DVTM           TO  WRK-MENSAGEM.
      ...
      *----------------------------------------------------------------*
           ...
           IF ERR-MODULO    NOT EQUAL  SPACES  AND  LOW-VALUES
              MOVE  'DCOM0422'         TO  ERR-PGM
           ELSE
              MOVE  'SENHAS02'         TO  ERR-PGM
              MOVE  'DCOM0422'         TO  ERR-MODULO
           END-IF.
