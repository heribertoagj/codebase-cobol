      ******************************************************************
      * DCLGEN TABLE(DB2PRD.ERRO_ENDER_ESTBL)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB004))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB004)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.ERRO_ENDER_ESTBL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.ERRO_ENDER_ESTBL            *
      ******************************************************************
       01  BVVEB004.
      *    *************************************************************
