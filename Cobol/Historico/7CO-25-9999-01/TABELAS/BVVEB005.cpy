      ******************************************************************
      * DCLGEN TABLE(DB2PRD.ERRO_FONE_ESTBL)                           *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB005))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB005)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.ERRO_FONE_ESTBL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.ERRO_FONE_ESTBL             *
      ******************************************************************
       01  BVVEB005.
      *    *************************************************************
