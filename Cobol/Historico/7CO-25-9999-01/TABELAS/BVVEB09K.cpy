      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TIMAGE_AGNDA_FINCR_RECPC)                  *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB09K))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB09K)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TIMAGE_AGNDA_FINCR_RECPC TABLE
           ( DMOVTO                         DATE NOT NULL,
             NIMAGE_AGNDA_RECPC             DECIMAL(9, 0) NOT NULL,
             NHEAD_AGNDA_RECPC              DECIMAL(5, 0) NOT NULL,
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TIMAGE_AGNDA_FINCR_RECPC    *
      ******************************************************************
       01  BVVEB09K.
      *    *************************************************************
           10 DMOVTO               PIC X(10).
      ...
      *    *************************************************************
           10 NHEAD-AGNDA-RECPC    PIC S9(5)V USAGE COMP-3.
      *    *************************************************************
