      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TFORNC_DESC_COML)                          *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0A3))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0A3)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TFORNC_DESC_COML TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TFORNC_DESC_COML            *
      ******************************************************************
       01  DCOMB0A3.
      *    *************************************************************
