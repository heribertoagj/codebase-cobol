      ******************************************************************
      * DCLGEN TABLE(DB2PRD.THIST_FORNC_DESC)                          *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0B1))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0B1)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.THIST_FORNC_DESC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.THIST_FORNC_DESC            *
      ******************************************************************
       01  DCOMB0B1.
      *    *************************************************************
