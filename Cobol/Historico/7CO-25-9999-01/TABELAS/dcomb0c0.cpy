      ******************************************************************
      * DCLGEN TABLE(DB2PRD.THIST_TITLO_DESC)                          *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0C0))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0C0)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.THIST_TITLO_DESC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.THIST_TITLO_DESC            *
      ******************************************************************
       01  DCOMB0C0.
      *    *************************************************************
