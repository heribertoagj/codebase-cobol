      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TOPER_MEIO_LIBRC)                          *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0C7))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0C7)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TOPER_MEIO_LIBRC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TOPER_MEIO_LIBRC            *
      ******************************************************************
       01  DCOMB0C7.
      *    *************************************************************
