      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TSMULA_CHEQC_DESC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0E0))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0E0)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TSMULA_CHEQC_DESC TABLE
           ( NSMULA_OPER_DESC               DECIMAL(9, 0) NOT NULL,
             ...
             CBCO_CLI_CHEQC                 DECIMAL(3, 0) NOT NULL,
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TSMULA_CHEQC_DESC           *
      ******************************************************************
       01  DCOMB0E0.
      *    *************************************************************
