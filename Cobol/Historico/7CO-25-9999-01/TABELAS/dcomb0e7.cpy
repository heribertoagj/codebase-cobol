      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TSMULA_TITLO_DESC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0E7))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0E7)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TSMULA_TITLO_DESC TABLE
           ( NSMULA_OPER_DESC               DECIMAL(9, 0) NOT NULL,
             ...
             CESPCE_TITLO_COBR              DECIMAL(3, 0),
             CIDTFD_PRODT_ORIGN             DECIMAL(2, 0),
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TSMULA_TITLO_DESC           *
      ******************************************************************
       01  DCOMB0E7.
      *    *************************************************************
