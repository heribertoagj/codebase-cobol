      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TTITLO_DESC_COML)                          *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0F1))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0F1)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TTITLO_DESC_COML TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TTITLO_DESC_COML            *
      ******************************************************************
       01  DCOMB0F1.
      *    *************************************************************
