      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TTRASI_CHEQC_DESC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0F5))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0F5)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TTRASI_CHEQC_DESC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TTRASI_CHEQC_DESC           *
      ******************************************************************
       01  DCOMB0F5.
      *    *************************************************************
