      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TTRASI_FORNC_OPER)                         *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0G0))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0G0)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TTRASI_FORNC_OPER TABLE
           ( DANO_OPER_DESC                 DECIMAL(4, 0) NOT NULL,
             ...
             CINDCD_CONF_UTILZ              CHAR(1) NOT NULL,
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TTRASI_FORNC_OPER           *
      ******************************************************************
       01  DCOMB0G0.
      *    *************************************************************
