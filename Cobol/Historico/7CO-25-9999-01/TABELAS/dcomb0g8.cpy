      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TTRASI_TITLO_OPER)                         *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0G8))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0G8)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TTRASI_TITLO_OPER TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TTRASI_TITLO_OPER           *
      ******************************************************************
       01  DCOMB0G8.
      *    *************************************************************
