      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TTRASI_MEIO_LIBRC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0H8))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0H8)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TTRASI_MEIO_LIBRC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TTRASI_MEIO_LIBRC           *
      ******************************************************************
       01  DCOMB0H8.
      *    *************************************************************
