      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TPOSIC_TITLO_ATIVO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0J3))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0J3)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TPOSIC_TITLO_ATIVO TABLE
           ( CBCO                           DECIMAL(3, 0) NOT NULL,
             ...
             VSDO_DVDOR_PCELA               DECIMAL(17, 2),
             VJURO_MORA_GERC                DECIMAL(17, 2),
             VIOF_PCELA_VENCD               DECIMAL(17, 2),
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TPOSIC_TITLO_ATIVO          *
      ******************************************************************
       01  DCOMB0J3.
      *    *************************************************************
      ...
      *    *************************************************************
           10 VSDO-DVDOR-PCELA     PIC S9(15)V9(2) USAGE COMP-3.
      *    *************************************************************
           10 VJURO-MORA-GERC      PIC S9(15)V9(2) USAGE COMP-3.
      *    *************************************************************
           10 VIOF-PCELA-VENCD     PIC S9(15)V9(2) USAGE COMP-3.
      *    *************************************************************
