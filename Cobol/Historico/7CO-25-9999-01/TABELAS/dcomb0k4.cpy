      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TPGTO_CORRC_BASIL)                         *
      *        LIBRARY(AD.DB2.DCLGEN(DCOMB0K4))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(DCOMB0K4)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TPGTO_CORRC_BASIL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TPGTO_CORRC_BASIL           *
      ******************************************************************
       01  DCOMB0K4.
      *    *************************************************************
