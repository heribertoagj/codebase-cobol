...
STEFAB 01  ACU-QTD-GLEBA-E             PIC  9(05) COMP-3   VALUE ZEROS.
...
7C2510     05 WRK-PONTO-CULTVD         OCCURS 1 TO 999 DEPENDING ON
7C2510                                 WRK-QTD-CULTVD.
7C2510        10 WRK-CULTVD-LAT        PIC X(11)           VALUE SPACES.
7C2510        10 FILLER                PIC X(01)           VALUE SPACES.
7C2510        10 WRK-CULTVD-LON        PIC X(11)           VALUE SPACES.
7C2510     05 WRK-QTD-NCULTVD          PIC 9(04) COMP-3    VALUE ZEROS.
7C2510     05 WRK-PONTO-NCULTVD        OCCURS 1 TO 999 DEPENDING ON
7C2510                                 WRK-QTD-NCULTVD.
7C2510        10 WRK-NCULTVD-LAT       PIC X(11)           VALUE SPACES.
7C2510        10 FILLER                PIC X(01)           VALUE SPACES.
7C2510        10 WRK-NCULTVD-LON       PIC X(11)           VALUE SPACES.
...
7C2510 01  IND-1                       PIC 9(03) COMP-3    VALUE ZEROS.
      ******************************************************************
       LINKAGE                         SECTION.
      ******************************************************************
...
STEFA4     MOVE  ZEROS                 TO  ACU-QTD-GLEBA-E
...
STEFA4     IF  ACU-QTD-GLEBA        EQUAL  ZEROS AND
STEFA4         ACU-QTD-GLEBA-E      EQUAL  ZEROS
...
STEFAB     MOVE  ZEROS                 TO  ACU-QTD-GLEBA-E

           PERFORM
             UNTIL  ACU-QTD-GLEBA   EQUAL  90
7C2510          OR  WRK-NUM-POLIGN  GREATER 1
...
7C2510          PERFORM  5141-MONTAR-POLIGONO
      ...
      *----------------------------------------------------------------*
7C2510     MOVE  RUCA66-COR0001-6      TO WRK-MSGEM-RURAL
7C2510                                   (ACU-POSICAO:
7C2510                                    LENGTH OF RUCA66-COR0001-6).
           ...
           DISPLAY 'QTD-CULTVD: ' WRK-QTD-CULTVD UPON CONSOLE
           DISPLAY 'QTD-NCULTVD: ' WRK-QTD-CULTVD UPON CONSOLE
...
7C2510*       XMOVE  RUCA66-COR0001-6  TO  WRK-MSGEM-RURAL(ACU-POSICAO:
7C2510*                                    LENGTH OF RUCA66-COR0001-6)
...
7C2510     ADD 1                       TO  WRK-QTD-CULTVD
           ...
           MOVE  WRK-MLATTD-IMOV-RURAL-X
7C2510                                 TO  WRK-CULTVD-LAT
7C2510                                    (WRK-QTD-CULTVD)
7C2510*                                TO  RUCA66-LAT-PONTO

           MOVE  MLOGTD-IMOV-RURAL     OF  RUCAB016
                                       TO  WRK-MLOGTD-IMOV-RURAL-N
           MOVE  WRK-MLOGTD-IMOV-RURAL-X
7C2510                                 TO  WRK-CULTVD-LON
7C2510                                    (WRK-QTD-CULTVD)
...
7C2510         MOVE  ACU-MAREA-NAO-CTVDA   TO  WRK-MAREA-NAO-CTVDA-N
7C2510         MOVE  WRK-MAREA-NAO-CTVDA-X TO  RUCA66-AREA-NCULTVD
...
STEFAB         IF  ACU-QTD-GLEBA-E     EQUAL  ZEROS
...
7C5.10*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY 'CCONTR: ' COMU-8810-CHAVE UPON CONSOLE
           DISPLAY 'DATA..: ' WRK-TIMESTAMP UPON CONSOLE
