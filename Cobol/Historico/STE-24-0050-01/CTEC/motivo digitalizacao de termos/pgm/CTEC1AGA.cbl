      ...
      *    CTECWD8E - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWD8I - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *    CTEC3AGA - ALTERAR MOTIVO DE DIGITALIZACAO                  *
      *================================================================*
      *================================================================*
      ...
      *----------------------------------------------------------------*
       77  WRK-PROGRAMA                PIC X(008) VALUE
           'CTEC1AGA'.
       77  WRK-CTEC3AGA                PIC X(008) VALUE
           'CTEC3AGA'.
      ...
      *----------------------------------------------------------------*
       01  WRK-AREA-CTEC3AGA.
           COPY 'CTECW00I'.
           COPY 'CTECWD8I'.

      *----------------------------------------------------------------*
       01  FILLER                      PIC X(050) VALUE
           '*** FIM DA WORKING CTEC1AGA ***'.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       LINKAGE                         SECTION.
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWD8E-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC CICS LINK
                 PROGRAM  (WRK-CTEC3AGA)
                 COMMAREA (WRK-AREA-CTEC3AGA)
                 LENGTH   (LENGTH OF WRK-AREA-CTEC3AGA)
                 NOHANDLE
           END-EXEC.
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE WRK-CTEC3AGA       TO FRWKGMOD-NOME-MODULO
               PERFORM 9998-TRATAR-ERRO
           END-EVALUATE.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWD8I-BLOCO-ENTRADA.

           MOVE CTECWD8E-BLOCO-ENTRADA TO CTECWD8I-BLOCO-ENTRADA.

           MOVE FRWKWAAA-CAUTEN-SEGRC(1:9)
                                       TO CTECWD8I-E-CUSUAR-MANUT.
