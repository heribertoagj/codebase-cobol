      ...
      *    CTECWD9E - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWD9I - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *    CTEC3AHE - EXCLUIR MOTIVO DE ENCERRAMENTO                   *
      *================================================================*
      *================================================================*
      ...
      *----------------------------------------------------------------*
       77  WRK-PROGRAMA                PIC X(008) VALUE
           'CTEC1AHE'.
       77  WRK-CTEC3AHE                PIC X(008) VALUE
           'CTEC3AHE'.
      ...
      *----------------------------------------------------------------*
       01  WRK-AREA-CTEC3AHE.
           COPY 'CTECW00I'.
           COPY 'CTECWD9I'.

      *----------------------------------------------------------------*
       01  FILLER                      PIC X(050) VALUE
           '*** FIM DA WORKING CTEC1AHE ***'.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       LINKAGE                         SECTION.
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWD9E-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC CICS LINK
                 PROGRAM  (WRK-CTEC3AHE)
                 COMMAREA (WRK-AREA-CTEC3AHE)
                 LENGTH   (LENGTH OF WRK-AREA-CTEC3AHE)
                 NOHANDLE
           END-EXEC.
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE WRK-CTEC3AHE       TO FRWKGMOD-NOME-MODULO
               PERFORM 9998-TRATAR-ERRO
           END-EVALUATE.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWD9I-BLOCO-ENTRADA.

           MOVE CTECWD9E-BLOCO-ENTRADA   TO CTECWD9I-BLOCO-ENTRADA.
