      ...
      *                   CTEC.SI.LISTAR.MOTIVO.DIGITALIZACAO          *  
      *----------------------------------------------------------------*
      *    BOOK'S FUNCIONAIS...:                                       *
      *    CTECW00I - AREA COMUM PARA TRATAMENTO DE ERROS              *
      *    CTECWDAE - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWDAS - AREA PARA DADOS DE SAIDA                         *
      *    CTECWDAI - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *    CTECWDAP - AREA PARA DADOS DE RESTART (PAGINACAO)           *
      *                                                                *
      ...
      *----------------------------------------------------------------*
       01  WRK-CTEC3AIL                PIC X(008) VALUE
           'CTEC3AIL'.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDAE-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWDAI-BLOCO-PAGINACAO.

           MOVE FRWKWAAA-SOLIC-MAIS-DADOS
                                       TO CTECWDAI-IND-PAGINACAO.         
           MOVE CTECWDAE-BLOCO-ENTRADA TO CTECWDAI-BLOCO-ENTRADA.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDAP-PRI-CHAVE     TO CTECWDAI-PRI-CHAVE.
                                       
           MOVE CTECWDAP-ULT-CHAVE     TO CTECWDAI-ULT-CHAVE.
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE CTECW00I-COD-MENSAGEM
                                       TO FRWKGLAQ-COD-MENSAGEM
               MOVE WRK-CTEC3AIL       TO FRWKGMOD-NOME-MODULO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDAS-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDAS-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDAP-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDAP-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.

           MOVE CTECWDAI-IND-PAGINACAO
                                       TO CTECWDAP-IND-PAGINACAO.

           MOVE CTECWDAI-BLOCO-PAGINACAO
                                       TO CTECWDAP-BLOCO-PAGINACAO.
