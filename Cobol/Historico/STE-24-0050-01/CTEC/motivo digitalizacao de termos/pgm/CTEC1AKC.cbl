      ...
      *                   CTEC.SI.DETALHAR.MOTIVO.DIGITALIZACAO        *
      *----------------------------------------------------------------*
      *    BOOK'S FUNCIONAIS...:                                       *
      *    CTECW00I - AREA COMUM PARA TRATAMENTO DE ERROS              *
      *    CTECWDBE - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWDBS - AREA PARA DADOS DE SAIDA                         *
      *    CTECWDBI - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *    CTEC3AKC - INCLUIR MOTIVO DE ENCERRAMENTO                   *
      *================================================================*
      *
      *================================================================*
      ...
      *----------------------------------------------------------------*
       77  WRK-PROGRAMA                PIC X(008) VALUE
           'CTEC1AKC'.
       77  WRK-CTEC3AKC                PIC X(008) VALUE
           'CTEC3AKC'.
      ...
      *----------------------------------------------------------------*
       01  WRK-AREA-CTEC3AKC.
           COPY 'CTECW00I'.
           COPY 'CTECWDBI'.

      *----------------------------------------------------------------*
       01  FILLER                      PIC X(050) VALUE
           '*** FIM DA WORKING CTEC1AKC ***'.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       LINKAGE                         SECTION.
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDBE-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC CICS LINK
                 PROGRAM  (WRK-CTEC3AKC)
                 COMMAREA (WRK-AREA-CTEC3AKC)
                 LENGTH   (LENGTH OF WRK-AREA-CTEC3AKC)
                 NOHANDLE
           END-EXEC.
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE WRK-CTEC3AKC       TO FRWKGMOD-NOME-MODULO
               PERFORM 9998-TRATAR-ERRO
           END-EVALUATE.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWDBI-BLOCO-ENTRADA.

           MOVE CTECWDBE-BLOCO-ENTRADA   TO CTECWDBI-BLOCO-ENTRADA.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDBS-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDBS-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.
