      ...
      *                   CTEC.SI.INCLUIR.MOTIVO.DIGITALIZACAO         *  
      *----------------------------------------------------------------*
      *    BCO DE DADOS:                                               *
      ...
      *----------------------------------------------------------------*
       01  WRK-AUXILIARES.
           ...
           05 WRK-PROGRAMA             PIC  X(008) VALUE 'CTEC3AFI'.
      ...
      *----------------------------------------------------------------*
      *
           IF  CTECWD7I-E-CMOTVO-PEND-DIGIT 
                                       NOT NUMERIC
           OR  CTECWD7I-E-CMOTVO-PEND-DIGIT 
                                       EQUAL ZEROS
           ...
           IF  CTECWD7I-E-RMOTVO-PEND-DIGIT 
                                       EQUAL LOW-VALUES 
           OR  CTECWD7I-E-RMOTVO-PEND-DIGIT 
                                       EQUAL SPACES
               MOVE 08                 TO CTECW00I-COD-RETORNO
                                       OF DFHCOMMAREA 
               MOVE '0010'             TO CTECW00I-COD-ERRO
           ...
           IF  CTECWD7I-E-CUSUAR-INCL  EQUAL LOW-VALUES 
           OR  CTECWD7I-E-CUSUAR-INCL  EQUAL SPACES
               MOVE 08                 TO CTECW00I-COD-RETORNO
                                       OF DFHCOMMAREA 
               MOVE '0010'             TO CTECW00I-COD-ERRO
                                       OF DFHCOMMAREA 
      ...
      *----------------------------------------------------------------*
           ...
           PERFORM 2100-INCLUIR-MOTVO-DIGIT.
      ...
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       2100-INCLUIR-MOTVO-DIGIT        SECTION.
      *----------------------------------------------------------------*
           ...
           EXEC SQL 
              INSERT INTO DB2PRD.TMOTVO_PEND_DIGIT_DOCTO
                      ( CMOTVO_PEND_DIGIT
                      , RMOTVO_PEND_DIGIT
                      , CUSUAR_INCL
                      , HINCL_REG
                      , CUSUAR_MANUT
                      , HMANUT_REG ) 
               VALUES ( :CTECB027.CMOTVO-PEND-DIGIT
                      , :CTECB027.RMOTVO-PEND-DIGIT
                      , :CTECB027.CUSUAR-INCL
                      , CURRENT_TIMESTAMP
                      , NULL
                      , NULL )
           END-EXEC.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWD7I-E-CMOTVO-PEND-DIGIT
                                       TO CMOTVO-PEND-DIGIT 
                                       OF CTECB027
           MOVE CTECWD7I-E-RMOTVO-PEND-DIGIT
                                       TO RMOTVO-PEND-DIGIT
                                       OF CTECB027
           MOVE CTECWD7I-E-CUSUAR-INCL TO CUSUAR-INCL
                                       OF CTECB027.
