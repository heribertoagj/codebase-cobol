      ...
      *                   CTEC.SI.ALTERAR.MOTIVO.ENCERRAMENTO          *
      *----------------------------------------------------------------*
      *    BOOK'S FUNCIONAIS...:                                       *
      *    CTECW00I - AREA COMUM PARA TRATAMENTO DE ERROS              *
      *    CTECWB2E - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWB2I - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWB2E-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWB2I-BLOCO-ENTRADA.

           MOVE CTECWB2E-BLOCO-ENTRADA   TO CTECWB2I-BLOCO-ENTRADA.

      *     MOVE FRWKWAAA-CAUTEN-SEGRC(1:9)
      *                                 TO CTECWB2I-E-CUSUAR-EXCL.
      *----------------------------------------------------------------*
       2110-99-FIM.                    EXIT.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
