      ...
      *                   CTEC.SI.DETALHAR.MOTIVO.ENCERRAMENTO         *
      *----------------------------------------------------------------*
      *    BOOK'S FUNCIONAIS...:                                       *
      *    CTECW00I - AREA COMUM PARA TRATAMENTO DE ERROS              *
      *    CTECWB3E - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWB3S - AREA PARA DADOS DE SAIDA                         *
      *    CTECWB3I - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWB3E-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWB3I-BLOCO-ENTRADA.

           MOVE CTECWB3E-BLOCO-ENTRADA   TO CTECWB3I-BLOCO-ENTRADA.

      *     MOVE FRWKWAAA-CAUTEN-SEGRC(1:9)
      *                                 TO CTECWB3I-E-CUSUAR-EXCL.
      *----------------------------------------------------------------*
       2110-99-FIM.                    EXIT.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWB3S-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWB3S-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.
