      ...
      *                   CTEC.SI.APROVAR.MOTIVO.ENCERRAMENTO          *
      *----------------------------------------------------------------*
      *    BOOK'S FUNCIONAIS...:                                       *
      *    CTECW00I - AREA COMUM PARA TRATAMENTO DE ERROS              *
      *    CTECWB6E - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWB6I - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWB6E-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWB6I-BLOCO-ENTRADA.

           MOVE CTECWB6E-BLOCO-ENTRADA   TO CTECWB6I-BLOCO-ENTRADA.

      *     MOVE FRWKWAAA-CAUTEN-SEGRC(1:9)
      *                                 TO CTECWB6I-E-CUSUAR-EXCL.
      *----------------------------------------------------------------*
       2110-99-FIM.                    EXIT.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
