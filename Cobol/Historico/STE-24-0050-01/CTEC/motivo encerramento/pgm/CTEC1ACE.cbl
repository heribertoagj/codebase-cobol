      ...
      *                   CTEC.SI.EXCLUIR.MOTIVO.ENCERRAMENTO          *
      *----------------------------------------------------------------*
      *    BOOK'S FUNCIONAIS...:                                       *
      *    CTECW00I - AREA COMUM PARA TRATAMENTO DE ERROS              *
      *    CTECWB4E - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWB4I - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWB4E-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWB4I-BLOCO-ENTRADA.

           MOVE CTECWB4E-BLOCO-ENTRADA   TO CTECWB4I-BLOCO-ENTRADA.

      *     MOVE FRWKWAAA-CAUTEN-SEGRC(1:9)
      *                                 TO CTECWB4I-E-CUSUAR-EXCL.
      *----------------------------------------------------------------*
       2110-99-FIM.                    EXIT.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
