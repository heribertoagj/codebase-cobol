      ...
      *                   CTEC.SI.LISTAR.MOTIVO.ENCERRAMENTO           *  
      *----------------------------------------------------------------*
      *    BOOK'S FUNCIONAIS...:                                       *
      *    CTECW00I - AREA COMUM PARA TRATAMENTO DE ERROS              *
      *    CTECWB0E - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWB0S - AREA PARA DADOS DE SAIDA                         *
      *    CTECWB0I - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *    CTECWB0P - AREA PARA DADOS DE RESTART (PAGINACAO)           *
      *                                                                *
      ...
      *    CTEC341L - LISTAR MOTIVO DE ENCERRAMENTO                    *
      *================================================================*
      *================================================================*
      ...
      *----------------------------------------------------------------*
       01  WRK-CTEC341L                PIC X(008) VALUE
           'CTEC341L'.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWB0E-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWB0I-BLOCO-PAGINACAO.

           MOVE FRWKWAAA-SOLIC-MAIS-DADOS
                                       TO CTECWB0I-INDICADOR-PAGINACAO.         
           MOVE CTECWB0E-BLOCO-ENTRADA TO CTECWB0I-BLOCO-ENTRADA.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWB0P-PRI-CHAVE     TO CTECWB0I-PRI-CHAVE.
                                       
           MOVE CTECWB0P-ULT-CHAVE     TO CTECWB0I-ULT-CHAVE.
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE CTECW00I-COD-MENSAGEM
                                       TO FRWKGLAQ-COD-MENSAGEM
               MOVE WRK-CTEC341L       TO FRWKGMOD-NOME-MODULO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWB0S-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWB0S-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWB0P-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWB0P-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.

           MOVE CTECWB0I-INDICADOR-PAGINACAO
                                       TO CTECWB0P-IND-PAGINACAO.

           MOVE CTECWB0I-BLOCO-PAGINACAO
                                       TO CTECWB0P-BLOCO-PAGINACAO.
