      ...
      *    CTECWDEE - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWDES - AREA PARA DADOS DE SAIDA                         *
      *    CTECWDEI - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *    CTEC3A1C - INCLUIR MOTIVO DE ENCERRAMENTO                   *
      *================================================================*
      *
      *================================================================*
      ...
      *----------------------------------------------------------------*
       77  WRK-PROGRAMA                PIC X(008) VALUE
           'CTEC1A1C'.
       77  WRK-CTEC3A1C                PIC X(008) VALUE
           'CTEC3A1C'.
      ...
      *----------------------------------------------------------------*
       01  WRK-AREA-CTEC3A1C.
           COPY 'CTECW00I'.
           COPY 'CTECWDEI'.

      *----------------------------------------------------------------*
       01  FILLER                      PIC X(050) VALUE
           '*** FIM DA WORKING CTEC1A1C ***'.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       LINKAGE                         SECTION.
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDEE-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC CICS LINK
                 PROGRAM  (WRK-CTEC3A1C)
                 COMMAREA (WRK-AREA-CTEC3A1C)
                 LENGTH   (LENGTH OF WRK-AREA-CTEC3A1C)
                 NOHANDLE
           END-EXEC.
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE WRK-CTEC3A1C       TO FRWKGMOD-NOME-MODULO
               PERFORM 9998-TRATAR-ERRO
           END-EVALUATE.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWDEI-BLOCO-ENTRADA.

           MOVE CTECWDEE-BLOCO-ENTRADA   TO CTECWDEI-BLOCO-ENTRADA.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDES-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDES-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.
