      ...
      *    CTECWDGE - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWDGS - AREA PARA DADOS DE SAIDA                         *
      *    CTECWDGI - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *    CTECWDGP - AREA PARA DADOS DE RESTART (PAGINACAO)           *
      *                                                                *
      ...
      *    CTEC3AGL - LISTAR BYPASS BLOQUEI JUDICIAL E ADM             *
      *================================================================*
      *================================================================*
      ...
      *----------------------------------------------------------------*
       01  WRK-CTEC3AGL                PIC X(008) VALUE
           'CTEC3AGL'.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDGE-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWDGI-BLOCO-PAGINACAO.

           MOVE FRWKWAAA-SOLIC-MAIS-DADOS
                                       TO CTECWDGI-IND-PAGINACAO.         
           MOVE CTECWDGE-BLOCO-ENTRADA TO CTECWDGI-BLOCO-ENTRADA.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDGP-PRI-CHAVE     TO CTECWDGI-PRI-CHAVE.
                                       
           MOVE CTECWDGP-ULT-CHAVE     TO CTECWDGI-ULT-CHAVE.
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE CTECW00I-COD-MENSAGEM
                                       TO FRWKGLAQ-COD-MENSAGEM
               MOVE WRK-CTEC3AGL       TO FRWKGMOD-NOME-MODULO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDGS-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDGS-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDGP-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDGP-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.

           MOVE CTECWDGI-IND-PAGINACAO
                                       TO CTECWDGP-IND-PAGINACAO.

           MOVE CTECWDGI-BLOCO-PAGINACAO
                                       TO CTECWDGP-BLOCO-PAGINACAO.
