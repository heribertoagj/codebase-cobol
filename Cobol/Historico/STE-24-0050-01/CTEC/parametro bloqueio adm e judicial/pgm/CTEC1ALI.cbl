      ...
      *    CTECWDDE - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWDDI - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *    CTEC3ALI - INCLUIR BYPASS BLOQUEI ADM E JUDICIAL            *
      *================================================================*
      *================================================================*
      ...
      *----------------------------------------------------------------*
       77  WRK-PROGRAMA                PIC X(008) VALUE
           'CTEC1ALI'.
       77  WRK-CTEC3ALI                PIC X(008) VALUE
           'CTEC3ALI'.
      ...
      *----------------------------------------------------------------*
       01  WRK-AREA-CTEC3ALI.
           COPY 'CTECW00I'.
           COPY 'CTECWDDI'.

      *----------------------------------------------------------------*
       01  FILLER                      PIC X(050) VALUE
           '*** FIM DA WORKING CTEC1ALI ***'.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       LINKAGE                         SECTION.
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDDE-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC CICS LINK
                 PROGRAM  (WRK-CTEC3ALI)
                 COMMAREA (WRK-AREA-CTEC3ALI)
                 LENGTH   (LENGTH OF WRK-AREA-CTEC3ALI)
                 NOHANDLE
           END-EXEC.
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE WRK-CTEC3ALI       TO FRWKGMOD-NOME-MODULO
               PERFORM 9998-TRATAR-ERRO
           END-EVALUATE.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWDDI-BLOCO-ENTRADA.

           MOVE CTECWDDE-BLOCO-ENTRADA   TO CTECWDDI-BLOCO-ENTRADA.
