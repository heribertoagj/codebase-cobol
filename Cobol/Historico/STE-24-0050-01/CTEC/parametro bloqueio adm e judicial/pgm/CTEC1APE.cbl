      ...
      *    CTECWDFE - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWDFI - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *                                                                *
      ...
      *    CTEC3APE - EXCLUIR BYPASS BLOQUEI ADM E JUDICIAL            *
      *================================================================*
      *================================================================*
      ...
      *----------------------------------------------------------------*
       77  WRK-PROGRAMA                PIC X(008) VALUE
           'CTEC1APE'.
       77  WRK-CTEC3APE                PIC X(008) VALUE
           'CTEC3APE'.
      ...
      *----------------------------------------------------------------*
       01  WRK-AREA-CTEC3APE.
           COPY 'CTECW00I'.
           COPY 'CTECWDFI'.

      *----------------------------------------------------------------*
       01  FILLER                      PIC X(050) VALUE
           '*** FIM DA WORKING CTEC1APE ***'.
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       LINKAGE                         SECTION.
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDFE-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC CICS LINK
                 PROGRAM  (WRK-CTEC3APE)
                 COMMAREA (WRK-AREA-CTEC3APE)
                 LENGTH   (LENGTH OF WRK-AREA-CTEC3APE)
                 NOHANDLE
           END-EXEC.
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE WRK-CTEC3APE       TO FRWKGMOD-NOME-MODULO
               PERFORM 9998-TRATAR-ERRO
           END-EVALUATE.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWDFI-BLOCO-ENTRADA.

           MOVE CTECWDFE-BLOCO-ENTRADA   TO CTECWDFI-BLOCO-ENTRADA.
