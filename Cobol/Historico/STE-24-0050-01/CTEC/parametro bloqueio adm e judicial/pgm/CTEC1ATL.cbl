      ...
      *    CTECWDIE - AREA PARA DADOS DE ENTRADA                       *
      *    CTECWDIS - AREA PARA DADOS DE SAIDA                         *
      *    CTECWDII - AREA DE INTERFACE COM PROGRAMA FUNCIONAL         *
      *    CTECWDIP - AREA PARA DADOS DE RESTART (PAGINACAO)           *
      *                                                                *
      ...
      *    CTEC3ATL - LISTAR LISTAR PARAMETROS BLOQUEIO ADM            *
      *================================================================*
      *================================================================*
      ...
      *----------------------------------------------------------------*
       01  WRK-CTEC3ATL                PIC X(008) VALUE
           'CTEC3ATL'.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDIE-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE CTECW00I-BLOCO-RETORNO
                      CTECWDII-BLOCO-PAGINACAO.

           MOVE FRWKWAAA-SOLIC-MAIS-DADOS
                                       TO CTECWDII-IND-PAGINACAO.         
           MOVE CTECWDIE-BLOCO-ENTRADA TO CTECWDII-BLOCO-ENTRADA.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CTECWDIP-PRI-CHAVE     TO CTECWDII-PRI-CHAVE.
                                       
           MOVE CTECWDIP-ULT-CHAVE     TO CTECWDII-ULT-CHAVE.
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE CTECW00I-COD-RETORNO
             ...
             WHEN OTHER
               ...
               MOVE CTECW00I-COD-MENSAGEM
                                       TO FRWKGLAQ-COD-MENSAGEM
               MOVE WRK-CTEC3ATL       TO FRWKGMOD-NOME-MODULO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDIS-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDIS-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FRWKGLAQ-IDENT-AREA-GLOBAL
                                       TO FRWKEL04-IDENT-AREA-GLOBAL.
           MOVE CTECWDIP-COD-LAYOUT    TO FRWKEL04-ID-BLOCO.
           MOVE CTECWDIP-TAM-LAYOUT    TO FRWKEL04-TAM-BLOCO.

           MOVE CTECWDII-IND-PAGINACAO
                                       TO CTECWDIP-IND-PAGINACAO.

           MOVE CTECWDII-BLOCO-PAGINACAO
                                       TO CTECWDIP-BLOCO-PAGINACAO.
