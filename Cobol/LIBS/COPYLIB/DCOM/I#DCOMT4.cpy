      ******************************************************************
      * SISTEMA : DCOM - I#DCOMT4                                      *
      * TAMANHO : 0400 BYTES                                           *
      * ARQUIVO : OPERACAO OFICIAL COMPLEMENTAR                        *
      * INCLUDE DA TABELA DCOMB0L8 - DB2PRD.TOPER_DESC_COMPL           *
      ******************************************************************
...
WIP001*================================================================*
       ...
       01  T4-L8-REGISTRO.
 01 03     05 T4-L8-DANO-OPER-DESC     PIC S9(004)V COMP-3.
 04 05     05 T4-L8-NSEQ-OPER-DESC     PIC S9(009)V COMP-3.
 09 03     05 T4-L8-CVAR-PRODT-RURAL   PIC S9(005)V COMP-3.
 12 10     05 T4-L8-CNRO-REFT-BACEN    PIC S9(018)V COMP-3.
 22 03     05 T4-L8-CCESTA-SAFRA-RURAL PIC S9(005)V COMP-3.
 25 01     05 T4-L8-CINDCD-ZNMTO       PIC S9(001)V COMP-3.
 26 02     05 T4-L8-CTPO-BNEFC-RURAL   PIC S9(002)V COMP-3.
 28 03     05 T4-L8-NBASE-LEGAL-RENEG  PIC S9(005)V COMP-3.
 31 41     05 T4-L8-CREG-AMBTL-RURAL   PIC  X(041).
 72 01     05 T4-L8-CORIGE-ANTEC-PGMD  PIC S9(001)V COMP-3.
 73 05     05 T4-L8-CCONTR-LIM-DESC    PIC S9(009)V COMP-3.
 78 02     05 T4-L8-CVRSAO-CONTR-LIM   PIC S9(003)V COMP-3.
 80 01     05 T4-L8-CINDCD-FORMA-LIQDC PIC  X(001).
 81 01     05 T4-L8-CINDCD-UTILZ-LIM   PIC  X(001).
 82 01     05 T4-L8-CINDCD-DEB-PCIAL   PIC  X(001).
 83 01     05 T4-L8-CINDCD-TENTV-DEB   PIC  X(001).
