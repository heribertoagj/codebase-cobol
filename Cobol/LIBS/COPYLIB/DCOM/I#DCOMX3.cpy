      ...
      *             NA PRIMEIRA OCORRENCIA DA ÙREA DE RETORNO,*
      *             E APENAS ESTA OCORRENCIA ESTARÙ PREENCHIDA*
      *                                                       *
      *           - SE FOREM INFORMADAS AGENCIA E CONTA,      *
      *             SER–O RETORNADOS OS DADOS DOS RESPECTIVOS *
      *             TITULARES, UM EM CADA OCORR®NCIA DA ÙREA  *
      *             DE RETORNO.                               *
      *                                                       *
      ...
      *      INFORMAR TERMINAL
              ...
              05 ROTENT-6408-NUM-CNPJ-ENV       PIC  9(09).
              05 ROTENT-6408-FIL-CNPJ-ENV       PIC  9(04).
      ...
      *      RETORNARÙ MENSAGEM QUANDO NECESSARIO
      ...
      *      RETORNARÙ ZEROS (ITULIZADO PARA TOTAIS)
