      ******************************************************************
      * DCLGEN TABLE(DB2PRD.MAPA_REMSS_BACC)                           *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB006))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB006)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.MAPA_REMSS_BACC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.MAPA_REMSS_BACC             *
      ******************************************************************
       01  BACCB006.
      *    *************************************************************
