      ******************************************************************
      * DCLGEN TABLE(DB2PRD.RSUMO_MENSAL_CONTA)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB009))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB009)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.RSUMO_MENSAL_CONTA TABLE
           ( CEMPR                          DECIMAL(5, 0) NOT NULL,
             ...
             CCTA_CTBIL                     DECIMAL(7, 0) NOT NULL,
             DMES_MOVTO_CTBIL               DECIMAL(6, 0) NOT NULL,
             CDIG_CTA                       CHAR(1) NOT NULL,
      ...
      *    *************************************************************
           10 CCTA-CTBIL           PIC S9(7)V USAGE COMP-3.
      *    *************************************************************
