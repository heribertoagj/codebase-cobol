      ******************************************************************
      * DCLGEN TABLE(DB2PRD.CARTAO_CREDITO)                            *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB016))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB016)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.CARTAO_CREDITO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.CARTAO_CREDITO              *
      ******************************************************************
       01  BACCB016.
      *    *************************************************************
