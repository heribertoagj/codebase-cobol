      ******************************************************************
      * DCLGEN TABLE(DB2PRD.MOVTO_CTA_CATAO)                           *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB041))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB041)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.MOVTO_CTA_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.MOVTO_CTA_CATAO             *
      ******************************************************************
       01  BACCB041.
      *    *************************************************************
