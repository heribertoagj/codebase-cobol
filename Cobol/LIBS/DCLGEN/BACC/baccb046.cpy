      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TOT_CATAO_MES)                             *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB046))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB046)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TOT_CATAO_MES TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TOT_CATAO_MES               *
      ******************************************************************
       01  BACCB046.
      *    *************************************************************
