      ******************************************************************
      * DCLGEN TABLE(DB2PRD.MASTCARD_ANLSE)                            *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB048))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB048)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.MASTCARD_ANLSE TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.MASTCARD_ANLSE              *
      ******************************************************************
       01  BACCB048.
      *    *************************************************************
