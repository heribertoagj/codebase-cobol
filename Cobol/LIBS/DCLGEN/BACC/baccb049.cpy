      ******************************************************************
      * DCLGEN TABLE(DB2PRD.MASTCARD_REJEI)                            *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB049))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB049)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.MASTCARD_REJEI TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.MASTCARD_REJEI              *
      ******************************************************************
       01  BACCB049.
      *    *************************************************************
