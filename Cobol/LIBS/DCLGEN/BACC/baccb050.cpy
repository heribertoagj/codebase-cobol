      ******************************************************************
      * DCLGEN TABLE(DB2PRD.MASTCARD_LIBRD)                            *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB050))                        *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB050)                                     *
      *        APOST                                                   *
      *        LABEL(YES)                                              *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.MASTCARD_LIBRD TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.MASTCARD_LIBRD              *
      ******************************************************************
       01  BACCB050.
      *    *************************************************************
