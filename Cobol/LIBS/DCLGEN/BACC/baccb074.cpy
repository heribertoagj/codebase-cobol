      ******************************************************************
      * DCLGEN TABLE(DB2PRD.HIST_MES_RENTB_AG)                         *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB074))                        *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB074)                                     *
      *        APOST                                                   *
      *        LABEL(YES)                                              *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.HIST_MES_RENTB_AG TABLE
           ( DANO_MES_RENTB                 DECIMAL(6, 0) NOT NULL,
             ...
             QCOMPR_VISTA_MES               DECIMAL(5, 0) NOT NULL,
             QCOMPR_PRZ_MES                 DECIMAL(5, 0) NOT NULL,
             QPRINC_SAQUE_MES               DECIMAL(5, 0) NOT NULL,
             QANUDD_MES                     DECIMAL(5, 0) NOT NULL
           ) END-EXEC.
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.HIST_MES_RENTB_AG           *
      ******************************************************************
       01  BACCB074.
      *    *************************************************************
      ...
      *    *************************************************************
           10 QCOMPR-VISTA-MES     PIC S9(5)V USAGE COMP-3.
      *    *************************************************************
           10 QCOMPR-PRZ-MES       PIC S9(5)V USAGE COMP-3.
      *    *************************************************************
           10 QPRINC-SAQUE-MES     PIC S9(5)V USAGE COMP-3.
      *    *************************************************************
           10 QANUDD-MES           PIC S9(5)V USAGE COMP-3.
      ******************************************************************
