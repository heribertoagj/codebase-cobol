      ******************************************************************
      * DCLGEN TABLE(DB2PRD.SERVC_INSTC_ISENC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB079))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB079)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.SERVC_INSTC_ISENC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.SERVC_INSTC_ISENC           *
      ******************************************************************
       01  BACCB079.
      *    *************************************************************
