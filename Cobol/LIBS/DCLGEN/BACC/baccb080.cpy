      ******************************************************************
      * DCLGEN TABLE(DB2PRD.CUSTM_SERVC_ISENC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB080))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB080)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.CUSTM_SERVC_ISENC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.CUSTM_SERVC_ISENC           *
      ******************************************************************
       01  BACCB080.
      *    *************************************************************
