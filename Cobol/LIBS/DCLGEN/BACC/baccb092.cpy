      ******************************************************************
      * DCLGEN TABLE(DB2PRD.QTD_CATAO_DIA)                             *
      *        LIBRARY(AD.DB2.DCLGEN(BACCB092))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCB092)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.QTD_CATAO_DIA TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.QTD_CATAO_DIA               *
      ******************************************************************
       01  BACCB092.
      *    *************************************************************
