      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01REMESSA_ORPAG)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BACCV008))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCV008)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01REMESSA_ORPAG TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01REMESSA_ORPAG            *
      ******************************************************************
       01  BACCV008.
      *    *************************************************************
