      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01TIPO_ATVDD_COML)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BACCV013))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCV013)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01TIPO_ATVDD_COML TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01TIPO_ATVDD_COML          *
      ******************************************************************
       01  BACCV013.
      *    *************************************************************
