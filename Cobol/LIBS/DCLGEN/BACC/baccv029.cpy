      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01INCOMING_LIBRD)                         *
      *        LIBRARY(AD.DB2.DCLGEN(BACCV029))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCV029)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01INCOMING_LIBRD TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01INCOMING_LIBRD           *
      ******************************************************************
       01  BACCV029.
      *    *************************************************************
