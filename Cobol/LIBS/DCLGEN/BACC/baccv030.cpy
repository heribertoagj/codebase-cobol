      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01ORPAG_ANALISE)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BACCV030))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCV030)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01ORPAG_ANALISE TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01ORPAG_ANALISE            *
      ******************************************************************
       01  BACCV030.
      *    *************************************************************
