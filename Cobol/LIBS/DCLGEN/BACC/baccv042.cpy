      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01HIST_CTA_CATAO)                         *
      *        LIBRARY(AD.DB2.DCLGEN(BACCV042))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCV042)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01HIST_CTA_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01HIST_CTA_CATAO           *
      ******************************************************************
       01  BACCV042.
