      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01TOT_CATAO_DIA)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BACCV045))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BACCV045)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01TOT_CATAO_DIA TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01TOT_CATAO_DIA            *
      ******************************************************************
       01  BACCV045.
      *    *************************************************************
