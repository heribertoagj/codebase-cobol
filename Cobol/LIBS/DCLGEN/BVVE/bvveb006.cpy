      ******************************************************************
      * DCLGEN TABLE(DB2PRD.ERRO_PPRIE_ESTBL)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB006))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB006)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.ERRO_PPRIE_ESTBL TABLE
