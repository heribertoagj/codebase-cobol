      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TAGNDA_CIPAG_FRIO)                         *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB052))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB052)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TAGNDA_CIPAG_FRIO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TAGNDA_CIPAG_FRIO           *
      ******************************************************************
       01  BVVEB052.
      *    *************************************************************
           10 DMOVTO               PIC X(10).
