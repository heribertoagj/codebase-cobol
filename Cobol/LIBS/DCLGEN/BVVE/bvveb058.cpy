      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TRCBVL_OPER_CIPAG)                         *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB058))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB058)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TRCBVL_OPER_CIPAG TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TRCBVL_OPER_CIPAG           *
      ******************************************************************
       01  BVVEB058.
      *    *************************************************************
