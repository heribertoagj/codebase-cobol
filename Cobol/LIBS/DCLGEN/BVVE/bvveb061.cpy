      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TCONTD_EXPUR_CATAO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB061))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB061)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TCONTD_EXPUR_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TCONTD_EXPUR_CATAO          *
      ******************************************************************
       01  BVVEB061.
      *    *************************************************************
