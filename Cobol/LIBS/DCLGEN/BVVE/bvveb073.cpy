      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TETAPA_EXPUR_CATAO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB073))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB073)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TETAPA_EXPUR_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TETAPA_EXPUR_CATAO          *
      ******************************************************************
       01  BVVEB073.
      *    *************************************************************
