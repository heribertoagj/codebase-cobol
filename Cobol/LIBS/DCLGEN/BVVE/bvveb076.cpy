      ******************************************************************
      * DCLGEN TABLE(DB2PRD.THIST_DIA_CATAO)                           *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB076))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB076)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.THIST_DIA_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.THIST_DIA_CATAO             *
      ******************************************************************
       01  BVVEB076.
      *    *************************************************************
