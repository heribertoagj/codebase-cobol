      ******************************************************************
      * DCLGEN TABLE(DB2PRD.THIST_MES_CATAO)                           *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB077))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB077)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.THIST_MES_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.THIST_MES_CATAO             *
      ******************************************************************
       01  BVVEB077.
      *    *************************************************************
