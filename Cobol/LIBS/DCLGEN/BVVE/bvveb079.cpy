      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TMNTRC_CONTG_CATAO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB079))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB079)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TMNTRC_CONTG_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TMNTRC_CONTG_CATAO          *
      ******************************************************************
       01  BVVEB079.
      *    *************************************************************
