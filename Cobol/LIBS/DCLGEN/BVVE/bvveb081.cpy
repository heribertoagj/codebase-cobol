      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TMNTRC_EXPUR_CATAO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB081))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB081)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TMNTRC_EXPUR_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TMNTRC_EXPUR_CATAO          *
      ******************************************************************
       01  BVVEB081.
      *    *************************************************************
