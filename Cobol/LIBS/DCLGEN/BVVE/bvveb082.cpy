      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TMNTRC_MSGRA_CATAO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB082))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB082)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TMNTRC_MSGRA_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TMNTRC_MSGRA_CATAO          *
      ******************************************************************
       01  BVVEB082.
      *    *************************************************************
