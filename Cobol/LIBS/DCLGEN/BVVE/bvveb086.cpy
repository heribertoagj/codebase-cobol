      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TMSGRA_ENVID_DIA)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB086))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB086)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TMSGRA_ENVID_DIA TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TMSGRA_ENVID_DIA            *
      ******************************************************************
       01  BVVEB086.
      *    *************************************************************
