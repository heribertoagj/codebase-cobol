      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TMSGRA_ENVID_MES)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB087))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB087)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TMSGRA_ENVID_MES TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TMSGRA_ENVID_MES            *
      ******************************************************************
       01  BVVEB087.
      *    *************************************************************
