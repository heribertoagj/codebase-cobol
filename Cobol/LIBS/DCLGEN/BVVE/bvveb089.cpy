      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TMSGRA_RECBD_DIA)                          *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB089))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB089)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TMSGRA_RECBD_DIA TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TMSGRA_RECBD_DIA            *
      ******************************************************************
       01  BVVEB089.
      *    *************************************************************
