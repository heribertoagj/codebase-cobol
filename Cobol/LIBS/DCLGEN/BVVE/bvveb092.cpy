      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TRESUL_MNTRC_CATAO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB092))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB092)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TRESUL_MNTRC_CATAO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TRESUL_MNTRC_CATAO          *
      ******************************************************************
       01  BVVEB092.
      *    *************************************************************
