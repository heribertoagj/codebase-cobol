      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TRESUL_MSGRA_CATAO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(BVVEB094))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(BVVEB094)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TRESUL_MSGRA_CATAO TABLE
           ( NRESUL_MNTRC_MSGRA             DECIMAL(18, 0) NOT NULL,
             ...
             CISPB_EMISR_MSGEM              CHAR(8) NOT NULL,
             CISPB_DSTNA_MSGEM              CHAR(8) NOT NULL,
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TRESUL_MSGRA_CATAO          *
      ******************************************************************
       01  BVVEB094.
      *    *************************************************************
