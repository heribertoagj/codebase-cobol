***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01CTA_POUPANCA)                           *
      *        LIBRARY(AD.DB2.DCLGEN(CLIEV007))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(CLIEV007)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01CTA_POUPANCA TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01CTA_POUPANCA             *
      ******************************************************************
       01  CLIEV007.
      *    *************************************************************
