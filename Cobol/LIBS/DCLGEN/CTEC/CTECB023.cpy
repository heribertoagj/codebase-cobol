      ******************************************************************
      * DCLGEN TABLE(DB2PRD.THIST_MOTVO_ENCRR_BCO)                     *
      *        LIBRARY(AD.DB2.DCLGEN(CTECB023))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(CTECB023)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.THIST_MOTVO_ENCRR_BCO TABLE          
           ( HINCL_REG_HIST                 TIMESTAMP NOT NULL,         
             ...
             CMOTVO_REJEI_VALDC             DECIMAL(2, 0),              
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.THIST_MOTVO_ENCRR_BCO       *
      ******************************************************************
       01  CTECB023.                                                    
      *    *************************************************************
      ...
      *    *************************************************************
           10 CMOTVO-REJEI-VALDC   PIC S9(2)V USAGE COMP-3.             
      *    *************************************************************
