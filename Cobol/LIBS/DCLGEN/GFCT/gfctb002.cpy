***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.ADSAO_GRP_DEPDC)                           *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB002))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB002)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.ADSAO_GRP_DEPDC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.ADSAO_GRP_DEPDC             *
      ******************************************************************
       01  GFCTB002.
      *    *************************************************************
