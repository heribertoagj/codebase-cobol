***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.BONIF_COMPO_PCOTE)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB018))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB018)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.BONIF_COMPO_PCOTE TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.BONIF_COMPO_PCOTE           *
      ******************************************************************
       01  GFCTB018.
      *    *************************************************************
