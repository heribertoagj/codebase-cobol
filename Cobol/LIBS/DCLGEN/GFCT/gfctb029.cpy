***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.COMPS_TARIF_PCOTE)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB029))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB029)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.COMPS_TARIF_PCOTE TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.COMPS_TARIF_PCOTE           *
      ******************************************************************
       01  GFCTB029.
      *    *************************************************************
