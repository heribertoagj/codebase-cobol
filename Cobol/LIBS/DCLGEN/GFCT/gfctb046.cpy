***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.EVNTO_CTBIL_GRP)                           *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB046))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB046)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.EVNTO_CTBIL_GRP TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.EVNTO_CTBIL_GRP             *
      ******************************************************************
       01  GFCTB046.
      *    *************************************************************
