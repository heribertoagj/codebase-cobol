***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TARIF_EVNTO_CTBIL)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB047))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB047)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TARIF_EVNTO_CTBIL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TARIF_EVNTO_CTBIL           *
      ******************************************************************
       01  GFCTB047.
      *    *************************************************************
