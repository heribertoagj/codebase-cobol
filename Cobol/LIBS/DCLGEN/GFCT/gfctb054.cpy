***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.FLEXZ_GRP_PAB)                             *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB054))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB054)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.FLEXZ_GRP_PAB TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.FLEXZ_GRP_PAB               *
      ******************************************************************
       01  GFCTB054.
      *    *************************************************************
