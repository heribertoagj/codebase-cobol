***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.GSTAO_MIDIA_DESC)                          *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB070))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB070)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.GSTAO_MIDIA_DESC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.GSTAO_MIDIA_DESC            *
      ******************************************************************
       01  GFCTB070.
      *    *************************************************************
