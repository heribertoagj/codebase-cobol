***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.GSTAO_SGMTO_SERVC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB075))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB075)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.GSTAO_SGMTO_SERVC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.GSTAO_SGMTO_SERVC           *
      ******************************************************************
       01  GFCTB075.
      *    *************************************************************
