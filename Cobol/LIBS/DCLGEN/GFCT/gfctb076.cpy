***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.GSTAO_TARIF_DESC)                          *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB076))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB076)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.GSTAO_TARIF_DESC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.GSTAO_TARIF_DESC            *
      ******************************************************************
       01  GFCTB076.
      *    *************************************************************
