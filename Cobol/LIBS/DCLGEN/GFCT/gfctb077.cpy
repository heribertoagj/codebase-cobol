***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.GSTAO_TARIF_ESTRN)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB077))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB077)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.GSTAO_TARIF_ESTRN TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.GSTAO_TARIF_ESTRN           *
      ******************************************************************
       01  GFCTB077.
      *    *************************************************************
