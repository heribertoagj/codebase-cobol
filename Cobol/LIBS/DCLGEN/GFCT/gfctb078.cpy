***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.GSTAO_TARIF_SERVC)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB078))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB078)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.GSTAO_TARIF_SERVC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.GSTAO_TARIF_SERVC           *
      ******************************************************************
       01  GFCTB078.
      *    *************************************************************
