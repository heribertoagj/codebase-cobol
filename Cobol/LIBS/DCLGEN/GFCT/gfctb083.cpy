***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.HIERQ_ALCAD_PDRAO)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB083))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB083)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.HIERQ_ALCAD_PDRAO TABLE
           ( CTPO_OPER_MOTVO                DECIMAL(3, 0) NOT NULL,
             CIDTFD_DEPDC_SUBOR             CHAR(2) NOT NULL,
             DINIC_ALCAD_PDRAO              DATE NOT NULL,
             DFIM_ALCAD_PDRAO               DATE NOT NULL,
             CIDTFD_DEPDC_SUPE              CHAR(2),
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.HIERQ_ALCAD_PDRAO           *
      ******************************************************************
       01  GFCTB083.
      *    *************************************************************
           10 CTPO-OPER-MOTVO      PIC S9(3)V USAGE COMP-3.
      *    *************************************************************
           10 CIDTFD-DEPDC-SUBOR   PIC X(2).
      *    *************************************************************
           10 DINIC-ALCAD-PDRAO    PIC X(10).
      *    *************************************************************
           10 DFIM-ALCAD-PDRAO     PIC X(10).
      *    *************************************************************
           10 CIDTFD-DEPDC-SUPE    PIC X(2).
      *    *************************************************************
