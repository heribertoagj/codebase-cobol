***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.HIST_VLR_COMPO)                            *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB088))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB088)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.HIST_VLR_COMPO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.HIST_VLR_COMPO              *
      ******************************************************************
       01  GFCTB088.
      *    *************************************************************
