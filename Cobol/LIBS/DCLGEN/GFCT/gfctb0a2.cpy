      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PARM_SERVC_TARIF)                          *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0A2))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0A2)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PARM_SERVC_TARIF TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PARM_SERVC_TARIF            *
      ******************************************************************
       01  GFCTB0A2.
      *    *************************************************************
