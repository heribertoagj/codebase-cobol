      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PDIDO_ESTRN_AG)                            *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0A3))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0A3)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PDIDO_ESTRN_AG TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PDIDO_ESTRN_AG              *
      ******************************************************************
       01  GFCTB0A3.
      *    *************************************************************
