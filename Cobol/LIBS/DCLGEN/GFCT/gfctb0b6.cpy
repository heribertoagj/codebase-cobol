      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PDIDO_FLEXZ_EMPR)                          *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0B6))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0B6)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PDIDO_FLEXZ_EMPR TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PDIDO_FLEXZ_EMPR            *
      ******************************************************************
       01  GFCTB0B6.
      *    *************************************************************
