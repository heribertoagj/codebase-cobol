      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PDIDO_FLEXZ_PSTAL)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0B9))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0B9)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PDIDO_FLEXZ_PSTAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PDIDO_FLEXZ_PSTAL           *
      ******************************************************************
       01  GFCTB0B9.
      *    *************************************************************
