      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PDIDO_FLEXZ_SGMTO)                         *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0C0))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0C0)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PDIDO_FLEXZ_SGMTO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PDIDO_FLEXZ_SGMTO           *
      ******************************************************************
       01  GFCTB0C0.
      *    *************************************************************
