      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PDIDO_FLEXZ_UF)                            *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0C1))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0C1)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PDIDO_FLEXZ_UF TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PDIDO_FLEXZ_UF              *
      ******************************************************************
       01  GFCTB0C1.
      *    *************************************************************
