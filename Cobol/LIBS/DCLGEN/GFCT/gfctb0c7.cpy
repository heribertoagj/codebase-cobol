      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PRMSS_GRP_DEPDC)                           *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0C7))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0C7)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PRMSS_GRP_DEPDC TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PRMSS_GRP_DEPDC             *
      ******************************************************************
       01  GFCTB0C7.
      *    *************************************************************
