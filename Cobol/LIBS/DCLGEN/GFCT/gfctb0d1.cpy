      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PRMSS_GRP_PSTAL)                           *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0D1))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0D1)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PRMSS_GRP_PSTAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PRMSS_GRP_PSTAL             *
      ******************************************************************
       01  GFCTB0D1.
      *    *************************************************************
