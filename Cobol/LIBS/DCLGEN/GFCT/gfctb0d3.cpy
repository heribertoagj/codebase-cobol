      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PRMSS_GRP_UF)                              *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0D3))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0D3)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PRMSS_GRP_UF TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PRMSS_GRP_UF                *
      ******************************************************************
       01  GFCTB0D3.
      *    *************************************************************
