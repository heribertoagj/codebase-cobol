      ******************************************************************
      * DCLGEN TABLE(DB2PRD.SUB_PRFIL_TELA)                            *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0E1))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0E1)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.SUB_PRFIL_TELA TABLE
           ( CPRFIL_ACSSO_TRANS             DECIMAL(3, 0) NOT NULL,
             ...
             HINCL_SUB_PRFIL                TIMESTAMP NOT NULL
           ) END-EXEC.
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.SUB_PRFIL_TELA              *
      ******************************************************************
       01  GFCTB0E1.
      *    *************************************************************
