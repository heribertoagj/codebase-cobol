      ******************************************************************
      * DCLGEN TABLE(DB2PRD.SUB_PRFIL_USUAR)                           *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0E2))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0E2)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.SUB_PRFIL_USUAR TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.SUB_PRFIL_USUAR             *
      ******************************************************************
       01  GFCTB0E2.
      *    *************************************************************
