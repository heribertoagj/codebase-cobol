      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TDEB_UNFCA_CLI)                            *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0H8))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0H8)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TDEB_UNFCA_CLI TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TDEB_UNFCA_CLI              *
      ******************************************************************
       01  GFCTB0H8.
      *    *************************************************************
