***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TSUSP_GRP_PAB)                             *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0I1))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0I1)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TSUSP_GRP_PAB TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TSUSP_GRP_PAB               *
      ******************************************************************
       01  GFCTB0I1.
      *    *************************************************************
