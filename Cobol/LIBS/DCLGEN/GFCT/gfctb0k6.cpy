***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TEXTRT_MES_TARIF)                          *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0K6))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0K6)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TEXTRT_MES_TARIF TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TEXTRT_MES_TARIF            *
      ******************************************************************
       01  GFCTB0K6.
      *    *************************************************************
