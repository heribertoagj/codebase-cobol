***************************** Top of Data ******************************
      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TAUTRZ_ENVIO_AGPTO)                        *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0L4))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0L4)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TAUTRZ_ENVIO_AGPTO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TAUTRZ_ENVIO_AGPTO          *
      ******************************************************************
       01  GFCTB0L4.
      *    *************************************************************
