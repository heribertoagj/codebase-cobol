      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TCDULA_TEMPR_RENEG)                        *
      *        LIBRARY(AD.DB2.DCLGEN(RUECB00C))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RUECB00C)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TCDULA_TEMPR_RENEG TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TCDULA_TEMPR_RENEG          *
      ******************************************************************
       01  RUECB00C.
      *    *************************************************************
