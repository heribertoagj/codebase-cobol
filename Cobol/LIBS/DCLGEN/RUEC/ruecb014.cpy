      ******************************************************************
      * DCLGEN TABLE(DB2PRD.PESSOA_CONTR_RURAL)                        *
      *        LIBRARY(AD.DB2.DCLGEN(RUECB014))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RUECB014)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.PESSOA_CONTR_RURAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.PESSOA_CONTR_RURAL          *
      ******************************************************************
       01  RUECB014.
      *    *************************************************************
