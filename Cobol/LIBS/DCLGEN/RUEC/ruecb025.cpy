      ******************************************************************
      * DCLGEN TABLE(DB2PRD.ORCAM_CDULA_RURAL)                         *
      *        LIBRARY(AD.DB2.DCLGEN(RUECB025))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RUECB025)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.ORCAM_CDULA_RURAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.ORCAM_CDULA_RURAL           *
      ******************************************************************
       01  RUECB025.
      *    *************************************************************
