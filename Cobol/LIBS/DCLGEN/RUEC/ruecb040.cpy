      ******************************************************************
      * DCLGEN TABLE(DB2PRD.MATR_CONTR_RURAL)                          *
      *        LIBRARY(AD.DB2.DCLGEN(RUECB040))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RUECB040)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.MATR_CONTR_RURAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.MATR_CONTR_RURAL            *
      ******************************************************************
       01  RUECB040.
      *    *************************************************************
