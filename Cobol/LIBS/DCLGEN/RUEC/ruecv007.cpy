      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01CEDULA_TEMPR)                           *
      *        LIBRARY(AD.DB2.DCLGEN(RUECV007))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RUECV007)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01CEDULA_TEMPR TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01CEDULA_TEMPR             *
      ******************************************************************
       01  RUECV007.
