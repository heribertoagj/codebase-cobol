      ******************************************************************
      * DCLGEN TABLE(DB2PRD.ATIVIDADE_RURAL)                           *
      *        LIBRARY(AD.DB2.DCLGEN(RURCB004))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RURCB004)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.ATIVIDADE_RURAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.ATIVIDADE_RURAL             *
      ******************************************************************
       01  RURCB004.
      *    *************************************************************
