      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TPO_PROTR_RURAL)                           *
      *        LIBRARY(AD.DB2.DCLGEN(RURCB022))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RURCB022)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TPO_PROTR_RURAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TPO_PROTR_RURAL             *
      ******************************************************************
       01  RURCB022.
      *    *************************************************************
