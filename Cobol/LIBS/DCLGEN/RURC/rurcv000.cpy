      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01ORIGEM_RECURSO)                         *
      *        LIBRARY(AD.DB2.DCLGEN(RURCV000))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RURCV000)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01ORIGEM_RECURSO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01ORIGEM_RECURSO           *
      ******************************************************************
       01  RURCV000.
