      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01FNALD_RURAL)                            *
      *        LIBRARY(AD.DB2.DCLGEN(RURCV003))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RURCV003)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01FNALD_RURAL TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01FNALD_RURAL              *
      ******************************************************************
       01  RURCV003.
      *    *************************************************************
