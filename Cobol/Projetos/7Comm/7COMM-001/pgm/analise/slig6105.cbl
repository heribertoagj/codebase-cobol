...
CNPJAN*                                     TO CGC-CPF-GRUPO-GP34
CNPJAN        MOVE SLIG02-CGC-CPF-CLIENTE-ST
CNPJAN                                      TO GRUPW01S-CGC-CPF
              IF SLIG02-FILIAL-CLIENTE-ST EQUAL SPACES
                 MOVE ZEROS               TO SLIG02-FILIAL-CLIENTE-ST
              END-IF
              MOVE SLIG02-FILIAL-CLIENTE-ST
CNPJAN                                    TO GRUPW01S-FILIAL-CGC-CPF
CNPJAN*       TO WRK-FILIAL-CLIENTE-AUX
CNPJAN*       MOVE WRK-FILIAL-CLIENTE-AUX-4 TO FILIAL-CGC-CPF-GRUPO-GP34
              MOVE SLIG02-CONTROLE-CLIENTE-ST
...
CNPJAN        TO GRUPW01S-CTRL-CGC-CPF
           ...
           MOVE WRK-NRO-GRUPO-CLIENTE-X  TO SLIG02-CGC-GRUPO-CLIENTE-ST.
CNPJ7C     MOVE WRK-NRO-GRUPO-CLIENTE    TO SLIG02-CGC-GRUPO-CLIENTE.
