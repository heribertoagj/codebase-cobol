...
CNPJAN*
CNPJAN*       -MOVE SLIG02-CGC-CPF-CLIENTE-ST TO WRK-HX-X-9
CNPJAN*       -MOVE WRK-HX-N-9              TO CGC-CPF-GRUPO-GP34
CNPJAN*       -MOVE SLIG02-FILIAL-CLIENTE-ST  TO WRK-HX-X-5
CNPJAN*       -MOVE WRK-HX-N-5              TO WRK-FILIAL-GRUPO-GP34-N5
...
CNPJAN        MOVE SLIG02-CGC-CPF-CLIENTE-ST TO GRUPW01S-CGC-CPF(3:9)
...
CNPJ7C*    -MOVE 'SLIG6100'                 TO PGM-CHAMADOR-GP34.
CNPJAN     MOVE 'SLIG6100'                 TO GRUPW01S-PGM-CHAMADOR.
...
CNPJ7C*        -IF RETURN-CODE-GP34         EQUAL 1
               IF GRUPW01S-RETURN-CODE     EQUAL 1
CNPJ7C*           -MOVE ZEROS               TO NUMERO-GRUPO-RET-GP34
...
CNPJ7C     MOVE GRUPW01S-NUMERO-GRUPO-RET  TO WRK-NRO-GRUPO-CLIENTE.
