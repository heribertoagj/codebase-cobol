...
CNPJAN 01  REG-CLISACOU                PIC  X(300)         VALUE SPACES.
      ...
      *----------------------------------------------------------------*
       ...
       77  WRK-NRO-GRUPO-SACADO-X  REDEFINES
           WRK-NRO-GRUPO-SACADO        PIC  X(009).
CNPJAN 01 WRK-GRUPO-SAC-X.
CNPJAN    05 WRK-GRUPO-SAC-N            PIC  9(09)   VALUE ZEROS.
...
CNPJAN        MOVE SLIG02-CONTROLE-SACADO-ST TO GRUPW01S-CTRL-CGC-CPF
...
CNPJAN     MOVE WRK-NRO-GRUPO-SACADO   TO WRK-GRUPO-SAC-N
CNPJAN     MOVE WRK-GRUPO-SAC-X        TO SLIG02-CGC-GRUPO-SACADO-ST.
           MOVE WRK-NRO-GRUPO-SACADO-X TO SLIG02-CGC-GRUPO-SACADO-ST
           IF WRK-NRO-GRUPO-SACADO     IS NUMERIC
              MOVE WRK-NRO-GRUPO-SACADO  
                                       TO SLIG02-CGC-GRUPO-SACADO
           ELSE
              MOVE ZEROS               TO SLIG02-CGC-GRUPO-SACADO
           END-IF.
