      ******************************************************************
      * DCLGEN TABLE(DB2PRD.V01HIST_MOVTO)                             *
      *        LIBRARY(AD.DB2.DCLGEN(RUMOV002))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(RUMOV002)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.V01HIST_MOVTO TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.V01HIST_MOVTO               *
      ******************************************************************
       01  RUMOV002.
      *    *************************************************************
