...
.     *                   EXCLUIR CAMPOS DA COR0005:                   *
.     *                   - IndrConfcAlertSustldd                      *
...
CAPG05**  EXCLUIDO - SICOR 5.12 - INCLUDE RURCB00P (IndrConfcAlertSustldd)
CAPG05*---------------------------------------------------------------*
CAPG05* -01  FILLER                      PIC  X(32)          VALUE
CAPG05*    '**** INCLUDE RURCB00P        ***'.
CAPG05*---------------------------------------------------------------*
CAPG05*
CAPG05*    -EXEC SQL
CAPG05*        -INCLUDE RURCB00P
...
CAPG05*    -05 WRK-B002-CCETFC-NULL     PIC S9(04) COMP VALUE +0.
CAPG05*    -05 WRK-B002-EURL-CETFC-NULL PIC S9(04) COMP VALUE +0.
CAPG05*    -05 WRK-B002-CRSTRB-NULL     PIC S9(04) COMP VALUE +0.
CAPG05*    -05 WRK-B002-EURL-RSTRB-NULL PIC S9(04) COMP VALUE +0.
CAPG05*    -05 WRK-B002-PENERG-NULL     PIC S9(04) COMP VALUE +0.
...
CAPG05*                 -WRK-B002-CCETFC-NULL
CAPG05*                 -WRK-B002-EURL-CETFC-NULL
CAPG05*                 -WRK-B002-CRSTRB-NULL
CAPG05*                 -WRK-B002-EURL-RSTRB-NULL
CAPG05*                 -WRK-B002-PENERG-NULL
                        WRK-B09A-CSIT-NULL
                        WRK-B09A-HINCL-NULL
                        WRK-B09B-CCTRL-NULL.
...
CAPG05**  EXCLUIDO - SICOR 5.12 - IndrConfcAlertSustldd
CAPG05*    -MOVE 'N'                    TO RUECC5-IND-CONF-ALRT-SUST
CAPG05*
CAPG05*    -EXEC SQL
CAPG05*      -SELECT CALERT_SUSTBD_PER
CAPG05*      -INTO  :RURCB00P.CALERT-SUSTBD-PER
CAPG05*      -FROM  DB2PRD.TPER_ALERT_SUSTBD
CAPG05*      -WHERE NPER_ALERT_SUSTBD   =  1
CAPG05*      -AND   DINIC_VGCIA_ALERT   <= CURRENT_DATE
CAPG05*      -AND   DFIM_VGCIA_ALERT    >= CURRENT_DATE
CAPG05*    END-EXEC.
CAPG05*
CAPG05*    -IF (SQLCODE                 NOT EQUAL ZEROS AND +100) OR
CAPG05*       (SQLWARN0                EQUAL 'W')
CAPG05*        -MOVE 'DB2'              TO ERR-TIPO-ACESSO
CAPG05*        -MOVE 'TPER_ALERT_SUSTBD' TO ERR-DBD-TAB
CAPG05*        -MOVE 'SELECT'           TO ERR-FUN-COMANDO
CAPG05*        -MOVE SQLCODE            TO ERR-SQL-CODE
CAPG05*        -MOVE '3100'             TO ERR-LOCAL
CAPG05*        -MOVE SPACES             TO ERR-SEGM
CAPG05*        -PERFORM 9000-ROTINA-FIM
CAPG05*    END-IF.
CAPG05*
CAPG05*    -IF  SQLCODE                 EQUAL +100
CAPG05*        -MOVE 'N'                TO CALERT-SUSTBD-PER OF RURCB00P
CAPG05*    END-IF.
CAPG05*
CAPG05*    -MOVE CALERT-SUSTBD-PER      OF RURCB00P
CAPG05*                                TO RUECC5-IND-CONF-ALRT-SUST
CAPG05*
...
BR0921**  -END-IF.
.
CAPG05**  EXCLUIDO - SICOR 5.12 - Grupo_COR0005_CertificOrgnco
CAPG05*    -IF CCETFC-ORGNC-EMPTO     OF RUFIB002 NOT EQUAL SPACES
CAPG05*       -MOVE CCETFC-ORGNC-EMPTO
CAPG05*                              OF RUFIB002
CAPG05*                              TO RUECC5-CCETFC-ORGNC
CAPG05*       -MOVE EURL-CETFC-ORGNC-TEXT
CAPG05*                              OF RUFIB002(1:EURL-CETFC-ORGNC-LEN)
CAPG05*                              TO RUECC5-EURL-CETFC-ORGNC
CAPG05*    -ELSE
CAPG05*       -MOVE ALL '*'           TO RUECC5-GP-COR0005-CORGN
CAPG05*    END-IF.
CAPG05*
CAPG05*    -MOVE RUECC5-COR0005-11      TO WRK-B09A-SIS (WRK-POSICAO:
CAPG05*                                       LENGTH OF RUECC5-COR0005-11)
CAPG05*    -ADD  LENGTH                 OF RUECC5-COR0005-11
CAPG05*                                    TO WRK-TAM
CAPG05*                                       -WRK-POSICAO.
CAPG05*
CAPG05**  EXCLUIDO - SICOR 5.12 - Grupo_COR0005_RastlddEmpnmnt
CAPG05*    -IF CRSTRB-EMPTO-RURAL     OF RUFIB002 NOT EQUAL SPACES
CAPG05*       -MOVE CRSTRB-EMPTO-RURAL
CAPG05*                              OF RUFIB002
CAPG05*                              TO RUECC5-CRSTRB-EMPTO
CAPG05*
CAPG05*       -MOVE EURL-RSTRB-EMPTO-TEXT
CAPG05*                              OF RUFIB002(1:EURL-RSTRB-EMPTO-LEN)
CAPG05*                              TO RUECC5-EURL-RSTRB
CAPG05*    -ELSE
CAPG05*       -MOVE ALL '*'           TO RUECC5-GP-COR0005-RASTB
CAPG05*    END-IF.
CAPG05*
CAPG05*    -MOVE RUECC5-COR0005-12      TO WRK-B09A-SIS (WRK-POSICAO:
CAPG05*                                       LENGTH OF RUECC5-COR0005-12)
CAPG05*    -ADD  LENGTH                 OF RUECC5-COR0005-12
CAPG05*                                    TO WRK-TAM
CAPG05*                                       -WRK-POSICAO.
CAPG05*
CAPG05**  EXCLUIDO - SICOR 5.12 - PercEnerRenovvlEmpnmnt
CAPG05*    -IF PENERG-RENOV-EMPTO       OF RUFIB002 GREATER ZEROS
CAPG05*       -MOVE  PENERG-RENOV-EMPTO OF RUFIB002
CAPG05*                                TO WRK-NUM5-S
CAPG05*       -MOVE  WRK-NUM5           TO RUECC5-PENERG-RENOV-N
CAPG05*    -ELSE
CAPG05*       -MOVE ALL '*'             TO RUECC5-PENERG-RENOV
CAPG05*    END-IF.
CAPG05*
CAPG05*    -MOVE RUECC5-COR0005-13      TO WRK-B09A-SIS (WRK-POSICAO:
CAPG05*                                       LENGTH OF RUECC5-COR0005-13)
CAPG05*    -ADD  LENGTH                 OF RUECC5-COR0005-13
CAPG05*                                    TO WRK-TAM
CAPG05*                                       -WRK-POSICAO.
WP0522
.     *** CodSTNEqulzc
...
BR0118********-PERFORM 9000-ROTINA-FIM
      ...
      *---------------------------------------------------------------*
           ...
           EXEC SQL
             ...
             ,      DVCTO_CONTR
4.13         ,      CORIGE_REC
CAPG05*       -,      CCETFC_ORGNC_EMPTO
CAPG05*       -,      EURL_CETFC_ORGNC
CAPG05*       -,      CRSTRB_EMPTO_RURAL
CAPG05*       -,      EURL_RSTRB_EMPTO
CAPG05*       -,      PENERG_RENOV_EMPTO
...
CAPG05*       -,      :RUFIB002.CCETFC-ORGNC-EMPTO
CAPG05*                                   :WRK-B002-CCETFC-NULL
CAPG05*       -,      :RUFIB002.EURL-CETFC-ORGNC
CAPG05*                                   :WRK-B002-EURL-CETFC-NULL
CAPG05*       -,      :RUFIB002.CRSTRB-EMPTO-RURAL
CAPG05*                                   :WRK-B002-CRSTRB-NULL
CAPG05*       -,      :RUFIB002.EURL-RSTRB-EMPTO
CAPG05*                                   :WRK-B002-EURL-RSTRB-NULL
CAPG05*       -,      :RUFIB002.PENERG-RENOV-EMPTO
CAPG05*                                   :WRK-B002-PENERG-NULL
...
CAPG05*    -IF  WRK-B002-CCETFC-NULL     LESS ZEROS
CAPG05*        -MOVE SPACES              TO CCETFC-ORGNC-EMPTO
CAPG05*                                 OF RUFIB002
CAPG05*    END-IF.
CAPG05*
CAPG05*    -IF  WRK-B002-EURL-CETFC-NULL LESS ZEROS
CAPG05*        -MOVE SPACES              TO EURL-CETFC-ORGNC-TEXT
CAPG05*                                 OF RUFIB002
CAPG05*    END-IF.
CAPG05*
CAPG05*    -IF  WRK-B002-CRSTRB-NULL     LESS ZEROS
CAPG05*        -MOVE SPACES              TO CRSTRB-EMPTO-RURAL
CAPG05*                                 OF RUFIB002
CAPG05*    END-IF.
CAPG05*
CAPG05*    -IF  WRK-B002-EURL-RSTRB-NULL LESS ZEROS
CAPG05*        -MOVE SPACES              TO EURL-RSTRB-EMPTO-TEXT
CAPG05*                                 OF RUFIB002
CAPG05*    END-IF.
CAPG05*
CAPG05*    -IF  WRK-B002-PENERG-NULL     LESS ZEROS
CAPG05*        -MOVE ZEROS               TO PENERG-RENOV-EMPTO
CAPG05*                                 OF RUFIB002
CAPG05*    END-IF.
