...
7C2510* GERACAO.............: NOV  / 2025                             *
      *---------------------------------------------------------------*
CAPG05*---------------------------------------------------------------*
CAPG05* ALTERACAO...........: ADEQUACAO COR0001 SICOR 5.12             *
.     *                       GRUPO SISTPRODC (8 CAMPOS)               *
.     *                       NUMORDEMDESTCRENEGC                      *
.     *                       EXCLUSAO CERTIF/RASTREAB/ENERGIA MSG   *
CAPG05* DEMANDA.............: AGROLEG-1482                             *
CAPG05* GERACAO.............: 05/2026                                  *
      *---------------------------------------------------------------*
      *
      **** TAMANHO = 140
...
CAPG05           15 RUCA66-NUM-ORDEM-DEST-RENEGC
CAPG05                                 PIC  X(003) VALUE SPACES.
...
CAPG05** SUBSTITUIDO COD-SIST-PRODC POR GRUPO SISTPRODC - SICOR 5.12
CAPG05*    -05 RUCA66-COD-SIST-PRODC        PIC  X(013) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-AGRCTUR            PIC  X(001) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-INTGC-CONSC         PIC  X(001) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-GRAO-SEMTE         PIC  X(001) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-IRRGC              PIC  X(002) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-CULTV-EXPLC         PIC  X(002) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-FASE-CICLO-PRODC    PIC  X(002) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-CLIMA              PIC  X(002) VALUE SPACES.
CAPG05*    -05 RUCA66-TP-OTR-PRATC-MANJ     PIC  X(002) VALUE SPACES.
CAPG05     05 RUCA66-GP-COR0001-SIST-PRODC.
CAPG05        10 RUCA66-TP-AGRCTUR         PIC  X(001) VALUE SPACES.
CAPG05        10 RUCA66-TP-INTGC-CONSC      PIC  X(001) VALUE SPACES.
CAPG05        10 RUCA66-TP-GRAO-SEMTE      PIC  X(001) VALUE SPACES.
CAPG05        10 RUCA66-TP-IRRGC           PIC  X(002) VALUE SPACES.
CAPG05        10 RUCA66-TP-CULTV-EXPLC      PIC  X(002) VALUE SPACES.
CAPG05        10 RUCA66-TP-FASE-CICLO-PRODC PIC  X(002) VALUE SPACES.
CAPG05        10 RUCA66-TP-CLIMA           PIC  X(002) VALUE SPACES.
CAPG05        10 RUCA66-TP-OTR-PRATC-MANJ  PIC  X(002) VALUE SPACES.
CAPG05*    -05 RUCA66-COD-SIST-PRODC REDEFINES RUCA66-GP-COR0001-SIST-PRODC
CAPG05*                            -PIC  X(013).
...
BRQ001**** TAMANHO = 351
BRQ001*
CAPG05** EXCLUIDO GRUPO CERTIFICACAO ORGANICA - SICOR 5.12
CAPG05* -01 RUCA66-COR0001-18.
CAPG05*    -05 RUCA66-GRUPO-COR0001-CERTIFCOR.
CAPG05*       -10 RUCA66-GP-COR0001-CERTIFCOR.
CAPG05*          -15 RUCA66-CODCERTIFCORGNCOEMPNMNT
CAPG05*                                     -PIC  X(080) VALUE SPACES.
CAPG05*          -15 RUCA66-URLCERTIFCORGNCOEMPNMNT
CAPG05*                                     -PIC  X(255) VALUE SPACES.


BRQ001**** TAMANHO = 351
BRQ001*
CAPG05** EXCLUIDO GRUPO RASTREABILIDADE - SICOR 5.12
CAPG05* -01 RUCA66-COR0001-19.
CAPG05*    -05 RUCA66-GRUPO-COR0001-RASTLDDEM.
CAPG05*       -10 RUCA66-GP-COR0001-RASTLDDEM.
CAPG05*          -15 RUCA66-CODRASTLDDEMPNMNT
CAPG05*                                     -PIC  X(080) VALUE SPACES.
CAPG05*          -15 RUCA66-URLCODRASTLDDEMPNMNT
CAPG05*                                     -PIC  X(255) VALUE SPACES.

BRQ001**** TAMANHO = 13
BRQ001*
CAPG05** EXCLUIDO PERC ENERGIA RENOVAVEL - SICOR 5.12
CAPG05* -01  RUCA66-COR0001-20.
CAPG05*    -05 RUCA66-PERCENERRENOVVLEMPNMNT -PIC  9(03)V99 VALUE ZEROS.
