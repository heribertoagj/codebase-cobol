...
CAPG05*  DATA..........:   05/2026                                      *
CAPG05*----------------------------------------------------------------*
CAPG05*  OBJETIVOS.....:   AGROLEG-1482 - COR0001 SICOR 5.12            *
CAPG05*                    GRUPO SISTPRODC; NUMORDEMDESTCRENEGC;        *
...
CAPG05*    -MOVE  RUEC58-SIST-PROD      TO  RUCA66-COD-SIST-PRODC
CAPG05     MOVE  RUEC58-SIST-PROD      TO  RUCA66-GP-COR0001-SIST-PRODC
           MOVE  VFINAN                OF  RUCAB015
                                       TO  WRK-S13V99-DRESS
...
BRQ001*----------------------------------------------------------------*
CAPG05*    -PERFORM 5106-MONTA-CERTIFICACAO.
BRQ001*----------------------------------------------------------------*
...
BRQ001*----------------------------------------------------------------*
CAPG05*5106-MONTA-CERTIFICACAO         SECTION.
CAPG05*----------------------------------------------------------------*
CAPG05*
CAPG05*    -IF  WRK-CCETFC-ORGNC-EMPTO-NULL LESS ZEROS
CAPG05*        -MOVE  ALL '*'       TO  RUCA66-CODCERTIFCORGNCOEMPNMNT
CAPG05*                                RUCA66-URLCERTIFCORGNCOEMPNMNT
CAPG05*    -ELSE
CAPG05*        -MOVE  CCETFC-ORGNC-EMPTO OF RUCAB015
CAPG05*                            TO RUCA66-CODCERTIFCORGNCOEMPNMNT
CAPG05*        -MOVE  EURL-CETFC-ORGNC-TEXT OF RUCAB015(1:255)
CAPG05*                            TO RUCA66-URLCERTIFCORGNCOEMPNMNT
CAPG05*    END-IF.
CAPG05*
CAPG05*    -MOVE  RUCA66-COR0001-18     TO  WRK-MSGEM-RURAL(ACU-POSICAO:
CAPG05*                                    LENGTH OF RUCA66-COR0001-18)
CAPG05*    -ADD   LENGTH OF RUCA66-COR0001-18
CAPG05*                                TO  ACU-TAM
CAPG05*                                    ACU-POSICAO.
CAPG05*
CAPG05*    -IF  WRK-CRSTRB-EMPTO-RURAL-NULL LESS ZEROS
CAPG05*        -MOVE  ALL '*'       TO  RUCA66-CODRASTLDDEMPNMNT
CAPG05*                                RUCA66-URLCODRASTLDDEMPNMNT
CAPG05*    -ELSE
CAPG05*        -MOVE  CRSTRB-EMPTO-RURAL OF RUCAB015
CAPG05*                            TO RUCA66-CODRASTLDDEMPNMNT
CAPG05*        -MOVE  EURL-RSTRB-EMPTO-TEXT OF RUCAB015(1:255)
CAPG05*                            TO RUCA66-URLCODRASTLDDEMPNMNT
CAPG05*    END-IF.
CAPG05*
CAPG05*    -MOVE  RUCA66-COR0001-19     TO  WRK-MSGEM-RURAL(ACU-POSICAO:
CAPG05*                                    LENGTH OF RUCA66-COR0001-19)
CAPG05*    -ADD   LENGTH OF RUCA66-COR0001-19
CAPG05*                                TO  ACU-TAM
CAPG05*                                    ACU-POSICAO.
CAPG05*
CAPG05*    -IF  WRK-PENERG-RENOV-EMPTO-NULL LESS ZEROS
CAPG05*        -MOVE  ALL '*'       TO  RUCA66-COR0001-20
CAPG05*    -ELSE
CAPG05*        -MOVE  PENERG-RENOV-EMPTO OF RUCAB015
CAPG05*                            TO WRK-PIC9-3V99-CS
CAPG05*        -MOVE  WRK-PIC9-3V99-SS  TO RUCA66-PERCENERRENOVVLEMPNMNT
CAPG05*    END-IF.
CAPG05*
CAPG05*    -MOVE  RUCA66-COR0001-20     TO  WRK-MSGEM-RURAL(ACU-POSICAO:
CAPG05*                                    LENGTH OF RUCA66-COR0001-20)
CAPG05*    -ADD   LENGTH OF RUCA66-COR0001-20
CAPG05*                                TO  ACU-TAM
CAPG05*                                    ACU-POSICAO.
CAPG05*
CAPG05*----------------------------------------------------------------*
CAPG05*5106-99-FIM.  EXIT.
CAPG05*----------------------------------------------------------------*
...
CAPG05     MOVE  ALL '*'               TO  RUCA66-NUM-ORDEM-DEST-RENEGC
