      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-INPUT.
           ...
           03 WRK-I-PROX-PAG           PIC  X(001)         VALUE SPACES.
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-OUTPUT.
           ...
           03 WRK-O-PROX-PAG           PIC  X(001)         VALUE SPACES.
      ...
      *----------------------------------------------------------------*
           ...
           IF WRK-FIM-CSR              EQUAL 'N'
              MOVE 'S'                 TO WRK-I-PROX-PAG
                                          WRK-O-PROX-PAG
           ELSE
              MOVE 'N'                 TO WRK-I-PROX-PAG
                                          WRK-O-PROX-PAG
           END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE VSDO-DVDOR-PRINC       OF RUFIB045
                                       TO WRK-S9-15V2.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WRK-I-PROX-PAG         TO WRK-O-PROX-PAG.
      ...
      *----------------------------------------------------------------*
           ...
           IF WRK-I-PAGINA             NOT GREATER 1
              MOVE 'NAO EXISTE PAGINA PARA RETORNAR'
                                       TO WRK-O-MENSA
              GO  TO 3400-99-FIM
           END-IF.
