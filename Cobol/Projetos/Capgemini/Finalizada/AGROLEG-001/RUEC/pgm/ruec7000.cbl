...
PW9931     END-IF.
           ...
           IF  INP-PFK-T700 EQUAL '4'
               MOVE INP-AAGENC-T700        TO AGENCIA 
                                           OF NAVEGACAO-RURAL
               MOVE INP-ACONTA-T700        TO CONTA   
                                           OF NAVEGACAO-RURAL
               MOVE INP-ACGCNUM-T700       TO CNPJ-CPF 
                                           OF NAVEGACAO-RURAL
               MOVE CIMPRE-CDULA-TEMPR     OF RUECB007
                                           TO CCDULA  
                                           OF NAVEGACAO-RURAL
...
PW9931     MOVE WRK-INP-RECBR-T700-X   TO   WRK-OUT-ARECBR-T700-X.
      ...
      *---------------------------------------------------------------*
           ...
           CALL 'POOL0110' USING WRK-CGC-CPF WRK-CONTROLE.
