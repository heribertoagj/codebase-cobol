      ...
      *----------------------------------------------------------------*
      *     TELAS.......:                                              *
      *     RUCAT652....: DESCLASSIFICACAO DE OPERACAO RURAL           *
      *----------------------------------------------------------------*
      *     BANCO DE DADOS :                                           *
      *----------------------------------------------------------------*
      *      DB2                                                       *
...
NAV506*================================================================*
      ...
      *----------------------------------------------------------------*
       ...
       77  FILLER                      PIC  X(46)        VALUE
           '*** INICIO DA WORKING DO PROGRAMA RUCA6652 ***'.
      ...
      *--- AUXILIARES -------------------------------------------------*
       ...
       77  WRK-ORIGEM-RECURSOS         PIC S9(03)V9(01)  USAGE COMP-3
                                                         VALUE ZEROS.
       77  WRK-TOTAL                   PIC S9(04)  COMP  VALUE ZEROS.
       77  WRK-SQLCODE                 PIC S9(09)  COMP  VALUE ZEROS.
...
NAV506*
NAV506*01  WRK-CPF-R             REDEFINES  WRK-CPF-X    PIC 9(15).
BRQ001
NAV506*01  WRK-CGC-X.
...
NAV506*
NAV506*01  WRK-CGC-R             REDEFINES  WRK-CGC-X    PIC 9(15).
BRQ001
...
BRQ001                                                   VALUE ZEROS.
       ...
       01  WRK-TOTAL-1                 PIC  9(04)        VALUE ZEROS.
       01  WRK-TOTAL-1-X               REDEFINES
           WRK-TOTAL-1                 PIC  X(04).
...
201609
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-INPUT-T652.
           03  WRK-FILLER-T652             PIC  X(18) VALUE SPACES.
           03  WRK-INP-PFK-T652            PIC  X(01) VALUE SPACES.
           03  WRK-INP-SENHAS-T652         PIC  X(37) VALUE SPACES.
           03  WRK-INP-NOPCAO-T652          PIC  X(02) VALUE SPACES.
           03  WRK-INP-FASE-T652            PIC  X(01) VALUE SPACES.
           03  WRK-INP-NROPER-T652-X.
               05  WRK-INP-NROPER-T652      PIC  9(09) VALUE ZEROS.
           03  WRK-INP-DADOS-T652.
               05  WRK-INP-DIGOPER-T652     PIC  X(01) VALUE SPACES.
               05  WRK-INP-NROANTE-T652     PIC  9(09) VALUE ZEROS.
               05  WRK-INP-SEQDESC-T652-X.
                   07  WRK-INP-SEQDESC-T652 PIC  9(03) VALUE ZEROS.
               05  WRK-INP-ASEQDESC-T652    PIC  9(03) VALUE ZEROS.
               05  WRK-INP-AGENCIA-T652-X.
                   07  WRK-INP-AGENCIA-T652 PIC  9(05) VALUE ZEROS.
               05  WRK-INP-NOMAG-T652       PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-INP-CTRLIF-T652      PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-INP-NMOTVO-T652      PIC  9(05) VALUE ZEROS.
               05  WRK-INP-AAFINAN-T652-X.
                   07  WRK-INP-AAFINAN-T652 PIC  9(07) VALUE ZEROS.
               05  WRK-INP-NOME-T652        PIC  X(30) VALUE SPACES.
               05  WRK-INP-CC-T652-X.
                   07  WRK-INP-CC-T652      PIC  9(07) VALUE ZEROS.
               05  WRK-INP-CCDIG-T652-X.
                   07  WRK-INP-CCDIG-T652   PIC  9(01) VALUE ZEROS.
               05  WRK-INP-CGCR-T652-X.
                   07  WRK-INP-CGCR-T652    PIC  9(09) VALUE ZEROS.
               05  WRK-INP-CGCF-T652-X.
                   07  WRK-INP-CGCF-T652    PIC  9(04) VALUE ZEROS.
               05  WRK-INP-CGCD-T652-X.
                   07  WRK-INP-CGCD-T652    PIC  9(02) VALUE ZEROS.
               05  WRK-INP-CREDITO-T652     PIC  X(21) VALUE SPACES.
               05  WRK-INP-DEVEDOR-T652     PIC  X(21) VALUE SPACES.
               05  WRK-INP-VLRDESC-T652     PIC  X(21) VALUE SPACES.
               05  WRK-INP-DTDESC-T652      PIC  X(10) VALUE SPACES.
               05  WRK-INP-MOTDES-T652-X.
                   07  WRK-INP-MOTDES-T652  PIC  9(03) VALUE ZEROS.
               05  WRK-INP-MOTDES1-T652     PIC  X(60) VALUE SPACES.
           03  WRK-INP-MENSAG-T652          PIC  X(79) VALUE SPACES.
           03  WRK-INP-T652.
               05  WRK-INP-LIN-T652         PIC S9(02) COMP VALUE ZEROS.
               05  WRK-INP-COL-T652         PIC S9(02) COMP VALUE ZEROS.

      /----------------------------------------------------------------*
      ***  TELA RUCAT652            - OUTPUT
      *----------------------------------------------------------------*

       01  WRK-OUTPUT-T652.
           03  WRK-OUT-LL-T652              PIC S9(04) COMP VALUE ZEROS.
           03  WRK-OUT-ZZ-T652              PIC S9(04) COMP VALUE ZEROS.
           03  WRK-OUT-SENHAS-T652          PIC  X(37) VALUE SPACES.
           03  WRK-OUT-NOPCAO-T652          PIC  X(02) VALUE SPACES.
           03  WRK-OUT-FASE-T652            PIC  X(01) VALUE SPACES.
           03  WRK-OUT-OPER-ATTR-T652       PIC  9(04) COMP VALUE ZEROS.
           03  WRK-OUT-NROPER-T652-X.
               05  WRK-OUT-NROPER-T652      PIC  9(09) VALUE ZEROS.
           03  WRK-OUT-DADOS-T652.
               05  WRK-OUT-DIGOPER-T652     PIC  X(01) VALUE SPACES.
               05  WRK-OUT-NROANTE-T652     PIC  9(09) VALUE ZEROS.
               05  WRK-OUT-SEQD-ATTR-T652   PIC  9(04) COMP VALUE ZEROS.
               05  WRK-OUT-SEQDESC-T652-X.
                   07  WRK-OUT-SEQDESC-T652 PIC  9(03) VALUE ZEROS.
               05  WRK-OUT-ASEQDESC-T652    PIC  9(03) VALUE ZEROS.
               05  WRK-OUT-AGENCIA-T652-X.
                   07  WRK-OUT-AGENCIA-T652 PIC  9(05) VALUE ZEROS.
               05  WRK-OUT-NOMAG-T652       PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-OUT-CTRLIF-T652      PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-OUT-NMOTVO-T652      PIC  9(05) VALUE ZEROS.
               05  WRK-OUT-AAFINAN-T652-X.
                   07  WRK-OUT-AAFINAN-T652 PIC  9(07) VALUE ZEROS.
               05  WRK-OUT-NOME-T652        PIC  X(30) VALUE SPACES.
               05  WRK-OUT-CC-T652-X.
                   07  WRK-OUT-CC-T652      PIC  9(07) VALUE ZEROS.
               05  WRK-OUT-CCDIG-T652-X.
                   07  WRK-OUT-CCDIG-T652   PIC  9(01) VALUE ZEROS.
               05  WRK-OUT-CGCR-T652-X.
                   07  WRK-OUT-CGCR-T652    PIC  9(09) VALUE ZEROS.
               05  WRK-OUT-CGCF-T652-X.
                   07  WRK-OUT-CGCF-T652    PIC  9(04) VALUE ZEROS.
               05  WRK-OUT-CGCD-T652-X.
                   07  WRK-OUT-CGCD-T652    PIC  9(02) VALUE ZEROS.
               05  WRK-OUT-CREDITO-T652-X.
                   07  WRK-OUT-CREDITO-T652 PIC  ZZ.ZZZ.ZZZ.ZZZ.ZZ9,99
                                                       VALUE ZEROS.
               05  WRK-OUT-DEVEDOR-T652-X.
                   07  WRK-OUT-DEVEDOR-T652 PIC  ZZ.ZZZ.ZZZ.ZZZ.ZZ9,99
                                                       VALUE ZEROS.
               05  WRK-OUT-VLRDESC-ATTR-T652 PIC 9(04) COMP VALUE ZEROS.
               05  WRK-OUT-VLRDESC-T652-X.
                   07  WRK-OUT-VLRDESC-T652 PIC  ZZ.ZZZ.ZZZ.ZZZ.ZZ9,99
                                                       VALUE ZEROS.
               05  WRK-OUT-DTDESC-ATTR-T652 PIC  9(04) COMP VALUE ZEROS.
               05  WRK-OUT-DTDESC-T652      PIC  X(10) VALUE SPACES.
               05  WRK-OUT-MOTDES-ATTR-T652 PIC  9(04) COMP VALUE ZEROS.
               05  WRK-OUT-MOTDES-T652-X.
                   07  WRK-OUT-MOTDES-T652  PIC  9(03) VALUE ZEROS.
               05  WRK-OUT-MOTDES1-T652     PIC  X(60) VALUE SPACES.
           03  WRK-OUT-MENSAG-T652          PIC  X(79) VALUE SPACES.

      *----------------------------------------------------------------*
      ***  AREA DA POOL0660 COM MASCARA DA TELA RUCAT652 - SEGMENTO 00
      *----------------------------------------------------------------*

       01  WRK-660-RUCAT652.
           03  WRK-660-LL-AREA-T652         PIC  9(04) COMP VALUE ZEROS.
           03  WRK-660-LL-MENSAGEM-T652     PIC  9(04) COMP VALUE ZEROS.
           03  WRK-660-SENHAS-T652          PIC  9(04) COMP VALUE 0037.
           03  WRK-660-NOPCAO-T652          PIC  9(04) COMP VALUE 0002.
           03  WRK-660-FASE-T652            PIC  9(04) COMP VALUE 0001.
           03  WRK-660-NROPER-T652          PIC  9(04) COMP VALUE 2011.
           03  WRK-660-DIGOPER-T652         PIC  9(04) COMP VALUE 0001.
           03  WRK-660-NROANTE-T652         PIC  9(04) COMP VALUE 0009.
           03  WRK-660-SEQDESC-T652         PIC  9(04) COMP VALUE 2005.
           03  WRK-660-ASEQDESC-T652        PIC  9(04) COMP VALUE 0003.
           03  WRK-660-AGENCIA-T652         PIC  9(04) COMP VALUE 0005.
           03  WRK-660-NOMAG-T652           PIC  9(04) COMP VALUE 0020.
BRQ001     03  WRK-660-CTRLIF-T652          PIC  9(04) COMP VALUE 0020.
BRQ001     03  WRK-660-NMOTVO-T652          PIC  9(04) COMP VALUE 0005.
           03  WRK-660-AAFINAN-T652         PIC  9(04) COMP VALUE 0007.
           03  WRK-660-NOME-T652            PIC  9(04) COMP VALUE 0030.
           03  WRK-660-CC-T652              PIC  9(04) COMP VALUE 0007.
           03  WRK-660-CCDIG-T652           PIC  9(04) COMP VALUE 0001.
           03  WRK-660-CGCR-T652            PIC  9(04) COMP VALUE 0009.
           03  WRK-660-CGCF-T652            PIC  9(04) COMP VALUE 0004.
           03  WRK-660-CGCD-T652            PIC  9(04) COMP VALUE 0002.
           03  WRK-660-CREDITO-T652         PIC  9(04) COMP VALUE 0021.
           03  WRK-660-DEVEDOR-T652         PIC  9(04) COMP VALUE 0021.
           03  WRK-660-VLRDESC-T652         PIC  9(04) COMP VALUE 2023.
           03  WRK-660-DTDESC-T652          PIC  9(04) COMP VALUE 2012.
           03  WRK-660-MOTDES-T652          PIC  9(04) COMP VALUE 2005.
           03  WRK-660-MOTDES1-T652         PIC  9(04) COMP VALUE 0060.
           03  WRK-660-MENSAG-T652          PIC  9(04) COMP VALUE 0079.
      ...
      *----------------------------------------------------------------*
       ...
       01  FILLER.
           03  WRK-VALOR-DESCL         PIC  9(014)V9(02)   COMP-3
                                                           VALUE ZEROS.
...
NAV506*       10 WRK-AGENCIA8870             PIC  9(005)   VALUE ZEROES.
NAV506*       10 WRK-CEDULA                  PIC  9(009)   VALUE ZEROES.
NAV506*       10 WRK-TIPO-PESSOA             PIC  X(001)   VALUE SPACES.
NAV506*       10 WRK-IDENTIF                 PIC  9(015)   VALUE ZEROES.
...
NAV506*       10 WRK-NUMREFORIG              PIC X(11)     VALUE SPACES.
NAV506*
NAV506*       10 FILLER                      PIC X(055)    VALUE SPACES.
NAV506*    05 WRK-RETORNO.
NAV506*       10 WRK-COD-RET                 PIC  9(002)   VALUE ZEROES.
NAV506*
NAV506*=======  00 - OK
...
NAV506*       10 WRK-AGENCIA-8871            PIC  9(005)   VALUE ZEROES.
NAV506*       10 WRK-CEDULA-8871             PIC  9(009)   VALUE ZEROES.
...
NAV506*       10 WRK-COD-RET-8871            PIC  9(002)   VALUE ZEROES.
NAV506*=======  00 - OK
NAV506*=======  01 - DADOS INCONSISTENTES
NAV506*=======  99 - ERRO DB2
...
NAV506*
       01  FILLER                      PIC  X(46)        VALUE
           '*** F I M  DA WORKING DO PROGRAMA RUCA6652 ***'.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE 'RUCAT652'             TO WRK-TELA.

           IF  WRK-TRANSACAO           NOT EQUAL 'RUCA6652'
201609         IF WRK-TRANSACAO        EQUAL 'RURC2770'
201609            PERFORM 1001-TRATAR-RETORNO-PF9
201609         ELSE
                  INSPECT WRK-OUTPUT-T652 REPLACING ALL ZEROS BY SPACES
                  MOVE WRK-MSG001      TO WRK-OUT-MENSAG-T652
201609         END-IF
           ELSE
               PERFORM 2000-PROCESSAR-RUCA6652
           END-IF.

           IF  WRK-TELA                EQUAL 'RUCAT652'
               PERFORM 4000-POOL0660-RUCAT652
           END-IF.
...
201609                                 TO  WRK-INPUT-T652
201609     MOVE '.'                    TO  WRK-INP-PFK-T652.
201609     MOVE WRK-2770-MOTIVO-SELCD-N
201609                                 TO  WRK-INP-MOTDES-T652.
201609     PERFORM 2001-DEVOLVER-TELA.
201609     PERFORM 2102-TRATA-FASE-2.
201609
201609*----------------------------------------------------------------*
...
201609
      *---------------------------------------------------------------*
       2000-PROCESSAR-RUCA6652         SECTION.
      *---------------------------------------------------------------*

           MOVE WRK-MENSAGEM           TO WRK-INPUT-T652.
           PERFORM 2001-DEVOLVER-TELA.

BRQ001     IF (WRK-INP-FASE-T652       EQUAL '3' OR '4') AND
BRQ001        (WRK-INP-PFK-T652        EQUAL '.')
BRQ001        MOVE '6'                 TO WRK-INP-PFK-T652
BRQ001     END-IF.

           EVALUATE WRK-INP-PFK-T652

               WHEN  '.'
                   PERFORM 2100-TRATAR-ENTER

               WHEN  '6'
BRQ001               EVALUATE WRK-INP-FASE-T652
BRQ001                 WHEN '3'
BRQ001                   PERFORM 2215-VERIFICA-DESCLA-TOT
NAV506***               -IF WRK-TP-DESCLASS EQUAL 'T'
BRQ001                     PERFORM 2200-CONFIRMAR-ALTERACAO
WP1122                     PERFORM 2220-ENVIAR-COR0005
BRQ001                     PERFORM 2214-ALTERACAO-EFETUADA
NAV506***               -ELSE
NAV506***                 -PERFORM 2118-OBTER-DADOS-RUFIV002
NAV506***                 -PERFORM 2206-ENVIAR-COR0003
NAV506***               -END-IF
NAV506***             -WHEN '4'
NAV506***--BUSCA-WCONTD-NA-TABELA-RUECB09C-COM-CTRLIF-E-COR0003R1
NAV506***               -PERFORM 2207-COUNT-RUECB09C
NAV506***               -IF WRK-TOTAL-COR0003R1 EQUAL ZEROS
NAV506***                   -MOVE 'AGUARDANDO RETORNO BACEN - COR0003'
NAV506***                                   TO WRK-OUT-MENSAG-T652
NAV506***               -ELSE
NAV506***                 -IF ACU-ENVIO-COR0001 EQUAL ZEROES
NAV506***                    -PERFORM 2200-CONFIRMAR-ALTERACAO
NAV506***                 -END-IF
NAV506***                 -PERFORM 2208-OPEN-COR0003R1
NAV506***                 -PERFORM 2209-FETCH-COR0003R1 UNTIL
NAV506***                                SQLCODE EQUAL +100
NAV506***                 -PERFORM 2210-CLOSE-COR0003R1
NAV506***                 -IF ACU-ENVIO-COR0001 GREATER ZEROS
NAV506***                    -MOVE '5'       TO WRK-OUT-FASE-T652
...
NAV506***               -PERFORM 2212-SELECT-COR0001R1
BRQ001               END-EVALUATE
...
201609
               ...
               WHEN OTHER
                   MOVE WRK-MSG002     TO WRK-OUT-MENSAG-T652
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-FASE-T652      TO WRK-OUT-FASE-T652.
           MOVE WRK-INP-NROPER-T652-X  TO WRK-OUT-NROPER-T652-X.
           MOVE WRK-INP-DIGOPER-T652   TO WRK-OUT-DIGOPER-T652.
           MOVE WRK-INP-NROANTE-T652   TO WRK-OUT-NROANTE-T652.
           MOVE WRK-INP-SEQDESC-T652-X TO WRK-OUT-SEQDESC-T652-X.
           MOVE WRK-INP-ASEQDESC-T652  TO WRK-OUT-ASEQDESC-T652.
           MOVE WRK-INP-AGENCIA-T652-X TO WRK-OUT-AGENCIA-T652-X.
           MOVE WRK-INP-NOMAG-T652     TO WRK-OUT-NOMAG-T652.
           MOVE WRK-INP-AAFINAN-T652-X TO WRK-OUT-AAFINAN-T652-X.
           MOVE WRK-INP-NOME-T652      TO WRK-OUT-NOME-T652.
           MOVE WRK-INP-CC-T652-X      TO WRK-OUT-CC-T652-X.
           MOVE WRK-INP-CCDIG-T652-X   TO WRK-OUT-CCDIG-T652-X.
           MOVE WRK-INP-CGCR-T652-X    TO WRK-OUT-CGCR-T652-X
           MOVE WRK-INP-CGCF-T652-X    TO WRK-OUT-CGCF-T652-X.
           MOVE WRK-INP-CGCD-T652-X    TO WRK-OUT-CGCD-T652-X.
           MOVE WRK-INP-CREDITO-T652   TO WRK-OUT-CREDITO-T652-X.
           MOVE WRK-INP-DEVEDOR-T652   TO WRK-OUT-DEVEDOR-T652-X.
           MOVE WRK-INP-VLRDESC-T652   TO WRK-OUT-VLRDESC-T652-X.
           MOVE WRK-INP-DTDESC-T652    TO WRK-OUT-DTDESC-T652.
           MOVE WRK-INP-MOTDES-T652-X  TO WRK-OUT-MOTDES-T652-X.
           MOVE WRK-INP-MOTDES1-T652   TO WRK-OUT-MOTDES1-T652.
BRQ001     MOVE WRK-INP-CTRLIF-T652    TO WRK-OUT-CTRLIF-T652.
BRQ001     MOVE WRK-INP-NMOTVO-T652    TO WRK-OUT-NMOTVO-T652.
      ...
      *---------------------------------------------------------------*
           ...
           IF WRK-INP-FASE-T652     EQUAL ' ' OR '0'
      *       RECEBE TELA
              MOVE '1'                 TO WRK-INP-FASE-T652
           END-IF.

           IF (WRK-INP-SEQDESC-T652  NOT EQUAL WRK-INP-ASEQDESC-T652) OR
              (WRK-INP-NROPER-T652   NOT EQUAL WRK-INP-NROANTE-T652)
      *       MUDOU A SEQUENCIA
              MOVE '1'                 TO WRK-INP-FASE-T652
           END-IF.

           EVALUATE  WRK-INP-FASE-T652
               WHEN  '1'
                     PERFORM 2101-TRATA-FASE-1
               WHEN  '2'
                     PERFORM 2102-TRATA-FASE-2
               WHEN  '3'
                     PERFORM 2103-TRATA-FASE-3
           END-EVALUATE.
      ...
      *---------------------------------------------------------------*
       2101-TRATA-FASE-1               SECTION.
      *---------------------------------------------------------------*

           MOVE 'N'                    TO WRK-INCONSISTENCIA.

           IF  WRK-INP-NROPER-T652-X   EQUAL SPACES OR LOW-VALUES
               MOVE 'INFORME A CHAVE DA OPERACAO'
                                       TO WRK-OUT-MENSAG-T652
               MOVE 'S'                TO WRK-INCONSISTENCIA
               MOVE WRK-49369          TO WRK-OUT-OPER-ATTR-T652
               GO TO 2101-99-FIM
           END-IF.

           INSPECT WRK-INP-NROPER-T652-X REPLACING LEADING ' ' BY '0'.

           IF  WRK-INP-NROPER-T652-X   NOT NUMERIC
           ...
           IF  WRK-INP-SEQDESC-T652    EQUAL ZEROS OR
               WRK-INP-SEQDESC-T652-X  EQUAL SPACES
               PERFORM 2111-CONSISTIR-SEQUENCIA
           ...
           IF  WRK-INCONSISTENCIA      NOT EQUAL 'S'
               PERFORM 2117-OBTER-DIGOPER
               PERFORM 2118-OBTER-DADOS-RUFIV002
               IF  WRK-NAO-ENCONTRADO  EQUAL 'S'
                   MOVE '1'            TO WRK-OUT-FASE-T652
                   MOVE 'S'            TO WRK-INCONSISTENCIA
                   PERFORM 2205-LIMPA-TELA
                   MOVE 'OPERACAO INFORMADA NAO CADASTRADA'
                                       TO WRK-OUT-MENSAG-T652
                   MOVE WRK-49369      TO WRK-OUT-OPER-ATTR-T652
                   MOVE WRK-INP-NROPER-T652-X
                                       TO WRK-OUT-NROPER-T652-X
                   GO TO 2101-99-FIM
               END-IF
               PERFORM 2115-OBTER-DADOS-SEQUENCIA
               IF  WRK-SQLCODE         EQUAL +100
                   MOVE '1'            TO WRK-OUT-FASE-T652
                   MOVE 'S'            TO WRK-INCONSISTENCIA
                   PERFORM 2205-LIMPA-TELA
                   STRING
                        'OPERACAO NAO POSSUI DESCLASSIFICACAO / '
                        'DESCLASSIFICACAO NAO ENCONTRADA'
                   DELIMITED BY SIZE INTO WRK-OUT-MENSAG-T652
                   MOVE WRK-49369      TO WRK-OUT-OPER-ATTR-T652
                   MOVE WRK-INP-NROPER-T652-X
                                       TO WRK-OUT-NROPER-T652-X
                   GO TO 2101-99-FIM
               END-IF
               PERFORM 2119-OBTER-DADOS-RUCAB003
               PERFORM 2120-MONTAR-DADOS-SAIDA
               IF  WRK-INP-SEQDESC-T652    NOT EQUAL
                   WRK-INP-ASEQDESC-T652
                   PERFORM 2115-OBTER-DADOS-SEQUENCIA
                   IF WRK-SQLCODE       EQUAL +100
                      MOVE '1'         TO WRK-OUT-FASE-T652
                      MOVE 'S'         TO WRK-INCONSISTENCIA
                      PERFORM 2205-LIMPA-TELA
                      MOVE 'DESCLASSIFICACAO NAO ENCONTRADA'
                                       TO WRK-OUT-MENSAG-T652
                      MOVE WRK-49369   TO WRK-OUT-SEQD-ATTR-T652
                      MOVE WRK-INP-NROPER-T652-X
                                       TO WRK-OUT-NROPER-T652-X
                      MOVE WRK-INP-SEQDESC-T652-X
                                       TO WRK-OUT-SEQDESC-T652-X
.                     GO TO 2101-99-FIM
.                  ELSE
.                     PERFORM 2116-MONTA-DADOS-SEQUENCIA
.                  END-IF
TESTE          END-IF
           END-IF.

           PERFORM 2125-DESBLOQUEIA-TELA.

           MOVE 'INFORME O VALOR A DESCLASSIFICAR'
                                       TO WRK-OUT-MENSAG-T652.
           MOVE WRK-49369              TO WRK-OUT-VLRDESC-ATTR-T652
                                          WRK-OUT-DTDESC-ATTR-T652
                                          WRK-OUT-MOTDES-ATTR-T652.
           MOVE '2'                    TO WRK-OUT-FASE-T652.
      ...
      *---------------------------------------------------------------*
           ...
           PERFORM 2112-CONSISTIR-VALOR-DESCL.

           IF  WRK-INCONSISTENCIA      EQUAL 'S'
               GO TO 2102-99-FIM
           END-IF.

           PERFORM 2113-CONSISTIR-DATA-DESCL.

           IF  WRK-INCONSISTENCIA      EQUAL 'S'
               GO TO 2102-99-FIM
           END-IF.

           PERFORM 2114-CONSISTIR-MOTIVO-DESCL.

           IF  (WRK-INCONSISTENCIA      NOT EQUAL 'S')
               PERFORM 2126-BLOQUEIA-TELA
           END-IF.
      ...
      *---------------------------------------------------------------*
       2104-CONSISTIR-ENTRADA          SECTION.
      *---------------------------------------------------------------*
      ...
      *---------------------------------------------------------------*
       2111-CONSISTIR-SEQUENCIA        SECTION.
      *---------------------------------------------------------------*

           MOVE WRK-INP-NROPER-T652   TO CCONTR             OF RUFIB044.
           ...
           IF ( SQLCODE                NOT EQUAL ZEROS AND +100)   OR
              ( SQLWARN0               EQUAL 'W' )
                ...
                MOVE 'SELECT C'           TO ERR-FUN-COMANDO
                MOVE SQLCODE              TO ERR-SQL-CODE
                MOVE '2111'               TO ERR-LOCAL
           ...
           EVALUATE WRK-TOTAL
               WHEN ZEROS
                    MOVE '1'           TO WRK-OUT-FASE-T652
                    MOVE 'OPERACAO NAO POSSUI DESCLASSIFICACAO'
                                       TO WRK-OUT-MENSAG-T652
                    MOVE 'S'           TO WRK-INCONSISTENCIA
                    MOVE WRK-49369     TO WRK-OUT-OPER-ATTR-T652
               WHEN 1
                    PERFORM 2127-OBTER-SEQ
                    IF WRK-SQLCODE   EQUAL +100
                       CONTINUE
                    ELSE
                       MOVE NMOTVO-DCLAS-CONTR OF RUFIB044
                                       TO WRK-INP-SEQDESC-T652
                                          WRK-OUT-SEQDESC-T652
                    END-IF
               WHEN OTHER
                    MOVE '1'           TO WRK-OUT-FASE-T652
                    MOVE WRK-TOTAL     TO WRK-TOTAL-1
                    STRING 'OPERACAO POSSUI '
                           WRK-TOTAL-1-X
                           ' DESCLASSIFICACOES. INFORME A SEQUENCIA DA'
                           ' DESCLASSIFICACAO.'
                    DELIMITED BY SIZE INTO WRK-OUT-MENSAG-T652
                    MOVE 'S'           TO WRK-INCONSISTENCIA
                    MOVE WRK-49369     TO WRK-OUT-SEQD-ATTR-T652
                    MOVE SPACES        TO WRK-OUT-VLRDESC-T652-X
                                          WRK-OUT-DTDESC-T652
                                          WRK-OUT-MOTDES-T652-X
                                          WRK-OUT-MOTDES1-T652
           END-EVALUATE.
      ...
      *---------------------------------------------------------------*
       2112-CONSISTIR-VALOR-DESCL      SECTION.
      *---------------------------------------------------------------*

           IF  WRK-INP-VLRDESC-T652    EQUAL SPACES
           OR  WRK-INP-VLRDESC-T652    EQUAL LOW-VALUES
               MOVE 'INFORME O VALOR A DESCLASSIFICAR'
                                       TO WRK-OUT-MENSAG-T652
               MOVE 'S'                TO WRK-INCONSISTENCIA
               MOVE WRK-49369          TO WRK-OUT-VLRDESC-ATTR-T652
           ...
           MOVE WRK-INP-VLRDESC-T652   TO WRK-POOL0496-ENTRADA.
           ...
           IF  WRK-POOL0496-RETURN-CODE EQUAL ZEROS OR 20
               ...
               MOVE WRK-ZD14V2         TO WRK-OUT-VLRDESC-T652
                                          WRK-VALOR-DESCL
           ELSE
               MOVE 'S'                TO WRK-INCONSISTENCIA
               MOVE WRK-49369          TO WRK-OUT-VLRDESC-ATTR-T652
      ...
      *---------------------------------------------------------------*
       2113-CONSISTIR-DATA-DESCL       SECTION.
      *---------------------------------------------------------------*

           INITIALIZE WRK-AREA-POOL1205.
           MOVE SPACES                 TO WRK-1205-MENSAGEM.

           IF  WRK-INP-DTDESC-T652     EQUAL SPACES OR LOW-VALUES
               MOVE 'S'                TO WRK-INCONSISTENCIA
               MOVE 'INFORME A DATA DA DESCLASSIFICACAO NO FORMATO DD/MM
      -              '/AAAA OU DDMMAAAA'
                                       TO WRK-OUT-MENSAG-T652
               MOVE WRK-49369          TO WRK-OUT-DTDESC-ATTR-T652
              GO TO 2113-99-FIM
           END-IF.

           MOVE WRK-INP-DTDESC-T652(7:4)
                                       TO WRK-ANO-ISO
           IF  WRK-ANO-ISO             NOT NUMERIC
               MOVE 'DATA DE DESCLASSIFICACAO INVALIDA - ANO NAO NUMERIC
      -              'O'               TO WRK-OUT-MENSAG-T652
               MOVE 'S'                TO WRK-INCONSISTENCIA
               MOVE WRK-49369          TO WRK-OUT-DTDESC-ATTR-T652
               GO TO 2113-99-FIM
           END-IF.

           IF  WRK-INP-DTDESC-T652(6:1)        NOT NUMERIC
               MOVE WRK-INP-DTDESC-T652(4:2)   TO WRK-MES-ISO
               MOVE WRK-INP-DTDESC-T652(1:2)   TO WRK-DIA-ISO
           ELSE
               IF WRK-INP-DTDESC-T652(1:2)     NOT EQUAL SPACES AND
                                                         LOW-VALUES
                  ...
                  GO TO 2113-99-FIM
               ELSE
                  MOVE WRK-INP-DTDESC-T652(5:2) TO WRK-MES-ISO
                  MOVE WRK-INP-DTDESC-T652(3:2) TO WRK-DIA-ISO
               END-IF
           END-IF
      ...
      -             'O'                TO WRK-OUT-MENSAG-T652
           ...
           MOVE WRK-DIA-ISO            TO WRK-OUT-DTDESC-T652(1:2).
           MOVE '/'                    TO WRK-OUT-DTDESC-T652(3:1).
           MOVE WRK-MES-ISO            TO WRK-OUT-DTDESC-T652(4:2).
           MOVE '/'                    TO WRK-OUT-DTDESC-T652(6:1).
           MOVE WRK-ANO-ISO            TO WRK-OUT-DTDESC-T652(7:4).
           MOVE WRK-OUT-DTDESC-T652    TO WRK-DATA-DESCL.
      ...
      *---------------------------------------------------------------*
       2114-CONSISTIR-MOTIVO-DESCL     SECTION.
      *---------------------------------------------------------------*

           IF  WRK-INP-MOTDES-T652-X   EQUAL SPACES OR
               WRK-INP-MOTDES-T652     EQUAL ZEROS
               MOVE 'INFORME O MOTIVO DA DESCLASSIFICACAO'
                                       TO WRK-OUT-MENSAG-T652
               MOVE 'S'                TO WRK-INCONSISTENCIA
               MOVE WRK-49369          TO WRK-OUT-MOTDES-ATTR-T652
               GO TO 2114-99-FIM
           END-IF.

           INSPECT WRK-INP-MOTDES-T652-X REPLACING LEADING ' ' BY '0'.
           IF  WRK-INP-MOTDES-T652-X   NOT NUMERIC
      ...
      *---------------------------------------------------------------*
       2115-OBTER-DADOS-SEQUENCIA      SECTION.
      *---------------------------------------------------------------*

           MOVE ZEROS                 TO WRK-SQLCODE.
           MOVE WRK-INP-NROPER-T652   TO CCONTR             OF RUFIB044.
           MOVE WRK-INP-SEQDESC-T652  TO NMOTVO-DCLAS-CONTR OF RUFIB044.
           ...
           EXEC SQL
             ...
             FROM DB2PRD.TMOTVO_DCLAS_CONTR
            WHERE CCONTR             = :RUFIB044.CCONTR
              AND NMOTVO_DCLAS_CONTR = :RUFIB044.NMOTVO-DCLAS-CONTR
           END-EXEC.
      ...
      *---------------------------------------------------------------*
       2116-MONTA-DADOS-SEQUENCIA      SECTION.
      *---------------------------------------------------------------*

           MOVE CMOTVO-DCLAS-OPER         OF RUFIB044
                                          TO WRK-INP-MOTDES-T652
                                             WRK-OUT-MOTDES-T652.
           MOVE DDCLAS-OPER-CREDT         OF RUFIB044
                                          TO WRK-DATA-DESCL
           INSPECT WRK-DATA-DESCL REPLACING ALL '.' BY '/'.

           MOVE WRK-DATA-DESCL            TO WRK-OUT-DTDESC-T652.

           MOVE VPRINC-DCLAS-CONTR        OF RUFIB044
                                          TO WRK-OUT-VLRDESC-T652.
           ...
           INSPECT WRK-OUT-SEQDESC-T652-X REPLACING LEADING ' ' BY '0'.

           MOVE WRK-INP-SEQDESC-T652      TO WRK-OUT-ASEQDESC-T652.
      ...
      *---------------------------------------------------------------*
       2117-OBTER-DIGOPER              SECTION.
      *---------------------------------------------------------------*

           INITIALIZE WRK-AREA-POOL0432.

           MOVE WRK-INP-NROPER-T652    TO WRK-VALOR-0432.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2118-OBTER-DADOS-RUFIV002       SECTION.
      *---------------------------------------------------------------*

           MOVE 'N'                    TO WRK-NAO-ENCONTRADO.
           MOVE WRK-INP-NROPER-T652    TO CCONTR      OF    RUFIV002.
...
BRQ001         :WRK-CREFT-RECOR-NULL
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2119-OBTER-DADOS-RUCAB003       SECTION.
      *---------------------------------------------------------------*

           MOVE WRK-INP-NROPER-T652    TO B003-CH-CONTR OF  RUCAB003.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2120-MONTAR-DADOS-SAIDA         SECTION.
      *---------------------------------------------------------------*

           PERFORM 2121-OBTER-NOME-AGENCIA.

           MOVE WRK-INP-NROPER-T652          TO WRK-OUT-NROPER-T652.
           MOVE WRK-DIGOPER                  TO WRK-OUT-DIGOPER-T652.
           MOVE CJUNC-DEPDC    OF RUFIV002   TO WRK-OUT-AGENCIA-T652.
           MOVE WRK-NOME-AGENCIA             TO WRK-OUT-NOMAG-T652.
           MOVE CCDULA         OF RUFIV002   TO WRK-OUT-AAFINAN-T652.
           MOVE B003-NOMUTUAR1 OF RUCAB003   TO WRK-OUT-NOME-T652.
           MOVE CCTA-CORR      OF RUFIV002   TO WRK-OUT-CC-T652.

           MOVE  SPACES                      TO WRK-DIGITO-COSA.
           MOVE  '7'                         TO WRK-DIGITO-COSA-1.

           CALL  'POOL0431'               USING WRK-OUT-CC-T652
                                                WRK-DIGITO-COSA-1
                                                WRK-TAMANHO-0431

           IF    WRK-DIGITO-COSA-1        EQUAL '.'
                 MOVE SPACES                 TO WRK-OUT-CCDIG-T652-X
           ELSE
                 MOVE WRK-DIGITO-COSA        TO WRK-OUT-CCDIG-T652-X
           END-IF.

           MOVE B003-CGCPF1    OF RUCAB003   TO WRK-DESC-CGC-R.
           MOVE WRK-RAIZ-CGC                 TO WRK-OUT-CGCR-T652.
           MOVE WRK-FILIAL-CGC               TO WRK-OUT-CGCF-T652.
           MOVE WRK-DIG-CGC                  TO WRK-OUT-CGCD-T652.
           MOVE VFINAN         OF RUFIV002   TO WRK-OUT-CREDITO-T652.
           ...
           MOVE WRK-DEVEDOR                  TO WRK-OUT-DEVEDOR-T652.
           ...
           MOVE WRK-INP-NROPER-T652    TO WRK-OUT-NROANTE-T652.

      *---------------------------------------------------------------*
       2120-99-FIM.                    EXIT.
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2121-OBTER-NOME-AGENCIA         SECTION.
      *---------------------------------------------------------------*

           IF CGARTD    OF   RUFIV002  EQUAL 700
              PERFORM 2122-TAB-INTERNA
           ELSE
              PERFORM 2123-ACESSAR-MESU9032
           END-IF.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2124-DESCRICAO-MOTIVO           SECTION.
      *---------------------------------------------------------------*

           MOVE WRK-INP-MOTDES-T652    TO CMOTVO-DCLAS-OPER OF RURCB097.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2125-DESBLOQUEIA-TELA           SECTION.
      *---------------------------------------------------------------*

           MOVE WRK-49361                 TO WRK-OUT-OPER-ATTR-T652
                                             WRK-OUT-VLRDESC-ATTR-T652
                                             WRK-OUT-DTDESC-ATTR-T652
                                             WRK-OUT-MOTDES-ATTR-T652
                                             WRK-OUT-SEQD-ATTR-T652.

      *---------------------------------------------------------------*
       2125-99-FIM.                    EXIT.
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2126-BLOQUEIA-TELA              SECTION.
      *---------------------------------------------------------------*

           MOVE 'TECLE PF6 PARA CONFIRMAR OU ENTER PARA ALTERAR'
                                          TO WRK-OUT-MENSAG-T652.
           MOVE '3'                       TO WRK-OUT-FASE-T652.
           MOVE WRK-225                   TO WRK-OUT-OPER-ATTR-T652
                                             WRK-OUT-VLRDESC-ATTR-T652
                                             WRK-OUT-DTDESC-ATTR-T652
                                             WRK-OUT-MOTDES-ATTR-T652
                                             WRK-OUT-SEQD-ATTR-T652.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2127-OBTER-SEQ                  SECTION.
      *---------------------------------------------------------------*

           MOVE ZEROS                 TO WRK-SQLCODE.
           MOVE WRK-INP-NROPER-T652   TO CCONTR             OF RUFIB044.
           MOVE ZEROS                 TO NMOTVO-DCLAS-CONTR OF RUFIB044.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2200-CONFIRMAR-ALTERACAO        SECTION.
      *---------------------------------------------------------------*

BRQ001     IF  WRK-INP-FASE-T652       NOT EQUAL '3' AND '4'
               MOVE WRK-MSG002         TO WRK-OUT-MENSAG-T652
               GO TO 2200-99-FIM
           END-IF.
           ...
           PERFORM 2104-CONSISTIR-ENTRADA.

           IF  WRK-INCONSISTENCIA      EQUAL 'S'
               MOVE '1'                TO WRK-OUT-FASE-T652
               MOVE 'NAO FOI POSSIVEL ALTERAR'
                                       TO WRK-OUT-MENSAG-T652
               GO TO 2200-99-FIM
           END-IF.
           ...
           PERFORM 2203-ATUALIZAR-REGISTROS.
           ...
           IF WRK-SQLCODE              EQUAL +100
              ...
              GO TO 2200-99-FIM
           ELSE
              MOVE 'COR0001 ENVIADA'   TO WRK-OUT-MENSAG-T652
           END-IF.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T652   TO CCONTR             OF RUFIB044.
           MOVE WRK-INP-MOTDES-T652   TO CMOTVO-DCLAS-OPER  OF RUFIB044.
...
BRQ001     MOVE -1                    TO WRK-CREFT-RECOR-NULL.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2203-ATUALIZAR-REGISTROS        SECTION.
      *---------------------------------------------------------------*

           MOVE ZEROS                     TO WRK-SQLCODE.

           EXEC SQL
             UPDATE DB2PRD.TMOTVO_DCLAS_CONTR
                SET
                    CMOTVO_DCLAS_OPER  = :RUFIB044.CMOTVO-DCLAS-OPER
                   ,DDCLAS_OPER_CREDT  = :RUFIB044.DDCLAS-OPER-CREDT
                   ,VPRINC_DCLAS_CONTR = :RUFIB044.VPRINC-DCLAS-CONTR
                   ,CUSUAR_INCL        = :RUFIB044.CUSUAR-INCL
                   ,HINCL              =  CURRENT TIMESTAMP
                   ,CUSUAR_MANUT       = :RUFIB044.CUSUAR-MANUT
                                         :WRK-CUSUAR-MANUT-NULL
                   ,HMANUT_REG         = :RUFIB044.HMANUT-REG
                                         :WRK-HMANUT-NULL
BRQ001             ,CREFT_RECOR        = :RUFIB044.CREFT-RECOR
BRQ001                                   :WRK-CREFT-RECOR-NULL
              WHERE
                    CCONTR             = :RUFIB044.CCONTR
                AND NMOTVO_DCLAS_CONTR = :RUFIB044.NMOTVO-DCLAS-CONTR
           END-EXEC.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2205-LIMPA-TELA                 SECTION.
      *---------------------------------------------------------------*

           MOVE ZEROS                  TO WRK-OUT-ASEQDESC-T652
                                          WRK-OUT-NROANTE-T652.

           MOVE SPACES                 TO WRK-OUT-NROPER-T652-X
                                          WRK-OUT-DIGOPER-T652
                                          WRK-OUT-AGENCIA-T652-X
                                          WRK-OUT-NOMAG-T652
                                          WRK-OUT-AAFINAN-T652-X
                                          WRK-OUT-NOME-T652
                                          WRK-OUT-CC-T652-X
                                          WRK-OUT-CCDIG-T652-X
                                          WRK-OUT-CGCR-T652-X
                                          WRK-OUT-CGCF-T652-X
                                          WRK-OUT-CGCD-T652-X
                                          WRK-OUT-CREDITO-T652-X
                                          WRK-OUT-DEVEDOR-T652-X
                                          WRK-OUT-VLRDESC-T652-X
                                          WRK-OUT-DTDESC-T652
                                          WRK-OUT-MOTDES-T652-X
                                          WRK-OUT-MOTDES1-T652
                                          WRK-OUT-SEQDESC-T652-X.

      *---------------------------------------------------------------*
       2205-99-FIM.                    EXIT.
      *---------------------------------------------------------------*
NAV506*---------------------------------------------------------------*
NAV506*2206-ENVIAR-COR0003             SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*
NAV506*   -MOVE 'RUCA6652'              TO WRK-PGM-CHAMADOR
NAV506*   -MOVE WRK-INP-AGENCIA-T652    TO WRK-AGENCIA8870
NAV506*   -MOVE WRK-INP-NROPER-T652     TO WRK-CEDULA
NAV506*   -IF WRK-INP-CGCF-T652      EQUAL ZEROES
NAV506*       -MOVE 'F'                 TO WRK-TIPO-PESSOA
NAV506*       -MOVE WRK-INP-CGCR-T652-X TO WRK-CPF-BAS
NAV506*       -MOVE WRK-INP-CGCD-T652-X TO WRK-CPF-DIG
NAV506*       -MOVE WRK-CPF-R           TO WRK-IDENTIF
NAV506*   -ELSE
NAV506*       -MOVE 'J'                 TO WRK-TIPO-PESSOA
NAV506*       -MOVE WRK-INP-CGCR-T652-X TO WRK-CGC-BAS
NAV506*       -MOVE WRK-INP-CGCF-T652-X TO WRK-CGC-FILI
NAV506*       -MOVE WRK-INP-CGCD-T652-X TO WRK-CGC-DIG
NAV506*       -MOVE WRK-CGC-R           TO WRK-IDENTIF
NAV506*   -END-IF.
NAV506*   -MOVE CREFT-RECOR OF RUFIV002 TO WRK-NUMREFORIG.
...
NAV506*       -MOVE  22                 TO WRK-LOCAL-ERRO
NAV506*       -MOVE  WRK-MENSAGEM8870   TO ERR-TEXTO
NAV506*       -PERFORM 9999-ROTINA-ERRO
NAV506*   -END-IF.
NAV506*
NAV506*   -MOVE '4'                    TO WRK-OUT-FASE-T652
NAV506*   -MOVE 'CONSULTA COR0003 ENVIADA'
NAV506*                                TO WRK-OUT-MENSAG-T652
NAV506*   -MOVE WRK-INP-NROPER-T652-X  TO WRK-OUT-NROPER-T652-X
NAV506*   -MOVE WRK-INP-DIGOPER-T652   TO WRK-OUT-DIGOPER-T652
NAV506*   -MOVE WRK-INP-AGENCIA-T652-X TO WRK-OUT-AGENCIA-T652-X
NAV506*   -MOVE WRK-INP-NOMAG-T652     TO WRK-OUT-NOMAG-T652
NAV506*   -MOVE WRK-INP-AAFINAN-T652-X TO WRK-OUT-AAFINAN-T652-X
NAV506*   -MOVE WRK-INP-NOME-T652      TO WRK-OUT-NOME-T652
NAV506*   -MOVE WRK-INP-CC-T652-X      TO WRK-OUT-CC-T652-X
NAV506*   -MOVE WRK-INP-CCDIG-T652-X   TO WRK-OUT-CCDIG-T652-X
NAV506*   -MOVE WRK-INP-CGCR-T652-X    TO WRK-OUT-CGCR-T652-X
NAV506*   -MOVE WRK-INP-CGCF-T652-X    TO WRK-OUT-CGCF-T652-X
NAV506*   -MOVE WRK-INP-CGCD-T652-X    TO WRK-OUT-CGCD-T652-X
NAV506*   -MOVE WRK-INP-CREDITO-T652   TO WRK-OUT-CREDITO-T652-X
NAV506*   -MOVE WRK-INP-DEVEDOR-T652   TO WRK-OUT-DEVEDOR-T652-X
NAV506*   -MOVE WRK-INP-VLRDESC-T652   TO WRK-OUT-VLRDESC-T652-X
NAV506*   -MOVE WRK-INP-DTDESC-T652    TO WRK-OUT-DTDESC-T652
NAV506*   -MOVE WRK-INP-MOTDES-T652-X  TO WRK-OUT-MOTDES-T652-X
NAV506*   -MOVE WRK-INP-MOTDES1-T652   TO WRK-OUT-MOTDES1-T652.
NAV506*
NAV506*   -MOVE WRK-CONTROLE-BACEN     TO WRK-INP-CTRLIF-T652
NAV506*                                   WRK-OUT-CTRLIF-T652.
NAV506*
NAV506*   -MOVE WRK-225                TO WRK-OUT-OPER-ATTR-T652
NAV506*                                   WRK-OUT-VLRDESC-ATTR-T652
NAV506*                                   WRK-OUT-DTDESC-ATTR-T652
NAV506*                                   WRK-OUT-MOTDES-ATTR-T652.
NAV506*
NAV506*---------------------------------------------------------------*
...
BRQ001
NAV506*---------------------------------------------------------------*
NAV506*2207-COUNT-RUECB09C             SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*   -INITIALIZE RUECB09C.
NAV506*
NAV506*   -MOVE WRK-INP-CTRLIF-T652    TO CCTRL-RQUIS-FINCR OF RUECB09C.
NAV506*
NAV506*   -EXEC SQL
NAV506*        -SELECT COUNT(*)
...
BRQ001
NAV506*---------------------------------------------------------------*
NAV506*2208-OPEN-COR0003R1             SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*   -INITIALIZE RUECB09C.
NAV506*
...
NAV506*
NAV506*---------------------------------------------------------------*
NAV506*2209-FETCH-COR0003R1            SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*   -EXEC SQL
...
NAV506*   -END-IF.
NAV506*
NAV506*   -PERFORM 2211-ENVIO-COR0001.
NAV506*
NAV506*---------------------------------------------------------------*
...
NAV506*
NAV506*---------------------------------------------------------------*
NAV506*2210-CLOSE-COR0003R1            SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*   -EXEC SQL
...
NAV506*
NAV506*---------------------------------------------------------------*
NAV506*2211-ENVIO-COR0001              SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*   -MOVE WCONTD-MSGEM-RURAL-TEXT OF RUECB09C
NAV506*                                 TO WRK-MSGEM-COR0003-TEXT.
NAV506*   -MOVE 'RUCA6652'              TO WRK-PGM-CHAMADOR-8871.
NAV506*   -MOVE WRK-INP-AGENCIA-T652    TO WRK-AGENCIA-8871.
NAV506*   -MOVE WRK-INP-NROPER-T652     TO WRK-CEDULA-8871.
NAV506*   -MOVE WRK-INP-SEQDESC-T652    TO WRK-NUM-SEQ-DESCLA.
NAV506*   -MOVE 'A'                     TO WRK-FUNCAO-8871.
NAV506*   -MOVE 14                     TO WRK-POOL0496-TAM-INT.
NAV506*   -MOVE 02                     TO WRK-POOL0496-TAM-DEC.
NAV506*   -MOVE WRK-INP-CREDITO-T652   TO WRK-POOL0496-ENTRADA.
...
NAV506*   -MOVE 14                     TO WRK-POOL0496-TAM-INT.
NAV506*   -MOVE 02                     TO WRK-POOL0496-TAM-DEC.
NAV506*   -MOVE WRK-INP-VLRDESC-T652   TO WRK-POOL0496-ENTRADA.
NAV506*   -MOVE ZEROS                  TO RETURN-CODE
NAV506*                                   WRK-POOL0496-RETURN-CODE.
NAV506*   -MOVE SPACES                 TO WRK-POOL0496-SAIDA.
NAV506*
...
NAV506*   -END-IF.
NAV506*   -MOVE WRK-INP-CTRLIF-T652     TO WRK-NUM-CTRL-IF.
...
NAV506*
NAV506***-------------------------------------------------------------*
NAV506*2212-SELECT-COR0001R1           SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*   -INITIALIZE RUECB09C.
NAV506*
...
NAV506*        -PERFORM 2213-UPDATE-RUFIB044
NAV506*     -END-IF
NAV506*   -END-IF.
NAV506*
NAV506*---------------------------------------------------------------*
...
NAV506*
NAV506*---------------------------------------------------------------*
NAV506*2213-UPDATE-RUFIB044            SECTION.
NAV506*---------------------------------------------------------------*
NAV506*
NAV506*   -INITIALIZE RUFIB044.
NAV506*
NAV506*   -MOVE WRK-INP-NROPER-T652  TO CCONTR      OF    RUFIB044.
NAV506*   -MOVE WRK-NUMREFBCCOR-COR1 TO CREFT-RECOR OF    RUFIB044.
NAV506*   -MOVE ZEROS                TO WRK-CREFT-RECOR-NULL.
NAV506*   MMOVE WRK-INP-NMOTVO-T652  TO NMOTVO-DCLAS-CONTR OF RUFIB044
NAV506*   -MOVE WRK-INP-SEQDESC-T652 TO NMOTVO-DCLAS-CONTR OF RUFIB044.
...
NAV506*        -MOVE 'SELECT  '           TO ERR-FUN-COMANDO
NAV506*        -MOVE SQLCODE              TO ERR-SQL-CODE
NAV506*        -MOVE '2213'               TO ERR-LOCAL
NAV506*        -MOVE SPACES               TO ERR-SEGM
NAV506*        -PERFORM 9999-ROTINA-ERRO
NAV506*   -END-IF.
NAV506*
NAV506*    -PERFORM 2214-ALTERACAO-EFETUADA.
NAV506*
NAV506*---------------------------------------------------------------*
NAV506*2213-99-FIM.                    EXIT.
NAV506*---------------------------------------------------------------*
BRQ001
BRQ001*---------------------------------------------------------------*
BRQ001 2214-ALTERACAO-EFETUADA         SECTION.
BRQ001*---------------------------------------------------------------*
BRQ001
BRQ001     MOVE '1'                    TO WRK-OUT-FASE-T652
BRQ001     MOVE 'ALTERACAO EFETUADA COM SUCESSO'
BRQ001                                 TO WRK-OUT-MENSAG-T652
BRQ001     MOVE WRK-49361              TO WRK-OUT-OPER-ATTR-T652
BRQ001                                    WRK-OUT-VLRDESC-ATTR-T652
BRQ001                                    WRK-OUT-DTDESC-ATTR-T652
BRQ001                                    WRK-OUT-MOTDES-ATTR-T652.
BRQ001
BRQ001     MOVE SPACES                 TO WRK-OUT-NROPER-T652-X
BRQ001                                    WRK-OUT-DIGOPER-T652
BRQ001                                    WRK-OUT-AGENCIA-T652-X
BRQ001                                    WRK-OUT-NOMAG-T652
BRQ001                                    WRK-OUT-AAFINAN-T652-X
BRQ001                                    WRK-OUT-NOME-T652
BRQ001                                    WRK-OUT-CC-T652-X
BRQ001                                    WRK-OUT-CCDIG-T652-X
BRQ001                                    WRK-OUT-CGCR-T652-X
BRQ001                                    WRK-OUT-CGCF-T652-X
BRQ001                                    WRK-OUT-CGCD-T652-X
BRQ001                                    WRK-OUT-CREDITO-T652-X
BRQ001                                    WRK-OUT-DEVEDOR-T652-X
BRQ001                                    WRK-OUT-VLRDESC-T652-X
BRQ001                                    WRK-OUT-DTDESC-T652
BRQ001                                    WRK-OUT-MOTDES-T652-X
BRQ001                                    WRK-OUT-MOTDES1-T652.
BRQ001
BRQ001*---------------------------------------------------------------*
...
BRQ001
BRQ001*---------------------------------------------------------------*
BRQ001 2215-VERIFICA-DESCLA-TOT        SECTION.
BRQ001*---------------------------------------------------------------*
BRQ001
BRQ001     MOVE 14                     TO WRK-POOL0496-TAM-INT.
BRQ001     MOVE 02                     TO WRK-POOL0496-TAM-DEC.
BRQ001     MOVE WRK-INP-CREDITO-T652   TO WRK-POOL0496-ENTRADA.
...
BRQ001     MOVE 14                     TO WRK-POOL0496-TAM-INT.
BRQ001     MOVE 02                     TO WRK-POOL0496-TAM-DEC.
BRQ001     MOVE WRK-INP-VLRDESC-T652   TO WRK-POOL0496-ENTRADA.
BRQ001     MOVE ZEROS                  TO RETURN-CODE
BRQ001                                    WRK-POOL0496-RETURN-CODE.
BRQ001     MOVE SPACES                 TO WRK-POOL0496-SAIDA.
BRQ001
...
-
-          MOVE 'RUCA6652'             TO RUEC65-PGM-CHAMADOR
-          MOVE WRK-INP-NROPER-T652    TO RUEC65-CCONTR
...
-                  PERFORM 9999-ROTINA-ERRO
-             WHEN OTHER
-                  MOVE RUEC65-MENSAGEM    TO WRK-OUT-MENSAG-T652
-          END-EVALUATE.
-
-     *----------------------------------------------------------------*
-      2220-99-FIM.    EXIT.
...
201609*----------------------------------------------------------------*
201609
BRQ001     IF  WRK-INP-FASE-T652       NOT EQUAL '3'
201609         MOVE WRK-MSG002         TO WRK-OUT-MENSAG-T652
201609         GO TO 2340-99-FIM
201609     END-IF.
201609
201609     IF  WRK-INP-LIN-T652        NOT EQUAL 18
201609     OR (WRK-INP-COL-T652        NOT EQUAL 54 AND 55 AND 56 )
201609         MOVE 'POSICIONE O CURSOR NO CAMPO MOTIVO PARA ACIONAR A L
201609-              'ISTA'            TO WRK-OUT-MENSAG-T652
201609         GO TO 2340-99-FIM
201609     END-IF.
201609
...
201609     MOVE 'RUCA6652'             TO  WRK-2770-TRANSACAO
201609     MOVE '.'                    TO  WRK-2770-PFK
201609     MOVE WRK-INP-SENHAS-T652    TO  WRK-2770-SENHAS
201609     MOVE ZEROS                  TO  WRK-2770-OPCAO
201609                                     WRK-2770-MOTIVO-SELCD
201609     MOVE SPACES                 TO  WRK-2770-MENSAGEM
201609     MOVE 'RUCA6652'             TO  WRK-2770-ANTE-TELA
201609     MOVE WRK-INPUT-T652(1:242)  TO  WRK-2770-NAVEGACAO.
201609
...
201609
      *---------------------------------------------------------------*
       4000-POOL0660-RUCAT652          SECTION.
      *---------------------------------------------------------------*

           MOVE LENGTH OF WRK-OUTPUT-T652
                                       TO WRK-660-LL-MENSAGEM-T652
                                          WRK-OUT-LL-T652
           MOVE LENGTH OF WRK-660-RUCAT652
                                       TO WRK-660-LL-AREA-T652

           CALL  'POOL0660'    USING   WRK-OUTPUT-T652
                                       WRK-660-RUCAT652.
           ...
           MOVE  WRK-OUTPUT-T652       TO WRK-MENSAGEM.
