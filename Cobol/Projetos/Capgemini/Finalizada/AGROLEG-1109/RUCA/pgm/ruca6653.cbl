      ...
      *----------------------------------------------------------------*
      *     TELAS.......:                                              *
      *     RUCAT653....: DESCLASSIFICACAO DE OPERACAO RURAL           *
      *----------------------------------------------------------------*
      *     BANCO DE DADOS :                                           *
      *----------------------------------------------------------------*
      *      DB2                                                       *
      ...
      *================================================================*
BRQ001*================================================================*
BRQ001*    PROGRAMADOR.:   RODOLFO VIEIRA           - BRQ              *
...
NAV506*================================================================*
      ...
      *----------------------------------------------------------------*
       ...
       77  FILLER                      PIC  X(46)        VALUE
           '*** INICIO DA WORKING DO PROGRAMA RUCA6653 ***'.
...
BRQ001     03  WRK-CREFT-RECOR-NULL    PIC S9(04) COMP   VALUE ZEROS.
       ...
       01  WRK-VALOR-DESCL             PIC  9(014)V9(02) VALUE ZEROS.
       01  WRK-DATA-DESCL              PIC  X(010)       VALUE SPACES.
...
BRQ001                                                   VALUE ZEROS.
BRQ001 01  WRK-CH21-GRUPO.
BRQ001     03 FILLER                   PIC  X(005)         VALUE SPACES.
BRQ001     03 WRK-ZD14V2               PIC  9(014)V9(02)   VALUE ZEROS.
BRQ001 01  WRK-CH21                    REDEFINES
BRQ001     WRK-CH21-GRUPO              PIC  X(021).

BRQ001*----------------------------------------------------------------*
BRQ001 01  FILLER                      PIC  X(032)         VALUE
BRQ001     '*** AREA DA POOL0496         ***'.
BRQ001*----------------------------------------------------------------*
BRQ001
BRQ001 01  WRK-POOL0496-AREA.
BRQ001     03  WRK-POOL0496-ENTRADA        PIC  X(21)  VALUE SPACES.
BRQ001     03  WRK-POOL0496-SAIDA          PIC  X(21)  VALUE SPACES.
BRQ001     03  WRK-POOL0496-TAMANHO.
BRQ001         05 WRK-POOL0496-TAM-ENT     PIC  9(02)  VALUE 21.
BRQ001         05 WRK-POOL0496-TAM-SAI     PIC  9(02)  VALUE 21.
BRQ001         05 WRK-POOL0496-TAM-INT     PIC  9(02)  VALUE ZEROS.
BRQ001         05 WRK-POOL0496-TAM-DEC     PIC  9(02)  VALUE ZEROS.
BRQ001
BRQ001 01  FILLER.
BRQ001     03 WRK-POOL0496-RETURN-CODE PIC S9(009) COMP VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-INPUT-T653.
           03  WRK-FILLER-T653             PIC  X(18) VALUE SPACES.
           03  WRK-INP-PFK-T653            PIC  X(01) VALUE SPACES.
           03  WRK-INP-SENHAS-T653         PIC  X(37) VALUE SPACES.
           03  WRK-INP-NOPCAO-T653         PIC  X(02) VALUE SPACES.
           03  WRK-INP-FASE-T653            PIC  X(01) VALUE SPACES.
           03  WRK-INP-NROPER-T653-X.
               05  WRK-INP-NROPER-T653      PIC  9(09) VALUE ZEROS.
           03  WRK-INP-DADOS-T653.
               05  WRK-INP-DIGOPER-T653     PIC  X(01) VALUE SPACES.
               05  WRK-INP-NROANTE-T653     PIC  9(09) VALUE ZEROS.
               05  WRK-INP-SEQDESC-T653-X.
                   07  WRK-INP-SEQDESC-T653 PIC  9(03) VALUE ZEROS.
               05  WRK-INP-ASEQDESC-T653    PIC  9(03) VALUE ZEROS.
               05  WRK-INP-AGENCIA-T653-X.
                   07  WRK-INP-AGENCIA-T653 PIC  9(05) VALUE ZEROS.
               05  WRK-INP-NOMAG-T653       PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-INP-CTRLIF-T653      PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-INP-NMOTVO-T653-X.
BRQ001             07  WRK-INP-NMOTVO-T653  PIC  9(05) VALUE ZEROS.
               05  WRK-INP-AAFINAN-T653-X.
                   07  WRK-INP-AAFINAN-T653 PIC  9(07) VALUE ZEROS.
               05  WRK-INP-NOME-T653        PIC  X(30) VALUE SPACES.
               05  WRK-INP-CC-T653-X.
                   07  WRK-INP-CC-T653      PIC  9(07) VALUE ZEROS.
               05  WRK-INP-CCDIG-T653-X.
                   07  WRK-INP-CCDIG-T653   PIC  9(01) VALUE ZEROS.
               05  WRK-INP-CGCR-T653-X.
                   07  WRK-INP-CGCR-T653    PIC  9(09) VALUE ZEROS.
               05  WRK-INP-CGCF-T653-X.
                   07  WRK-INP-CGCF-T653    PIC  9(04) VALUE ZEROS.
               05  WRK-INP-CGCD-T653-X.
                   07  WRK-INP-CGCD-T653    PIC  9(02) VALUE ZEROS.
               05  WRK-INP-CREDITO-T653     PIC  X(21) VALUE SPACES.
               05  WRK-INP-DEVEDOR-T653     PIC  X(21) VALUE SPACES.
               05  WRK-INP-VLRDESC-T653     PIC  X(21) VALUE SPACES.
               05  WRK-INP-DTDESC-T653      PIC  X(10) VALUE SPACES.
               05  WRK-INP-MOTDES-T653-X.
                   07  WRK-INP-MOTDES-T653  PIC  9(03) VALUE ZEROS.
               05  WRK-INP-MOTDES1-T653     PIC  X(60) VALUE SPACES.
           03  WRK-INP-MENSAG-T653          PIC  X(79) VALUE SPACES.

      /----------------------------------------------------------------*
      ***  TELA RUCAT653            - OUTPUT
      *----------------------------------------------------------------*

       01  WRK-OUTPUT-T653.
           03  WRK-OUT-LL-T653              PIC S9(04) COMP VALUE ZEROS.
           03  WRK-OUT-ZZ-T653              PIC S9(04) COMP VALUE ZEROS.
           03  WRK-OUT-SENHAS-T653          PIC  X(37) VALUE SPACES.
           03  WRK-OUT-NOPCAO-T653          PIC  X(02) VALUE SPACES.
           03  WRK-OUT-FASE-T653            PIC  X(01) VALUE SPACES.
           03  WRK-OUT-OPER-ATTR-T653       PIC  9(04) COMP VALUE ZEROS.
           03  WRK-OUT-NROPER-T653-X.
               05  WRK-OUT-NROPER-T653      PIC  9(09) VALUE ZEROS.
           03  WRK-OUT-DADOS-T653.
               05  WRK-OUT-DIGOPER-T653     PIC  X(01) VALUE SPACES.
               05  WRK-OUT-NROANTE-T653     PIC  9(09) VALUE ZEROS.
               05  WRK-OUT-SEQD-ATTR-T653   PIC  9(04) COMP VALUE ZEROS.
               05  WRK-OUT-SEQDESC-T653-X.
                   07  WRK-OUT-SEQDESC-T653 PIC  9(03) VALUE ZEROS.
               05  WRK-OUT-ASEQDESC-T653    PIC  9(03) VALUE ZEROS.
               05  WRK-OUT-AGENCIA-T653-X.
                   07  WRK-OUT-AGENCIA-T653 PIC  9(05) VALUE ZEROS.
               05  WRK-OUT-NOMAG-T653       PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-OUT-CTRLIF-T653      PIC  X(20) VALUE SPACES.
BRQ001         05  WRK-OUT-NMOTVO-T653-X.
BRQ001             07  WRK-OUT-NMOTVO-T653  PIC  9(05) VALUE ZEROS.
               05  WRK-OUT-AAFINAN-T653-X.
                   07  WRK-OUT-AAFINAN-T653 PIC  9(07) VALUE ZEROS.
               05  WRK-OUT-NOME-T653        PIC  X(30) VALUE SPACES.
               05  WRK-OUT-CC-T653-X.
                   07  WRK-OUT-CC-T653      PIC  9(07) VALUE ZEROS.
               05  WRK-OUT-CCDIG-T653-X.
                   07  WRK-OUT-CCDIG-T653   PIC  9(01) VALUE ZEROS.
               05  WRK-OUT-CGCR-T653-X.
                   07  WRK-OUT-CGCR-T653    PIC  9(09) VALUE ZEROS.
               05  WRK-OUT-CGCF-T653-X.
                   07  WRK-OUT-CGCF-T653    PIC  9(04) VALUE ZEROS.
               05  WRK-OUT-CGCD-T653-X.
                   07  WRK-OUT-CGCD-T653    PIC  9(02) VALUE ZEROS.
               05  WRK-OUT-CREDITO-T653-X.
                   07  WRK-OUT-CREDITO-T653 PIC  ZZ.ZZZ.ZZZ.ZZZ.ZZ9,99
                                                       VALUE ZEROS.
               05  WRK-OUT-DEVEDOR-T653-X.
                   07  WRK-OUT-DEVEDOR-T653 PIC  ZZ.ZZZ.ZZZ.ZZZ.ZZ9,99
                                                       VALUE ZEROS.
               05  WRK-OUT-VLRDESC-T653-X.
                   07  WRK-OUT-VLRDESC-T653 PIC  ZZ.ZZZ.ZZZ.ZZZ.ZZ9,99
                                                       VALUE ZEROS.
               05  WRK-OUT-DTDESC-T653      PIC  X(10) VALUE SPACES.
               05  WRK-OUT-MOTDES-T653-X.
                   07  WRK-OUT-MOTDES-T653  PIC  9(03) VALUE ZEROS.
               05  WRK-OUT-MOTDES1-T653     PIC  X(60) VALUE SPACES.
           03  WRK-OUT-MENSAG-T653          PIC  X(79) VALUE SPACES.

      *----------------------------------------------------------------*
      ***  AREA DA POOL0660 COM MASCARA DA TELA RUCAT653 - SEGMENTO 00
      *----------------------------------------------------------------*

       01  WRK-660-RUCAT653.
           03  WRK-660-LL-AREA-T653         PIC  9(04) COMP VALUE ZEROS.
           03  WRK-660-LL-MENSAGEM-T653     PIC  9(04) COMP VALUE ZEROS.
           03  WRK-660-SENHAS-T653          PIC  9(04) COMP VALUE 1037.
           03  WRK-660-NOPCAO-T653          PIC  9(04) COMP VALUE 0002.
           03  WRK-660-FASE-T653            PIC  9(04) COMP VALUE 0001.
           03  WRK-660-NROPER-T653          PIC  9(04) COMP VALUE 2011.
           03  WRK-660-DIGOPER-T653         PIC  9(04) COMP VALUE 0001.
           03  WRK-660-NROANTE-T653         PIC  9(04) COMP VALUE 0009.
           03  WRK-660-SEQDESC-T653         PIC  9(04) COMP VALUE 2005.
           03  WRK-660-ASEQDESC-T653        PIC  9(04) COMP VALUE 0003.
           03  WRK-660-AGENCIA-T653         PIC  9(04) COMP VALUE 0005.
           03  WRK-660-NOMAG-T653           PIC  9(04) COMP VALUE 0020.
BRQ001     03  WRK-660-CTRLIF-T653          PIC  9(04) COMP VALUE 0020.
BRQ001     03  WRK-660-NMOTVO-T653          PIC  9(04) COMP VALUE 0005.
           03  WRK-660-AAFINAN-T653         PIC  9(04) COMP VALUE 0007.
           03  WRK-660-NOME-T653            PIC  9(04) COMP VALUE 0030.
           03  WRK-660-CC-T653              PIC  9(04) COMP VALUE 0007.
           03  WRK-660-CCDIG-T653           PIC  9(04) COMP VALUE 0001.
           03  WRK-660-CGCR-T653            PIC  9(04) COMP VALUE 0009.
           03  WRK-660-CGCF-T653            PIC  9(04) COMP VALUE 0004.
           03  WRK-660-CGCD-T653            PIC  9(04) COMP VALUE 0002.
           03  WRK-660-CREDITO-T653         PIC  9(04) COMP VALUE 0021.
           03  WRK-660-DEVEDOR-T653         PIC  9(04) COMP VALUE 0021.
           03  WRK-660-VLRDESC-T653         PIC  9(04) COMP VALUE 0021.
           03  WRK-660-DTDESC-T653          PIC  9(04) COMP VALUE 0010.
           03  WRK-660-MOTDES-T653          PIC  9(04) COMP VALUE 0003.
           03  WRK-660-MOTDES1-T653         PIC  9(04) COMP VALUE 0060.
           03  WRK-660-MENSAG-T653          PIC  9(04) COMP VALUE 0079.
...
NAV506*
       01  FILLER                      PIC  X(46)        VALUE
           '*** F I M  DA WORKING DO PROGRAMA RUCA6653 ***'.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE 'RUCAT653'             TO WRK-TELA.

           IF  WRK-TRANSACAO           NOT EQUAL 'RUCA6653'
               INSPECT WRK-OUTPUT-T653 REPLACING ALL ZEROS BY SPACES
               MOVE WRK-MSG001         TO WRK-OUT-MENSAG-T653
           ELSE
               PERFORM 2000-PROCESSAR-RUCA6653
           END-IF.

           IF  WRK-TELA                EQUAL 'RUCAT653'
               PERFORM 4000-POOL0660-RUCAT653
           END-IF.
      ...
      *---------------------------------------------------------------*
       2000-PROCESSAR-RUCA6653         SECTION.
      *---------------------------------------------------------------*

           MOVE WRK-MENSAGEM           TO WRK-INPUT-T653.
           PERFORM 2001-DEVOLVER-TELA.

BRQ001     IF (WRK-INP-FASE-T653       EQUAL '3' OR '4') AND
BRQ001        (WRK-INP-PFK-T653        EQUAL '.')
BRQ001        MOVE '6'                 TO WRK-INP-PFK-T653
BRQ001     END-IF.

           EVALUATE WRK-INP-PFK-T653

               WHEN  '.'
                   PERFORM 2100-TRATAR-ENTER

               WHEN  '6'
BRQ001               EVALUATE WRK-INP-FASE-T653
BRQ001                 WHEN '2'
BRQ001                   PERFORM 2213-VERIFICA-DESCLA-TOT
NAV506*                 -IF WRK-TP-DESCLASS EQUAL 'T'
BRQ001                     PERFORM 2200-CONFIRMAR-EXCLUSAO
WP1122                     PERFORM 2220-ENVIAR-COR0005
BRQ001                     PERFORM 2212-EXCLUSAO-EFETUADA
NAV506*                 -ELSE
...
NAV506*                                     TO WRK-OUT-MENSAG-T653
NAV506*                 -ELSE
NAV506*                   -IF ACU-ENVIO-COR0001 EQUAL ZEROES
NAV506*                      -PERFORM 2200-CONFIRMAR-EXCLUSAO
NAV506*                   -END-IF
...
NAV506*                      -MOVE '4'       TO WRK-OUT-FASE-T653
NAV506*                      -MOVE 'COR0001 ENVIADA BACEN'
NAV506*                                   TO WRK-OUT-MENSAG-T653
NAV506*                   -END-IF
NAV506*                 -END-IF
NAV506*               -WHEN '4'
NAV506*----BUSCA-WCONTD-NA-TABELA-RUECB09C-COM-CTRLIF-E-COR0001R1
...
BRQ001               END-EVALUATE
               ...
               WHEN OTHER
                   MOVE WRK-MSG002     TO WRK-OUT-MENSAG-T653
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-FASE-T653      TO WRK-OUT-FASE-T653.
           MOVE WRK-INP-NROPER-T653-X  TO WRK-OUT-NROPER-T653-X.
           MOVE WRK-INP-DIGOPER-T653   TO WRK-OUT-DIGOPER-T653.
           MOVE WRK-INP-NROANTE-T653   TO WRK-OUT-NROANTE-T653.
           MOVE WRK-INP-SEQDESC-T653-X TO WRK-OUT-SEQDESC-T653-X.
           MOVE WRK-INP-ASEQDESC-T653  TO WRK-OUT-ASEQDESC-T653.
           MOVE WRK-INP-AGENCIA-T653-X TO WRK-OUT-AGENCIA-T653-X.
           MOVE WRK-INP-NOMAG-T653     TO WRK-OUT-NOMAG-T653.
           MOVE WRK-INP-AAFINAN-T653-X TO WRK-OUT-AAFINAN-T653-X.
           MOVE WRK-INP-NOME-T653      TO WRK-OUT-NOME-T653.
           MOVE WRK-INP-CC-T653-X      TO WRK-OUT-CC-T653-X.
           MOVE WRK-INP-CCDIG-T653-X   TO WRK-OUT-CCDIG-T653-X.
           MOVE WRK-INP-CGCR-T653-X    TO WRK-OUT-CGCR-T653-X
           MOVE WRK-INP-CGCF-T653-X    TO WRK-OUT-CGCF-T653-X.
           MOVE WRK-INP-CGCD-T653-X    TO WRK-OUT-CGCD-T653-X.
           MOVE WRK-INP-CREDITO-T653   TO WRK-OUT-CREDITO-T653-X.
           MOVE WRK-INP-DEVEDOR-T653   TO WRK-OUT-DEVEDOR-T653-X.
           MOVE WRK-INP-VLRDESC-T653   TO WRK-OUT-VLRDESC-T653-X.
           MOVE WRK-INP-DTDESC-T653    TO WRK-OUT-DTDESC-T653.
           MOVE WRK-INP-MOTDES-T653-X  TO WRK-OUT-MOTDES-T653-X.
           MOVE WRK-INP-MOTDES1-T653   TO WRK-OUT-MOTDES1-T653.
BRQ001     MOVE WRK-INP-CTRLIF-T653    TO WRK-OUT-CTRLIF-T653.
BRQ001     MOVE WRK-INP-NMOTVO-T653    TO WRK-OUT-NMOTVO-T653.
      ...
      *---------------------------------------------------------------*
           ...
           IF  WRK-INP-FASE-T653       EQUAL '2'

               MOVE '1'                TO WRK-OUT-FASE-T653
               MOVE 'INFORME A CHAVE DA OPERACAO E TECLE ENTER'
                                       TO WRK-OUT-MENSAG-T653
               MOVE WRK-49361          TO WRK-OUT-OPER-ATTR-T653
                                          WRK-OUT-SEQD-ATTR-T653
               GO TO 2100-99-FIM
           END-IF.
           ...
           IF  (WRK-INCONSISTENCIA      NOT EQUAL 'S')
               MOVE 'TECLE PF6 PARA CONFIRMAR OU ENTER PARA ALTERAR'
                                       TO WRK-OUT-MENSAG-T653
               MOVE '2'                TO WRK-OUT-FASE-T653
               MOVE WRK-225            TO WRK-OUT-OPER-ATTR-T653
                                          WRK-OUT-SEQD-ATTR-T653
           END-IF.
      ...
      *---------------------------------------------------------------*
           ...
           IF  WRK-INP-NROPER-T653-X   EQUAL SPACES OR LOW-VALUES
               MOVE 'INFORME A CHAVE DA OPERACAO'
                                       TO WRK-OUT-MENSAG-T653
               MOVE 'S'                TO WRK-INCONSISTENCIA
               MOVE WRK-49369          TO WRK-OUT-OPER-ATTR-T653
               GO TO 2101-99-FIM
           END-IF.

           INSPECT WRK-INP-NROPER-T653-X REPLACING LEADING ' ' BY '0'.

           IF  WRK-INP-NROPER-T653-X   NOT NUMERIC
           ...
           IF  WRK-INP-SEQDESC-T653    EQUAL ZEROS OR
               WRK-INP-SEQDESC-T653-X  EQUAL SPACES
           ...
           IF  WRK-INCONSISTENCIA      NOT EQUAL 'S'
               ...
               IF  WRK-SQLCODE         EQUAL +100
                   ...
                   DELIMITED BY SIZE INTO WRK-OUT-MENSAG-T653
                   MOVE WRK-49369      TO WRK-OUT-OPER-ATTR-T653
                   MOVE ZEROS          TO WRK-OUT-ASEQDESC-T653
                   MOVE SPACES         TO WRK-OUT-SEQDESC-T653-X
                                          WRK-OUT-AGENCIA-T653-X
                                          WRK-OUT-NOMAG-T653
                                          WRK-OUT-AAFINAN-T653-X
                                          WRK-OUT-NOME-T653
                                          WRK-OUT-CC-T653-X
                                          WRK-OUT-CCDIG-T653-X
                                          WRK-OUT-CGCR-T653-X
                                          WRK-OUT-CGCF-T653-X
                                          WRK-OUT-CGCD-T653-X
                                          WRK-OUT-CREDITO-T653-X
                                          WRK-OUT-DEVEDOR-T653-X
                                          WRK-OUT-VLRDESC-T653-X
                                          WRK-OUT-DTDESC-T653
                                          WRK-OUT-MOTDES-T653-X
                                          WRK-OUT-MOTDES1-T653
                                          WRK-OUT-SEQDESC-T653-X
                   GO TO 2101-99-FIM
               END-IF
               PERFORM 2119-OBTER-DADOS-RUCAB003
               PERFORM 2120-MONTAR-DADOS-SAIDA
               IF  WRK-INP-SEQDESC-T653    NOT EQUAL
                   WRK-INP-ASEQDESC-T653
                   PERFORM 2115-OBTER-DADOS-SEQUENCIA
                   IF WRK-SQLCODE       EQUAL +100
                      MOVE '1'          TO WRK-OUT-FASE-T653
                      MOVE 'S'          TO WRK-INCONSISTENCIA
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T653   TO CCONTR             OF RUFIB044.
           ...
           EVALUATE WRK-TOTAL
               WHEN ZEROS
                    ...
                    MOVE WRK-49369     TO WRK-OUT-OPER-ATTR-T653
               WHEN 1
                    PERFORM 2125-OBTER-SEQ
                    IF WRK-SQLCODE   EQUAL +100
                       CONTINUE
                    ELSE
                       MOVE NMOTVO-DCLAS-CONTR OF RUFIB044
                                       TO WRK-INP-SEQDESC-T653
                                          WRK-OUT-SEQDESC-T653
                    END-IF
               WHEN OTHER
                    MOVE '1'           TO WRK-OUT-FASE-T653
                    ...
                    DELIMITED BY SIZE INTO WRK-OUT-MENSAG-T653
                    MOVE 'S'           TO WRK-INCONSISTENCIA
                    MOVE WRK-49369     TO WRK-OUT-SEQD-ATTR-T653
                    MOVE SPACES        TO WRK-OUT-VLRDESC-T653-X
                                          WRK-OUT-DTDESC-T653
                                          WRK-OUT-MOTDES-T653-X
                                          WRK-OUT-MOTDES1-T653
           END-EVALUATE.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T653   TO CCONTR             OF RUFIB044.
           MOVE WRK-INP-SEQDESC-T653  TO NMOTVO-DCLAS-CONTR OF RUFIB044.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE CMOTVO-DCLAS-OPER  OF  RUFIB044
                                   TO  WRK-INP-MOTDES-T653
                                       WRK-OUT-MOTDES-T653.
           MOVE DDCLAS-OPER-CREDT  OF  RUFIB044
                                   TO  WRK-DATA-DESCL
           INSPECT WRK-DATA-DESCL REPLACING ALL '.' BY '/'.

           MOVE WRK-DATA-DESCL     TO  WRK-OUT-DTDESC-T653.

           MOVE VPRINC-DCLAS-CONTR OF  RUFIB044
                                   TO  WRK-OUT-VLRDESC-T653.

           PERFORM 2124-DESCRICAO-MOTIVO.

           MOVE RMOTVO-DCLAS-OPER      OF RURCB097
                                       TO WRK-OUT-MOTDES1-T653.

           INSPECT WRK-OUT-SEQDESC-T653-X REPLACING LEADING ' ' BY '0'.

           MOVE    WRK-INP-SEQDESC-T653 TO WRK-OUT-ASEQDESC-T653.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T653    TO WRK-VALOR-0432.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T653    TO CCONTR      OF    RUFIV002.
...
BRQ001     IF  WRK-CREFT-RECOR-NULL      LESS ZEROS
BRQ001         MOVE ZEROS                 TO CREFT-RECOR OF RUFIV002
BRQ001     END-IF.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T653    TO B003-CH-CONTR OF  RUCAB003.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T653          TO WRK-OUT-NROPER-T653.
           MOVE WRK-DIGOPER                  TO WRK-OUT-DIGOPER-T653.
           MOVE CJUNC-DEPDC    OF RUFIV002   TO WRK-OUT-AGENCIA-T653.
           MOVE WRK-NOME-AGENCIA             TO WRK-OUT-NOMAG-T653.
           MOVE CCDULA         OF RUFIV002   TO WRK-OUT-AAFINAN-T653.
           MOVE B003-NOMUTUAR1 OF RUCAB003   TO WRK-OUT-NOME-T653.
           MOVE CCTA-CORR      OF RUFIV002   TO WRK-OUT-CC-T653.

           MOVE  SPACES                      TO WRK-DIGITO-COSA.
           MOVE  '7'                         TO WRK-DIGITO-COSA-1.

           CALL  'POOL0431'               USING WRK-OUT-CC-T653
                                                WRK-DIGITO-COSA-1
                                                WRK-TAMANHO-0431

           IF    WRK-DIGITO-COSA-1        EQUAL '.'
                 MOVE SPACES                 TO WRK-OUT-CCDIG-T653-X
           ELSE
                 MOVE WRK-DIGITO-COSA        TO WRK-OUT-CCDIG-T653-X
           END-IF.

           MOVE B003-CGCPF1    OF RUCAB003   TO WRK-DESC-CGC-R.
           MOVE WRK-RAIZ-CGC                 TO WRK-OUT-CGCR-T653.
           MOVE WRK-FILIAL-CGC               TO WRK-OUT-CGCF-T653.
           MOVE WRK-DIG-CGC                  TO WRK-OUT-CGCD-T653.
           MOVE VFINAN         OF RUFIV002   TO WRK-OUT-CREDITO-T653.
           ...
           MOVE WRK-DEVEDOR                  TO WRK-OUT-DEVEDOR-T653.
      ...
      *
      *---------------------------------------------------------------*
      * ACESSAR MESU9032 E OBTER NOME DA AGENCIA                      *
      *---------------------------------------------------------------*
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-MOTDES-T653    TO CMOTVO-DCLAS-OPER OF RURCB097.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2200-CONFIRMAR-EXCLUSAO         SECTION.
      *---------------------------------------------------------------*

BRQ001     IF  WRK-INP-FASE-T653       NOT EQUAL '2' AND '3'
               MOVE WRK-MSG002         TO WRK-OUT-MENSAG-T653
               GO TO 2200-99-FIM
           END-IF.
           ...
           PERFORM 2203-EXCLUIR-REGISTROS.
      ...
      *---------------------------------------------------------------*
           ...
           MOVE WRK-INP-NROPER-T653   TO CCONTR             OF RUFIB044.
           MOVE WRK-INP-MOTDES-T653   TO CMOTVO-DCLAS-OPER  OF RUFIB044.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2203-EXCLUIR-REGISTROS          SECTION.
      *---------------------------------------------------------------*

BRQ001     MOVE NMOTVO-DCLAS-CONTR OF RUFIB044
BRQ001                                TO WRK-PIC9-5-CS.
BRQ001     MOVE WRK-PIC9-5-SS         TO WRK-INP-NMOTVO-T653
BRQ001                                   WRK-INP-NMOTVO-T653.
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       2204-LIMPA-TELA                 SECTION.
      *---------------------------------------------------------------*

           MOVE ZEROS                  TO WRK-OUT-ASEQDESC-T653.

           MOVE SPACES                 TO WRK-OUT-NROPER-T653-X
                                          WRK-OUT-DIGOPER-T653
                                          WRK-OUT-SEQDESC-T653-X
                                          WRK-OUT-AGENCIA-T653-X
                                          WRK-OUT-NOMAG-T653
                                          WRK-OUT-AAFINAN-T653-X
                                          ...
                                          WRK-OUT-MOTDES1-T653
                                          WRK-OUT-SEQDESC-T653-X
BRQ001                                    WRK-OUT-CTRLIF-T653
BRQ001                                    WRK-OUT-NMOTVO-T653-X.
...
NAV506*
NAV506*
NAV506*   -MOVE 'RUCA6653'              TO WRK-PGM-CHAMADOR
NAV506*   -MOVE WRK-INP-AGENCIA-T653    TO WRK-AGENCIA8870
NAV506*   -MOVE WRK-INP-NROPER-T653     TO WRK-CEDULA
NAV506*   -IF WRK-INP-CGCF-T653      EQUAL ZEROES
NAV506*       -MOVE 'F'                 TO WRK-TIPO-PESSOA
NAV506*       -MOVE WRK-INP-CGCR-T653-X TO WRK-CPF-BAS
NAV506*       -MOVE WRK-INP-CGCD-T653-X TO WRK-CPF-DIG
NAV506*       -MOVE WRK-CPF-X           TO WRK-PICX-15
NAV506*       -MOVE WRK-PIC9-15         TO WRK-IDENTIF
NAV506*   -ELSE
NAV506*       -MOVE 'J'                 TO WRK-TIPO-PESSOA
NAV506*       -MOVE WRK-INP-CGCR-T653-X TO WRK-CGC-BAS
NAV506*       -MOVE WRK-INP-CGCF-T653-X TO WRK-CGC-FILI
NAV506*       -MOVE WRK-INP-CGCD-T653-X TO WRK-CGC-DIG
...
NAV506*   -END-IF.
NAV506*
NAV506*   -MOVE '3'                    TO WRK-OUT-FASE-T653
NAV506*   -MOVE 'CONSULTA COR0003 ENVIADA'
NAV506*                                TO WRK-OUT-MENSAG-T653
NAV506*   -MOVE WRK-INP-NROPER-T653-X  TO WRK-OUT-NROPER-T653-X
NAV506*   -MOVE WRK-INP-DIGOPER-T653   TO WRK-OUT-DIGOPER-T653
NAV506*   -MOVE WRK-INP-AGENCIA-T653-X TO WRK-OUT-AGENCIA-T653-X
NAV506*   -MOVE WRK-INP-NOMAG-T653     TO WRK-OUT-NOMAG-T653
NAV506*   -MOVE WRK-INP-AAFINAN-T653-X TO WRK-OUT-AAFINAN-T653-X
NAV506*   -MOVE WRK-INP-NOME-T653      TO WRK-OUT-NOME-T653
NAV506*   -MOVE WRK-INP-CC-T653-X      TO WRK-OUT-CC-T653-X
NAV506*   -MOVE WRK-INP-CCDIG-T653-X   TO WRK-OUT-CCDIG-T653-X
NAV506*   -MOVE WRK-INP-CGCR-T653-X    TO WRK-OUT-CGCR-T653-X
NAV506*   -MOVE WRK-INP-CGCF-T653-X    TO WRK-OUT-CGCF-T653-X
NAV506*   -MOVE WRK-INP-CGCD-T653-X    TO WRK-OUT-CGCD-T653-X
NAV506*   -MOVE WRK-INP-CREDITO-T653   TO WRK-OUT-CREDITO-T653-X
NAV506*   -MOVE WRK-INP-DEVEDOR-T653   TO WRK-OUT-DEVEDOR-T653-X
NAV506*   -MOVE WRK-INP-VLRDESC-T653   TO WRK-OUT-VLRDESC-T653-X
NAV506*   -MOVE WRK-INP-DTDESC-T653    TO WRK-OUT-DTDESC-T653
NAV506*   -MOVE WRK-INP-MOTDES-T653-X  TO WRK-OUT-MOTDES-T653-X
NAV506*   -MOVE WRK-INP-MOTDES1-T653   TO WRK-OUT-MOTDES1-T653.
NAV506*
NAV506*   -MOVE WRK-CONTROLE-BACEN     TO WRK-INP-CTRLIF-T653
NAV506*                                   WRK-OUT-CTRLIF-T653.
NAV506*
NAV506*   -MOVE WRK-225                TO WRK-OUT-OPER-ATTR-T653
NAV506*                                   WRK-OUT-SEQD-ATTR-T653.
NAV506*
NAV506*---------------------------------------------------------------*
...
NAV506*
NAV506*   -MOVE WRK-INP-CTRLIF-T653    TO CCTRL-RQUIS-FINCR OF RUECB09C.
NAV506*
NAV506*   -EXEC SQL
NAV506*        -SELECT COUNT(*)
...
NAV506*   -MOVE 'RUCA6653'              TO WRK-PGM-CHAMADOR-8871.
NAV506*   -MOVE WRK-INP-AGENCIA-T653    TO WRK-AGENCIA-8871.
NAV506*   -MOVE WRK-INP-NROPER-T653     TO WRK-CEDULA-8871.
NAV506*   -MOVE WRK-INP-SEQDESC-T653    TO WRK-NUM-SEQ-DESCLA.
NAV506*   -MOVE 'E'                     TO WRK-FUNCAO-8871.
NAV506*   -MOVE 14                     TO WRK-POOL0496-TAM-INT.
NAV506*   -MOVE 02                     TO WRK-POOL0496-TAM-DEC.
NAV506*   -MOVE WRK-INP-CREDITO-T653   TO WRK-POOL0496-ENTRADA.
...
NAV506*   -MOVE 14                     TO WRK-POOL0496-TAM-INT.
NAV506*   -MOVE 02                     TO WRK-POOL0496-TAM-DEC.
NAV506*   -MOVE WRK-INP-VLRDESC-T653   TO WRK-POOL0496-ENTRADA.
NAV506*   -MOVE ZEROS                  TO RETURN-CODE
NAV506*                                   WRK-POOL0496-RETURN-CODE.
NAV506*   -MOVE SPACES                 TO WRK-POOL0496-SAIDA.
NAV506*
...
NAV506*   -END-IF.
NAV506*   -MOVE WRK-INP-CTRLIF-T653     TO WRK-NUM-CTRL-IF.
...
NAV506*                                   WRK-OUT-SEQD-ATTR-T653
NAV506*     -ELSE
NAV506*        -PERFORM 2212-EXCLUSAO-EFETUADA
NAV506*     -END-IF
NAV506*   -END-IF.
NAV506*
NAV506*---------------------------------------------------------------*
...
BRQ001
BRQ001*---------------------------------------------------------------*
BRQ001 2212-EXCLUSAO-EFETUADA          SECTION.
BRQ001*---------------------------------------------------------------*
BRQ001
BRQ001     MOVE '1'                    TO WRK-OUT-FASE-T653
BRQ001     MOVE 'EXCLUSAO EFETUADA COM SUCESSO'
BRQ001                                 TO WRK-OUT-MENSAG-T653
BRQ001     MOVE WRK-49361              TO WRK-OUT-OPER-ATTR-T653.
BRQ001     PERFORM 2204-LIMPA-TELA.
BRQ001
BRQ001*---------------------------------------------------------------*
BRQ001 2212-99-FIM.                    EXIT.
BRQ001*---------------------------------------------------------------*
BRQ001
BRQ001*---------------------------------------------------------------*
BRQ001 2213-VERIFICA-DESCLA-TOT        SECTION.
BRQ001*---------------------------------------------------------------*
BRQ001
BRQ001     MOVE 14                     TO WRK-POOL0496-TAM-INT.
BRQ001     MOVE 02                     TO WRK-POOL0496-TAM-DEC.
BRQ001     MOVE WRK-INP-CREDITO-T653   TO WRK-POOL0496-ENTRADA.
...
BRQ001     MOVE 14                     TO WRK-POOL0496-TAM-INT.
BRQ001     MOVE 02                     TO WRK-POOL0496-TAM-DEC.
BRQ001     MOVE WRK-INP-VLRDESC-T653   TO WRK-POOL0496-ENTRADA.
BRQ001     MOVE ZEROS                  TO RETURN-CODE
BRQ001                                    WRK-POOL0496-RETURN-CODE.
BRQ001     MOVE SPACES                 TO WRK-POOL0496-SAIDA.
BRQ001
...
-
-          MOVE 'RUCA6653'             TO RUEC65-PGM-CHAMADOR
-          MOVE WRK-INP-NROPER-T653    TO RUEC65-CCONTR
...
-                  PERFORM 9999-ROTINA-ERRO
-             WHEN OTHER
-                  MOVE RUEC65-MENSAGEM    TO WRK-OUT-MENSAG-T653
-          END-EVALUATE.
-
-     *----------------------------------------------------------------*
-      2220-99-FIM.    EXIT.
WP2211*----------------------------------------------------------------*
      ...
      *---------------------------------------------------------------*
      *---------------------------------------------------------------*
       4000-POOL0660-RUCAT653          SECTION.
      *---------------------------------------------------------------*

           MOVE LENGTH OF WRK-OUTPUT-T653
                                       TO WRK-660-LL-MENSAGEM-T653
                                          WRK-OUT-LL-T653
           MOVE LENGTH OF WRK-660-RUCAT653
                                       TO WRK-660-LL-AREA-T653

           CALL  'POOL0660'    USING   WRK-OUTPUT-T653
                                       WRK-660-RUCAT653.
           ...
           MOVE  WRK-OUTPUT-T653       TO WRK-MENSAGEM.
