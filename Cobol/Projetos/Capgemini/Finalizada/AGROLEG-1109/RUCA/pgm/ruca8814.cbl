...
BRQ001     MOVE  'N'                   TO  RUCA67-IND-CONF-ALRT-SUST.
...
BRQ001*----------------------------------------------------------------*
BRQ001
BRQ001     IF CCETFC-ORGNC-EMPTO OF RUCAB015 EQUAL SPACES
BRQ001        MOVE ALL '*'             TO RUCA67-GP-COR0005-CORGN
BRQ001     ELSE
BRQ001        MOVE CCETFC-ORGNC-EMPTO OF RUCAB015
BRQ001                                 TO RUCA67-CCETFC-ORGNC
BRQ001        MOVE EURL-CETFC-ORGNC-TEXT OF RUCAB015(1:255)
BRQ001                                 TO RUCA67-EURL-CETFC-ORGNC
BRQ001     END-IF.
BRQ001
BRQ001     MOVE RUCA67-COR0005-11
BRQ001                              TO WRK-MSGEM-RURAL(ACU-POSICAO:
BRQ001                              LENGTH OF RUCA67-COR0005-11)
BRQ001     ADD  LENGTH OF RUCA67-COR0005-11
BRQ001                              TO ACU-TAM
BRQ001                                 ACU-POSICAO
BRQ001
BRQ001     IF CRSTRB-EMPTO-RURAL OF RUCAB015 EQUAL SPACES
BRQ001        MOVE ALL '*'             TO RUCA67-GP-COR0005-RASTB
BRQ001     ELSE
BRQ001        MOVE CRSTRB-EMPTO-RURAL OF RUCAB015
BRQ001                                 TO RUCA67-CRSTRB-EMPTO
BRQ001        MOVE EURL-RSTRB-EMPTO-TEXT OF RUCAB015(1:255)
BRQ001                                 TO RUCA67-EURL-RSTRB
BRQ001     END-IF.
BRQ001
BRQ001     MOVE RUCA67-COR0005-12
BRQ001                              TO WRK-MSGEM-RURAL(ACU-POSICAO:
BRQ001                              LENGTH OF RUCA67-COR0005-12)
BRQ001     ADD  LENGTH OF RUCA67-COR0005-12
BRQ001                              TO ACU-TAM
BRQ001                                 ACU-POSICAO
BRQ001
BRQ001     IF PENERG-RENOV-EMPTO OF RUCAB015 EQUAL ZEROS
BRQ001        MOVE ALL '*'             TO RUCA67-PENERG-RENOV
BRQ001     ELSE
BRQ001        MOVE PENERG-RENOV-EMPTO OF RUCAB015
BRQ001                                 TO WRK-PIC9-3V99-CS
BRQ001        MOVE WRK-PIC9-3V99-SS    TO RUCA67-PENERG-RENOV-N
BRQ001     END-IF.
BRQ001
BRQ001     MOVE RUCA67-COR0005-13
BRQ001                              TO WRK-MSGEM-RURAL(ACU-POSICAO:
BRQ001                              LENGTH OF RUCA67-COR0005-13)
BRQ001     ADD  LENGTH OF RUCA67-COR0005-13
BRQ001                              TO ACU-TAM
BRQ001                                 ACU-POSICAO.
WP0522
