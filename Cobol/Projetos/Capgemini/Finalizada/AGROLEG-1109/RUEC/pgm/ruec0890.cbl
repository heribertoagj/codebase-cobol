...
CAT408 01  FD-ARQLIBER                 PIC  X(1259).
      ...
      *---------------------------------------------------------------*
       77  FILLER                      PIC  X(050)         VALUE
           '*** RUEC0890 - INICIO DA AREA DE WORKING ***'.
      *---------------------------------------------------------------*
...
CAT408
      ...
      *---------------------------------------------------------------*
       01  FILLER                      PIC  X(050)         VALUE
           '*** RUEC0890 - FIM DA AREA DE WORKING ***'.
      *---------------------------------------------------------------*
...
CAT408                                 TO WRK-SIS-TAM
                       PERFORM 3100-MONTAR-GRAVAR-COR0001A
                   ELSE
                       DISPLAY '*RUEC0890* CONTRATO ' WRK-LIB-CCONTR
...
BR0618*      -DISPLAY '*RUEC0890* CONTRATO ' WRK-LIB-CCONTR
...
CAT408*---------------------------------------------------------------*
CAT408
BR0618     IF  WRK-DES-CCONTR-X        NUMERIC
BR0618         MOVE WRK-SIS-TXT        TO WRK-MENSAGEM
BR0618         PERFORM 4120-EXCLUIR-GRUPO-DESCL
