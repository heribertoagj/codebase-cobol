...
.     * DATA...............: MARCO   - 2026                            *
.     * OBJETIVOS..........: AGROLEG-668 - ERRO AO EXIBIR CONTRATO COM *
.     *                      120 PARCELAS - RENEGOCIACAO               *
CCM01A*================================================================*
...
MJ0001                                                      VALUE ZEROS.
MJ1024 01  WRK-VALOR-LIB-ACU           PIC S9(13)V99 COMP-3 VALUE ZEROS.
MJ1024 01  WRK-VALOR-PAG-ACU           PIC S9(13)V99 COMP-3 VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-LIBERACOES.
           03 WRK-LIB-TABELA.
CCM01A*       -5 WRK-LIB-OCORR             OCCURS 050 TIMES.
CCM01A        05 WRK-LIB-OCORR             OCCURS 200 TIMES.
...
CCM01A     MOVE WRK-COMU-SENHAS  TO WRK-I-SENHAS.
CCM01A     PERFORM 3100-EFETUAR-INSPECT.
...
CCM01A*      -NTIL IND-HEX          GREATER 50
CCM01A       UNTIL IND-HEX          GREATER 200
...
MJ1024     IF  WRK-VALOR-LIB-ACU      EQUAL WRK-VALOR-PAG-ACU
               PERFORM 3728-ACESSAR-RUEC8880
MJ1024     END-IF

           PERFORM VARYING  IND-HEX2  FROM  1 BY 1
CCM01A*      -NTIL IND-HEX2           GREATER 50
CCM01A       UNTIL IND-HEX2           GREATER IND-HEX
...
MJ1024     IF (B004-DEBCRED            EQUAL '6')    AND
MJ1024        (B004-IDENTDC        NOT EQUAL X'B0')
MJ1024        GO                       TO 3722-LER-CSR01-RUCAB004
MJ1024     END-IF.
...
MJ1024        ADD  B004-VLPRICOR   OF RUCAB004
MJ1024                             TO WRK-VALOR-LIB-ACU
           ELSE
              MOVE B004-DTEVENTO   OF RUCAB004
...
MJ1124         IF VPCELA      OF RUMOV000 EQUAL ZEROS  AND
MJ1124            VPROVS-JURO OF RUMOV000 EQUAL ZEROS
MJ1124            MOVE 'LIQUIDADA'     TO        WRK-I-SITUA(IND-1)
MJ1124         ELSE
