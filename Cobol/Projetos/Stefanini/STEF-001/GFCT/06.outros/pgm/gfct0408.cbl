...
0410   01 WRK-ACM-SOLICITACAO           PIC  9(005) COMP-3
                                                       VALUE ZEROS.
...
080508    05 WRK-DIA-INV-PERM           PIC  9(002).
       ...
       01 WRK-CDEPDC-INICIAL            PIC S9(005) COMP-3
                                                       VALUE ZEROS.
       01 WRK-CDEPDC-FINAL              PIC S9(005) COMP-3
                                                       VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
       ...
       01 WRK-1280-DATA-INFERIOR        PIC  9(008) COMP-3
                                                       VALUE ZEROS.
       01 WRK-1280-DATA-SUPERIOR        PIC  9(008) COMP-3
                                                       VALUE ZEROS.
       01 WRK-1280-NRO-DIAS             PIC S9(005) COMP-3
                                                       VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
       ...
       01 WRK-5521-AREA-SAIDA.
          ...
          05 WRK-5521-RETORNO-VALOR-TARIFA.
             10 WRK-5521-TAXA-MOEDA-TAR PIC  9(006)V9(12)
                                                       VALUE ZEROS.
             10 WRK-5521-TAXA-MOEDA-EVN PIC  9(006)V9(12)
                                                       VALUE ZEROS.
             10 WRK-5521-VLR-TOT-TAR-PERC
                                        PIC  9(009)V99 VALUE ZEROS.
             10 WRK-5521-VLR-SOMA-AJU-MINI
                                        PIC  9(009)V99 VALUE ZEROS.
             10 WRK-5521-VLR-SUBT-AJU-MAXI
                                        PIC  9(009)V99 VALUE ZEROS.
             10 WRK-5521-VLR-CALC-TAR-PERC
                                        PIC  9(009)V99 VALUE ZEROS.
             10 WRK-5521-VLR-CALC-TAR-FIXO
                                        PIC  9(009)V99 VALUE ZEROS.
             10 WRK-5521-VLR-TOTAL-TARIFA
                                        PIC  9(009)V99 VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
       ...
       01 WRK-5018-DADOS-RETORNO.
          05 WRK-5018-DADOS-PRINCIPAIS.
             ...
             10 WRK-5018-CSEQ-MANUT-SERVC-R
                                        PIC  9(002)    VALUE ZEROS.
             10 WRK-5018-CTPO-LCTO-COBR PIC  9(002)    VALUE ZEROS.
             10 WRK-5018-CTPO-LCTO-ESTRN
                                        PIC  9(002)    VALUE ZEROS.
             10 WRK-5018-CCART-DEB-TARIF
                                        PIC  9(005)    VALUE ZEROS.
             10 WRK-5018-CINDCD-DEB-PCIAL
                                        PIC  X(001)    VALUE SPACES.
             10 WRK-5018-CINDCD-PCIAL-ULT
                                        PIC  X(001)    VALUE SPACES.
             10 WRK-5018-CINDCD-EVNTO-PCELD
                                        PIC  X(001)    VALUE SPACES.

          05 WRK-5018-DADOS-DE-PACOTE OCCURS 50.
             10 WRK-5018-DINIC-VGCIA-COMPS
                                        PIC  X(010)    VALUE SPACES.
             10 WRK-5018-CSEQ-COMPO-PCOTE
                                        PIC  9(003)    VALUE ZEROS.
             10 WRK-5018-DFIM-VGCIA-COMPS
                                        PIC  X(010)    VALUE SPACES.
             10 WRK-5018-CGRP-SERVC     PIC  9(005)    VALUE ZEROS.
             10 WRK-5018-DINIC-VGCIA-SERVC
                                        PIC  X(010)    VALUE SPACES.
             10 WRK-5018-CTARIF-COMPO-PCOTE
                                        PIC  9(005)    VALUE ZEROS.
             10 WRK-5018-QFRANQ-COMPO-PCOTE
                                        PIC  9(003)    VALUE ZEROS.
             10 WRK-5018-CPER-COBR-COMPO
                                        PIC  9(001)    VALUE ZEROS.
             10 WRK-5018-VEXCED-COMPO-PCOTE
                                        PIC  9(011)V9(002)
                                                       VALUE ZEROS.
             10 WRK-5018-PEXCED-COMPO-PCOTE
                                        PIC  9(007)V9(004)
                                                       VALUE ZEROS.
             10 WRK-5018-QDIA-COBR-COMPO
                                        PIC  9(002)    VALUE ZEROS.
             10 WRK-5018-RSEGDA-LIN-EXCED
                                        PIC  X(032)    VALUE SPACES.
             10 WRK-5018-HIDTFD-MANUT-SERVC
                                        PIC  X(026)    VALUE SPACES.
             10 WRK-5018-CSEQ-MANUT-SERVC
                                        PIC  9(002)    VALUE ZEROS.
          05 WRK-5018-DADOS-DE-PARAMENTROS.
             10 WRK-5018-DINIC-VGCIA-TARIF-P
                                        PIC  X(010)    VALUE SPACES.
             10 WRK-5018-DFIM-VGCIA-TARIF
                                        PIC  X(010)    VALUE SPACES.
             10 WRK-5018-CNATUZ-SERVC   PIC  9(003)    VALUE ZEROS.
             10 WRK-5018-CCJTO-SERVC    PIC  9(003)    VALUE ZEROS.
             10 WRK-5018-CINDCD-DEB-CONSL
                                        PIC  X(001)    VALUE SPACES.
             10 WRK-5018-CINDCD-EXCED-CONSL
                                        PIC  X(001)    VALUE SPACES.
             10 WRK-5018-QFRANQ-TARIF   PIC  9(003)    VALUE ZEROS.
             10 WRK-5018-QMAX-TENTV-DEB PIC  9(003)    VALUE ZEROS.
             10 WRK-5018-CPER-FRANQ-TARIF
                                        PIC  9(001)    VALUE ZEROS.
             10 WRK-5018-CPER-CALC-TARIF
                                        PIC  9(001)    VALUE ZEROS.
             10 WRK-5018-CINIC-PER-CALC PIC  9(001)    VALUE ZEROS.
             10 WRK-5018-DDIA-COBR-TARIF
                                        PIC  9(002)    VALUE ZEROS.
BI0413       10 WRK-5018-QDIA-CAREN-TARIF
                                        PIC  9(003)    VALUE ZEROS.
             10 WRK-5018-PDESC-CAREN-TARIF
                                        PIC  9(007)V9(004)
                                                       VALUE ZEROS.
             10 WRK-5018-CINDCD-INIC-CAREN
                                        PIC  9(001)    VALUE ZEROS.
             10 WRK-5018-QDIA-RTCAO-COBR
                                        PIC  9(002)    VALUE ZEROS.
             10 WRK-5018-DINIC-CAREN-TARIF
                                        PIC  X(010)    VALUE SPACES.
             10 WRK-5018-RSEGDA-LIN-EXTRT
                                        PIC  X(032)    VALUE SPACES.
             10 WRK-5018-HIDTFD-MANUT-SERVC-P
                                        PIC  X(026)    VALUE SPACES.
             10 WRK-5018-CSEQ-MANUT-SERVC-P
                                        PIC  9(002)    VALUE ZEROS.
             10 WRK-5018-CTPO-FRANQ-TARIF
                                        PIC  9(001)    VALUE ZEROS.

          05 WRK-5018-DADOS-DE-VALORES OCCURS 50.
             10 WRK-5018-DINIC-VGCIA-TARIF
                                        PIC  X(010)    VALUE SPACES.
             10 WRK-5018-CSEQ-COMPO-TARIF
                                        PIC  9(002)    VALUE ZEROS.
             ...
             10 WRK-5018-PSERVC-PTADO   PIC  9(007)V9(004)
                                                       VALUE ZEROS.
             10 WRK-5018-VMAX-COMPO-TARIF
                                        PIC  9(011)V9(002)
                                                       VALUE ZEROS.
             10 WRK-5018-VMIN-COMPO-TARIF
                                        PIC  9(011)V9(002)
                                                       VALUE ZEROS.
             10 WRK-5018-CMOMEN-CONVS-MOEDA
                                        PIC  9(001)    VALUE ZEROS.
...
ST2506*        1F  GFCTN9-CGC-CPF          NOT NUMERIC OR
...
ST2506             GFCTN9-FILIAL EQUAL SPACES OR
...
ST2506*    M0VE GFCTN9-CGC-CPF         TO WRK-NUMERO-0110.
ST2506*    M0VE GFCTN9-FILIAL          TO WRK-FILIAL-0110.
ST2506*
...
ST2506*    1F  GFCTN9-CONTROLE         NOT EQUAL WRK-CONTROLE-0110
ST2506     MOVE WRK-CAD-CONTROLE TO WRK-9-02.
ST2506     IF GFCTN9-CONTROLE NOT EQUAL WRK-9-X-2 
...
ST2605*    MOVE GFCTN9-CGC-CPF TO CCGC-CPF OF GFCTB0B3.
ST2605*    MOVE GFCTN9-FILIAL TO CFLIAL-CGC OF GFCTB0B3.
ST2605*    MOVE GFCTN9-CONTROLE TO CCTRL-CPF-CGC OF GFCTB0B3.
ST2605     MOVE GFCTN9-CGC-CPF TO CCGC-CPF-ST OF GFCTB0B3.
ST2605     MOVE GFCTN9-FILIAL TO CFLIAL-CGC-ST OF GFCTB0B3.
           MOVE GFCTN9-CONTROLE TO CCTRL-CPF-CGC-ST OF GFCTB0B3.
...
ST2506*    MOVE GFCTN9-CGC-CPF TO CCGC-CPF OF GFCTB0B3.
ST2506*    MOVE GFCTN9-FILIAL TO CFLIAL-CGC OF GFCTB0B3.
ST2506*    MOVE GFCTN9-CONTROLE TO CCTRL-CPF-CGC OF GFCTB0B3.
ST2506     MOVE GFCTN9-CGC-CPF TO CCGC-CPF-ST OF GFCTB0B3.
ST2506     MOVE GFCTN9-FILIAL TO CFLIAL-CGC-ST OF GFCTB0B3.
ST2506     MOVE GFCTN9-CONTROLE TO CCTRL-CPF-CGC-ST OF GFCTB0B3.
...
ST2506*    MOVE GFCTN9-FILIAL TO CFLIAL-CGC OF GFCTB0B3.
ST2506*
ST2506*    MOVE GFCTN9-CONTROLE TO WRK-CPF-CGC-CONTROLE.
ST2506*    MOVE WRK-CPF-CGC-CONTROLE-9 TO CCTRL-CPF-CGC OF GFCTB0B3.

ST2506     MOVE GFCTN9-CGC-CPF TO CCGC-CPF-ST OF GFCTB0B3.
ST2506     MOVE GFCTN9-FILIAL TO CFLIAL-CGC-ST OF GFCTB0B3.
ST2506 
ST2506     MOVE GFCTN9-CONTROLE TO WRK-CPF-CGC-CONTROLE.
ST2506     MOVE WRK-CPF-CGC-CONTROLE-9 TO CCTRL-CPF-CGC-ST OF GFCTB0B3.
0410XS
