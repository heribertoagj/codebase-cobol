...
ST25X6*01  WRK-CPF-CNPJ                PIC S9(009)V COMP-3 VALUE +0.
ST25X6*01  WRK-FILIAL                  PIC S9(005)V COMP-3 VALUE +0.
ST25X6 01  WRK-CPF-CNPJ                PIC  X(009)         VALUE SPACES.
ST25X6 01  WRK-FILIAL                  PIC  X(004)         VALUE SPACES.
...
ST25X6*----------------------------------------------------------------*
ST25X6*01  FILLER                      PIC  X(050)         VALUE
ST25X6*    '*** AREAS DA POOL0110 ***'.
ST25X6*----------------------------------------------------------------*
ST25X6*
...
ST25X6*
ST25X6*01  WRK-CONTROLE-0110           PIC  X(002)         VALUE SPACES.

ST25X6*----------------------------------------------------------------*
ST25X6 01  FILLER                      PIC  X(050)         VALUE
ST25X6    '*** AREAS DA BRAD2000 ***'.
ST25X6*----------------------------------------------------------------*
ST25X6
ST25X6 01  WRK-BRAD2000                 PIC  X(08)  VALUE
ST25X6     'BRAD2000'.
ST25X6 
ST25X6 01 WRK-AREA-BRAD2000.
ST25X6    05 WRK-CAD-CPFCGC.
ST25X6       10 WRK-CAD-NUMERO         PIC X(09)           VALUE SPACES.
ST25X6       10 WRK-CAD-FILIAL         PIC X(04)           VALUE SPACES.
ST25X6 77  WRK-CAD-CONTROLE            PIC 9(02)           VALUE ZEROS.
ST25X6 01  WRK-9-X-2.
ST25X6     05 WRK-9-02                 PIC 9(02)           VALUE ZEROS.
...
ST2506*       (GFCTIQ-CPF-CNPJ         NOT NUMERIC)                OR
ST2506        (GFCTIQ-CPF-CNPJ         EQUAL SPACES OR
ST2506         GFCTIQ-CPF-CNPJ         EQUAL LOW-VALUES)           OR
              (GFCTIQ-CTRL             NOT NUMERIC)                OR
ST2506*       (GFCTIQ-FILIAL           NOT NUMERIC)                OR
ST2506        (GFCTIQ-FILIAL           EQUAL SPACES OR
ST2506         GFCTIQ-FILIAL           EQUAL LOW-VALUES)           OR
...
ST25X6*    MOVE SPACES                 TO WRK-CONTROLE-0110.
ST25X6*    MOVE GFCTIQ-CPF-CNPJ        TO WRK-NUMERO-0110.
ST25X6*    MOVE GFCTIQ-FILIAL          TO WRK-FILIAL-0110.
ST25X6*
ST25X6*    CALL 'POOL0110'             USING WRK-CGC-CPF-0110
ST25X6*                                      WRK-CONTROLE-0110.
ST25X6     MOVE ZEROS                  TO WRK-CAD-CONTROLE.
ST25X6     MOVE GFCTIQ-CPF-CNPJ        TO WRK-CAD-NUMERO.
ST25X6     MOVE GFCTIQ-FILIAL          TO WRK-CAD-FILIAL.

ST25X6     CALL WRK-BRAD2000           USING WRK-CAD-CPFCGC
ST25X6                                        WRK-CAD-CONTROLE.

ST25X6     IF  RETURN-CODE             NOT EQUAL ZEROS
ST25X6         MOVE 1                  TO GFCTIR-ERRO
ST25X6         MOVE 0468               TO GFCTIR-COD-MSG-ERRO
ST25X6         MOVE ZEROS              TO GFCTIR-COD-SQL-ERRO
ST25X6         MOVE '0468'             TO GFCTG2-COD-MSG
ST25X6         PERFORM 1100-OBTER-DESCRICAO
ST25X6         MOVE GFCTG3-DESC-MSG    TO GFCTIR-DESC-MSG-ERRO
ST25X6         PERFORM 3000-FINALIZAR
ST25X6     END-IF.

ST25X6     MOVE WRK-9-02               TO WRK-9-X-2.
ST25X6     MOVE WRK-CAD-CONTROLE       TO WRK-9-02.

ST25X6     IF  GFCTIQ-CTRL             NOT EQUAL WRK-9-02
ST25X6         MOVE 1                  TO GFCTIR-ERRO
ST25X6         MOVE 0507               TO GFCTIR-COD-MSG-ERRO
ST25X6         MOVE ZEROS              TO GFCTIR-COD-SQL-ERRO
ST25X6         MOVE '0507'             TO GFCTG2-COD-MSG
ST25X6         PERFORM 1100-OBTER-DESCRICAO
ST25X6         MOVE GFCTG3-DESC-MSG    TO GFCTIR-DESC-MSG-ERRO
ST25X6         PERFORM 3000-FINALIZAR
ST25X6     END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  WRK-CPF-CNPJ       TO CCGC-CPF         OF GFCTB0H8.
           MOVE  WRK-FILIAL         TO CFLIAL-CGC       OF GFCTB0H8.
           ...
           EXEC SQL DELETE
              FROM DB2PRD.TDEB_UNFCA_CLI
               WHERE
                   CCGC_CPF_ST         = :WRK-CPF-CNPJ            AND
                   CFLIAL_CGC_ST       = :WRK-FILIAL              AND
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  GFCTIQ-CPF-CNPJ       TO CCGC-CPF         OF GFCTB0H8.
           MOVE  GFCTIQ-FILIAL         TO CFLIAL-CGC       OF GFCTB0H8.
...
ST25X6             CFLIAL_CGC_ST       =  :GFCTB0H8.CFLIAL-CGC-ST AND
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  GFCTIQ-CTRL           TO CCTRL-CPF-CGC    OF GFCTB0H8.
           ...
           EXEC SQL
               ...
               VALUES
                  (:GFCTB0H8.CCGC-CPF,
                   ...
                   :GFCTB0H8.CCGC-CPF-ST,
                   :GFCTB0H8.CFLIAL-CGC-ST,
                   :GFCTB0H8.CCTRL-CPF-CGC-ST,
