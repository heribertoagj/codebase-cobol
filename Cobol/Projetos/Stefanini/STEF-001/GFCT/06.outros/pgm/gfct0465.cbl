...
ST2506*01  WRK-BUSCA-CPF-CNPJ          PIC S9(009)V COMP-3 VALUE ZEROS.
ST2506*01  WRK-BUSCA-FILIAL            PIC S9(005)V COMP-3 VALUE ZEROS.
ST2506 01  WRK-BUSCA-CPF-CNPJ          PIC  X(009)         VALUE SPACES.
ST2506 01  WRK-BUSCA-FILIAL            PIC  X(004)         VALUE SPACES.
...
ST2506              CFLIAL_CGC_ST,
              ...
              WHERE CCGC_CPF_ST        = :WRK-BUSCA-CPF-CNPJ
                AND CFLIAL_CGC_ST      = :WRK-BUSCA-FILIAL
...
ST2506*    MOVE GFCTIS-CPF-CNPJ        TO GFCTIU-NRO-CPF-CNPJ.
ST2506*    MOVE GFCTIS-FILIAL          TO GFCTIU-NRO-FILIAL.
ST2506     MOVE GFCTIS-CPF-CNPJ        TO GFCTIU-COD-CPF-CNPJ.
ST2506     MOVE GFCTIS-FILIAL          TO GFCTIU-COD-FILIAL.
...
ST2506*        MOVE CCGC-CPF OF GFCTB0H8
ST2506*                                TO GFCTIT-CPF-CNPJ-P
ST2506*        MOVE CFLIAL-CGC OF GFCTB0H8
ST2506*                                TO GFCTIT-FILIAL-P
ST2506         MOVE CCGC-CPF-ST OF GFCTB0H8
ST2506                                 TO GFCTIT-CPF-CNPJ-P
ST2506         MOVE CFLIAL-CGC-ST OF GFCTB0H8
ST2506                                 TO GFCTIT-FILIAL-P
...
ST2506*    IF  GFCTIS-CPF-CNPJ-P       EQUAL ZEROS AND
ST2506*        GFCTIS-FILIAL-P         EQUAL ZEROS
ST2506     IF  GFCTIS-CPF-CNPJ-P       EQUAL SPACES AND
ST2506         GFCTIS-FILIAL-P         EQUAL SPACES
...
ST2506*             INTO :GFCTB0H8.CCGC-CPF,
ST2506*                  :GFCTB0H8.CFLIAL-CGC,
ST2506              INTO :GFCTB0H8.CCGC-CPF-ST,
ST2506                   :GFCTB0H8.CFLIAL-CGC-ST,
