//GFCTA148 JOB 'GFCT,4220,PR14','H65052',MSGCLASS=Z,SCHENV=BATCH
//JOBLIB   DD DSN=MX.BIBGERAL,DISP=SHR
//         DD DSN=DB2M1.R2.DSNLOAD,DISP=SHR
//         DD DSN=SYS1.CEE.SCEERUN,DISP=SHR
//*
//* ***    TRATAMENTO DE SOLICITACOES DE CANCELAMENTO (CALCULO QUANT.)
...
//* ***    ------------------------------------------------------------
//*
//LEITURA  DD DSN=MX.GFCT.CALCA146.SOLICPAB(0),
//       DISP=SHR
//SYSOUT   DD SYSOUT=*
...
//* ***    ------------------------------------------------------------
//*
//SORTIN   DD DSN=MX.GFCT.CALCA142.ARQCESTA(0),
//       DISP=SHR
//SORTOUT  DD DSN=MX.GFCT.CALCA148.ARQCESTA(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
...
//       DISP=SHR
//SAI      DD DSN=MX.GFCT.CALCA148.ARQCLIE1(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
...
//       DISP=SHR
//SORTOUT  DD DSN=MX.GFCT.CALCA148.ARQCLIE1.CLASS(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
//       SPACE=(TRK,(010000,02000),RLSE),
//       DCB=(MX.A,LRECL=180,RECFM=FB)
...
//       DISP=SHR
//CLICESTA DD DSN=MX.GFCT.CALCA148.CLICESTA(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
...
//* ***    ------------------------------------------------------------
//*
//SORTIN   DD DSN=MX.GFCT.CALCA146.SOLICPAB(0),
//       DISP=SHR
//SORTOUT  DD DSN=MX.GFCT.CALCA148.SOLICPAB(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
//       SPACE=(TRK,(002001,0201),RLSE),
...
//       DISP=SHR
//SORTOUT  DD DSN=MX.GFCT.CALCA148.CLICESTA.CLASS(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
//       SPACE=(TRK,(005001,0501),RLSE),
//       DCB=(MX.A,LRECL=150,RECFM=FB)
...
//       DISP=SHR
//DELETPAB DD DSN=MX.GFCT.CALCA148.DELETPAB(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
//       SPACE=(TRK,(002001,0201),RLSE),
//       DCB=(MX.A,LRECL=150,RECFM=FB)
...
//SORTIN   DD DSN=MX.GFCT.CALCA146.SOLICPAB(0),
//       DISP=SHR
//SORTOUT  DD DSN=MX.GFCT.CALCA108.SOLICPAB.CLAS2(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
//       SPACE=(TRK,(002001,0201),RLSE),
//       DCB=(MX.A,LRECL=700,RECFM=FB)
...
//       DISP=SHR
//SORTOUT  DD DSN=MX.GFCT.CALCA148.DELETPAB.CLASS(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
//       SPACE=(TRK,(002001,0201),RLSE),
//       DCB=(MX.A,LRECL=150,RECFM=FB)
...
//       DISP=SHR
//ATUALPAB DD DSN=MX.GFCT.CALCA148.ATUALPAB(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,10),
//       SPACE=(TRK,(002001,0201),RLSE),
//       DCB=(MX.A,LRECL=700,RECFM=FB)
