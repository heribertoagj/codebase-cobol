//GFCT9320 JOB 'GFCT,4220,PR14','C214524',MSGCLASS=Z,SCHENV=BATCH
...
//       DISP=SHR
//SAI      DD DSN=MX.GFCT.CADNOVGR.DESCOMP(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,58),
//       SPACE=(TRK,(20000,4000),RLSE),
...
//       DISP=SHR
//SORTOUT  DD DSN=MX.GFCT.CLIEDESC.PAB(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,58),
//       SPACE=(TRK,(20000,4000),RLSE),
...
//       DISP=SHR
//PABEXPRE DD DSN=MX.GFCT.POSTEXPR(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,58),
//       SPACE=(TRK,(20000,4000),RLSE),
...
//       DISP=SHR
//COMPACOT DD DSN=MX.GFCT.COMPACOT(+1),
//       DISP=(,CATLG,DELETE),
//       UNIT=(DISCO,58),
//       SPACE=(TRK,(20000,4000),RLSE),
