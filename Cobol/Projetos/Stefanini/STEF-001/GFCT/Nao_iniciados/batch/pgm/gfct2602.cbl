      ...
      *----------------------------------------------------------------*
           ...
           MOVE WADJ-DT-LANCTO-MM      TO WRK-MES-ARQ.
           MOVE WADJ-DT-LANCTO-AAAA    TO WRK-ANO-ARQ.
...
ST25X6*        AJUSTE ST25X6: CAMPOS NO PADRÃO ST (CPF/CNPJ = PIC X(009)).
ST25X6*        REMOVER CHECAGEM "NOT NUMERIC" PARA CPF/CNPJ; VALIDAR BRANCO/ZEROS.
