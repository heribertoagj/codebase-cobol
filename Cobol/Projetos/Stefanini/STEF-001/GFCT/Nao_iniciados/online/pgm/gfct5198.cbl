      ...
      *                                                                *
      *    NAVEGACAO                                                   *
      *      CHAMADO POR: GFCT7279                                     *
      *                                                                *
      *================================================================*
RU0719*  07/2019 - MARCIO ALEXANDRO RUI                                *
RU0719*            LIBERACAO DE COMBO DE TARIFAS PARA DEPARTAMENTO     *
RU0719*            DIFERENTE DO MASTER CADASTRADO                      *
      *                                                                *
      *================================================================*
...
ST25X6*    03  WRK-CNPJ-CON-0315       PIC  9(002)         VALUE ZEROS.
      ...
      *================================================================*
       PROCEDURE DIVISION              USING GFCTYE-ENTRADA
                                             GFCTYF-SAIDA
                                             GFCT0M-AREA-ERROS.
      *================================================================*
      ...
      *----------------------------------------------------------------*
           ...
           INITIALIZE GFCTYF-SAIDA.

           MOVE +268                   TO GFCTYF-LL.
           MOVE ZEROS                  TO GFCTYF-ZZ.
           MOVE GFCTYE-TRANSACAO       TO GFCTYF-TRANSACAO.
           MOVE GFCTYE-FUNCAO          TO GFCTYF-FUNCAO.

           IF  GFCTYE-QTDE-OCOR        NOT NUMERIC
               MOVE ZEROS              TO GFCTYF-QTDE-OCOR
           ELSE
               MOVE GFCTYE-QTDE-OCOR   TO GFCTYF-QTDE-OCOR
           END-IF.

           IF  GFCTYE-QTDE-TOT-REG     NOT NUMERIC
               MOVE ZEROS              TO GFCTYF-QTDE-TOT-REG
           ELSE
               MOVE GFCTYE-QTDE-TOT-REG
                                       TO GFCTYF-QTDE-TOT-REG
           END-IF

           MOVE GFCTYE-FUNC-BDSCO      TO GFCTYF-FUNC-BDSCO.
           MOVE GFCTYE-TERMINAL        TO GFCTYF-TERMINAL.
           MOVE GFCTYE-PONTEIRO-TARIFA
                                       TO GFCTYF-PONTEIRO-TARIFA.
           MOVE GFCTYE-PONTEIRO-DATA   TO GFCTYF-PONTEIRO-DATA.
           MOVE ZEROS                  TO GFCTYF-ERRO
                                          GFCTYF-COD-SQL-ERRO
                                          GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG.
           MOVE 'N'                    TO GFCTYF-FIM.

           PERFORM 11100-OBTER-DESC-MSG.

           MOVE WRK-5000-DESC-MSG      TO GFCTYF-DESC-MSG-ERRO.
      ...
      *----------------------------------------------------------------*
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               MOVE 9                  TO GFCTYF-ERRO

               MOVE 'GFCT5198'         TO GFCT0M-PROGRAMA
           ...
           IF  WRK-5000-COD-RETORNO    NOT EQUAL ZEROS
               IF  WRK-5000-COD-RETORNO
                                       EQUAL 01
                   MOVE 1              TO GFCTYF-ERRO
                   MOVE ZEROS          TO GFCTYF-COD-SQL-ERRO
                                          GFCTYF-COD-MSG-ERRO
                   MOVE WRK-5000-DESC-MSG
                                       TO GFCTYF-DESC-MSG-ERRO
               END-IF
               IF  WRK-5000-COD-RETORNO
                                       EQUAL 99
                   MOVE 1              TO GFCTYF-ERRO
                   MOVE WRK-5000-COD-SQL-ERRO
                                       TO GFCTYF-COD-SQL-ERRO
                   MOVE ZEROS          TO GFCTYF-COD-MSG-ERRO
                   MOVE WRK-5000-DESC-MSG
                                       TO GFCTYF-DESC-MSG-ERRO
               END-IF
               MOVE 'S'                TO GFCTYF-FIM
               INITIALIZE GFCTYF-DADOS
               PERFORM 30000-FINALIZAR
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF (GFCTYE-TRANSACAO        EQUAL SPACES)          OR
              (GFCTYE-FUNCAO           EQUAL SPACES)          OR
              (GFCTYE-CSERVC-TARIF     IS NOT NUMERIC)        OR
              (GFCTYE-QTDE-OCOR        IS NOT NUMERIC)        OR
              (GFCTYE-QTDE-TOT-REG     IS NOT NUMERIC)        OR
              (GFCTYE-FUNC-BDSCO       EQUAL SPACES)          OR
              (GFCTYE-PONTEIRO-TARIFA  IS NOT NUMERIC)        OR
              (GFCTYE-TIPO-DATA        EQUAL  0               AND
               GFCTYE-PONTEIRO-DATA    EQUAL SPACES)          OR
              (GFCTYE-FIM              NOT EQUAL 'S' AND 'N') OR
              (GFCTYE-TIPO-VIGENCIA    NOT EQUAL 'V' AND 'N'  AND
                                                 'T' AND 'P'  AND
                                                 'H' AND 'F') OR
              (GFCTYE-TIPO-DATA        IS NOT NUMERIC         OR
               GFCTYE-TIPO-DATA        NOT EQUAL  0  AND  1   AND
RIC                                               2  AND  3 ) OR
RIC           (GFCTYE-TIPO-DEPENDENCIA NOT EQUAL 'GM' AND 'AG'  AND
RIC                                              'GR' AND 'DR'  AND
RU0719                                  'DA' AND 'DS' AND '  ' )
               MOVE 1                  TO GFCTYF-ERRO
               MOVE ZEROS              TO GFCTYF-COD-SQL-ERRO
               MOVE 0001               TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
               MOVE 'S'                TO GFCTYF-FIM
               PERFORM 11100-OBTER-DESC-MSG
               MOVE WRK-5000-DESC-MSG  TO GFCTYF-DESC-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           IF  WRK-5500-COD-RETORNO    EQUAL 04
               MOVE 1                  TO GFCTYF-ERRO
               MOVE ZEROS              TO GFCTYF-COD-SQL-ERRO
               MOVE 0030               TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
               MOVE 'S'                TO GFCTYF-FIM
               PERFORM 11100-OBTER-DESC-MSG
               MOVE WRK-5000-DESC-MSG  TO GFCTYF-DESC-MSG-ERRO
           ...
           ELSE
               IF  WRK-5500-COD-RETORNO
                   ...
                   MOVE 0012           TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTYE-PONTEIRO-TARIFA  EQUAL ZEROS
               MOVE GFCTYE-CSERVC-TARIF
                                       TO WRK-AUX-TARIFA
               MOVE '01.01.0001'       TO WRK-DATA-PONTEIRO
           ELSE
               MOVE GFCTYE-PONTEIRO-TARIFA
                                       TO WRK-AUX-TARIFA
               MOVE GFCTYE-PONTEIRO-DATA
                                       TO WRK-DATA-PONTEIRO
           END-IF.

           EVALUATE GFCTYE-TIPO-VIGENCIA
               WHEN 'T'
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTYE-FUNC-BDSCO          TO WRK-COD-FUNCIONAL-0315.
           ...
           IF  RETURN-CODE                 NOT EQUAL ZEROS AND 04
               MOVE 'S'                    TO GFCTYF-FIM
               MOVE 1                      TO GFCTYF-ERRO
               MOVE RETURN-CODE            TO GFCTYF-COD-SQL-ERRO
               MOVE 0056                   TO GFCTYF-COD-MSG-ERRO
                                              WRK-5000-COD-MSG
               PERFORM 11100-OBTER-DESC-MSG
               MOVE WRK-5000-DESC-MSG      TO GFCTYF-DESC-MSG-ERRO
               PERFORM 30000-FINALIZAR
           ...
           IF  RETURN-CODE                 EQUAL 04
               ...
               IF  WRK-COD-MENSAGEM-0315   EQUAL 001
                   MOVE 1                  TO GFCTYF-ERRO
                   MOVE ZEROS              TO GFCTYF-COD-SQL-ERRO
                   MOVE 0057               TO GFCTYF-COD-MSG-ERRO
                                              WRK-5000-COD-MSG
                   PERFORM 11100-OBTER-DESC-MSG
                   MOVE WRK-5000-DESC-MSG  TO GFCTYF-DESC-MSG-ERRO
                   PERFORM 30000-FINALIZAR
               ...
               IF  WRK-COD-MENSAGEM-0315   EQUAL 154
                   MOVE 1                  TO GFCTYF-ERRO
                   MOVE ZEROS              TO GFCTYF-COD-SQL-ERRO
                   MOVE 0058               TO GFCTYF-COD-MSG-ERRO
                                              WRK-5000-COD-MSG
                   PERFORM 11100-OBTER-DESC-MSG
                   MOVE WRK-5000-DESC-MSG  TO GFCTYF-DESC-MSG-ERRO
                   PERFORM 30000-FINALIZAR
               ...
               IF  WRK-COD-MENSAGEM-0315   EQUAL 242
                   MOVE 1                  TO GFCTYF-ERRO
                   MOVE ZEROS              TO GFCTYF-COD-SQL-ERRO
                   MOVE 0059               TO GFCTYF-COD-MSG-ERRO
                                              WRK-5000-COD-MSG
                   PERFORM 11100-OBTER-DESC-MSG
                   MOVE WRK-5000-DESC-MSG  TO GFCTYF-DESC-MSG-ERRO
                   PERFORM 30000-FINALIZAR
               ...
               IF  WRK-COD-MENSAGEM-0315   EQUAL 138
                   MOVE 1                  TO GFCTYF-ERRO
                   MOVE ZEROS              TO GFCTYF-COD-SQL-ERRO
                   MOVE 0060               TO GFCTYF-COD-MSG-ERRO
                                              WRK-5000-COD-MSG
                   PERFORM 11100-OBTER-DESC-MSG
                   MOVE WRK-5000-DESC-MSG  TO GFCTYF-DESC-MSG-ERRO
                   PERFORM 30000-FINALIZAR
...
RU0719     MOVE 4008                   TO WRK-5507-CJUNC-DEPDC
RU0719                                    WRK-COD-JUNCAO-0315
RU0719     MOVE 'GM'                   TO GFCTYE-TIPO-DEPENDENCIA
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTYE-TIPO-DATA        EQUAL ZEROS
               MOVE GFCTYE-DATA-REFER  TO WRK-DATA-DD-MM-AAAA
               PERFORM 23100-FORMATAR-DT-WEB
               IF  WRK-ERRO-DATA       EQUAL 'S'
                   MOVE 1              TO GFCTYF-ERRO
                   MOVE ZEROS          TO GFCTYF-COD-SQL-ERRO
                   MOVE 125            TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
                   MOVE 'S'            TO GFCTYF-FIM
                   PERFORM 11100-OBTER-DESC-MSG
                   MOVE WRK-5000-DESC-MSG
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0011               TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
      ...
      *----------------------------------------------------------------*
           ...
           MOVE SPACES                 TO GFCTYF-DESC-MSG-ERRO.

           STRING WRK-5000-DESC-MSG ' - '
                  WRK-NOME-TAB
           DELIMITED BY '   '          INTO GFCTYF-DESC-MSG-ERRO.
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND +100) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0006               TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
           ...
           ELSE
RIC   *        IF (WRK-5507-IDTFD-MASTER
RIC   *                                EQUAL 'N' AND
RIC   *            WRK-COD-JUNCAO-0315 NOT EQUAL CDEPDC OF GFCTB0D8)
RIC            IF (GFCTYE-TIPO-DEPENDENCIA EQUAL 'GM' OR
RIC                                              'AG' OR 'GR'  OR
RIC                                     'DA' OR  'DR' OR 'DS') OR
RIC               (GFCTYE-TIPO-DEPENDENCIA EQUAL '  ' AND
RIC               (WRK-COD-JUNCAO-0315     EQUAL CDEPDC OF GFCTB0D8))
RIC                GO                  TO 24200-99-FIM
RIC            ELSE
      ...
      *----------------------------------------------------------------*
           ...
           IF  IND-1                   EQUAL ZEROS
               MOVE ZEROS              TO GFCTYF-ERRO
                                          GFCTYF-COD-SQL-ERRO
               MOVE WRK-NRO-SEQ        TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0005               TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
...
RIC               (GFCTYE-TIPO-DEPENDENCIA EQUAL '  ' AND
RIC               (WRK-COD-JUNCAO-0315     EQUAL CDEPDC OF GFCTB0D8))
RIC                GO                  TO 25200-99-FIM
RIC            ELSE
RIC                GO                  TO 25200-LER-CSR-2
RIC            END-IF
RIC        END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           ADD 106                     TO GFCTYF-LL

           MOVE CSERVC-TARIF OF GFCTB0D8
                                       TO GFCTYF-COD-TARIFA(IND-1).
           MOVE RSERVC-TARIF-REDZD OF GFCTB0D8
                                       TO GFCTYF-DESC-TARIFA(IND-1).
           MOVE WRK-TIPO-VIGENCIA      TO GFCTYF-TIPO-VIGENCIA(IND-1).

           ADD 1                       TO GFCTYF-QTDE-TOT-REG.
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND +100 AND
              ...
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0009               TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
               MOVE 'GFCTB0D8'         TO WRK-NOME-TAB
               PERFORM 23210-MOVER-ERRO-SQL
               PERFORM 30000-FINALIZAR
           ...
           IF  SQLCODE                 EQUAL +100
               ...
               IF  IND-1               EQUAL ZEROS
                   MOVE 1              TO GFCTYF-ERRO
                   MOVE ZEROS          TO GFCTYF-COD-SQL-ERRO
                   MOVE 0242           TO GFCTYF-COD-MSG-ERRO
                                          WRK-5000-COD-MSG
                   PERFORM 11100-OBTER-DESC-MSG
                   MOVE WRK-5000-DESC-MSG  TO GFCTYF-DESC-MSG-ERRO
                   PERFORM 30000-FINALIZAR
