...
______*77__WRK-CURRENT-TIMESTAMP_______PIC__X(026)________VALUE_SPACES.
      ...
      *----------------------------------------------------------------*
           ...
           IF (F17-CPF-CNPJ EQUAL SPACES OR
               F17-CPF-CNPJ NOT NUMERIC)
              MOVE 'S'                TO WRK-ERRO
              MOVE 'CPF CNPJ INVALIDO' TO WRK-MSG
              GO TO 3120-99-FIM
           END-IF

           IF (F17-FILIAL EQUAL SPACES OR
               F17-FILIAL NOT NUMERIC)
              MOVE 'S'                TO WRK-ERRO
              MOVE 'FILIAL CNPJ INVALIDO' TO WRK-MSG
              GO TO 3120-99-FIM
           END-IF

           IF (F17-DIGITO-FJ EQUAL SPACES OR
               F17-DIGITO-FJ NOT NUMERIC)
              MOVE 'S'                TO WRK-ERRO
