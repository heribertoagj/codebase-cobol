      ...
      *----------------------------------------------------------------*
       ...
       FILE-CONTROL.
           ...
           SELECT ARQUSIGB   ASSIGN    TO UT-S-ARQUSIGB
           FILE STATUS                 IS WRK-FS-ARQUSIGB.
      ...
      *----------------------------------------------------------------*
      *    OUTPUT: ARQUIVO ARQUSIGB                                    *
      *            ORG. SEQUENCIAL     - LRECL = 018                   *
      *----------------------------------------------------------------*
      ...
      *********************************************************
       ...
       01  FD-SIGB-REG.
           02  FD-SIGB-CONTA                PIC S9(007)       COMP-3.
           02  FD-SIGB-COD-CART             PIC S9(005)       COMP-3.
           02  FD-SIGB-VALOR                PIC S9(013)V9(02) COMP-3.
      ...
      *----------------------------------------------------------------*
       ...
       77  ACU-GRAVADOS-ARQUSIGB       PIC  9(015) COMP-3  VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
       ...
       77  WRK-FS-ARQUSIGB             PIC  X(002)         VALUE SPACES.
      ...
      *----------------------------------------------------------------*
       ...
       77  WRK-VALOR                  PIC S9(15)V9(2)    COMP-3 VALUE 0.

       01  WRK-VALOR-RED1.
           10 WRK-VALOR-RED1-X        PIC S9(15)V9(2)    COMP-3 VALUE 0.

       01  WRK-VALOR-RED2.
           10 WRK-VALOR-RED2-X        PIC S9(13)V9(2)    COMP-3 VALUE 0.

       01  WRK-9-13                    PIC  9(013)        VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
           ...
           PERFORM 1135-TESTAR-FS-ARQUSIGB.
      *----------------------------------------------------------------*
       1100-99-FIM.                    EXIT.
      *----------------------------------------------------------------*
      ...
      ******************************************************************
      *    ROTINA DE TESTE PARA ARQUIVO ARQUSIGB                       *
      ******************************************************************
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*

           IF  WRK-FS-ARQUSIGB         NOT EQUAL '00'
               MOVE 'APL'              TO ERR-TIPO-ACESSO
               MOVE 'ARQUSIGB'         TO WRK-NOME-ARQ
               MOVE WRK-FS-ARQUSIGB    TO WRK-FILE-STATUS
               MOVE WRK-ERRO-FILE-STATUS  TO ERR-TEXTO
               PERFORM 9999-PROCESSAR-ROTINA-ERRO
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF (G00-COR-H-TP-REG        NOT NUMERIC     OR
      ...
      *----------------------------------------------------------------*
           ...
           IF (G00-COR-D-CPF-CNPJ EQUAL SPACES OR
               G00-COR-D-CPF-CNPJ EQUAL LOW-VALUES)
              MOVE 'S'                TO WRK-ERRO
              MOVE 'CPF/CNPJ INVALIDO' TO WRK-MSG
              GO TO 3120-99-FIM
           END-IF.
           IF (G00-COR-D-FILIAL EQUAL SPACES OR
               G00-COR-D-FILIAL EQUAL LOW-VALUES)
              MOVE 'S'                TO WRK-ERRO
              MOVE 'FILIAL CNPJ INVALIDO' TO WRK-MSG
              GO TO 3120-99-FIM
           END-IF.

           IF (G00-COR-D-CTR  EQUAL SPACES OR
               G00-COR-D-CTR  EQUAL LOW-VALUES)
              MOVE 'S'                TO WRK-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE ZEROS                  TO WF25-VSDO-APLIC-DBTRS.
           MOVE G00-COR-D-CPF-CNPJ-R   TO WF25-CNPJ-CPF.
           MOVE G00-COR-D-FILIAL-R     TO WF25-FILIAL.
           MOVE G00-COR-D-CTR-R        TO WF25-DIGITO-FJ.

           COMPUTE WRK-VALOR = WF25-VSDO-APLIC-ACOES +
                               WF25-VSDO-APLIC-TSORO.

           MOVE WRK-VALOR      TO WRK-VALOR-RED1-X.
           MOVE WRK-VALOR-RED1(2:8) TO WRK-VALOR-RED2.
           MOVE WRK-VALOR-RED2-X    TO FD-SIGB-VALOR.
           ...
           ADD 1 TO ACU-GRAVADOS-ARQUSIGB.
      ...
      *----------------------------------------------------------------*
      ...
      -        '*********'
               ...
               DISPLAY '* TOTAL DE REGISTROS GRAVADOS GFCTB0P0  = '
                 WRK-MASCARA
                           ' *'
               DISPLAY '* TOTAL DE REGISTROS GRAVADOS ARQUSIGB  = '
                 WRK-MASCARA
                           ' *'
               DISPLAY '************************************************
      -        '*********'
