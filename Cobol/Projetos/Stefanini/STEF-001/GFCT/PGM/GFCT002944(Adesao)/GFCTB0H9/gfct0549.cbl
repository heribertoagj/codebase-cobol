...
ST25X6*    MOVE WAGO-NUMERO            TO WRK-NUMERO-0110.
ST25X6*    MOVE WAGO-FILIAL            TO WRK-FILIAL-0110.
ST25X6*
ST25X6*    CALL 'POOL0110'             USING WRK-CGC-CPF-0110
ST25X6*                                      WRK-CONTROLE-0110.
ST25X6     MOVE ZEROS                 TO WRK-CAD-CONTROLE. 
ST25X6     MOVE WAGO-NUMERO           TO WRK-CAD-NUMERO.
ST25X6     MOVE WAGO-FILIAL           TO WRK-CAD-FILIAL.
...
ST25X6*    MOVE WRK-CONTROLE-0110      TO WRK-CONTROLE
ST25X6     MOVE WRK-CAD-CONTROLE       TO WRK-CONTROLE

           IF  WAGO-CONTRL             NOT EQUAL WRK-CONTROLE-R
               MOVE 1                  TO WAGP-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAGO-NUMERO            TO GFCTIU-NRO-CPF-CNPJ.
           MOVE WAGO-FILIAL            TO GFCTIU-NRO-FILIAL.
