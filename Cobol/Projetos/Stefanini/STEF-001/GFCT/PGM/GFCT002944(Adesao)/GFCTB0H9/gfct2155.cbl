...
BI0412     END-EXEC.
           ...
           EXEC SQL
             DECLARE CSR01-GFCTB006 CURSOR FOR
             SELECT
                   A.CSERVC_TARIF,
                   A.CAGPTO_CTA,
                   A.CSEQ_AGPTO_CTA,
...
BI0810                                 TO TAB-1-TPSSOA-ADESAO(IND-1).
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CDEPDC OF GFCTB006         TO TAB-2-AGENC-N.
           MOVE CPOSTO-SERVC OF GFCTB006   TO TAB-2-CORRESP.

           PERFORM 3431-MONTAR-TAB-2                               UNTIL
               CDEPDC OF GFCTB006          GREATER TAB-2-AGENC-N   OR
               CPOSTO-SERVC OF GFCTB006    GREATER TAB-2-CORRESP   OR
               WRK-FIM-CSR01               EQUAL 'S'.
...
SV2204*----------------------------------------------------------------*
SV2204 3511-2-MONTA-NO-MES             SECTION.
SV2204*----------------------------------------------------------------
SV2204
