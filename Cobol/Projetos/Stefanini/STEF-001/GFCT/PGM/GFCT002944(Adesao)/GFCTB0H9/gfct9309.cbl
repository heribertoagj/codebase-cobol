...
ST2506*01  WRK-CCGC-CPF                PIC S9(009) COMP-3  VALUE ZEROS.
ST2506*01  FILLER                      REDEFINES WRK-CCGC-CPF.
ST2506*    05  WRK-COD-CGC-CPF         PIC  9(009) COMP-3.
...
ST2506*    05  WRK-TAB-CGC-CPF         PIC  9(009)         VALUE ZEROS.
ST2506     05  WRK-TAB-CGC-CPF         PIC  X(009)         VALUE SPACES.
           05  WRK-TAB-DADOS           OCCURS 300 TIMES.
             ...
             10  FILLER                REDEFINES WRK-TAB-DINI.
               15  WRK-TAB-DIAI        PIC  9(002).
               15  FILLER              PIC  X(001).
               15  WRK-TAB-MESI        PIC  9(002).
               15  FILLER              PIC  X(001).
               15  WRK-TAB-ANOI        PIC  9(004).
      ...
      *----------------------------------------------------------------*
       ...
       01  CABEC2.
           ...
           05  CB2-PAG                 PIC  ZZ99           VALUE ZEROS.
       ...
       01  LINDET1.
           05  FILLER                  PIC  X(001)         VALUE ' '.
           05  LD1-CGC                 PIC  ZZZZZZZZ9      VALUE ZEROS.
           05  FILLER                  PIC  X(001)         VALUE '-'.
           05  LD1-FILIAL              PIC  99999          VALUE ZEROS.
           05  FILLER                  PIC  X(001)         VALUE '-'.
           05  LD1-CONTROLE            PIC  99             VALUE ZEROS.
           05  FILLER                  PIC  X(002)         VALUE SPACES.
           05  LD1-AGENCIA             PIC  9(005)         VALUE ZEROS.
           05  FILLER                  PIC  X(007)         VALUE SPACES.
           05  LD1-CONTA               PIC  9(007)         VALUE ZEROS.
           05  FILLER                  PIC  X(008)         VALUE SPACES.
           05  LD1-PACOTE              PIC  99999          VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC SQL
               DECLARE CSR01-GFCTB0H9-JN CURSOR FOR
               SELECT
                   A.CSERVC_TARIF,
                   A.CAGPTO_CTA,
                   A.CSEQ_AGPTO_CTA,
...
PWI        MOVE  DPROCM-ATUAL OF GFCTB0A1  TO WRK-DATA-AUX
PWI                                           WRK-DDISPL.
PWI        MOVE  WRK-DIA-AUX               TO CB5-DIA-MOV.
PWI        MOVE  WRK-MES-AUX               TO CB5-MES-MOV.
PWI        MOVE  WRK-ANO-AUX               TO CB5-ANO-MOV.
PWI
...
ST2506*        M0VE  999999999         TO CCGC-CPF         OF GFCTB0H9
...
ST2506*    M0VE CCGC-CPF OF GFCTB0H9   TO WRK-CCGC-CPF.
ST2506     MOVE CCGC-CPF-ST            OF GFCTB0H9 
                                       TO WRK-CCGC-CPF.

ST2506*    1F  WRK-COD-CGC-CPF                 LESS GFCTRU-CGC-CPF
ST2506     IF  WRK-CCGC-CPF                    LESS GFCTRU-CGC-CPF
               PERFORM 3200-LER-CURSOR1        UNTIL
ST2506*            WRK-COD-CGC-CPF             NOT LESS GFCTRU-CGC-CPF
ST2506             WRK-CCGC-CPF                NOT LESS GFCTRU-CGC-CPF
                OR WRK-FIM-CURSOR1             EQUAL 'S'
           ELSE
ST2506*        1F  WRK-COD-CGC-CPF             GREATER GFCTRU-CGC-CPF
ST2506         IF  WRK-CCGC-CPF                GREATER GFCTRU-CGC-CPF
                   PERFORM 2100-LER-CLIEADES   UNTIL
ST2506*                GFCTRU-CGC-CPF          NOT LESS WRK-COD-CGC-CPF
ST2506                 GFCTRU-CGC-CPF          NOT LESS WRK-CCGC-CPF
                    OR WRK-FS-CLIEADES         EQUAL '10'
               ELSE
                   INITIALIZE WRK-TABELA-INTERNA-1
ST2506*            MOVE WRK-COD-CGC-CPF        TO WRK-TAB-CGC-CPF
ST2506             MOVE WRK-CCGC-CPF           TO WRK-TAB-CGC-CPF
                   MOVE ZEROS TO IND-1
                   PERFORM 3310-MONTAR-TABELA1 UNTIL
ST2506*                WRK-COD-CGC-CPF         GREATER WRK-TAB-CGC-CPF
ST2506                 WRK-CCGC-CPF            GREATER WRK-TAB-CGC-CPF
                    OR WRK-FIM-CURSOR1         EQUAL 'S'
...
PWI
PWI        MOVE DINIC-ADSAO-COMP       OF GFCTB0H9
PWI                                      TO WRK-DATA-AUX
PWI        MOVE WRK-DIA-AUX              TO WRK-DIA-AUX1
PWI        MOVE WRK-MES-AUX              TO WRK-MES-AUX1
PWI        MOVE WRK-ANO-AUX              TO WRK-ANO-AUX1.
...
PWI           PERFORM 3321-2-MONTA-NOMES
PWI        ELSE
...
PWI   *----------------------------------------------------------------*
PWI   *----------------------------------------------------------------*
PWI    3321-2-MONTA-NOMES             SECTION.
PWI   *----------------------------------------------------------------
PWI
PWI        MOVE DPROCM-ANTER OF GFCTB0A1 TO WRK-DATA-AUX.
...
PWI   *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE  GFCTRU-AGENCIA            TO WRK-GFCTRU-AGENCIA.
           MOVE  WRK-COD-AGENCIA           TO  LD1-AGENCIA.
           ...
           MOVE  WRK-TAB-DIAI(IND-1)   TO  LD1-DIA-INIC.
           MOVE  WRK-TAB-MESI(IND-1)   TO  LD1-MES-INIC.
           MOVE  WRK-TAB-ANOI(IND-1)   TO  LD1-ANO-INIC.
      ...
      ******************************************************************
      * AREA PARA EXIBICAO DE INFORMACAO DO PROCESSAMENTO.             *
      ******************************************************************
      *----------------------------------------------------------------*
