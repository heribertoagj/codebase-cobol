      ...
      *                    DE ADESAO QUE PODEM SER CANCELADAS.         *
      *                                                                *
      *    BANCO DE DADOS:                                             *
      *      DB2                                                       *
      *       TABLE                                INCLUDE/BOOK        *
      ...
      *----------------------------------------------------------------*
       ...
       01  FILLER                      REDEFINES WRK-FUNC-BDSCO.
           05  FILLER                  PIC  9(002).
           05  WRK-WAFH-FUNC-BDSCO     PIC  X(007).

       01  WRK-QTDE-OCOR               PIC  9(003) COMP-3  VALUE ZEROS.

       01  WRK-WAFI-QTDE-OCOR          PIC  9(003) COMP-3  VALUE ZEROS.
       01  WRK-WAFI-QTDE-TOT-REG       PIC  9(006) COMP-3  VALUE ZEROS.
...
ST2506*  WRK-CCNPJ-CPF               PIC S9(009)         VALUE ZEROS.
ST2506*01  FILLER                      REDEFINES WRK-CCNPJ-CPF.
ST2506*    05  WRK-COD-CNPJ            PIC  9(009).
ST2506 01  WRK-CCNPJ-CPF               PIC X(009)         VALUE SPACES.

ST2509*01  WRK-CFLIAL-CNPJ             PIC S9(005)         VALUE ZEROS.
ST2509*01  FILLER                      REDEFINES WRK-CFLIAL-CNPJ.
ST2509*    05  WRK-COD-FILIAL          PIC  9(005).
ST2509 01  WRK-CFLIAL-CNPJ             PIC X(004)         VALUE SPACES.
      ...
      *================================================================*
       PROCEDURE DIVISION              USING WAFH-ENTRADA
                                             WAFI-SAIDA
                                             GFCT0M-AREA-ERROS.
      *================================================================*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE +395                   TO WAFI-LL.
           MOVE WAFH-TRANSACAO         TO WAFI-TRANSACAO.
           MOVE WAFH-FUNCAO            TO WAFI-FUNCAO.

           MOVE WAFH-QTDE-OCOR         TO WAFI-QTDE-OCOR.
           MOVE ZEROS                  TO WAFI-QTDE-TOT-REG.
           MOVE WAFH-FUNC-BDSCO        TO WAFI-FUNC-BDSCO.
           MOVE ZEROS                  TO WAFI-ERRO
                                          WAFI-COD-SQL-ERRO
                                          WAFI-COD-MSG-ERRO
                                          GFCTG2-COD-MSG.
           ...
           MOVE GFCTG3-DESC-MSG        TO WAFI-DESC-MSG-ERRO.

           MOVE WAFH-AGPTO             TO WAFI-AGPTO.
           MOVE WAFH-COD-PACOTE        TO WAFI-COD-PACOTE.
           MOVE 'N'                    TO WAFI-FIM.
           MOVE WAFH-OPCAO             TO WAFI-OPCAO.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAFH-TRANSACAO         TO GFCTFZ-TRANSACAO.
           MOVE WAFH-FUNCAO            TO GFCTFZ-FUNCAO.
           MOVE WAFH-FUNC-BDSCO        TO GFCTFZ-FUNC-BDSCO.
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               ...
               MOVE 'GFCT0143'         TO GFCT0M-TRANSACAO
           ...
           IF  GFCTG1-ERRO             EQUAL 9
               ...
               IF  GFCT0M-TIPO-ACESSO  EQUAL 'DB2'
                   MOVE GFCTG1-COD-MSG-ERRO
                                       TO WAFI-COD-MSG-ERRO
                   MOVE GFCTG1-COD-SQL-ERRO
                                       TO WAFI-COD-SQL-ERRO
                   MOVE GFCTG1-DESC-MSG-ERRO
                                       TO WAFI-DESC-MSG-ERRO
               ELSE
                   MOVE 'APL'          TO GFCT0M-TIPO-ACESSO
                   MOVE 'GFCT0143'     TO GFCT0M-TRANSACAO
                   MOVE WRK-MODULO     TO GFCT0M-PROGRAMA
      ...
      *----------------------------------------------------------------*
           ...
           IF (WAFH-TRANSACAO          EQUAL SPACES OR LOW-VALUES) OR
              (WAFH-FUNCAO             EQUAL SPACES OR LOW-VALUES) OR
              (WAFH-QTDE-OCOR          NOT NUMERIC)                OR
              (WAFH-QTDE-TOT-REG       NOT NUMERIC)                OR
              (WAFH-FUNC-BDSCO         EQUAL SPACES OR LOW-VALUES) OR
              (WAFH-AGPTO              NOT NUMERIC)                OR
              (WAFH-AGPTO              EQUAL ZEROS)                OR
              (WAFH-COD-PACOTE         NOT NUMERIC)                OR
              (WAFH-FIM                NOT EQUAL 'N' AND 'S')      OR
              (WAFH-OPCAO              NOT NUMERIC)                OR
              (WAFH-OPCAO              NOT EQUAL 1 AND 2)
               MOVE 'S'                TO WAFI-FIM

               MOVE 1                  TO WAFI-ERRO
               MOVE ZEROS              TO WAFI-COD-SQL-ERRO
               MOVE 0001               TO WAFI-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAFH-QTDE-OCOR         TO WRK-QTDE-OCOR.

           IF  WAFH-OPCAO              EQUAL 1
               MOVE WAFH-AGPTO         TO CAGPTO-CTA OF GFCTB0L0

               IF  WAFH-COD-PACOTE     EQUAL ZEROS
                   PERFORM 2100-TRATAR-CURSOR-1
               ELSE
                   MOVE WAFH-COD-PACOTE
                                       TO CSERVC-TARIF OF GFCTB0L0

                   PERFORM 2200-TRATAR-CURSOR-2
               END-IF
           ELSE
               PERFORM 2500-TRATAR-CANCELAMENTO
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF  WRK-FIM-CURSOR          EQUAL 'S'
               ...
               MOVE WAFI-QTDE-OCOR     TO WRK-QTDE-OCOR

               IF  WRK-QTDE-OCOR       EQUAL ZEROS
                   MOVE 1              TO WAFI-ERRO
                   MOVE ZEROS          TO WAFI-COD-SQL-ERRO
                   MOVE 1576           TO WAFI-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0005               TO WAFI-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND +100) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0006               TO WAFI-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0011               TO WAFI-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0012               TO WAFI-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAFI-QTDE-OCOR         TO WRK-WAFI-QTDE-OCOR.
           ADD  +1                     TO WRK-WAFI-QTDE-OCOR.
           MOVE WRK-WAFI-QTDE-OCOR     TO WAFI-QTDE-OCOR.

           MOVE WAFI-QTDE-TOT-REG      TO WRK-WAFI-QTDE-TOT-REG.
           ADD  +1                     TO WRK-WAFI-QTDE-TOT-REG.
           MOVE WRK-WAFI-QTDE-TOT-REG  TO WAFI-QTDE-TOT-REG.
           ...
           MOVE HINCL-REG OF GFCTB0L0  TO WAFI-HINCL(IND-1)
                                          WRK-HINCL.

           MOVE WRK-ANO-INCL           TO WRK-ANO-DB2.
           MOVE WRK-MES-INCL           TO WRK-MES-DB2.
           MOVE WRK-DIA-INCL           TO WRK-DIA-DB2.
           MOVE WRK-DATA-DB2           TO WAFI-DATA-SOLIC(IND-1).

           MOVE CSERVC-TARIF OF GFCTB0L0
                                       TO WRK-CSERVC-TARIF.
           MOVE WRK-COD-TARIFA         TO WAFI-PACOTE(IND-1).

           MOVE RSERVC-TARIF-REDZD OF GFCTB0D8 (1:20)
                                       TO WAFI-NOME-PACOTE(IND-1).
           MOVE CSIT-SOLTC-CANCT OF GFCTB0L0
                                       TO WAFI-SITUACAO(IND-1).
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WRK-COD-AGENCIA        TO WAFI-AGENCIA(IND-1).

           MOVE CPOSTO-SERVC OF GFCTB0L3
                                       TO WRK-POSTO.
           MOVE WRK-COD-POSTO          TO WAFI-POSTO(IND-1).


           IF  WAFH-AGPTO              EQUAL 015
               PERFORM 2411-OBTER-DESC-PAB
           ELSE
               PERFORM 2412-OBTER-DESC-CORRESP-BANC
           END-IF.

           MOVE GFCTGC-DESC-POSTO(1)   TO WAFI-NOME-POSTO(IND-1).
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAFH-TRANSACAO         TO GFCTGB-TRANSACAO.
           MOVE WAFH-FUNCAO            TO GFCTGB-FUNCAO.
           MOVE WAFH-FUNC-BDSCO        TO GFCTGB-FUNC-BDSCO.
           ...
           IF  GFCTGC-ERRO             NOT EQUAL ZEROS
               ...
               IF  GFCTGC-ERRO         EQUAL 1
                   MOVE ZEROS          TO WAFI-COD-SQL-ERRO
                   MOVE 1577           TO WAFI-COD-MSG-ERRO
               ...
               ELSE
                   ...
                   DELIMITED BY SIZE   INTO WAFI-DESC-MSG-ERRO
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTGC-ERRO             NOT EQUAL ZEROS
               ...
               IF  GFCTGC-ERRO         EQUAL 1
                   MOVE ZEROS          TO WAFI-COD-SQL-ERRO
                   MOVE 1579           TO WAFI-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CCTA-BCRIA-CLI OF GFCTB0L1
                                       TO WRK-CONTA.
           MOVE WRK-COD-CONTA          TO WAFI-CONTA(IND-1).
...
ST2506     MOVE CCTRL-CNPJ-ST          OF GFCTB0L2 
      ...
      *----------------------------------------------------------------*
       2500-TRATAR-CANCELAMENTO        SECTION.
      *----------------------------------------------------------------*
           ...
           VARYING IND-1               FROM 1 BY 1
             UNTIL IND-1               GREATER WRK-QTDE-OCOR
                   ...
                   PERFORM 2510-CANCEL-EXCL-ADESAO-AGRUP

           END-PERFORM.

           MOVE ZEROS                  TO WAFI-QTDE-OCOR.

           MOVE 'S'                    TO WAFI-FIM.

           IF  WRK-WAFI-QTDE-TOT-REG   GREATER ZEROS
               MOVE 1                  TO WAFI-ERRO
               MOVE ZEROS              TO WAFI-COD-SQL-ERRO
               MOVE 1578               TO WAFI-COD-MSG-ERRO

               MOVE '1578'             TO GFCTG2-COD-MSG
      ...
      *----------------------------------------------------------------*
       2510-CANCEL-EXCL-ADESAO-AGRUP   SECTION.
      *----------------------------------------------------------------*

           MOVE WAFH-AGPTO             TO CAGPTO-CTA       OF GFCTB0L0.
           MOVE WAFH-PACOTE(IND-1)     TO CSERVC-TARIF     OF GFCTB0L0.
           MOVE WAFH-HINCL(IND-1)      TO HINCL-REG        OF GFCTB0L0.

           MOVE WAFH-FUNC-BDSCO        TO WRK-WAFH-FUNC-BDSCO.
           MOVE WRK-FUNC-BDSCO         TO CFUNC-MANUT      OF GFCTB0L0.

           MOVE 06                     TO CSIT-SOLTC-CANCT OF GFCTB0L0.

           MOVE 'REGISTRO EXCLUIDO PELO USUARIO'
                                       TO RJUSTF-PAREC-CANCT-TEXT
                                                            OF GFCTB0L0.
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND +100) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0019               TO WAFI-COD-MSG-ERRO
           ...
           IF  SQLCODE                 EQUAL +100
               ...
               MOVE WAFI-QTDE-TOT-REG  TO WRK-WAFI-QTDE-TOT-REG
               ADD  +1                 TO WRK-WAFI-QTDE-TOT-REG
               MOVE WRK-WAFI-QTDE-TOT-REG
                                       TO WAFI-QTDE-TOT-REG

               ADD  +123               TO WAFI-LL

               MOVE WAFH-HINCL(IND-1)  TO WAFI-HINCL(IND-2)
               MOVE WAFH-AGENCIA(IND-1)
                                       TO WAFI-AGENCIA(IND-2)
               MOVE WAFH-POSTO(IND-1)  TO WAFI-POSTO(IND-2)
               MOVE WAFH-NOME-POSTO(IND-1)
                                       TO WAFI-NOME-POSTO(IND-2)
               MOVE WAFH-CONTA(IND-1)  TO WAFI-CONTA(IND-2)
ST2506*        MOVE WAFH-CNPJ-NUM(IND-1)
ST2506*                                TO WAFI-CNPJ-NUM(IND-2)
ST2506         MOVE WAFH-CNPJ-CGC(IND-1)
ST2506                                 TO WAFI-CNPJ-CGC(IND-2)
               MOVE WAFH-CNPJ-FIL(IND-1)
                                       TO WAFI-CNPJ-FIL(IND-2)
               MOVE WAFH-CNPJ-CTR(IND-1)
                                       TO WAFI-CNPJ-CTR(IND-2)
               MOVE WAFH-DATA-SOLIC(IND-1)
                                       TO WAFI-DATA-SOLIC(IND-2)
               MOVE WAFH-PACOTE(IND-1) TO WAFI-PACOTE(IND-2)
               MOVE WAFH-NOME-PACOTE(IND-1)
                                       TO WAFI-NOME-PACOTE(IND-2)
               MOVE WAFH-SITUACAO(IND-1)
                                       TO WAFI-SITUACAO(IND-2)
               MOVE 1                  TO WAFI-ERRO-OCOR(IND-2)
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 9                      TO WAFI-ERRO.
           MOVE 'GFCT0143'             TO GFCT0M-PROGRAMA.
           MOVE 'DB2'                  TO GFCT0M-TIPO-ACESSO.
           MOVE SQLCA                  TO GFCT0M-SQLCA-AREA.
           MOVE SQLCODE                TO GFCT0M-SQLCODE
                                          WRK-SQLCODE.

           MOVE WRK-COD-SQL            TO WAFI-COD-SQL-ERRO

           MOVE SPACES                 TO WAFI-DESC-MSG-ERRO.
           ...
           STRING GFCTG3-DESC-MSG
                  ' - '
                  WRK-COD-TABELA
           DELIMITED BY '  '           INTO WAFI-DESC-MSG-ERRO.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAFH-TRANSACAO         TO GFCTG2-TRANSACAO.
           MOVE WAFH-FUNCAO            TO GFCTG2-FUNCAO.
           MOVE WAFH-FUNC-BDSCO        TO GFCTG2-FUNC-BDSCO.
