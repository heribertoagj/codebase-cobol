      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-CGC-CPF-0110.
           05  WRK-NUMERO-0110         PIC  9(009)         VALUE ZEROS.
           05  WRK-FILIAL-0110         PIC  9(005)         VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC SQL
              ...
              WHERE  A.CAGPTO_CTA         = B.CAGPTO_CTA
                ...
                AND  B.CCNPJ_CPF          = :GFCTB0L5.CCNPJ-CPF
                AND  B.CFLIAL_CGC         = :GFCTB0L5.CFLIAL-CGC
                AND  B.CCTRL_CPF_CGC      = :GFCTB0L5.CCTRL-CPF-CGC
           END-EXEC.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG2-NUMERO            TO WRK-NUMERO-0110.
           MOVE WAG2-FILIAL            TO WRK-FILIAL-0110.

           CALL 'POOL0110'             USING WRK-CGC-CPF-0110
                                             WRK-CONTROLE-0110.
           ...
           IF  WAG2-CONTRL             NOT EQUAL WRK-CONTROLE-R
               MOVE 1                  TO WAG3-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG2-NUMERO            TO GFCTIU-NRO-CPF-CNPJ.
           MOVE WAG2-FILIAL            TO GFCTIU-NRO-FILIAL.
