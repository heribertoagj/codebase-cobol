      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTIU-NRO-CPF-CNPJ    TO GFCTIV-NRO-CPF-CNPJ.
           MOVE GFCTIU-NRO-FILIAL      TO GFCTIV-NRO-FILIAL.
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTIU-TRANSACAO        EQUAL SPACES  OR
               ...
               GFCTIU-NRO-CPF-CNPJ     NOT NUMERIC   OR
               GFCTIU-NRO-FILIAL       NOT NUMERIC   OR
               GFCTIU-CTRL-CPF-CNPJ    NOT NUMERIC   OR
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTIU-NRO-CPF-CNPJ    TO WRK-0110-NRO-CPF-CNPJ.
           MOVE GFCTIU-NRO-FILIAL      TO WRK-0110-NRO-FILIAL.

           CALL 'POOL0110'             USING WRK-0110-CPF-CNPJ
                                             WRK-0110-CONTROLE.

           IF  RETURN-CODE             EQUAL ZEROS
               IF  WRK-0110-CTRL-CPF-CNPJ
                                       NOT EQUAL GFCTIU-CTRL-CPF-CNPJ
                   MOVE 'S'            TO GFCTIV-FIM
                   MOVE 1              TO GFCTIV-ERRO
                   MOVE ZEROS          TO GFCTIV-COD-SQL-ERRO
                   MOVE 0760           TO GFCTIV-COD-MSG-ERRO
                                          GFCTG2-COD-MSG
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTIU-NRO-CPF-CNPJ    TO CCGC-CPF      OF CLIEV004.
           MOVE GFCTIU-NRO-FILIAL      TO CFLIAL-CGC    OF CLIEV004.
