      ...
      *                                                                *
      *    OBJETIVO     :                                              *
      *      LISTA DE CONSULTA DA AUTORIZACAO DE EMISSAO DE EXTRATO    *
...
ST25X6*         ORDER BY   CCNPJ_CPF,
ST25X6*                    CFLIAL_CGC,
ST25X6*                    HINCL_REG_SIST
ST25X6          ORDER BY   CCNPJ_CPF_ST,
ST25X6                     CFLIAL_CGC_ST,
ST25X6                     HINCL_REG_SIST
           END-EXEC.
      ...
      *----------------------------------------------------------------*
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               ...
               MOVE 'GFCT0565'         TO GFCT0M-TRANSACAO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT0565'             TO GFCT0M-PROGRAMA.
...
ST25X6             :GFCTB0L5.CCTRL-CPF-CGC-ST
           ...
           IF  SQLCODE                 EQUAL +100
               ...
               IF  IND-1               EQUAL ZEROS
                   MOVE 1              TO WAGV-ERRO
                   MOVE ZEROS          TO WAGV-COD-SQL-ERRO
                   MOVE 1618           TO WAGV-COD-MSG-ERRO
                   MOVE '1618'         TO GFCTG2-COD-MSG
                   PERFORM 1100-OBTER-DESC-MSG
                   MOVE 'S'            TO WAGV-FIM
                   PERFORM 3000-FINALIZAR
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           IF  SQLCODE              EQUAL ZEROS
               ...
               MOVE HINCL-REG-SIST     OF GFCTB0L5
                                       TO WAGV-HINCL(IND-1)
ST25X6*        MOVE CCNPJ-CPF          OF GFCTB0L5
ST25X6*                                TO WRK-AUX-9-S
ST25X6*        MOVE WRK-AUX-9          TO WAGV-NUMERO(IND-1)
ST25X6*        MOVE CFLIAL-CGC         OF GFCTB0L5
ST25X6*                                TO WRK-AUX-5-S
ST25X6*        MOVE WRK-AUX-5          TO WAGV-FILIAL(IND-1)
ST25X6*        MOVE CCTRL-CPF-CGC      OF GFCTB0L5
ST25X6*                                TO WRK-AUX-2-S
ST25X6*        MOVE WRK-AUX-2          TO WAGV-CONTRL(IND-1)
ST25X6         MOVE CCNPJ-CPF-ST       OF GFCTB0L5
                                       TO WRK-AUX-9-S
               MOVE WRK-AUX-9          TO WAGV-NUMERO(IND-1)
ST25X6         MOVE CFLIAL-CGC-ST      OF GFCTB0L5
                                       TO WRK-AUX-5-S
...
ST25X6         MOVE CCTRL-CPF-CGC-ST   OF GFCTB0L5
               ...
               IF  HEXCL-REG-SIST OF GFCTB0L4  NOT EQUAL  WRK-TIMESTAMP
                   ...
                   MOVE WRK-MES        TO WRK-MES-AUX
                   MOVE WRK-DIA        TO WRK-DIA-AUX
                   MOVE WRK-DATA-AUX   TO WAGV-DT-EXCL(IND-1)
