      ...
      *             DETALHADO, O ARQUIVO DE ENTRADA FOI GERADO         *
      *             PELO JOB DE EXPURGO DA BASE DB2 GFCTB0K6           *
      *             ATRAVEZ DO PGM GFCT1817.                           *
      ...
      *                                                                *
BI0112*----------------------------------------------------------------*
BI0112*    ULTIMA ALTERACAO EM JANEIRO / 2012                          *
BI0112*    - ADEQUACAO DA MENSAGEM OBRIGATORIA LEI N. 12007/2009       *
BI0112*                                                                *
BI1112*----------------------------------------------------------------*
...
BI1112*                                                                *
      ...
      *================================================================*
       FILE-CONTROL.
           ...
           SELECT BXEXTMES ASSIGN      TO UT-S-BXEXTMES
                      FILE STATUS      IS WRK-FS-BXEXTMES.

           SELECT EXTMVALI ASSIGN      TO UT-S-EXTMVALI
                      FILE STATUS      IS WRK-FS-EXTMVALI.
      ...
      *----------------------------------------------------------------*
      *   INPUT: HPU DA TABELA GFCTB0K6 (EXTRATO MENSAL)               *
      ...
      *----------------------------------------------------------------*
       ...
       01  FD-REG-BXEXTMES             PIC  X(093).

      *----------------------------------------------------------------*
      *  OUTPUT: ARQ.NO FORMATO DO LAYOUT DO EXTRATO      (MENSAL)     *
      ...
      *---------------------------------------------------------------*
       ...
       01  WRK-TIPO-PROCESSO           PIC  X(001)         VALUE ' '.
       01  WRK-IND-MES                 PIC S9(003) COMP-3  VALUE 0.
...
BI1112 01  WRK-IND                     PIC S9(003) COMP-3  VALUE 0.
       ...
       01  FILLER.
           05   WRK-MES-2CS            PIC S9(002)         VALUE 0.
           05   WRK-MES-2X  REDEFINES  WRK-MES-2CS.
                10   WRK-MES-2SS       PIC  9(002).
       ...
       01   WRK-CNPJ.
            05   WRK-CCGC              PIC  999.999.999  VALUE ZEROS.
            05   FILLER                PIC  X(001)         VALUE '/'.
            05   WRK-CFLIAL            PIC  9999           VALUE 0.
            05   FILLER                PIC  X(001)         VALUE '-'.
       ...
       01   WRK-CHV-ATU.
            ...
            05   WRK-MES-ATU           PIC  9(002)         VALUE 0.
       ...
       01   WRK-CHV-ANT.
            ...
            05   WRK-MES-ANT           PIC  9(002)         VALUE 0.
      ...
      *---------------------------------------------------------------*
       ...
       01  WRK-TOTAIS.
           ...
           05   WRK-TOT-MES            PIC S9(09)V99 COMP-3 VALUE 0.
           05   WRK-TOT-QREG-MES       PIC S9(05)    COMP-3 VALUE 0.
           ...
           05   WRK-TOT-CLI-MES        PIC  9(11)   COMP-3  VALUE 0.
           05   WRK-TGRAVA-MES         PIC  9(11)   COMP-3  VALUE 0.
           05   WRK-TOT-LIDO-MEN       PIC  9(11)   COMP-3  VALUE 0.

       01  WRK-EDT-TOTAIS              PIC  ZZ.ZZZ.ZZZ.ZZ9
                                       VALUE  ZEROS.
      *---------------------------------------------------------------*
       01  FILLER                      PIC  X(032)         VALUE
           '*  BOOK DO ARQUIVO BXEXTMES    *'.
      *---------------------------------------------------------------*
...
BI1112         07  WRK-LINHA-LEI    PIC  X(080).
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-TABMES-W.
           ...
           05  WRK-TABMES1-R      REDEFINES       WRK-TABMES1-W.
              10  WRK-MESEXT-W    PIC  X(009)     OCCURS  12.
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-FS-BXEXTMES             PIC  X(002)         VALUE SPACES.
       01  WRK-FS-EXTMVALI             PIC  X(002)         VALUE SPACES.
...
BI1112         05  FILLER              PIC X(01)           VALUE SPACES.
      ...
      *----------------------------------------------------------------*
       1000-PROCESSA-MES                 SECTION.
      *----------------------------------------------------------------*

      *----->  PRIMEIRA LEITURA DO ARQUIVO

           MOVE   'M'           TO   WRK-TIPO-PROCESSO.

           PERFORM   7200-LER-BXEXTMES

           MOVE   WRK-AGE-ATU   TO   WRK-AGE-ANT.
           MOVE   WRK-CTA-ATU   TO   WRK-CTA-ANT.
           MOVE   WRK-MES-ATU   TO   WRK-MES-ANT.
           MOVE   WRK-ANO-ATU   TO   WRK-ANO-ANT.
           MOVE   WRK-TIPO-ATU  TO   WRK-TIPO-ANT.

           PERFORM   1050-PROCESSA-AGENCIA
                     UNTIL   WRK-FS-BXEXTMES EQUAL '10'.
      ...
      *----------------------------------------------------------------*
       1050-PROCESSA-AGENCIA             SECTION.
      *----------------------------------------------------------------*

           PERFORM   1100-PROCESSA-AGE-CONTA
             UNTIL   WRK-AGE-ANT  NOT EQUAL  WRK-AGE-ATU
      ...
      *----------------------------------------------------------------*
       1200-EMITE-MES-ANO                SECTION.
      *----------------------------------------------------------------*

           MOVE   ZEROS   TO   WRK-TOT-MES WRK-TOT-QREG-MES.

           IF WRK-TIPO-ATU          NOT EQUAL  4
              PERFORM   5100-CABECALHO-MES-ANO
           END-IF.

           PERFORM   1300-EMITE-TIPO
             UNTIL   WRK-AGE-ANT  NOT EQUAL WRK-AGE-ATU OR
                     WRK-CTA-ANT  NOT EQUAL WRK-CTA-ATU OR
                     WRK-ANO-ANT  NOT EQUAL WRK-ANO-ATU OR
                     WRK-MES-ANT  NOT EQUAL WRK-MES-ATU

           IF  WRK-TOT-QREG-MES    GREATER  ZEROS
               PERFORM  5500-TOTAL-DO-MES
           END-IF.
      ...
      *----------------------------------------------------------------*
       1300-EMITE-TIPO                   SECTION.
      *----------------------------------------------------------------*

           MOVE   ZEROS   TO   WRK-TOT-TIPO-TARIF

      ***   WRK-TIPO-ATU IGUAL A 5 EH PENDENTE

           IF  WRK-TIPO-ATU   NOT EQUAL   5 AND 4
               PERFORM   5200-CABECALHO-TIPO-SERV
           END-IF.

           PERFORM   1400-EMITE-TARIFA
             UNTIL   WRK-AGE-ANT  NOT EQUAL WRK-AGE-ATU  OR
                     WRK-CTA-ANT  NOT EQUAL WRK-CTA-ATU  OR
                     WRK-MES-ANT  NOT EQUAL WRK-MES-ATU  OR
                     WRK-ANO-ANT  NOT EQUAL WRK-ANO-ATU  OR
                     WRK-TIPO-ANT NOT EQUAL WRK-TIPO-ATU

      ***   WRK-TIPO-ANT IGUAL A 5 EH PENDENTE,
      ***   WRK-TIPO-ANT IGUAL A 4 EH ESTORNO,
      ***   NESTE PROGRAMA O ESTORNO NAO SERA CONSIDERADO NO TOTAL
      ***   DO MES E DO ANO
           ...
           ELSE
               ...
               ELSE
                   ADD    1                    TO   WRK-TOT-QREG-MES
                   ADD    WRK-TOT-TIPO-TARIF   TO   WRK-TOT-MES
                                                    WRK-TOT-ANO
               END-IF
           END-IF.
      ...
      *----------------------------------------------------------------*
       1400-EMITE-TARIFA                 SECTION.
      *----------------------------------------------------------------*

           IF  WRK-TIPO-ATU  EQUAL 5
               IF  WRK-MES-ATU  EQUAL  12
                   ADD  WADN-VCONSL-DETRM-TARIF TO WRK-TOT-PEND
               END-IF
           ELSE
               PERFORM  1500-DETALHE-SERVICO
           END-IF.
      ...
      *     PROCESSAMENTO                                              *
      *----------------------------------------------------------------*
       1500-DETALHE-SERVICO            SECTION.
      *----------------------------------------------------------------*

           MOVE  WADN-RSEGDA-LIN        TO  WRK-L04-DESCR-SERV

           IF  WADN-CIDTFD-TARIF  EQUAL  1 OR 2  OR   3
               MOVE  WADN-QCONSL-DETRM-TARIF TO WRK-QTDE-5CS
               MOVE  WRK-QTDE-5SS            TO WRK-L04-QTDE
           ELSE
               MOVE  SPACES                  TO WRK-L04-QTDE-X
           END-IF.

           MOVE WADN-VCONSL-DETRM-TARIF TO  WRK-VALOR-11CS
           MOVE WRK-VALOR-11SS          TO  WRK-L04-VALOR
           ADD  WADN-VCONSL-DETRM-TARIF TO  WRK-TOT-TIPO-TARIF.
      ...
      *--> ACESSAR NOME DO CLIENTE E CNPJ/CPF
           ...
           MOVE     WRK-LINHA01A     TO WRK-LINHA.
           PERFORM  5900-GRAVAR.
      ...
      *----------------------------------------------------------------*
           ...
           IF   WRK-5527-CFLIAL-CGC  NOT EQUAL  ZEROS
      ...
      *----------------------------------------------------------------*
       5100-CABECALHO-MES-ANO          SECTION.
      *----------------------------------------------------------------*
           ...
           MOVE   WRK-MES-ATU                 TO   WRK-IND-MES
           MOVE   WRK-MESEXT-W (WRK-IND-MES)  TO   WRK-L02-MES-LANC
           MOVE   WRK-ANO-ATU                 TO   WRK-L02-ANO-LANC
           MOVE   WRK-LINHA02                 TO   WRK-LINHA.
           PERFORM  5900-GRAVAR.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE   WRK-LINHA-SP        TO   WRK-LINHA.
           PERFORM  5900-GRAVAR.
BI1110     MOVE   WRK-LINHA00         TO   WRK-LINHA.
BI1110     PERFORM  5900-GRAVAR.
...
BI1112     IF   WRK-L02-ANO-LANC    EQUAL   EXGXB2-ANO-EXTRT
...
BI1112     PERFORM 5820-ACESSAR-LEI-PARTE-II.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE   WRK-TOT-MES         TO   WRK-VALOR-11CS
           MOVE   WRK-VALOR-11SS      TO   WRK-L06-TOT-MES
           MOVE   WRK-LINHA06         TO   WRK-LINHA.
           PERFORM  5900-GRAVAR.
...
BI1112*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           IF  RETURN-CODE             NOT  EQUAL   ZEROS
               DISPLAY '*-------------------------------------------*'
               DISPLAY '*   ROTINA DE EXPURGO DA BASE GFCTB0K6      *'
               DISPLAY '*           PROGRAMA  GFCT1825              *'
               DISPLAY '*           ------------------              *'
               DISPLAY '*                                           *'
               DISPLAY '*   ERRO NA CHAMADA DO MODULO EXGX1730 ,    *'
               DISPLAY '* MENSAGENS (LEI 12.007) NAO CADASTRADAS NA *'
               DISPLAY '* BASE EXGXB055 PARA O ANO ' WRK-L02-ANO-LANC
               DISPLAY '*                                           *'
               ...
               MOVE WRK-L02-ANO-LANC        TO WRK-MSG1-ANO
...
BI1112*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT1825'             TO EXGXB1-TRANSACAO.
           ...
           IF  RETURN-CODE             NOT  EQUAL ZEROS
               ...
               DISPLAY '* MENSAGENS (LEI 12.007) NAO CADASTRADAS NA *'
               DISPLAY '* BASE EXGXB045 PARA O ANO ' WRK-L02-ANO-LANC
               DISPLAY '*                                           *'
               DISPLAY '* RC             => ' RETURN-CODE
               ...
               MOVE WRK-L02-ANO-LANC        TO WRK-MSG2-ANO
...
BI1112*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           IF     WRK-TIPO-PROCESSO          EQUAL  'M'
                  WRITE  FD-REG-EXTMVALI     FROM WRK-LINHA
                  PERFORM   9230-TESTAR-FS-EXTMVALI
                  ADD     1                  TO   WRK-TGRAVA-MES
           END-IF.
...
BI1110     MOVE   WRK-LINHA-SP        TO   WRK-LINHA.
      ...
      *----------------------------------------------------------------*
       7200-LER-BXEXTMES               SECTION.
      *----------------------------------------------------------------*

           MOVE WRK-LEITURA            TO WRK-MSG-FS-OPERACAO.

           READ  BXEXTMES  INTO  GFCTWADN-REG

           PERFORM 9210-TESTAR-FS-BXEXTMES

           IF WRK-FS-BXEXTMES  EQUAL  '10'
              MOVE 99999                TO  WRK-AGE-ATU
              MOVE 9999999999999        TO  WRK-CTA-ATU
              MOVE 9999                 TO  WRK-ANO-ATU
              MOVE 99                   TO  WRK-MES-ATU
              MOVE  9                   TO  WRK-TIPO-ATU
           ELSE
              MOVE WADN-CAG-BCRIA       TO  WRK-AGE-5CS
              MOVE WRK-AGE-5SS          TO  WRK-AGE-ATU
              MOVE WADN-CCTA-BCRIA-CLI  TO  WRK-CTA13CS
              MOVE WRK-CTA13SS          TO  WRK-CTA-ATU
              MOVE WADN-DANO-REFT       TO  WRK-ANO-4CS
              MOVE WRK-ANO-4SS          TO  WRK-ANO-ATU
              MOVE WADN-DMES-REFT       TO  WRK-MES-2CS
              MOVE WRK-MES-2SS          TO  WRK-MES-ATU
              MOVE WADN-CIDTFD-TARIF    TO  WRK-TIPO-1CS
              MOVE WRK-TIPO-1SS         TO  WRK-TIPO-ATU
              ADD    1                  TO  WRK-TOT-LIDO-MEN
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '*                                               *'.
           DISPLAY '*-----------------------------------------------*'.
           MOVE     WRK-TOT-LIDO-MEN  TO  WRK-EDT-TOTAIS
           DISPLAY '* TOTAL DE LIDOS BXEXTMES = ' WRK-EDT-TOTAIS
           MOVE     WRK-TGRAVA-MES     TO  WRK-EDT-TOTAIS
           DISPLAY '* TOTAL DE GRAVA EXTMVALI = ' WRK-EDT-TOTAIS
           MOVE     WRK-TOT-CLI-MES   TO  WRK-EDT-TOTAIS
           DISPLAY '* TOT. EXTRATO CLIENTE MES= ' WRK-EDT-TOTAIS
           DISPLAY '*-----------------------------------------------*'.
      ...
      *----------------------------------------------------------------*
       9210-TESTAR-FS-BXEXTMES         SECTION.
      *----------------------------------------------------------------*

           IF WRK-FS-BXEXTMES              NOT EQUAL '00'
              IF  WRK-FS-BXEXTMES          EQUAL '10'  AND
                  WRK-LEITURA              EQUAL WRK-MSG-FS-OPERACAO
                  NEXT  SENTENCE
              ELSE
                  MOVE 'APL'               TO ERR-TIPO-ACESSO
                  MOVE 'BXEXTMES'          TO WRK-MSG-FS-NOME-ARQ
                  MOVE WRK-FS-BXEXTMES     TO WRK-MSG-FS-CODIGO
      ...
      *----------------------------------------------------------------*
       9230-TESTAR-FS-EXTMVALI         SECTION.
      *----------------------------------------------------------------*

           IF WRK-FS-EXTMVALI          NOT EQUAL '00'
              MOVE 'APL'               TO ERR-TIPO-ACESSO
              MOVE 'EXTMVALI'          TO WRK-MSG-FS-NOME-ARQ
              MOVE WRK-FS-EXTMVALI     TO WRK-MSG-FS-CODIGO
              MOVE WRK-MSG-FILE-STATUS TO ERR-TEXTO
              MOVE 4                   TO WRK-RETURN-CODE
              PERFORM 9999-ROTINA-ERRO
           END-IF.
