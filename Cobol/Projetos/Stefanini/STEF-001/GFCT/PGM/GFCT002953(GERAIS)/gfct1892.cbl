...
LIE   *                    DB2PRD.OBJE_CAD_POUPADOR      OBJEB010
      ...
      *    I#MESUM8 - AREA DO MODULO MESU9018.                         *
      ...
      *================================================================*
      *    ULTIMA ALTERACAO: MAR/2007 - VALERIA                        *
      *    NAO CHAMAR O MODULO MESU9018 QUANDO POSTO = ZEROS           *
      *================================================================*
      *================================================================*
...
LIE    77  WRK-ROTINA                  PIC  X(04)          VALUE SPACES.
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-MSG04                   PIC  X(075)         VALUE
           '** ERRO MODULO MESU9018 - INCONSISTENCIA FISICA **'.

       01  WRK-MSG05                   PIC  X(075)         VALUE
           '** ERRO MODULO MESU9018 - INCONSISTENCIA LOGICA **'.

       01  WRK-MSG06                   PIC  X(075)         VALUE
           '** ERRO MODULO MESU9018 - ERRO GENERICO **'.
      ...
      *----------------------------------------------------------------*
       01  FILLER                      PIC  X(050)         VALUE
           '*** AREA PARA COMUNICACAO COM MESU9018 ***'.
      *----------------------------------------------------------------*
...
LIE        IF    WRK-ACHOU0        EQUAL   'S'
                 MOVE NUM-CGCCPF     OF  OBJEB000
                                        TO GFCTVA-CPF-CNPJ
                 MOVE FILIAL-CGCCPF  OF  OBJEB000
                                        TO GFCTVA-FILIAL
                 MOVE CONTR-CGCCPF   OF  OBJEB000
LIE                                     TO GFCTVA-CONTROLE
LIE        END-IF

LIE        IF    WRK-ACHOU10        EQUAL   'S'
                 MOVE POUPADOR-CGC-CPF  OF  OBJEB010
                                        TO GFCTVA-CPF-CNPJ
                 MOVE POUPADOR-FILIAL   OF  OBJEB010
                                        TO GFCTVA-FILIAL
                 MOVE POUPADOR-CONTROLE  OF  OBJEB010
                                        TO GFCTVA-CONTROLE
LIE        END-IF
...
LIE        IF    WRK-ACHOU4         EQUAL   'S'
                 ...
                 MOVE CCTRL-CPF-CGC   OF CLIEV004
                                        TO WRK-CCTRL-CPF
                 MOVE WRK-CCTRL-CPF-AUX TO GFCTVA-CONTROLE
           ELSE
LIE          IF  WRK-ACHOU4         EQUAL   'N'
                 MOVE  ZEROS            TO   GFCTVA-CPF-CNPJ
                                             GFCTVA-FILIAL
                                             GFCTVA-CONTROLE
LIE          END-IF
LIE        END-IF
...
LIE        ADD 1                       TO ACU-LIDOS-CLIEV004.
      ...
      ******************************************************************
      *    CHAMA MODULO MESU9018 PARA VER SE EH POSTO OU BCO POSTAL.   *
      ******************************************************************
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           IF RETURN-CODE             NOT EQUAL ZEROS
              IF RETURN-CODE         EQUAL 4
                 DISPLAY '************** GFCT1892 **************'
                 DISPLAY '*  ERRO NO ACESSO AO MODULO MESU9018  '
