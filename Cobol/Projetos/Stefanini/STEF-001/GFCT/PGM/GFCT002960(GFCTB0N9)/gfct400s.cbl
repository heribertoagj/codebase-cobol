      ...
      *    ANALISTA....: FABRICA SONDA PROCWORK                        *
      *    DATA........: 06/2013                                       *
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-AUXILIARES.
           ...
           05  WRK-PROGRAMA            PIC X(008)      VALUE 'GFCT400S'.
...
ST25X6                 ,CCTRL_CPF_CNPJ_ST
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTW10C-E-CFUNC-BDSCO  NOT NUMERIC
           ...
           IF  (GFCTW10C-E-CAG-BCRIA    NOT NUMERIC OR
                GFCTW10C-E-CAG-BCRIA    EQUAL ZEROS)
               MOVE 08                 TO GFCTW100-COD-RETORNO
                                       OF DFHCOMMAREA
               MOVE '0001'             TO GFCTW100-COD-ERRO
                                       OF DFHCOMMAREA
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTW10C-E-CFUNC-BDSCO
                                       TO CFUNC-BDSCO OF GFCTB0N9.
           MOVE GFCTW10C-E-CAG-BCRIA
                                       TO CAG-BCRIA   OF GFCTB0N9.

           EVALUATE TRUE
               WHEN GFCTW10C-P-INICIAL
               WHEN GFCTW10C-P-PRIMEIRA
                   MOVE 1              TO WRK-NUMBER-ROW

               WHEN GFCTW10C-P-SEGUINTE
                   MOVE GFCTW10C-F-NUMBER-ROW
                                       TO WRK-NUMBER-ROW
                   ADD 1               TO WRK-NUMBER-ROW

               WHEN GFCTW10C-P-ANTERIOR
                   MOVE GFCTW10C-I-NUMBER-ROW
                                       TO WRK-NUMBER-ROW
                   SUBTRACT 1          FROM WRK-NUMBER-ROW

               WHEN GFCTW10C-P-ULTIMA
      ...
      *--> FORMATAR BLOCO-RETORNO COM SUCESSO
           MOVE WRK-IND-I              TO GFCTW10C-S-QTD-LISTA-OCORR

           IF GFCTW10C-S-QTD-LISTA-OCORR GREATER ZEROS
      ...
      *--------> CONSULTA EFETUADA COM SUCESSO
           ...
           ELSE
               IF  GFCTW10C-P-SEGUINTE OR
                   GFCTW10C-P-ANTERIOR OR
                   GFCTW10C-P-ULTIMA
                   MOVE ZEROS          TO GFCTW100-COD-RETORNO
               ELSE
                   MOVE 08             TO GFCTW100-COD-RETORNO
...
ST25X6              ,:GFCTB0N9.CCTRL-CPF-CNPJ-ST
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTW10C-P-INICIAL OR
               GFCTW10C-P-PRIMEIRA OR
               GFCTW10C-P-SEGUINTE
               EXEC SQL
...
ST25X6              ,:GFCTB0N9.CCTRL-CPF-CNPJ-ST
      ...
      *----------------------------------------------------------------*
           ...
           MOVE CFUNC-BDSCO            OF GFCTB0N9
                                       TO GFCTW10C-S-CFUNC-BDSCO
                                          (WRK-IND-I)
           MOVE CSERVC-TARIF           OF GFCTB0N9
                                       TO GFCTW10C-S-CSERVC-TARIF
                                          (WRK-IND-I)
           MOVE CINDCD-VNCLO-FL        OF GFCTB0N9
                                       TO GFCTW10C-S-CINDCD-VINCLO-FL
                                          (WRK-IND-I).
           IF VRENTB OF GFCTB0N9       IS NEGATIVE
              MOVE '-'                 TO GFCTW10C-S-SINAL-VRENTB
                                          (WRK-IND-I)
           ELSE
              MOVE '+'                 TO GFCTW10C-S-SINAL-VRENTB
                                          (WRK-IND-I)
           ...
           MOVE VRENTB                 OF GFCTB0N9
                                       TO GFCTW10C-S-VRENTB
                                          (WRK-IND-I)

           IF VINVES OF GFCTB0N9       IS NEGATIVE
              MOVE '-'                 TO GFCTW10C-S-SINAL-VINVES
                                          (WRK-IND-I)
           ELSE
              MOVE '+'                 TO GFCTW10C-S-SINAL-VINVES
                                          (WRK-IND-I)
...
ST25X6                                     (WRK-IND-I)
           ...
           MOVE NLIN-TFONI             OF GFCTB0N9
                                       TO GFCTW10C-S-NLIN-TFONI
                                          (WRK-IND-I)
           MOVE CID-RMAL               OF GFCTB0N9
                                       TO GFCTW10C-S-CID-RMAL-BIP-PAGER
                                          (WRK-IND-I)
           MOVE CINDCD-REST-CNTAT      OF GFCTB0N9
                                       TO GFCTW10C-S-CINDCD-REST-CNTAT
                                          (WRK-IND-I)
           MOVE DABERT-CTA             OF GFCTB0N9
                                       TO GFCTW10C-S-DABERT-CTA
                                          (WRK-IND-I).

           IF  WRK-IND-I                   EQUAL 1
               IF  GFCTW10C-P-PRIMEIRA OR
                   GFCTW10C-P-INICIAL  OR
                   GFCTW10C-P-SEGUINTE
                   MOVE WRK-NUMBER-ROW TO GFCTW10C-I-NUMBER-ROW
               ELSE
                   MOVE WRK-NUMBER-ROW TO GFCTW10C-F-NUMBER-ROW
               END-IF
           ELSE
               IF  GFCTW10C-P-PRIMEIRA OR
                   GFCTW10C-P-INICIAL  OR
