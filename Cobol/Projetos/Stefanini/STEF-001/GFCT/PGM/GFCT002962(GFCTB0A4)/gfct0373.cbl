      ...
      *================================================================*
ST2506*================================================================*
ST2506*                       A L T E R A C A O                        *
ST2506*================================================================*
ST2506*    AUTHOR: STEFANINI                                           *
ST2506*    DATA..: 23/07/2025                                          *
ST2506*    DESCRIACAO: AJUSTE CNPJ ALFANUMERICO                        *
ST2506*================================================================*
...
ST2506*    MOVE SPACES                 TO WRK-CAD-CONTROLE.
ST25X6*    MOVE GFCTFR-CGC-CPF         TO WRK-CPF.
ST25X6*    MOVE GFCTFR-FILIAL          TO WRK-FILIAL.
ST25X6
           MOVE GFCTFR-CGC-CPF         TO WRK-CAD-NUMERO.
           MOVE GFCTFR-FILIAL          TO WRK-CAD-FILIAL.
           MOVE GFCTFR-CONTROLE        TO WRK-CAD-CONTROLE.
           MOVE WRK-CAD-CONTROLE       TO WRK-9-02.
           MOVE WRK-9-02               TO WRK-CAD-CONTROLE.

ST25X6*    CALL 'POOL0110'             USING WRK-CPF-CGC
ST25X6*                                      WRK-CONTROLE.
ST25X6     CALL WRK-BRAD2000           USING WRK-AREA-BRAD2000.
...
ST25X6*    IF GFCTFR-CONTROLE          NOT EQUAL WRK-CONTROLE
ST25X6     IF GFCTFR-CONTROLE          NOT EQUAL WRK-CAD-CONTROLE
              MOVE 1                   TO GFCTFS-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTFR-CGC-CPF         TO GFCTIU-COD-CPF-CNPJ
           MOVE GFCTFR-FILIAL          TO GFCTIU-COD-FILIAL
...
ST25X6*    MOVE GFCTFR-CGC-CPF         TO CCGC-CPF          OF GFCTB0A4.
ST25X6*    MOVE GFCTFR-FILIAL          TO CFLIAL-CGC        OF GFCTB0A4.
ST25X6*    MOVE GFCTFR-CONTROLE        TO CCTRL-CPF-CGC     OF GFCTB0A4.
ST25X6     MOVE GFCTFR-CGC-CPF         TO CCGC-CPF-ST       OF GFCTB0A4.
ST25X6     MOVE GFCTFR-FILIAL          TO CFLIAL-CGC-ST     OF GFCTB0A4.
ST25X6     MOVE GFCTFR-CONTROLE        TO CCTRL-CPF-CGC-ST  OF GFCTB0A4.
...
ST25X6*          AND   CCGC_CPF           = :GFCTB0A4.CCGC-CPF
ST25X6*          AND   CFLIAL_CGC         = :GFCTB0A4.CFLIAL-CGC
ST25X6*          AND   CCTRL_CPF_CGC      = :GFCTB0A4.CCTRL-CPF-CGC
