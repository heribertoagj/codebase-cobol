...
ST25X6*    MOVE CCGC-CPF OF GFCTB0A4   TO GFCTGK-CGC-CPF.
ST25X6*    MOVE CFLIAL-CGC OF GFCTB0A4 TO GFCTGK-FILIAL.
ST25X6*    MOVE CCTRL-CPF-CGC OF GFCTB0A4
ST25X6*                                TO GFCTGK-CONTROLE.
ST25X6     MOVE CCGC-CPF-ST OF GFCTB0A4 TO GFCTGK-CGC-CPF.
ST25X6     MOVE CFLIAL-CGC-ST OF GFCTB0A4 TO GFCTGK-FILIAL.
