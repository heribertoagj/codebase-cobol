...
ST25X6          AND  B.CCTRL_CPF_CGC_ST   = :GFCTB0L5.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAGO-NUMERO            TO WRK-NUMERO-0110.
           MOVE WAGO-FILIAL            TO WRK-FILIAL-0110.
      ...
      *----------------------------------------------------------------*
           ...
           ST25X6* MOVE WAGO-FILIAL            TO GFCTIU-NRO-FILIAL
           ST25X6* MOVE WAGO-CONTRL            TO GFCTIU-CTRL-CPF-CNPJ
           
           ST25X6  MOVE WAGO-NUMERO            TO GFCTIU-COD-CPF-CNPJ
           ST25X6  MOVE WAGO-FILIAL            TO GFCTIU-COD-FILIAL
           ST25X6  MOVE WAGO-CONTRL            TO GFCTIU-CTRL-CPF-CNPJ
...
ST25X6* MOVE WAGO-NUMERO            TO CCNPJ-CPF          OF GFCTB0L5
ST25X6* MOVE WAGO-FILIAL            TO CFLIAL-CGC         OF GFCTB0L5
ST25X6* MOVE WAGO-CONTRL            TO CCTRL-CPF-CGC      OF GFCTB0L5
