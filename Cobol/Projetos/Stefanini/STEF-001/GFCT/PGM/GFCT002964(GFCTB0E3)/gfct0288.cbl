...
ST25X6 77  WRK-CAD-CONTROLE            PIC 9(02)           VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE GFCTP6-CAGPTO
               ...
               WHEN 4
                  IF  GFCTP6-CGC-CPF       NOT NUMERIC OR
                      GFCTP6-CGC-CPF       EQUAL ZEROS
                      MOVE 1               TO GFCTP7-ERRO
...
ST25X6*    MOVE GFCTP6-CGC-CPF         TO WRK-NUMERO-0110.
ST25X6*    MOVE GFCTP6-FILIAL          TO WRK-FILIAL-0110.
ST25X6*
ST25X6*    CALL 'POOL0110'             USING WRK-CGC-CPF-0110
ST25X6*                                      WRK-CONTROLE-0110.
ST25X6     MOVE GFCTP6-CGC-CPF         TO WRK-CAD-NUMERO.
ST25X6     MOVE GFCTP6-FILIAL          TO WRK-CAD-FILIAL.
ST25X6     MOVE GFCTP6-CONTROLE        TO WRK-CAD-CONTROLE.
ST25X6
...
ST25X6*    IF  GFCTP6-CONTROLE         NOT EQUAL WRK-CONTROLE-0110
ST25X6     IF  GFCTP6-CONTROLE         NOT EQUAL WRK-CAD-CONTROLE
               MOVE 1                  TO GFCTP7-ERRO
...
ST25X6*    MOVE GFCTP6-CGC-CPF         TO GFCTIU-NRO-CPF-CNPJ.
ST25X6*    MOVE GFCTP6-FILIAL          TO GFCTIU-NRO-FILIAL.
ST25X6     MOVE GFCTP6-CGC-CPF         TO GFCTIU-COD-CPF-CNPJ.
ST25X6     MOVE GFCTP6-FILIAL          TO GFCTIU-COD-FILIAL.
...
ST25X6*    MOVE GFCTP6-CGC-CPF         TO CCGC-CPF          OF GFCTB0E3.
ST25X6     MOVE GFCTP6-CGC-CPF         TO CCGC-CPF-ST       OF GFCTB0E3.
ST25X6*    MOVE GFCTP6-FILIAL          TO CFLIAL-CGC        OF GFCTB0E3.
ST25X6     MOVE GFCTP6-FILIAL          TO CFLIAL-CGC-ST     OF GFCTB0E3.
ST25X6*    MOVE GFCTP6-CONTROLE        TO CCTRL-CPF-CGC     OF GFCTB0E3.
ST25X6     MOVE GFCTP6-CONTROLE        TO CCTRL-CPF-CGC-ST  OF GFCTB0E3.
...
ST25X6*            CFLIAL_CGC         = :GFCTB0E3.CFLIAL-CGC         AND
ST25X6*            CCTRL_CPF_CGC      = :GFCTB0E3.CCTRL-CPF-CGC
ST25X6             CCGC_CPF_ST        = :GFCTB0E3.CCGC-CPF-ST        AND
ST25X6             CFLIAL_CGC_ST      = :GFCTB0E3.CFLIAL-CGC-ST      AND
ST25X6             CCTRL_CPF_CGC_ST   = :GFCTB0E3.CCTRL-CPF-CGC-ST
           END-EXEC.
