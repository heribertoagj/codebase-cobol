...
ST25X6*    MOVE GFCTVA-CPF-CNPJ        TO CCGC-CPF         OF GFCTB0E3.
ST25X6     MOVE GFCTVA-CPF-CNPJ        TO CCGC-CPF-ST      OF GFCTB0E3.
ST25X6*    MOVE GFCTVA-FILIAL          TO CFLIAL-CGC       OF GFCTB0E3.
ST25X6     MOVE GFCTVA-FILIAL          TO CFLIAL-CGC-ST    OF GFCTB0E3.
           MOVE GFCTVA-CONTROLE        TO WRK-CONTROLE-AUX.
ST25X6*    MOVE WRK-CONTROLE-AUX-REDEF TO CCTRL-CPF-CGC    OF GFCTB0E3.
ST25X6     MOVE WRK-CONTROLE-AUX-R     TO CCTRL-CPF-CGC-ST OF GFCTB0E3.
...
ST25X6*            T2.CCGC_CPF         = :GFCTB0E3.CCGC-CPF        AND
ST25X6*            T2.CFLIAL_CGC       = :GFCTB0E3.CFLIAL-CGC      AND
ST25X6*            T2.CCTRL_CPF_CGC    = :GFCTB0E3.CCTRL-CPF-CGC   AND
ST25X6             T2.CCGC_CPF_ST      = :GFCTB0E3.CCGC-CPF-ST     AND
ST25X6             T2.CFLIAL_CGC_ST    = :GFCTB0E3.CFLIAL-CGC-ST   AND
ST25X6             T2.CCTRL_CPF_CGC_ST = :GFCTB0E3.CCTRL-CPF-CGC-ST AND
