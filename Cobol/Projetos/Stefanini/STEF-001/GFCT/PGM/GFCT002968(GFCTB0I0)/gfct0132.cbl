...
BI0810*                                                                *
      ...
      *---------------------------------------------------------------*
       ...
       77  WRK-SEQUENCIA               PIC  9(009) COMP-3  VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-CGC-CPF-0110.
           05  WRK-CPF-0110            PIC  9(009)  COMP-3 VALUE ZEROS.
           05  WRK-FILIAL-0110         PIC  9(005)  COMP-3 VALUE ZEROS.
...
BI0810        (GFCTLH-CPSSOA-TARIFA NOT EQUAL '1' AND '2' AND '3') OR
      ...
      *----------------------------------------------------------------*
           ...
           EVALUATE GFCTLH-CAGPTO
               WHEN 4
                   IF  GFCTLH-CGC-CPF          NOT NUMERIC     OR
                       GFCTLH-CGC-CPF          EQUAL ZEROS
                       MOVE 1                  TO GFCTLI-ERRO
...
BI0810         OR  A.CPSSOA_SERVC_TARIF = '3')
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTLH-CGC-CPF         TO  WRK-CPF-0110.
           MOVE GFCTLH-FILIAL          TO  WRK-FILIAL-0110.

ST25X6*    CALL  'POOL0110'            USING WRK-CGC-CPF-0110
ST25X6     CALL  'BRAD2000'            USING WRK-CGC-CPF-0110
                                             WRK-CONTROLE-0110.
           ...
           IF  GFCTLH-CONTROLE         NOT EQUAL WRK-CONTROLE-0110
               MOVE 1                  TO GFCTLI-ERRO
               MOVE ZEROS              TO GFCTLI-COD-SQL-ERRO
...
ST25X6*    MOVE GFCTLH-CGC-CPF         TO GFCTIU-NRO-CPF-CNPJ.
ST25X6*    MOVE GFCTLH-FILIAL          TO GFCTIU-NRO-FILIAL.
ST25X6     MOVE GFCTLH-CGC-CPF         TO GFCTIU-COD-CPF-CNPJ.
ST25X6     MOVE GFCTLH-FILIAL          TO GFCTIU-COD-FILIAL.
...
ST25X6*    MOVE GFCTLH-CGC-CPF         TO  CCGC-CPF OF GFCTB0H9.
ST25X6     MOVE GFCTLH-CGC-CPF         TO  CCGC-CPF-ST OF GFCTB0H9.
BI0810     MOVE GFCTLH-CPSSOA-TARIFA   TO  CPSSOA-SERVC-TARIF
BI0810                                     OF GFCTB0C6.
...
BI0810        AND (A.CPSSOA_SERVC_TARIF = :GFCTB0C6.CPSSOA-SERVC-TARIF
BI0810         OR  A.CPSSOA_SERVC_TARIF = '3')
ST25X6*       AND  B.CCGC_CPF           = :GFCTB0H9.CCGC-CPF
ST25X6       AND  B.CCGC_CPF_ST        = :GFCTB0H9.CCGC-CPF-ST
           END-EXEC.
...
ST25X6*    MOVE GFCTLH-CGC-CPF           TO CCGC-CPF      OF GFCTB0H9.
ST25X6     MOVE GFCTLH-CGC-CPF           TO CCGC-CPF-ST   OF GFCTB0H9.
ST25X6*    MOVE GFCTLH-FILIAL            TO CFLIAL-CGC    OF GFCTB0H9.
ST25X6     MOVE GFCTLH-FILIAL            TO CFLIAL-CGC-ST OF GFCTB0H9.
ST25X6*    MOVE GFCTLH-CONTROLE          TO CCTRL-CPF-CGC OF GFCTB0H9.
ST25X6     MOVE GFCTLH-CONTROLE          TO CCTRL-CPF-CGC-ST OF GFCTB0H9.
...
ST25X6             CFLIAL_CGC_ST
             INTO
                   ...
                   :GFCTB0H9.CFLIAL-CGC,
ST25X6             :GFCTB0H9.CCGC-CPF-ST,
ST25X6             :GFCTB0H9.CCTRL-CPF-CGC-ST,
ST25X6             :GFCTB0H9.CFLIAL-CGC-ST
             FROM  DB2PRD.TADSAO_GRP_CLI
             WHERE CAGPTO_CTA         = :GFCTB0H9.CAGPTO-CTA
              AND  DINIC_ADSAO_COMP  <= :GFCTB0H9.DINIC-ADSAO-COMP
ST25X6*       AND  CCGC_CPF           = :GFCTB0H9.CCGC-CPF
ST25X6*       AND  CFLIAL_CGC         = :GFCTB0H9.CFLIAL-CGC
ST25X6*       AND  CCTRL_CPF_CGC      = :GFCTB0H9.CCTRL-CPF-CGC
ST25X6       AND  CCGC_CPF_ST        = :GFCTB0H9.CCGC-CPF-ST
ST25X6       AND  CFLIAL_CGC_ST      = :GFCTB0H9.CFLIAL-CGC-ST
ST25X6       AND  CCTRL_CPF_CGC_ST   = :GFCTB0H9.CCTRL-CPF-CGC-ST
           END-EXEC.
