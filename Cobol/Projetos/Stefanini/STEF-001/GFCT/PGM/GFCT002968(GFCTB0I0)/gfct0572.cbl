      ...
      *----------------------------------------------------------------*
      *    BOOK'S......:                                               *
      *    GFCTWAI2 - ENTRADA - MODULO CORPORATIVO GFCT0572            *
      *    GFCTWAI3 - SAIDA   - MODULO CORPORATIVO GFCT0572            *
      ...
      *================================================================*
ABR10 *================================================================*
ABR10 *      S O N D A  P R O C W O R K  -  C O N S U L T O R I A      *
ABR10 *----------------------------------------------------------------*
ABR10 *    PROGRAMADOR.:   FABRICA SOFTWARE            - PROCWORK      *
ABR10 *    ANALISTA....:   MARCUS VINICIUS             - PROCWORK      *
ABR10 *    DATA........:   ABR/2010                                    *
ABR10 *----------------------------------------------------------------*
ABR10 *    OBJETIVO....:   BLOQUEAR ENTRADA CESTA CELULAR.             *
ABR10 *================================================================*
BI0511*----------------------------------------------------------------*
...
BI0412 01  WRK-CINDCD-ADSAO-AMBAS      PIC  X(001)         VALUE 'A'.
      ...
      *----------------------------------------------------------------*
           ...
           ELSE
BI0816         MOVE 2                  TO WRK-TIPO-CONTA-CLIENTE
BI0816         MOVE CID-CLI            OF CLIEV007
BI0816                                 TO CID-CLI          OF CLIEV004
BI0816         PERFORM 1220-ACESSAR-CLIEV004
BI0816     END-IF.
...
ABR10                      MOVE '1688'     TO GFCTG2-COD-MSG
ABR10                      MOVE 1688       TO GFCTWAI3-COD-MSG-RETORNO
ABR10                      PERFORM 1500-OBTER-DESC-MSG
ABR10                      MOVE 1          TO GFCTWAI3-COD-RETORNO
ABR10                                      WRK-COD-RETORNO
ABR10                      MOVE GFCTG3-DESC-MSG
ABR10                                      TO GFCTWAI3-COD-MSG-GFCT
ABR10                      MOVE 12         TO RETURN-CODE
ABR10                      MOVE 1688       TO WRK-COD-MSG
ABR10                      PERFORM 3300-INSERIR-GFCTB0L9
ABR10                      MOVE WRK-TIMESTAMP
ABR10                                      TO GFCTWAI3-LOG-TIMESTAMP
ABR10                      MOVE GFCTWAI2-TRANSACAO(1:8)
ABR10                                      TO GFCTWAI3-LOG-TRANSACAO
ABR10                      MOVE GFCTWAI2-FUNCAO
ABR10                                      TO GFCTWAI3-LOG-FUNCAO
...
BI0511*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT0572'                 TO WRK-5527-CHAMADOR.
...
BI0412              CINDCD_ADSAO_INDVD  = :WRK-CINDCD-ADSAO-AMBAS)
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 0572                   TO CFUNC-MANUT-INCL OF GFCTB009.

           IF GFCTWAI2-SEGMENTO-CLIE   EQUAL 14 OR 114
              MOVE 0578                TO CFUNC-MANUT-INCL
                                       OF GFCTB009
           END-IF.
      ...
      * ESTAMOS MOVENDO FIXO 0572 NA FUNCAO POR HAVER APENAS UMA VERSAO*
      ******************************************************************
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE '0572'               TO  CFNCAO-SOLTC-CORSP OF GFCTB0L9.
