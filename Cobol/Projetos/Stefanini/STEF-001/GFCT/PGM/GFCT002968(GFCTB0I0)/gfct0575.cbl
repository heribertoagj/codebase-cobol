      ...
      *
VI0816*--- DADOS ENVIADOS AO MODULO GFCT6047 INCONSISTENTES
      *
...
ST25X6          AND  CCTRL_CPF_CGC_ST   = :GFCTB0I0.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6047'                 TO WRK-5527-CHAMADOR.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 000000575              TO CFUNC-MANUT-INCL  OF GFCTB009.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6047'             TO GFCTG2-TRANSACAO
                                          GFCTG2-FUNCAO.
