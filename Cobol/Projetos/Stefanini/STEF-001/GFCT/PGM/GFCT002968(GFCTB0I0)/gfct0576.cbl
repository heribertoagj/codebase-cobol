      ...
      *----------------------------------------------------------------*
      *    BOOK'S......:                                               *
      *    GFCTWAI2 - ENTRADA - MODULO CORPORATIVO GFCT0576            *
      *    GFCTWAI3 - SAIDA   - MODULO CORPORATIVO GFCT0576            *
...
BI0511*                                                                *
      ...
      *----------------------------------------------------------------*
       ...
       01  FILLER            REDEFINES WRK-NUM-CEL.
           ...
           05 WRK-NUM-CEL-9            PIC  9(09).
           05 FILLER REDEFINES WRK-NUM-CEL-9.
              10 WRK-NUM-CEL-9-1       PIC  9(01).
              10 WRK-NUM-CEL-9-8       PIC  9(08).
       01  FILLER            REDEFINES WRK-NUM-CEL.
...
______*COPY_'I#BRAD7C'.
      ...
      *================================================================*
       PROCEDURE                       DIVISION USING WAI2B-ENTRADA
                                                      GFCTWAI3-SAIDA
                                                      GFCT0M-AREA-ERROS.
      *================================================================*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-ZZ            TO GFCTWAI3-ZZ.
           MOVE WAI2B-TRANSACAO     TO GFCTWAI3-TRANSACAO.
           MOVE WAI2B-FUNCAO        TO GFCTWAI3-FUNCAO.
      ...
      *----------------------------------------------------------------*
           ...
           IF (WAI2B-AGENCIA           NOT NUMERIC)                OR
              (WAI2B-AGENCIA           EQUAL ZEROS)                OR
              (WAI2B-CONTA             NOT NUMERIC)                OR
              (WAI2B-CONTA             EQUAL ZEROS)                OR
              (WAI2B-PAB               NOT NUMERIC)                OR
              (WAI2B-PACOTE            NOT NUMERIC)                OR
              (WAI2B-SEGMENTO-CLIE     NOT NUMERIC)                OR
              (WAI2B-DT-ABERTURA-CONTA NOT NUMERIC)                OR
              (WAI2B-VERSAO            NOT NUMERIC)                OR
              (WAI2B-VERSAO            NOT =  003 )                OR
              (WAI2B-DDD               NOT NUMERIC)                OR
              (WAI2B-DDD-N             EQUAL ZEROS)                OR
              (WAI2B-NUMERO            NOT NUMERIC)                OR
              (WAI2B-NUMERO-N          EQUAL ZEROS)                OR
              (WAI2B-OPERADORA         NOT NUMERIC)                OR
              (WAI2B-OPERADORA-N       EQUAL ZEROS)
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA       TO LKW-CJUNC-DEPC.
           MOVE WAI2B-CONTA         TO LKW-CTA-CORR.
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               ...
               MOVE WAI2B-TRANSACAO(1:8) TO GFCTWAI3-LOG-TRANSACAO
               MOVE WAI2B-FUNCAO    TO GFCTWAI3-LOG-FUNCAO
               PERFORM 4000-FINALIZAR
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA  TO CJUNC-DEPDC      OF CLIEV007.
           MOVE WAI2B-CONTA    TO CCTA-CLI         OF CLIEV007.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA  TO CJUNC-DEPDC      OF CLIEV008.
           MOVE WAI2B-CONTA    TO CCTA-CLI         OF CLIEV008.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-NUMERO-N         TO WRK-NUM-CEL-9
           ...
           IF WRK-DT-PROC-A1 LESS 20120729
              MOVE 0         TO WRK-NUM-CEL-9-1
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-PACOTE TO CSERVC-TARIF       OF GFCTB0C6.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-TRANSACAO     TO GFCTG2-TRANSACAO.
           MOVE WAI2B-FUNCAO        TO GFCTG2-FUNCAO.
...
BI0511         MOVE WAI2B-TRANSACAO(1:8) TO GFCTWAI3-LOG-TRANSACAO
BI0511         MOVE WAI2B-FUNCAO    TO GFCTWAI3-LOG-FUNCAO
...
BI0511*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           ELSE
              ...
              ELSE
               ...
               MOVE 1925               TO GFCTWAI3-COD-MSG-RETORNO
               PERFORM 1500-OBTER-DESC-MSG
               MOVE 1                  TO GFCTWAI3-COD-RETORNO
                                          WRK-COD-RETORNO
               MOVE GFCTG3-DESC-MSG    TO GFCTWAI3-COD-MSG-GFCT
               MOVE 12                 TO RETURN-CODE
               MOVE 1925               TO WRK-COD-MSG
               PERFORM 3300-INSERIR-GFCTB0L9
               MOVE WRK-TIMESTAMP      TO GFCTWAI3-LOG-TIMESTAMP
               MOVE WAI2B-TRANSACAO(1:8) TO GFCTWAI3-LOG-TRANSACAO
               MOVE WAI2B-FUNCAO    TO GFCTWAI3-LOG-FUNCAO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT0576'                 TO WRK-5527-CHAMADOR.
           MOVE WAI2B-AGENCIA           TO WRK-5527-AGENCIA-CLIENTE
           MOVE WAI2B-CONTA             TO WRK-5527-CONTA-CLIENTE.
...
ST25X6             CCTRL_CPF_CGC_ST   = :GFCTB0I0.CCTRL-CPF-CGC-ST  AND
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA  TO GFCTJM-CJUNC-DEPDC.
           MOVE WAI2B-CONTA    TO GFCTJM-CCTA-CLI.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA       TO CDEPDC            OF GFCTB0C7.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA       TO CDEPDC            OF GFCTB0D0.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA       TO CDEPDC            OF GFCTB0D1.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA       TO GFCTRK-CJUNC-DEPDC.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-PACOTE      TO WRK-TAR-CEL-5.
           MOVE WRK-TAR-CEL          TO CSERVC-TARIF     OF GFCTB0N7.
           MOVE WAI2B-OPERADORA-N TO WRK-OPE-CEL-9.
           MOVE WRK-OPE-CEL          TO COPER-FONE-MOVEL OF GFCTB0N7.
           MOVE WAI2B-DDD-N       TO WRK-DDD-CEL-3.
           ...
           IF  SQLCODE                 EQUAL +100
            ...
            IF (WRK-NUM-CEL-9-1     EQUAL ZEROS     AND
                QMAX-DIG-MOVEL OF GFCTB0N7 = 8) OR
               (WRK-NUM-CEL-9-1 NOT EQUAL ZEROS     AND
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-PACOTE   TO CTARIF-PCOTE     OF GFCTB029.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA  TO CJUNC-DEPDC      OF GFCTB009.
           MOVE WAI2B-CONTA    TO CCTA-CLI         OF GFCTB009.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA       TO CJUNC-DEPDC      OF GFCTB009.
           MOVE WAI2B-CONTA         TO CCTA-CLI         OF GFCTB009.
           MOVE WAI2B-PACOTE        TO CSERVC-TARIF     OF GFCTB009.
           ...
           IF SQLCODE EQUAL ZEROS
               ...
               MOVE WAI2B-DT-ABERTURA-CONTA(3:2) TO WRK-MES-ABERT
               MOVE WAI2B-DT-ABERTURA-CONTA(5:4) TO WRK-ANO-ABERT
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-CONTA         TO CCTA-CLI         OF GFCTB0M2.
           MOVE WAI2B-PACOTE
           ...
           MOVE WAI2B-OPERADORA-N   TO COPER-FONE-MOVEL OF GFCTB0M2.
           MOVE WAI2B-DDD-N         TO CDDD-FONE-MOVEL  OF GFCTB0M2.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-AGENCIA     TO  CJUNC-DEPDC        OF GFCTB0L9.
           MOVE WAI2B-CONTA       TO  CCTA-BCRIA-CLI     OF GFCTB0L9.
           MOVE WAI2B-PACOTE      TO  CSERVC-TARIF       OF GFCTB0L9.
           ...
           MOVE WAI2B-VERSAO            TO  WRK-VERSAO
           MOVE WAI2B-PAB               TO  WRK-PAB
           MOVE WAI2B-SEGMENTO-CLIE     TO  WRK-SEGMENTO
           MOVE WAI2B-DT-ABERTURA-CONTA TO  WRK-DT-CONTA
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAI2B-DDD-N            TO WAN7-CD-DDD.
