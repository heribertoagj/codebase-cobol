...
070528*        H - GRAVA SOMENTE HISTORICO
      ...
      *        99 - ERRO DB2
           ...
           03  WRK-5527-DADOS-RETORNO.
               05  WRK-5527-CCGC-CPF       PIC  9(009)     VALUE ZEROS.
               05  WRK-5527-CFLIAL-CGC     PIC  9(004)     VALUE ZEROS.
      ...
      *----------------------------------------------------------------*
      *  AREA PADRONIZADA ST PARA CPF/CNPJ/Filial (preserva zeros)    *
      *  - Numero e Filial como alfanumericos; Controle permanece 9   *
      *----------------------------------------------------------------*
       01  WRK-COBR-CGC-CPF-ST.
           05  WRK-COBR-CGC-CPF-MUNERO-ST  PIC  X(09)      VALUE SPACES.
           05  WRK-COBR-CGC-CPF-FILIAL-ST  PIC  X(06)      VALUE SPACES.
           05  WRK-COBR-CGC-CPF-CONTROLE   PIC  9(02)      VALUE ZEROS.
...
PERJS          TO    WRK-CCTA-CTLZA-DEB
           ...
           IF  SQLCODE  EQUAL  ZEROS
               ...
               MOVE NUM-CGCCPF           TO WRK-5527-CCGC-CPF
                                            COBR-CGC-CPF-MUNERO
                                         OF ARQCOBR
               MOVE FILIAL-CGCCPF        TO WRK-5527-CFLIAL-CGC
                                            COBR-CGC-CPF-FILIAL
                                         OF ARQCOBR
               MOVE CONTR-CGCCPF         TO WRK-5527-CCTRL-CPF-CGC
                                            COBR-CGC-CPF-CONTROLE
                                         OF ARQCOBR
               MOVE RAZAO                TO WRK-RAZAO
