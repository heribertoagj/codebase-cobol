...
231109*********END-IF
      ...
      *----------------------------------------------------------------*
           ...
           ELSE
               ...
               IF WRK-DTINIC-INV LESS        WRK-DTINIC-TAB-INV
                   MOVE FD-ENTRADA           TO FD-REJEITADO
                   MOVE WRK-MSG17            TO FD-MENSAGEM-RJ
                   PERFORM 3100-GRAVAR-REJEITADOS
               ELSE
                   IF WRK-DTFIM-INV GREATER  WRK-DTFIM-TAB-INV
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 1585                   TO CFUNC-MANUT-INCL OF FD-IMAG009
...
BI0511*----------------------------------------------------------------*
BI0511
BI0511     MOVE CSERVC-TARIF OF IMAG009
BI0511                                 TO CSERVC-TARIF      OF GFCTB0A2.
BI0511     MOVE DINIC-ADSAO-INDVD OF IMAG009
...
BI0511*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT1585'                 TO WRK-5527-CHAMADOR.
