...
ST25X6*       05 FD-CGC-CPF                    PIC  9(009).
ST25X6        05 FD-CGC-CPF                    PIC  X(009).
ST25X6*       05 FD-FILIAL                     PIC  9(005).
ST25X6        05 FD-FILIAL                     PIC  X(005).
      ...
      *
      *----------------------------------------------------------------*
ST25X6*77  FILLER                      PIC  X(050)         VALUE
...
ST25X6*    03  WRK-NUMERO-0110         PIC  9(009)         VALUE ZEROS.
ST25X6*    03  WRK-FILIAL-0110         PIC  9(005)         VALUE ZEROS.
ST25X6*
...
ST25X6 77  WRK-CAD-CONTROLE            PIC 9(02)           VALUE ZEROS.
      ...
      *
ST25X6*    IF GFCTK7-CGC-CPF-R         NOT NUMERIC
ST25X6     IF GFCTK7-CGC-CPF           EQUAL SPACES OR
ST25X6                                 EQUAL LOW-VALUES
           ...
           END-IF.
      *
ST25X6*    IF GFCTK7-FILIAL-R          NOT NUMERIC
ST25X6     IF GFCTK7-FILIAL            EQUAL SPACES OR
ST25X6                                 EQUAL LOW-VALUES
      ...
      *----------------------------------------------------------------*
      *
ST25X6*    INITIALIZE                  WRK-CGC-CPF-0110
ST25X6*                                WRK-CONTROLE-0110
ST25X6     INITIALIZE                  WRK-AREA-BRAD2000
                                       WRK-CAD-CONTROLE
      *
ST25X6*    MOVE SPACES                 TO WRK-CONTROLE-0110.
ST25X6*    MOVE GFCTK7-CGC-CPF         TO WRK-NUMERO-0110.
ST25X6*    MOVE GFCTK7-FILIAL          TO WRK-FILIAL-0110.
ST25X6*
ST25X6*    CALL 'POOL0110'             USING WRK-CGC-CPF-0110
ST25X6*                                      WRK-CONTROLE-0110.
ST25X6     MOVE ZEROS                  TO WRK-CAD-CONTROLE. 
ST25X6     MOVE GFCTK7-CGC-CPF         TO WRK-CAD-NUMERO.
ST25X6     MOVE GFCTK7-FILIAL          TO WRK-CAD-FILIAL.
ST25X6
...
ST25X6                                       WRK-CAD-CONTROLE.
      *
           ...
           END-IF
      *
ST25X6*    IF  GFCTK7-CONTROLE         NOT EQUAL WRK-CONTROLE-0110
ST25X6     IF  GFCTK7-CONTROLE         NOT EQUAL WRK-CAD-CONTROLE
      ...
      *
           MOVE DINIC-PRMSS-PCOTE      OF GFCTB0C6
                                       ...
                                       OF GFCTB0I0
      *
ST25X6*    MOVE GFCTK7-CGC-CPF         TO CCGC-CPF
ST25X6*                                OF GFCTB0I0
ST25X6     MOVE GFCTK7-CGC-CPF         TO CCGC-CPF-ST 
                                       OF GFCTB0I0
      *
ST25X6*    MOVE GFCTK7-FILIAL          TO CFLIAL-CGC
ST25X6*                                       OF GFCTB0I0
ST25X6     MOVE GFCTK7-FILIAL          TO CFLIAL-CGC-ST
                                       OF GFCTB0I0
      *
           MOVE GFCTK7-CONTROLE        TO WRK-CCTRL-CPF-CGC-X
ST25X6*    MOVE WRK-CCTRL-CPF-CGC-9    TO CCTRL-CPF-CGC
ST25X6*                                OF GFCTB0I0
ST25X6     MOVE WRK-CCTRL-CPF-CGC-9    TO CCTRL-CPF-CGC-ST
                                       OF GFCTB0I0
      *
           EXEC SQL
               SELECT  CCGC_CPF,
