...
______*____END-IF.
           ...
           IF WRK-ERRO = 'N'
              IF (BC0-OPERADORA    EQUAL SPACES AND
                  BC0-DDD          EQUAL SPACES AND
                  BC0-NUM-CEL      EQUAL SPACES)      OR
                 (BC0-OPERADORA    NUMERIC      AND
                  BC0-DDD          NUMERIC      AND
                  BC0-NUM-CEL      NUMERIC      AND
                  BC0-OPERADORA-R  EQUAL ZEROS  AND
                  BC0-DDD-R        EQUAL ZEROS  AND
                  BC0-NUM-CEL-R    EQUAL ZEROS)
                  NEXT SENTENCE
              ELSE
                 MOVE 'S'                   TO WRK-ERRO
...
______*___________END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT3622'                 TO WRK-5527-CHAMADOR.
      ...
      ******************************************************************
       4200-OBTER-SEG-GESTAO SECTION.
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              ...
              END-IF
              MOVE    'ERRO ABERTURA GFCTB0H3' TO WRK-MSG-IMP
              MOVE    'S'   TO WRK-ERRO-IMP
              MOVE 12 TO RETURN-CODE
           END-IF.
      ...
      ******************************************************************
       4210-PROCESSA-CURSOR-H3 SECTION.
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND +100) OR
              ...
              END-IF
              MOVE    'ERRO LEITURA GFCTB0H3' TO WRK-MSG-IMP
              MOVE    'S'   TO WRK-ERRO-IMP
              MOVE 12 TO RETURN-CODE
           END-IF.
      ...
      ******************************************************************
       4230-CLOSE-CURSOR-H3    SECTION.
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              ...
              END-IF
              MOVE    'ERRO FECHTO CURSOR H3' TO WRK-MSG-IMP
              MOVE    'S'   TO WRK-ERRO-IMP
              MOVE 12 TO RETURN-CODE
           END-IF.
