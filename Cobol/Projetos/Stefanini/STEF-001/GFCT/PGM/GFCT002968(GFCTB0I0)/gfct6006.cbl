...
ABR10 *================================================================*
AP285 *================================================================*
AP285 *           SONDA PROCWORK -  CONSULTORIA - ALTERACAO            *
AP285 *----------------------------------------------------------------*
AP285 *    ANALISTA....:   ANTONIO PAGNOCCA NETO                       *
AP285 *    PROGRAMADOR.:   ANTONIO PAGNOCCA NETO                       *
AP285 *    DATA........:   MAI/2010                                    *
AP285 *    OBJETIVO....:   EXIBE CESTAS DE TARIFAS COM FLAG PARA       *
AP285 *                    CESTAS CELULAR.                             *
BI0511*----------------------------------------------------------------*
...
BI0511*----------------------------------------------------------------*
BI0511*                                                                *
BI0511*    ANALISTA....:  UBIRAJARA       - SONDA/PROCWORK             *
BI0511*    DATA........:  05 / 2011                                    *
...
BI0412*----------------------------------------------------------------*
BI0412*                                                                *
BI0412*    ANALISTA....:  UBIRAJARA       - SONDA - IT                 *
BI0412*    DATA........:  04 / 2012                                    *
...
ABR10  77  WRK-CESTA-CELULAR           PIC  X(001)         VALUE SPACES.
ABR10  77  WRK-COUNT                   PIC S9(009) COMP    VALUE ZEROS.
...
BI0412 01  WRK-CINDCD-ADSAO-AMBAS      PIC  X(001)         VALUE 'A'.
      ...
      *    05 WRK-MODULO-MSG-2         PIC  X(008)         VALUE SPACES.

      *01  WRK-MSG003.
      *    05 FILLER                   PIC  X(040)         VALUE
      *       'INCONSISTENCIA NOS PARAMETROS DO MODULO'.
      *    05 WRK-MODULO-MSG-3         PIC  X(008)         VALUE SPACES.
...
BI0412             CINDCD_ADSAO_INDVD  = :WRK-CINDCD-ADSAO-AMBAS)    AND
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6006'             TO GFCTG2-TRANSACAO
                                          GFCTG2-FUNCAO.
...
231109         END-IF
AP285 *****ELSE
AP285 *********PERFORM 2310-ACESSAR-GFCTB0C6
AP285 *********IF  WRK-CESTA-CELULAR       EQUAL 'S'
AP285 *********IF  CSERVC-TARIF OF GFCTB0C6 EQUAL 01123 OR 01124
AP285 *************GO TO  2300-LER-CURSOR-A
AP285 *********END-IF
231109     END-IF.
...
BI0511******************************************************************
BI0511*----------------------------------------------------------------*
BI0511 2310-ACESSAR-GFCTB0A2       SECTION.
BI0511*----------------------------------------------------------------*
BI0511
...
BI0511         IF GFCTV9-AMBIENTE EQUAL 'O'
BI0511             MOVE '1318'              TO GFCTG2-COD-MSG
BI0511             MOVE 1318                TO GFCTV9-COD-MENSAGEM
BI0511         ELSE
BI0511             MOVE '1198'              TO GFCTG2-COD-MSG
BI0511             MOVE 1198                TO GFCTV9-COD-MENSAGEM
BI0511         END-IF
BI0511         PERFORM 1200-OBTER-DESC-MSG
BI0511         MOVE 33                  TO GFCTV9-COD-RETORNO
BI0511         MOVE GFCTG3-DESC-MSG     TO GFCTV9-MENSAGEM
BI0511         MOVE SQLCA               TO GFCTV9-SQLCA
...
BI1113     END-IF.
           ...
           IF CTPO-SERVC-TARIF OF GFCTB0D8 EQUAL +4
              MOVE ZEROS TO WRK-TIPO-CONTA-CLIENTE
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6006'                 TO WRK-5527-CHAMADOR.
...
BI0511     PERFORM 2310-ACESSAR-GFCTB0A2.
AP285      MOVE WRK-CESTA-CELULAR TO GFCTV9-CESTA-CELULAR(IND-1).
