...
231109*****IF  GFCTVH-PACOTE            EQUAL 01123 OR 01124
231109*********IF GFCTVH-AMBIENTE EQUAL 'B'
231109*************MOVE '1482'              TO GFCTG2-COD-MSG
231109*************MOVE  1482               TO GFCTVH-COD-MENSAGEM
231109*********ELSE
231109*************MOVE '1626'              TO GFCTG2-COD-MSG
231109*************MOVE  1626               TO GFCTVH-COD-MENSAGEM
231109*********END-IF
231109*********PERFORM 1500-OBTER-DESC-MSG
231109*********MOVE 49                  TO GFCTVH-COD-RETORNO
231109*********MOVE GFCTG3-DESC-MSG     TO GFCTVH-MENSAGEM
231109*********MOVE SPACES              TO GFCTVH-SQLCA
231109*********MOVE 04                  TO RETURN-CODE
231109*********PERFORM 4000-FINALIZAR
231109*****END-IF.
...
BI0511         MOVE SQLCA              TO GFCTVH-SQLCA
...
BI0511*----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6011'             TO GFCTG2-TRANSACAO
                                          GFCTG2-FUNCAO.
           MOVE '6011'                 TO GFCTG2-FUNC-BDSCO.
...
ST25X6               AND  WRK-5527-CCGC-CPF          NOT EQUAL LOW-VALUES
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6011'                 TO WRK-5527-CHAMADOR.
...
BI0412              CINDCD_ADSAO_INDVD  = :WRK-CINDCD-ADSAO-AMBAS)
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTVH-AGENCIA         TO CJUNC-DEPDC       OF GFCTB009.
           MOVE GFCTVH-CONTA           TO CCTA-CLI          OF GFCTB009.
PROC*******MOVE GFCTVH-PACOTE          TO CSERVC-TARIF      OF GFCTB009.
           MOVE WRK-DIA-INI-ADSAO-INDVD
                                TO DFIM-ADSAO-INDVD OF GFCTB009(1:2).
           MOVE WRK-MES-INI-ADSAO-INDVD
                                TO DFIM-ADSAO-INDVD OF GFCTB009(4:2).
...
PROC***************CSERVC_TARIF        = :GFCTB009.CSERVC-TARIF      AND
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 6011                   TO CFUNC-MANUT-INCL OF GFCTB009.
