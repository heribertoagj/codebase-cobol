      ...
      *                                                                *
      *    BOOK'S......:                                               *
      *       GFCTWN00 - ENTRADA E SAIDA - INC MODULO CORPORATIVO      *
      *                  GFCT6400                                      *
...
ST25X6         10  WRK-5527-CFLIAL-CGC PIC  X(004)         VALUE SPACES.
      ...
      *================================================================*
       PROCEDURE                       DIVISION USING LNK-GFCTWN00.
      *================================================================*
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTWN00-E-AMBIENTE     EQUAL 'B' OR 'b'
               CALL 'POOL1050'
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF  GFCTWN00-E-AMBIENTE     EQUAL 'o'
               MOVE 'O'                TO GFCTWN00-E-AMBIENTE
           END-IF.

           IF  GFCTWN00-E-AMBIENTE     EQUAL 'b'
               MOVE 'B'                TO GFCTWN00-E-AMBIENTE
           END-IF.

           IF (GFCTWN00-E-CD-COML-AGENCIA        NOT NUMERIC)      OR
              (GFCTWN00-E-CD-COML-AGENCIA        EQUAL ZEROS)      OR
              (GFCTWN00-E-CD-COML-CONTA          NOT NUMERIC)      OR
              (GFCTWN00-E-CD-COML-CONTA          EQUAL ZEROS)      OR
              (GFCTWN00-E-CD-CESTA-PERM          NOT NUMERIC)      OR
              (GFCTWN00-E-AMBIENTE               NOT EQUAL 'O' AND 'B')
               MOVE 'B'                TO GFCTWN00-E-AMBIENTE

               MOVE 08                 TO GFCTWN00-COD-RETORNO
      *
VI0816*--- DADOS ENVIADOS AO MODULO GFCT6400 INCONSISTENTES
      *
               MOVE '1501'             TO GFCTG2-COD-MSG
               MOVE 1501               TO GFCTWN00-COD-MENSAGEM

               PERFORM 9900-OBTER-DESC-MSG

               MOVE GFCTG3-DESC-MSG    TO GFCTWN00-MENSAGEM
               MOVE SPACES             TO GFCTWN00-SQLCA
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               MOVE 12                 TO GFCTWN00-COD-RETORNO
      *
      *--- ERRO NA TABELA GFCTB0A1
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   MOVE '1717'         TO GFCTG2-COD-MSG
                   MOVE 1717           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1507'         TO GFCTG2-COD-MSG
                   MOVE 1507           TO GFCTWN00-COD-MENSAGEM
               END-IF

               PERFORM 9900-OBTER-DESC-MSG

               MOVE GFCTG3-DESC-MSG    TO GFCTWN00-MENSAGEM
               MOVE SQLCA(1:LENGTH OF GFCTWN00-SQLCA)
                                       TO GFCTWN00-SQLCA
               MOVE 12                 TO RETURN-CODE
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-CESTA-PERM TO CSERVC-TARIF    OF GFCTB0C6.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1739           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1530'         TO GFCTG2-COD-MSG
                   MOVE 1530           TO GFCTWN00-COD-MENSAGEM
               END-IF

               PERFORM 9900-OBTER-DESC-MSG

               MOVE GFCTG3-DESC-MSG    TO GFCTWN00-MENSAGEM
               MOVE SQLCA(1:LENGTH OF GFCTWN00-SQLCA) TO GFCTWN00-SQLCA
               MOVE 12                 TO RETURN-CODE
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1740           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1531'         TO GFCTG2-COD-MSG
                   MOVE 1531           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *--- TARIFA PACOTE NAO PODE SER CESTA CELULAR
               ...
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1626           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1482'         TO GFCTG2-COD-MSG
                   MOVE 1482           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-CESTA-PERM TO CSERVC-TARIF OF GFCTB0A2.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1722           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1530'         TO GFCTG2-COD-MSG
                   MOVE 1530           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO LKW-CJUNC-DEPC.
           MOVE GFCTWN00-E-CD-COML-CONTA   TO LKW-CTA-CORR.
      ...
      *
               MOVE 1392               TO GFCTWN00-COD-MENSAGEM

               MOVE WRK-MSG-SCCE9100   TO GFCTWN00-MENSAGEM
      ...
      *--- PROBLEMA NO ACESSO A BASE DE MENSAGENS
      *
               MOVE 1306               TO GFCTWN00-COD-MENSAGEM

               MOVE LKW-MENSAGEM       TO GFCTWN00-MENSAGEM
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO CJUNC-DEPDC OF CLIEV007.
           MOVE GFCTWN00-E-CD-COML-CONTA   TO CCTA-CLI    OF CLIEV007.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1718           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1508'         TO GFCTG2-COD-MSG
                   MOVE 1508           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO CJUNC-DEPDC OF CLIEV008.
           MOVE GFCTWN00-E-CD-COML-CONTA   TO CCTA-CLI    OF CLIEV008.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1719           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1509'         TO GFCTG2-COD-MSG
                   MOVE 1509           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1724           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1514'         TO GFCTG2-COD-MSG
                   MOVE 1514           TO GFCTWN00-COD-MENSAGEM
               END-IF
...
ST25X6              :CLIEV004.CCTRL-CPF-CGC-ST,
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1720           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1510'         TO GFCTG2-COD-MSG
                   MOVE 1510           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1725           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1515'         TO GFCTG2-COD-MSG
                   MOVE 1515           TO GFCTWN00-COD-MENSAGEM
               END-IF
...
ST25X6               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1721           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1511'         TO GFCTG2-COD-MSG
                   MOVE 1511           TO GFCTWN00-COD-MENSAGEM
               END-IF
           ...
           ELSE
              IF CTPO-SERVC-TARIF OF GFCTB0D8 EQUAL 4
                 ...
                 MOVE 1926           TO GFCTWN00-COD-MENSAGEM
                 PERFORM 9900-OBTER-DESC-MSG
                 MOVE GFCTG3-DESC-MSG    TO GFCTWN00-MENSAGEM
                 MOVE SQLCA(1:LENGTH OF GFCTWN00-SQLCA)
                                         TO GFCTWN00-SQLCA
              ...
              ELSE
                 ...
                 MOVE 1925           TO GFCTWN00-COD-MENSAGEM
                 PERFORM 9900-OBTER-DESC-MSG
                 MOVE GFCTG3-DESC-MSG    TO GFCTWN00-MENSAGEM
                 MOVE SQLCA(1:LENGTH OF GFCTWN00-SQLCA)
                                         TO GFCTWN00-SQLCA
      ...
      *----------------------------------------------------------------*
           ...
           IF  WRK-TARIFA-VALIDA       EQUAL 'S'
               ...
               IF  GFCTWN00-COD-RETORNO EQUAL ZEROS

      *--- ADESAO AO PACOTE - TARIFA PACOTE ADERIDA COM SUCESSO

                   IF      GFCTWN00-E-AMBIENTE
                                   EQUAL 'O'
                       MOVE '1399' TO GFCTG2-COD-MSG
                       MOVE 1399       TO GFCTWN00-COD-MENSAGEM
                   ELSE
                       MOVE '1201' TO GFCTG2-COD-MSG
                       MOVE 1201       TO GFCTWN00-COD-MENSAGEM
                   END-IF

                   PERFORM 9800-OBTER-DESC-MSG-S-FIN

                   IF      GFCTWN00-COD-RETORNO EQUAL 00
                       MOVE GFCTG3-DESC-MSG
                                   TO GFCTWN00-MENSAGEM
                       MOVE SPACES TO GFCTWN00-SQLCA
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1743           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1534'         TO GFCTG2-COD-MSG
                   MOVE 1534           TO GFCTWN00-COD-MENSAGEM
               END-IF
...
ST25X6              AND  CCTRL_CPF_CGC_ST   = :GFCTB0I0.CCTRL-CPF-CGC-ST
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1726           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1516'         TO GFCTG2-COD-MSG
                   MOVE 1516           TO GFCTWN00-COD-MENSAGEM
               END-IF
...
ST25X6              AND  CCTRL_CPF_CGC_ST   = :GFCTB0I0.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-AMBIENTE        TO GFCTJM-TPO-AMBIENTE.
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO GFCTJM-CJUNC-DEPDC.
           MOVE GFCTWN00-E-CD-COML-CONTA   TO GFCTJM-CCTA-CLI.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1728           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1518'         TO GFCTG2-COD-MSG
                   MOVE 1518           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1729           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1519'         TO GFCTG2-COD-MSG
                   MOVE 1519           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1730           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1520'         TO GFCTG2-COD-MSG
                   MOVE 1520           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO CDEPDC        OF GFCTB0C7.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1731           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1521'         TO GFCTG2-COD-MSG
                   MOVE 1521           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6400'                 TO WRK-5527-CHAMADOR.
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO WRK-5527-AGENCIA-CLIENTE.
           MOVE GFCTWN00-E-CD-COML-CONTA   TO WRK-5527-CONTA-CLIENTE.
           MOVE GFCTWN00-E-AMBIENTE        TO WRK-5527-AMBIENTE.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1723           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1513'         TO GFCTG2-COD-MSG
                   MOVE 1513           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
                   IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                       ...
                       MOVE 1727       TO GFCTWN00-COD-MENSAGEM
                   ELSE
                       MOVE '1517'     TO GFCTG2-COD-MSG
                       MOVE 1517       TO GFCTWN00-COD-MENSAGEM
                   END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO CDEPDC        OF GFCTB0D0.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1732           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1522'         TO GFCTG2-COD-MSG
                   MOVE 1522           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO CDEPDC        OF GFCTB0D1.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1733           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1523'         TO GFCTG2-COD-MSG
                   MOVE 1523           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-AMBIENTE        TO GFCTRK-TPO-AMBIENTE.
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO GFCTRK-CJUNC-DEPDC.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1734           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1524'         TO GFCTG2-COD-MSG
                   MOVE 1524           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1735           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1525'         TO GFCTG2-COD-MSG
                   MOVE 1525           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1736           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1526'         TO GFCTG2-COD-MSG
                   MOVE 1526           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1737           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1527'         TO GFCTG2-COD-MSG
                   MOVE 1527           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1738           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1528'         TO GFCTG2-COD-MSG
                   MOVE 1528           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO CJUNC-DEPDC  OF GFCTB009.
           MOVE GFCTWN00-E-CD-COML-CONTA   TO CCTA-CLI     OF GFCTB009.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1742           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1533'         TO GFCTG2-COD-MSG
                   MOVE 1533           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1741           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1532'         TO GFCTG2-COD-MSG
                   MOVE 1532           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1745           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1539'         TO GFCTG2-COD-MSG
                   MOVE 1539           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1746           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1537'         TO GFCTG2-COD-MSG
                   MOVE 1537           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-CESTA-PERM TO CTARIF-PCOTE OF GFCTB029.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1747           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1535'         TO GFCTG2-COD-MSG
                   MOVE 1535           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1748           TO  GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1536'         TO GFCTG2-COD-MSG
                   MOVE 1536           TO  GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   ...
                   MOVE 1744           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE '1538'         TO GFCTG2-COD-MSG
                   MOVE 1538           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *
               ...
               ELSE
                   ...
                   MOVE 1512           TO GFCTWN00-COD-MENSAGEM
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           MOVE GFCTWN00-E-CD-COML-AGENCIA TO CJUNC-DEPDC   OF GFCTB009.
           MOVE GFCTWN00-E-CD-COML-CONTA   TO CCTA-CLI      OF GFCTB009.
           MOVE GFCTWN00-E-CD-CESTA-PERM   TO CSERVC-TARIF  OF GFCTB009.

           MOVE WRK-HINCL-REG          TO HINCL-REG         OF GFCTB009.

           MOVE 000006400              TO CFUNC-MANUT-INCL  OF GFCTB009.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT6400'             TO GFCTG2-TRANSACAO
                                          GFCTG2-FUNCAO.
           MOVE '1'                    TO GFCTG2-FUNC-BDSCO.
           MOVE GFCTWN00-E-AMBIENTE    TO GFCTG2-TIPO-PROC.
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   MOVE 1803           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE 1593           TO GFCTWN00-COD-MENSAGEM
               END-IF

               MOVE WRK-MSG-1          TO GFCTWN00-MENSAGEM
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   MOVE 1804           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE 1594           TO GFCTWN00-COD-MENSAGEM
               END-IF

               MOVE WRK-MSG-2          TO GFCTWN00-MENSAGEM
      ...
      *
               IF  GFCTWN00-E-AMBIENTE EQUAL 'O'
                   MOVE 1805           TO GFCTWN00-COD-MENSAGEM
               ELSE
                   MOVE 1595           TO GFCTWN00-COD-MENSAGEM
               END-IF

               MOVE WRK-MSG-3          TO GFCTWN00-MENSAGEM
