      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-DATA-HORA.
           ...
           05  WRK-TIMESTAMP.
               10  WRK-ANO-X           PIC  9(004)         VALUE ZEROS.
               10  WRK-MES-X           PIC  9(002)         VALUE ZEROS.
               10  WRK-DIA-X           PIC  9(002)         VALUE ZEROS.
               10  WRK-HOR-X           PIC  9(002)         VALUE ZEROS.
               10  WRK-MIN-X           PIC  9(002)         VALUE ZEROS.
               10  WRK-SEG-X           PIC  9(002)         VALUE ZEROS.
               10  WRK-MIL-SEG-X       PIC  X(006)         VALUE SPACES.
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-TIMESTAMP-AUX.
           ...
           05  FILLER                  PIC  X(001)         VALUE '.'.
           05  WRK-MIL-SEG-AUX         PIC  X(006)         VALUE SPACES.
...
ST25X6         10  WRK-5527-CFLIAL-CGC PIC  X(004)         VALUE SPACES.
      ...
      *
VI0816*--- DADOS ENVIADOS AO MODULO GFCT7500 INCONSISTENTES
      *
...
RJOVA      IF CMTFWY6I-E-PERMIS-GOTF   EQUAL 'S'
              GO                       TO 1300-99-FIM
RJOVA      END-IF.
...
ST25X6          AND  CCTRL_CPF_CGC_ST   = :GFCTB0I0.CCTRL-CPF-CGC-ST
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND -305
                                       AND +100)
               MOVE 12                 TO CMTFWY6I-COD-RETORNO
      *
      *--- ERRO NA TABELA GFCTB0I0
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT7500'                 TO WRK-5527-CHAMADOR.
...
ST25X6          MOVE ZEROS              TO WRK-5527-CCTRL-CPF-CGC
      ...
      *----------------------------------------------------------------*
           ...
           PERFORM 2850-OBTER-DATA-SISTEMA

           MOVE WRK-TIMESTAMP-AUX   TO HINCL-REG         OF GFCTB009.

           MOVE 000007500              TO CFUNC-MANUT-INCL  OF GFCTB009.
      ...
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       2850-OBTER-DATA-SISTEMA         SECTION.
      *----------------------------------------------------------------*

           CALL  'BRAD7600'            USING WRK-DATA-HORA.

           MOVE WRK-ANO-X              TO WRK-ANO-AUX.
           MOVE WRK-MES-X              TO WRK-MES-AUX.
           MOVE WRK-DIA-X              TO WRK-DIA-AUX.
           MOVE WRK-HOR-X              TO WRK-HOR-AUX.
           MOVE WRK-MIN-X              TO WRK-MIN-AUX.
           MOVE WRK-SEG-X              TO WRK-SEG-AUX.
           MOVE WRK-MIL-SEG-X          TO WRK-MIL-SEG-AUX.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT7500'             TO GFCTG2-TRANSACAO
                                          GFCTG2-FUNCAO.
