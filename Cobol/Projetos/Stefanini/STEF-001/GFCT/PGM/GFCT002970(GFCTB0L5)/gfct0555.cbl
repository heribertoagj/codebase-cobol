      ...
      *----------------------------------------------------------------*
           ...
           EXEC SQL
              ...
              WHERE  A.CAGPTO_CTA         = B.CAGPTO_CTA
                ...
                AND  B.CAGPTO_CTA         = :GFCTB0L5.CAGPTO-CTA
...
ST25X6          AND  B.CCTRL_CPF_CGC_ST   = :GFCTB0L5.CCTRL-CPF-CGC-ST
           ...
           IF (SQLCODE                 NOT  EQUAL  ZEROS  AND  +100) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE  0010              TO WAG3-COD-MSG-ERRO
           ...
           IF  SQLCODE                 EQUAL ZEROS
               MOVE 1                  TO WAG3-ERRO
               MOVE ZEROS              TO WAG3-COD-SQL-ERRO
               MOVE 1545               TO WAG3-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 9                      TO WAG3-ERRO.
           MOVE 'GFCT0555'             TO GFCT0M-PROGRAMA.
           MOVE 'DB2'                  TO GFCT0M-TIPO-ACESSO.
           MOVE SQLCA                  TO GFCT0M-SQLCA-AREA.
           MOVE SQLCODE                TO GFCT0M-SQLCODE
                                          WRK-AUX-9-S
           MOVE WRK-AUX-9-3            TO WAG3-COD-SQL-ERRO.
           MOVE SPACES                 TO WAG3-DESC-MSG-ERRO.

           PERFORM 1110-OBTER-DESC-MSG.

           STRING GFCTG3-DESC-MSG ' - ' WRK-NOM-TAB
               DELIMITED BY '  '       INTO WAG3-DESC-MSG-ERRO
           END-STRING.
...
ST2506*    MOVE WAG2-NUMERO            TO WRK-NUMERO-0110.
ST2506*    MOVE WAG2-FILIAL            TO WRK-FILIAL-0110.
ST2506*
ST2506*    CALL 'POOL0110'             USING WRK-CGC-CPF-0110
ST2506*                                      WRK-CONTROLE-0110.

ST2506     MOVE ZEROS                 TO WRK-CAD-CONTROLE. 
ST2506     MOVE WAG2-NUMERO           TO WRK-CAD-NUMERO.
ST2506     MOVE WAG2-FILIAL           TO WRK-CAD-FILIAL.
ST2506
...
ST2506                                       WRK-CAD-CONTROLE.
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               MOVE 1                  TO WAG3-ERRO
               MOVE 0468               TO WAG3-COD-MSG-ERRO
               MOVE '0468'             TO GFCTG2-COD-MSG
               MOVE ZEROS              TO WAG3-COD-SQL-ERRO
               PERFORM 1110-OBTER-DESC-MSG
               MOVE GFCTG3-DESC-MSG    TO WAG3-DESC-MSG-ERRO
               PERFORM 3000-FINALIZAR
           END-IF.

ST2506*    MOVE  WRK-CONTROLE-0110     TO WRK-CONTROLE
ST2506*
ST2506*    IF  WAG2-CONTRL             NOT EQUAL WRK-CONTROLE-R
ST2506     MOVE  WRK-CAD-CONTROLE      TO WRK-9-02.
ST2506     MOVE  WRK-9-02              TO WRK-CONTROLE.
ST2506
ST2506     IF  WAG2-CONTRL             NOT EQUAL WRK-CONTROLE-R
               MOVE 1                  TO WAG3-ERRO
               MOVE 0507               TO WAG3-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG2-TRANSACAO         TO GFCTIU-TRANSACAO.
           MOVE WAG2-FUNCAO            TO GFCTIU-FUNCAO.
           MOVE WAG2-FUNC-BDSCO        TO GFCTIU-FUNC-BDSCO.
           MOVE 'N'                    TO GFCTIU-FIM.
ST2506*    MOVE WAG2-NUMERO            TO GFCTIU-NRO-CPF-CNPJ.
ST2506*    MOVE WAG2-FILIAL            TO GFCTIU-NRO-FILIAL.
ST2506     MOVE WAG2-NUMERO            TO GFCTIU-COD-CPF-CNPJ.
ST2506     MOVE WAG2-FILIAL            TO GFCTIU-COD-FILIAL.
           MOVE WAG2-CONTRL            TO GFCTIU-CTRL-CPF-CNPJ.
           ...
           IF  GFCTIV-ERRO              NOT EQUAL ZEROS
               MOVE GFCTIV-ERRO         TO WAG3-ERRO
               MOVE GFCTIV-COD-SQL-ERRO TO WAG3-COD-SQL-ERRO
               MOVE GFCTIV-COD-MSG-ERRO TO WAG3-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG2-CAGPTO            TO CAGPTO-CTA         OF GFCTB0L7
           MOVE WAG2-CSEGMTO           TO CSGMTO-INIC-CLI    OF GFCTB0L7
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG2-CAGPTO            TO CAGPTO-CTA         OF GFCTB0L6
           MOVE WAG2-CPAB              TO CPOSTO-SERVC       OF GFCTB0L6
           MOVE WAG2-CAGEN             TO CDEPDC             OF GFCTB0L6
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG2-CAGPTO            TO CAGPTO-CTA         OF GFCTB0L4
           MOVE 2                      TO CINDCD-AUTRZ-EMIS  OF GFCTB0L4
           MOVE WAG2-FUNC-BDSCO        TO WRK-FUNC-BDSCO-X.
           ...
           MOVE WAG2-JUSTIF            TO RJUSTF-INCL-AUTRZ-TEXT
                                                             OF GFCTB0L4
           MOVE LENGTH OF RJUSTF-INCL-AUTRZ-TEXT             OF GFCTB0L4
                                       TO RJUSTF-INCL-AUTRZ-LEN
                                                             OF GFCTB0L4
...
ST25X6               :GFCTB0L5.CCNPJ-CPF-ST,
ST25X6               :GFCTB0L5.CFLIAL-CGC-ST,
ST25X6               :GFCTB0L5.CCTRL-CPF-CGC-ST)
           END-EXEC.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 2                      TO CINDCD-AUTRZ-EMIS  OF GFCTB0L7
           MOVE WAG2-CSEGMTO           TO CSGMTO-INIC-CLI    OF GFCTB0L7
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 2                      TO CINDCD-AUTRZ-EMIS  OF GFCTB0L6
      ...
      *----------------------------------------------------------------*
           ...
           IF  WAG3-ERRO               NOT EQUAL ZEROS
               MOVE WAG2-CAGPTO        TO WAG3-CAGPTO
               MOVE WAG2-CSEGMTO       TO WAG3-CSEGMTO
               MOVE WAG2-CAGEN         TO WAG3-CAGEN
               MOVE WAG2-CPAB          TO WAG3-CPAB
               MOVE WAG2-CCNPJ-CPF     TO WAG3-CNPJ-CPF
               MOVE WAG2-JUSTIF        TO WAG3-JUSTIF
           END-IF.
