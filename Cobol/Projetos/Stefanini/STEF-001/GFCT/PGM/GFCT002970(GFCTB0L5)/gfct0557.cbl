      ...
      *                                                                *
      *    OBJETIVO     :                                              *
      *      LISTA DE EXCLUSAO DO CANCELAMENTO - EMISSAO DE EXTRATO    *
...
ST25X6                 CCTRL_CPF_CGC_ST
      ...
      *----------------------------------------------------------------*
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               ...
               MOVE 'GFCT0557'         TO GFCT0M-TRANSACAO
      ...
      *----------------------------------------------------------------*
           ...
           IF  WRK-WAG7-QTDE-TOT    EQUAL ZEROS
               MOVE 1                  TO WAG7-ERRO
               MOVE ZEROS              TO WAG7-COD-SQL-ERRO
               MOVE 1590               TO WAG7-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT0557'             TO GFCT0M-PROGRAMA.
      ...
      *----------------------------------------------------------------*
           ...
           IF  SQLCODE              EQUAL ZEROS
               ADD 1                   TO IND-1
                                          ...
                                          WRK-WAG7-QTDE-OCOR
               MOVE WRK-WAG7-QTDE-TOT  TO WAG7-QTDE-TOT-REG
               MOVE WRK-WAG7-QTDE-OCOR TO WRK-WAG7-QTDE-OCOR
               ADD 158                 TO WAG7-LL
