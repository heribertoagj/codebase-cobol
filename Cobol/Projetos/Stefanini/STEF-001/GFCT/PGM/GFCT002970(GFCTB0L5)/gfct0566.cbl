      ...
      *                                                                *
      *    OBJETIVO     :                                              *
      *      LISTA DE CONSULTA DO CANCELAMENTO - EMISSAO DE EXTRATO    *
      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-WAG7-QTDE-TOT           PIC  9(006) COMP-3  VALUE ZEROS.
       01  WRK-WAG7-QTDE-OCOR          PIC  9(003) COMP-3  VALUE ZEROS.
      ...
      *-->      SELECIONAR TODOS CLIENTES
           EXEC SQL
               DECLARE CSR01-GFCTB0L5 CURSOR FOR
               SELECT  CAGPTO_CTA,
                       HINCL_REG_SIST,
                       CCNPJ_CPF,
                       CFLIAL_CGC,
...
ST25X6                 CCTRL_CPF_CGC_ST
      ...
      *-->      SELECIONAR TODOS SEGMENTO
           EXEC SQL
               DECLARE CSR02-GFCTB0L7 CURSOR FOR
               SELECT  CAGPTO_CTA,
                       HINCL_REG_SIST,
                       CSGMTO_INIC_CLI
      ...
      *-->      SELECIONAR TODOS POSTO
           EXEC SQL
               DECLARE CSR03-GFCTB0L6 CURSOR FOR
               SELECT  CAGPTO_CTA,
                       HINCL_REG_SIST,
                       CDEPDC,
                       CPOSTO_SERVC
      ...
      *================================================================*
       PROCEDURE DIVISION              USING WAG6-ENTRADA
                                             WAG7-SAIDA
                                             GFCT0M-AREA-ERROS.
      *================================================================*
      ...
      *----------------------------------------------------------------*
           ...
           MOVE SPACES                 TO WAG7-SAIDA
                                          GFCT0M-AREA-ERROS.

           INITIALIZE                  WAG7-SAIDA
                                       GFCT0M-AREA-ERROS
                                       SQLCA.

           MOVE 220                    TO WAG7-LL
           MOVE WAG6-TRANSACAO         TO WAG7-TRANSACAO
           MOVE WAG6-FUNCAO            TO WAG7-FUNCAO
           MOVE WAG6-FUNC-BDSCO        TO WAG7-FUNC-BDSCO
           MOVE WAG6-FILTRO            TO WAG7-FILTRO
           MOVE ZEROS                  TO WAG7-ERRO
                                          WAG7-COD-SQL-ERRO
                                          WAG7-COD-MSG-ERRO
                                          GFCTG2-COD-MSG.
           MOVE ZEROS                  TO WAG7-QTDE-TOT-REG
                                          WRK-WAG7-QTDE-TOT
           MOVE 'N'                    TO WAG7-FIM
                                          WRK-FINALIZAR.

           IF  WAG6-QTDE-OCOR        IS NUMERIC
               MOVE WAG6-QTDE-OCOR     TO WAG7-QTDE-OCOR
                                          WRK-WAG7-QTDE-OCOR
           ELSE
               MOVE ZEROS              TO WAG7-QTDE-OCOR
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG6-TRANSACAO         TO GFCTG2-TRANSACAO.
           MOVE WAG6-FUNCAO            TO GFCTG2-FUNCAO.
           MOVE WAG6-FUNC-BDSCO        TO GFCTG2-FUNC-BDSCO.
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               ...
               MOVE SPACES             TO WAG7-DESC-MSG-ERRO
               MOVE 9                  TO WAG7-ERRO
               MOVE WRK-MODULO         TO GFCT0M-PROGRAMA
                                          WRK-MODULO-MSG
               MOVE WRK-MSG001         TO GFCT0M-TEXTO
               MOVE 'APL'              TO GFCT0M-TIPO-ACESSO
               MOVE 'GFCT0566'         TO GFCT0M-TRANSACAO
           ...
           IF  GFCTG3-ERRO             EQUAL 9
               ...
               ELSE
                   MOVE GFCTG3-COD-SQL-ERRO
                                       TO WAG7-COD-SQL-ERRO
                   MOVE GFCTG3-DESC-MSG-ERRO
                                       TO WAG7-DESC-MSG-ERRO
               END-IF

               MOVE WRK-MODULO         TO GFCT0M-PROGRAMA
               MOVE 'GFCT0566'         TO GFCT0M-TRANSACAO
               MOVE GFCTG3-ERRO        TO WAG7-ERRO
           ...
           IF  GFCTG3-ERRO             EQUAL 1
               ...
               MOVE GFCTG3-COD-MSG-ERRO
                                       TO WAG7-COD-MSG-ERRO
               MOVE GFCTG3-DESC-MSG-ERRO
                                       TO WAG7-DESC-MSG-ERRO
               PERFORM 3000-FINALIZAR
           END-IF.

           MOVE GFCTG3-DESC-MSG        TO WAG7-DESC-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           IF (WAG6-TRANSACAO       EQUAL SPACES  OR LOW-VALUES) OR
              (WAG6-FUNCAO          EQUAL SPACES  OR LOW-VALUES) OR
              (WAG6-FUNC-BDSCO      EQUAL SPACES  OR LOW-VALUES) OR
              (WAG6-CAGPTO            NOT NUMERIC)               OR
              (WAG6-CAGPTO          EQUAL ZEROS)
               MOVE 1                  TO WAG7-ERRO
               MOVE ZEROS              TO WAG7-COD-SQL-ERRO
               MOVE 0001               TO WAG7-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG6-TRANSACAO         TO GFCTFZ-TRANSACAO.
           MOVE WAG6-FUNCAO            TO GFCTFZ-FUNCAO.
           MOVE WAG6-FUNC-BDSCO        TO GFCTFZ-FUNC-BDSCO.
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG6-QTDE-OCOR         TO WRK-DESPREZA
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE SQLCODE            TO GFCT0M-SQLCODE
                                          WRK-AUX-9-S
               MOVE WRK-AUX-9-3        TO WAG7-COD-SQL-ERRO
               MOVE '0010'             TO GFCT0M-LOCAL
               MOVE 0005               TO WAG7-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           MOVE 'GFCT0566'             TO GFCT0M-PROGRAMA.
           ...
           STRING GFCTG3-DESC-MSG   ' - '
                  WRK-NOME-TAB
           DELIMITED BY '   '          INTO WAG7-DESC-MSG-ERRO.
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND +100) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0006               TO WAG7-COD-MSG-ERRO
           ...
           IF  SQLCODE                 EQUAL +100
               ...
               IF  IND-1               EQUAL ZEROS
                   MOVE 1              TO WAG7-ERRO
                   MOVE ZEROS          TO WAG7-COD-SQL-ERRO
                   MOVE 1619           TO WAG7-COD-MSG-ERRO
                   MOVE '1619'         TO GFCTG2-COD-MSG
                   PERFORM 1100-OBTER-DESC-MSG
                   MOVE 'S'            TO WAG7-FIM
                   PERFORM 3000-FINALIZAR
               END-IF
      ...
      *----------------------------------------------------------------*
           ...
           IF  SQLCODE              EQUAL ZEROS
               ADD 1                   TO IND-1
                                          WRK-WAG7-QTDE-TOT
                                          WRK-WAG7-QTDE-OCOR
               MOVE WRK-WAG7-QTDE-TOT  TO WAG7-QTDE-TOT-REG
               MOVE WRK-WAG7-QTDE-OCOR TO WAG7-QTDE-OCOR
               ADD 158                 TO WAG7-LL
               MOVE CAGPTO-CTA         OF GFCTB0L5
                                       TO WRK-AUX-3-S
               MOVE WRK-AUX-3          TO WAG7-CAGPTO(IND-1)
               MOVE HINCL-REG-SIST     OF GFCTB0L5
                                       TO WAG7-HINCL(IND-1)
               MOVE CCNPJ-CPF          OF GFCTB0L5
                                       TO WRK-AUX-9-S
               MOVE WRK-AUX-9          TO WAG7-NUMERO(IND-1)
               MOVE CFLIAL-CGC         OF GFCTB0L5
                                       TO WRK-AUX-5-S
               MOVE WRK-AUX-5          TO WAG7-FILIAL(IND-1)
               MOVE CCTRL-CPF-CGC      OF GFCTB0L5
                                       TO WRK-AUX-2-S
               MOVE WRK-AUX-2          TO WAG7-CONTRL(IND-1)
               ...
               MOVE WRK-DATA-AUX       TO WAG7-DT-SOLC(IND-1)

               IF  HEXCL-REG-SIST OF GFCTB0L4  NOT EQUAL  WRK-TIMESTAMP
                   MOVE HEXCL-REG-SIST OF GFCTB0L4
                                       TO WRK-HINCL
                   MOVE WRK-ANO        TO WRK-ANO-AUX
                   MOVE WRK-MES        TO WRK-MES-AUX
                   MOVE WRK-DIA        TO WRK-DIA-AUX
                   MOVE WRK-DATA-AUX   TO WAG7-DT-EXCL(IND-1)
           ...
           IF  IND-1                 EQUAL 5
               IF  WRK-FINALIZAR NOT EQUAL 'S'
                   ...
                   MOVE CAGPTO-CTA     OF GFCTB0L5
                                       TO WRK-AUX-3-S
                   MOVE WRK-AUX-3      TO WAG7-FTR-CAGPTO
               END-IF
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS AND +100) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0012               TO WAG7-COD-MSG-ERRO
...
ST25X6*    MOVE CCNPJ-CPF OF GFCTB0L5  TO CCGC-CPF          OF CLIEV004
ST25X6*    MOVE CFLIAL-CGC OF GFCTB0L5 TO CFLIAL-CGC        OF CLIEV004
ST25X6*    MOVE CCTRL-CPF-CGC          OF GFCTB0L5
ST25X6*                                TO CCTRL-CPF-CGC     OF CLIEV004
ST25X6     MOVE CCNPJ-CPF-ST OF GFCTB0L5 TO CCGC-CPF        OF CLIEV004
ST25X6     MOVE CFLIAL-CGC-ST OF GFCTB0L5 TO CFLIAL-CGC     OF CLIEV004
ST25X6     MOVE CCTRL-CPF-CGC-ST       OF GFCTB0L5
ST25X6                                 TO CCTRL-CPF-CGC     OF CLIEV004
      ...
      *----------------------------------------------------------------*
           ...
           IF (SQLCODE                 NOT EQUAL ZEROS) OR
              (SQLWARN0                EQUAL 'W')
               ...
               MOVE 0011               TO WAG7-COD-MSG-ERRO
      ...
      *----------------------------------------------------------------*
           ...
           IF  SQLCODE              EQUAL ZEROS
               ...
               MOVE CSGMTO-INIC-CLI    OF GFCTB0L7
                                       TO WRK-AUX-3-S
               MOVE WRK-AUX-3          TO WAG7-CSEGMTO(IND-1)
      ...
      *----------------------------------------------------------------*
           ...
           MOVE ISGMTO-GSTAO-TARIF     TO WAG7-NM-SEGMTO(IND-1).
      ...
      *----------------------------------------------------------------*
           ...
           IF  SQLCODE              EQUAL ZEROS
               ...
               MOVE WRK-AUX-5          TO WAG7-CAGEN(IND-1)
               MOVE CPOSTO-SERVC       OF GFCTB0L6
                                       TO WRK-AUX-5-S
               MOVE WRK-AUX-5          TO WAG7-CPAB(IND-1)
      ...
      *----------------------------------------------------------------*
           ...
           MOVE WAG6-TRANSACAO         TO GFCTGB-TRANSACAO.
           MOVE WAG6-FUNCAO            TO GFCTGB-FUNCAO.
           MOVE ZEROS                  TO GFCTGB-QTDE-OCOR.
           MOVE ZEROS                  TO GFCTGB-QTDE-TOT-REG.
           MOVE WAG6-FUNC-BDSCO        TO GFCTGB-FUNC-BDSCO.
           ...
           IF  GFCTGC-ERRO            NOT EQUAL ZEROS
               ...
               ELSE
                   ...
                   DELIMITED BY SIZE   INTO WAG7-DESC-MSG-ERRO
               END-IF

               PERFORM 3000-FINALIZAR
           END-IF.

           MOVE GFCTGC-DESC-POSTO(1)   TO WAG7-NM-PAB(IND-1).
