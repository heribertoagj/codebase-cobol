...
ST25X6*     05  WRK-TAB-CGC-CPF         PIC  9(009)         VALUE ZEROS.
ST25X6      05  WRK-TAB-CGC-CPF         PIC  X(09)          VALUE SPACES.
...
BI0810       10  WRK-TAB-TPSSOA-ADESAO PIC  X(001).
      ...
      *----------------------------------------------------------------*
       ...
       01  LINDET1.
           ...
           05  FILLER                  PIC  X(001)         VALUE '-'.
ST25X6*      05  LD1-FILIAL              PIC  99999.
ST25X6       05  LD1-FILIAL              PIC  X(04).
           05  FILLER                  PIC  X(001)         VALUE '-'.
...
ST25X6       05  FILLER                  PIC  X(001)         VALUE SPACES.
...
ST25X6*        MOVE  999999999         TO CCGC-CPF         OF GFCTB0H9
ST25X6         MOVE  SPACES            TO CCGC-CPF-ST      OF GFCTB0H9
           ELSE
...
ST25X6*     IF  CCGC-CPF OF GFCTB0H9            LESS GFCTRU-CGC-CPF
           IF  CCGC-CPF-ST OF GFCTB0H9          LESS GFCTRU-CGC-CPF
               PERFORM 3200-LER-CURSOR1        UNTIL
ST25X6*             CCGC-CPF OF GFCTB0H9        NOT LESS GFCTRU-CGC-CPF
                   CCGC-CPF-ST OF GFCTB0H9      NOT LESS GFCTRU-CGC-CPF
                OR WRK-FIM-CURSOR1             EQUAL 'S'
           ELSE
ST25X6*         IF  CCGC-CPF OF GFCTB0H9        GREATER GFCTRU-CGC-CPF
               IF  CCGC-CPF-ST OF GFCTB0H9      GREATER GFCTRU-CGC-CPF
                   PERFORM 2100-LER-CLIEADES   UNTIL
ST25X6*                 GFCTRU-CGC-CPF          NOT LESS CCGC-CPF
ST25X6*                                                         OF GFCTB0H9
                       GFCTRU-CGC-CPF          NOT LESS CCGC-CPF-ST
                                                           OF GFCTB0H9
                    OR WRK-FS-CLIEADES         EQUAL '10'
               ELSE
                   INITIALIZE WRK-TABELA-INTERNA-1
ST25X6*             MOVE  CCGC-CPF OF GFCTB0H9  TO WRK-TAB-CGC-CPF
                   MOVE  CCGC-CPF-ST OF GFCTB0H9 TO WRK-TAB-CGC-CPF
                   MOVE ZEROS TO IND-1
                   PERFORM 3310-MONTAR-TABELA1 UNTIL
ST25X6*                 CCGC-CPF OF GFCTB0H9    GREATER WRK-TAB-CGC-CPF
                       CCGC-CPF-ST OF GFCTB0H9  GREATER WRK-TAB-CGC-CPF
                    OR WRK-FIM-CURSOR1         EQUAL 'S'
