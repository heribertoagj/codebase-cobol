      ...
      *---------------------------------------------------------------*
       01  FILLER                      PIC  X(050)         VALUE
           '*** GFCT2BDF - INICIO DA AREA DE WORKING ***'.
      *---------------------------------------------------------------*
      ...
      *---------------------------------------------------------------*
       01  FILLER                      PIC  X(050)         VALUE
           '*** GFCT2BDF - FIM DA AREA DE WORKING ***'.
      *---------------------------------------------------------------*
      ...
      *---------------------------------------------------------------*
           ...
           MOVE GFCTWBDF-CAG-BCRIA-SALRL    OF WRK-NEGCVIGE
                                            TO WRK-JH-AGENCIA
           MOVE WRK-JH-AGE                  TO WRK-AGENCIA-FTCONTB

           MOVE GFCTWBDF-CCTA-BCRIA-SALRL   OF WRK-NEGCVIGE
                                            TO WRK-JH-CONTA
      ...
      *---------------------------------------------------------------*
           ...
           WRITE FD-NEGCVIGS           FROM WRK-NEGCVIGS.
      ...
      *---------------------------------------------------------------*
      *
           MOVE GFCTWBDF-CBCO-SALRL
                                      TO GFCTWBTF-CBCO-SALRL
           MOVE GFCTWBDF-CAG-BCRIA-SALRL
                                      TO GFCTWBTF-CAG-BCRIA-SALRL
           MOVE GFCTWBDF-CCTA-BCRIA-SALRL
                                      TO GFCTWBTF-CCTA-BCRIA-SALRL
           MOVE GFCTWBDF-NFLEXZ-TARIF-AVULS
                                      TO GFCTWBTF-NFLEXZ-TARIF-AVULS
           MOVE GFCTWBDF-CBCO-CLI
                                      TO GFCTWBTF-CBCO-CLI
           MOVE GFCTWBDF-CAG-BCRIA
                                      TO GFCTWBTF-CAG-BCRIA
           MOVE GFCTWBDF-CCTA-BCRIA-CLI
                                      TO GFCTWBTF-CCTA-BCRIA-CLI
           MOVE GFCTWBDF-CPSSOA-JURID-CONTR
                                      TO GFCTWBTF-CPSSOA-JURID-CONTR
           MOVE GFCTWBDF-CTPO-CONTR-NEGOC
                                      TO GFCTWBTF-CTPO-CONTR-NEGOC
           MOVE GFCTWBDF-NSEQ-CONTR-NEGOC
                                      TO GFCTWBTF-NSEQ-CONTR-NEGOC
           MOVE GFCTWBDF-CGRP-SERVC
                                      TO GFCTWBTF-CGRP-SERVC
           MOVE GFCTWBDF-DINIC-VGCIA-SERVC
                                      TO GFCTWBTF-DINIC-VGCIA-SERVC
           MOVE GFCTWBDF-DINIC-VGCIA-FLEXZ
                                      TO GFCTWBTF-DINIC-VGCIA-FLEXZ
           MOVE GFCTWBDF-DINIC-VGCIA-FLEXZ-N
                                      TO GFCTWBTF-DINIC-VGCIA-FLEX-NULL
           MOVE GFCTWBDF-DFIM-VGCIA-FLEXZ
                                      TO GFCTWBTF-DFIM-VGCIA-FLEXZ
           MOVE GFCTWBDF-DFIM-VGCIA-FLEXZ-N
                                      TO GFCTWBTF-DFIM-VGCIA-FLEX-NULL
           MOVE GFCTWBDF-CINDCD-TPO-NEGOC
                                      TO GFCTWBTF-CINDCD-TPO-NEGOC
           MOVE GFCTWBDF-QFRANQ-TARIF-CADTR
                                      TO GFCTWBTF-QFRANQ-TARIF-CADTR
           MOVE GFCTWBDF-CSIT-NEGOC-TARIF
                                      TO GFCTWBTF-CSIT-NEGOC-TARIF
           MOVE GFCTWBDF-CSIST
                                      TO GFCTWBTF-CSIST
           MOVE GFCTWBDF-CUSUAR-INCL
                                      TO GFCTWBTF-CUSUAR-INCL
           MOVE GFCTWBDF-RJUSTF-INC-NEG-LEN
                                      TO GFCTWBTF-RJUSTF-INCL-NEG-LEN
           MOVE GFCTWBDF-RJUSTF-INC-NEG-TEXT
                                      TO GFCTWBTF-RJUSTF-INCL-NEG-TEXT

           MOVE  CHEQ-RAZ             TO WRK-RAZAO-R

           MOVE  WRK-RAZAO1           TO WRK-GRUPO-RAZAO-02
           MOVE  WRK-GRUPO-RAZAO      TO GFCTWBTF-CGRUPO-SALRL

           MOVE  WRK-RAZAO2           TO WRK-GRUPO-RAZAO-02
           MOVE  WRK-GRUPO-RAZAO      TO GFCTWBTF-CSUBGR-SALRL.
      ...
      *---------------------------------------------------------------
           ...
           DISPLAY '************ PROGRAMA GFCT2BDF *************'
           DISPLAY '*                                          *'
           DISPLAY '* PROGRAMA GFCT2BDF ENCERRADO COM SUCESSO  *'
           DISPLAY '*                                          *'
           DISPLAY '************ PROGRAMA GFCT2BDF *************'
