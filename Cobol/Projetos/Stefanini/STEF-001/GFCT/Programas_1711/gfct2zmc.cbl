      ...
      *                  ATUALIZAR NO ARQUIVO DE SAIDA - CONTA DESTINO *
      *----------------------------------------------------------------*
      *    ARQUIVOS....:                              DE/BOOK         *
      *                        MULTIPAE            GFCTWQHF           *
      *                        ECCTACLI            I#CHEQ04           *
      ...
      *---------------------------------------------------------------*
       01  FILLER                      PIC  X(050)         VALUE
           '*** GFCT2ZMC - INICIO DA AREA DE WORKING ***'.
      *---------------------------------------------------------------*
      ...
      *---------------------------------------------------------------*
       01  FILLER                      PIC  X(050)         VALUE
           '*** GFCT2ZMC - FIM DA AREA DE WORKING ***'.
      *---------------------------------------------------------------*
      ...
      *---------------------------------------------------------------*
           ...
           MOVE GFCTWQHF-CAG-RCDOR         TO WRK-JH-AGENCIA
           MOVE WRK-JH-AGE                 TO WRK-AGENCIA-FTCONTB

           MOVE GFCTWQHF-CCTA-RCDOR        TO WRK-JH-CONTA
      ...
      *
           ...
           MOVE WRK-GRUPO-RAZAO          TO GFCTWQHF-CGRUPO-DSTNO

           MOVE WRK-RAZAO2               TO WRK-GRUPO-RAZAO-02
           MOVE WRK-GRUPO-RAZAO          TO GFCTWQHF-CSUBGR-DSTNO.
      ...
      *---------------------------------------------------------------
           ...
           DISPLAY '************ PROGRAMA GFCT2ZMC *************'
           DISPLAY '*                                          *'
           DISPLAY '* PROGRAMA GFCT2ZMC ENCERRADO COM SUCESSO  *'
           DISPLAY '*                                          *'
           DISPLAY '************ PROGRAMA GFCT2ZMC *************'
