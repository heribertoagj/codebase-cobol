      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT2050'.
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCGC-CPF            OF GFCTB050
                                    TO CCGC-CPF-ST
                                    OF GFCTB050
           
           MOVE CFLIAL-CGC          OF GFCTB050
                                    TO CFLIAL-CGC-ST
                                    OF GFCTB050
           
           MOVE CCTRL-CPF-CGC-ST    OF GFCTB050
                                    TO CCTRL-CPF-CGC-ST
                                    OF GFCTB050.

      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.FLEXZ_GRP_CLI
                  SET CCGC_CPF_ST      = :GFCTB050.CCGC-CPF-ST,
                      CFLIAL_CGC_ST    = :GFCTB050.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST = :GFCTB050.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT2050'.
           DISPLAY '*'
