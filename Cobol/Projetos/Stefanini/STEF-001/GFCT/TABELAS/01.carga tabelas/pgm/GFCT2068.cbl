      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT2068'.
      ...
      *----------------------------------------------------------------*
           ...
           OR (SQLWARN0                EQUAL 'W')            
              MOVE 'GSTAO_CLI_ESTRN'   TO ERR-DBD-TAB        
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCGC-CPF              OF GFCTB068
                                      TO CCGC-CPF-ST
                                      OF GFCTB068

           MOVE CFLIAL-CGC            OF GFCTB068
                                      TO CFLIAL-CGC-ST
                                      OF GFCTB068

           MOVE CCTRL-CPF-CGC         OF GFCTB068
                                      TO CCTRL-CPF-CGC-ST
                                      OF GFCTB068.

      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.GSTAO_CLI_ESTRN
                  SET CCGC_CPF_ST    = :GFCTB068.CCGC-CPF-ST,
                      CFLIAL_CGC_ST  = :GFCTB068.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST = :GFCTB068.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT2068'.
           DISPLAY '*'
