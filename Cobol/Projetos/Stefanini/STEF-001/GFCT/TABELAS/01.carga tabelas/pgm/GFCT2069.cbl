      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT2069'.
      ...
      *----------------------------------------------------------------*
           ...
           OR (SQLWARN0                EQUAL 'W')            
              MOVE 'GSTAO_CLI_SERVC'   TO ERR-DBD-TAB        
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCGC-CPF              OF GFCTB069
                                      TO CCGC-CPF-ST
                                      OF GFCTB069
           
           MOVE CFLIAL-CGC            OF GFCTB069
                                      TO CFLIAL-CGC-ST
                                      OF GFCTB069
           
           MOVE CCTRL-CPF-CGC         OF GFCTB069
                                      TO CCTRL-CPF-CGC-ST
                                      OF GFCTB069.   
      ...
      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.GSTAO_CLI_SERVC
                  SET CCGC_CPF_ST       = :GFCTB069.CCGC-CPF-ST,
                      CFLIAL_CGC_ST     = :GFCTB069.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST  = :GFCTB069.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT2069'.
           DISPLAY '*'
