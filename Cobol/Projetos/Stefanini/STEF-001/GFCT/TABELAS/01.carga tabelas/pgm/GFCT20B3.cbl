      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20B3'.
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCGC-CPF        TO CCGC-CPF-ST
                                OF GFCTB0B3
           MOVE CFLIAL-CGC      TO CFLIAL-CGC-ST
                                OF GFCTB0B3

      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.PDIDO_FLEXZ_CLI
                  SET CCGC_CPF_ST       = :GFCTB0B3.CCGC-CPF-ST,
                      CFLIAL_CGC_ST     = :GFCTB0B3.CFLIAL-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20B3'.
           DISPLAY '*'
