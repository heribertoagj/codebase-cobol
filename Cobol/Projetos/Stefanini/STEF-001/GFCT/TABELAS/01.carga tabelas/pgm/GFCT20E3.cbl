      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20E3'.
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCGC-CPF        OF GFCTB0E3
                                TO CCGC-CPF-ST
                                OF GFCTB0E3

           MOVE CFLIAL-CGC      OF GFCTB0E3
                                TO CFLIAL-CGC-ST
                                OF GFCTB0E3
           
           MOVE CCTRL-CPF-CGC   OF GFCTB0E3
                                TO CCTRL-CPF-CGC-ST
                                OF GFCTB0E3.   
      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.SUSP_GRP_CLI
                  SET CCGC_CPF_ST       = :GFCTB0E3.CCGC-CPF-ST,
                      CFLIAL_CGC_ST     = :GFCTB0E3.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST  = :GFCTB0E3.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20E3'.
           DISPLAY '*'
