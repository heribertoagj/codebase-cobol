      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20H8'.
      ...
      *----------------------------------------------------------------*
           ...
           OR (SQLWARN0                EQUAL 'W')            
              MOVE 'TDEB_UNFCA_CLI'      TO ERR-DBD-TAB        
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           ...
           MOVE CCTRL-CPF-CGC         OF GFCTB0H8
                                      TO CCTRL-CPF-CGC-ST
                                      OF GFCTB0H8.
      ...
      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.TDEB_UNFCA_CLI
                  SET CCGC_CPF_ST       = :GFCTB0H8.CCGC-CPF-ST,
                      CFLIAL_CGC_ST     = :GFCTB0H8.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST  = :GFCTB0H8.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20H8'.
           DISPLAY '*'
