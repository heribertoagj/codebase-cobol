      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20H9'.
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCGC-CPF        OF GFCTB0H9
                                TO CCGC-CPF-ST
                                OF GFCTB0H9

           MOVE CFLIAL-CGC      OF GFCTB0H9
                                TO CFLIAL-CGC-ST
                                OF GFCTB0H9

           MOVE CCTRL-CPF-CGC   OF GFCTB0H9
                                TO CCTRL-CPF-CGC-ST
                                OF GFCTB0H9.

      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.TADSAO_GRP_CLI
                  SET CCGC_CPF_ST      = :GFCTB0H9.CCGC-CPF-ST,
                      CFLIAL_CGC_ST    = :GFCTB0H9.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST = :GFCTB0H9.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20H9'.
           DISPLAY '*'.
