      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20I0'.
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCGC-CPF        OF GFCTB0I0
                                TO CCGC-CPF-ST
                                OF GFCTB0I0

           MOVE CFLIAL-CGC      OF GFCTB0I0
                                TO CFLIAL-CGC-ST
                                OF GFCTB0I0
           
           MOVE CCTRL-CPF-CGC   OF GFCTB0I0
                                TO CCTRL-CPF-CGC-ST
                                OF GFCTB0I0.   

      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.TPRMSS_GRP_CLI
                  SET CCGC_CPF_ST      = :GFCTB0I0.CCGC-CPF-ST,
                      CFLIAL_CGC_ST    = :GFCTB0I0.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST = :GFCTB0I0.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20I0'.
           DISPLAY '*'.
