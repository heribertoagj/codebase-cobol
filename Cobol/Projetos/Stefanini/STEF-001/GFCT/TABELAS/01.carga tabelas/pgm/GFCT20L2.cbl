      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20L2'.
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCNPJ-CPF            OF GFCTB0L2
                                     TO CCNPJ-CPF-ST
                                     OF GFCTB0L2

           MOVE CFLIAL-CNPJ          OF GFCTB0L2
                                     TO CFLIAL-CNPJ-ST
                                     OF GFCTB0L2

           MOVE CCTRL-CNPJ           OF GFCTB0L2
                                     TO CCTRL-CNPJ-ST
                                     OF GFCTB0L2.                               

      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.TCANCT_ADSAO_FORNC
                  SET CCNPJ_CPF_ST       = :GFCTB0L2.CCNPJ-CPF-ST,
                      CFLIAL_CNPJ_ST     = :GFCTB0L2.CFLIAL-CNPJ-ST,
                      CCTRL_CNPJ_ST      = :GFCTB0L2.CCTRL-CNPJ-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20L2'.
           DISPLAY '*'
