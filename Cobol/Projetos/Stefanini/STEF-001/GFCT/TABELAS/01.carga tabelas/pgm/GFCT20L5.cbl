      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20L5'.
      ...
      *----------------------------------------------------------------*
           ...
           OR (SQLWARN0                EQUAL 'W')            
              MOVE 'TAUTRZ_ENVIO_CLI'   TO ERR-DBD-TAB        
      ...
      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.TAUTRZ_ENVIO_CLI
                  SET CCNPJ_CPF_ST       = :GFCTB0L5.CCNPJ-CPF-ST,
                      CFLIAL_CGC_ST     = :GFCTB0L5.CFLIAL-CGC-ST,
                      CCTRL_CPF_CGC_ST  = :GFCTB0L5.CCTRL-CPF-CGC-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20L5'.
           DISPLAY '*'
