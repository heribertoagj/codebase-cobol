      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT20N9'.
      ...
      *----------------------------------------------------------------*
           ...
           OR (SQLWARN0                EQUAL 'W')            
              MOVE 'TCLI_SEM_CESTA'    TO ERR-DBD-TAB        
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
           MOVE CCPF-CNPJ             OF GFCTB0N9
                                      TO CCPF-CNPJ-ST
                                      OF GFCTB0N9

           MOVE CFLIAL-CPF-CNPJ       OF GFCTB0N9
                                      TO CFLIAL-CPF-CNPJ-ST
                                      OF GFCTB0N9

           MOVE CCTRL-CPF-CNPJ        OF GFCTB0N9
                                      TO CCTRL-CPF-CNPJ-ST
                                      OF GFCTB0N9.

      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.TCLI_SEM_CESTA
                  SET CCPF_CNPJ_ST  = :GFCTB0N9.CCPF-CNPJ-ST,
                      CFLIAL_CPF_CNPJ_ST 
                                    = :GFCTB0N9.CFLIAL-CPF-CNPJ-ST,
                      CCTRL_CPF_CNPJ_ST 
                                    = :GFCTB0N9.CCTRL-CPF-CNPJ-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT20N9'.
           DISPLAY '*'
