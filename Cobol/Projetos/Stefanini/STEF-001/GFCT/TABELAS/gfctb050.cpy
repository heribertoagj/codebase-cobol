      ******************************************************************
      * DCLGEN TABLE(DB2PRD.FLEXZ_GRP_CLI)                             *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB050))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB050)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.FLEXZ_GRP_CLI TABLE
           ( CSERVC_TARIF                   DECIMAL(5, 0) NOT NULL,
             ...
             CCGC_CPF_ST                    CHAR(9),
             CFLIAL_CGC_ST                  CHAR(4),
             CCTRL_CPF_CGC_ST               DECIMAL(2, 0) NOT NULL
           ) END-EXEC.
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.FLEXZ_GRP_CLI               *
      ******************************************************************
       01  GFCTB050.
      *    *************************************************************
