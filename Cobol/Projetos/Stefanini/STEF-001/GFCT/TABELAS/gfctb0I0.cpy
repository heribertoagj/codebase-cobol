      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TPRMSS_GRP_CLI)                            *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0I0))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0I0)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TPRMSS_GRP_CLI TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TPRMSS_GRP_CLI              *
      ******************************************************************
       01  GFCTB0I0.
      *    *************************************************************
