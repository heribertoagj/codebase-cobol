      ******************************************************************
      * DCLGEN TABLE(DB2PRD.SUSP_GRP_CLI)                              *
      *        LIBRARY(AD.DB2.DCLGEN(GFCTB0E3))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(GFCTB0E3)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.SUSP_GRP_CLI TABLE
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.SUSP_GRP_CLI                *
      ******************************************************************
       01  GFCTB0E3.
      *    *************************************************************
