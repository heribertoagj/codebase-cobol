      ...
      *----------------------------------------------------------------*
       ...
       01  WRK-PGM                     PIC X(08) VALUE 'GFCT2A16'.
      ...
      *----------------------------------------------------------------*
           ...
           EXEC SQL
               ...
               SELECT CCGC_CPF
                 FROM DB2PRD.TFLEXZ_CNPJ_PRINC
                 FOR UPDATE OF CCGC_CPF_ST
           END-EXEC.
      *----------------------------------------------------------------*
       01  FILLER                      PIC X(032)      VALUE
          '*    FIM DA WORKING GFCT2A16   *'.
      *----------------------------------------------------------------*
      *================================================================*
       PROCEDURE                       DIVISION.
      *================================================================*
      ...
      *----------------------------------------------------------------*
           ...
           OR (SQLWARN0                EQUAL 'W')            
              MOVE 'TFLEXZ_CNPJ_PRINC' TO ERR-DBD-TAB        
      ...
      *-- MOVENDO DADOS NUMERICOS PARA CAMPOS ALFANUMERICOS
            MOVE CCGC-CPF        OF CEPTB016
                                 TO CCGC-CPF-ST
                                 OF CEPTB016
 
      *-- ATUALIZANDO O REGISTRO
           EXEC SQL
               UPDATE DB2PRD.TFLEXZ_CNPJ_PRINC
                  SET CCGC_CPF_ST       = :CEPTB016.CCGC-CPF-ST
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '* FIM DO PROGRAMA GFCT2A16'.
           DISPLAY '*'
